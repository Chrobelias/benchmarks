...
(assert (and (> (+ (* it261 2) it262 (* it260 (- 1)) 3) 0) (= (+ it257 (- 20)) 0)))
(assert (= (+ it264 (- 18)) 0))
(assert (= (+ (* it258 (- 1)) it265 (- 4)) 0))
(assert (= (+ (* it262 (- 1)) it266 (- 1)) 0))
(assert (= (+ it267 (* it260 (- 1))) 0))
(assert (= (+ (* it261 (- 1)) it268) 0))
(assert (= (+ (* it262 (- 1)) it269 (- 1)) 0))
(assert (= (+ it270 (* it263 (- 1))) 0))
(assert (and (= (+ it264 (- 18)) 0) (<= (+ (* it267 (- 1)) it269 2) 0)))
(assert (= (+ it271 (- 20)) 0))
(assert (= (+ (* it265 (- 1)) it272 (- 2)) 0))
(assert (= (+ it273 (* it266 (- 1))) 0))
(assert (= (+ (* it267 (- 1)) it274) 0))
(assert (= it275 0))
(assert (= (+ it276 (* it269 (- 1))) 0))
(assert (= (+ (* it270 (- 1)) it277) 0))
(assert (let ((a!1 (* (* (+ 0 it275) (** 2 (+ it101 (- 1)))) (+ 0 (- 2))))
      (a!3 (* (* (+ 0 it275) (** 2 (+ it101 (- 1)))) (+ 0 2))))
(let ((a!2 (+ (* (** 2 (+ it101 (- 1))) (+ 0 (- 2)))
  ...
  (and (>= a!2 (+ 0 0))
       (>= (+ (* it271 (- 1)) 20) 0)
       (>= (+ (* it275 (- 2)) (* it276 (- 1)) it274 (- 3)) 0)
       (>= a!4 (+ 0 0))
       (>= (+ it271 (- 20)) 0)
       (>= (+ it101 (- 1)) 0)
       (>= (+ (* it275 2) it276 (* it274 (- 1)) 3) 0)))))
(check-sat)
