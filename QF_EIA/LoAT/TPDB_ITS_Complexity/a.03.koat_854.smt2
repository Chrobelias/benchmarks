...
(assert (and (= (+ (* it2592 (- 1)) it2590) 0) (= (+ it2587 (- 3)) 0)))
(assert (= (+ it2604 (- 4)) 0))
(assert (= (+ it2605 (* it2588 (- 1)) (- 1)) 0))
(assert (= (+ (* it2589 (- 1)) it2606) 0))
(assert (= (+ it2607 (* it2590 (- 1))) 0))
(assert (= (+ it2608 (* it2591 (- 1))) 0))
(assert (= (+ (* it2592 (- 1)) it2609) 0))
(assert (let ((a!1 (>= (+ (+ it2607 (* it2606 (- 2))) (- 2)) 0))
      (a!2 (>= (+ (+ it2607 (* it2606 (- 2))) (- 1)) 0)))
  (and (>= (+ (* it2606 (- 1)) 1) 0)
       (>= (+ (* it2604 (- 1)) 4) 0)
       (>= (+ it2606 (- 1)) 0)
       a!1
