...
(assert (and (= (+ it1770 (- 20)) 0) (> (+ (* it1774 2) it1775 (* it1773 (- 1)) 3) 0)))
(assert (= (+ it1777 (- 18)) 0))
(assert (= (+ (* it1771 (- 1)) it1778 (- 4)) 0))
(assert (= (+ (* it1775 (- 1)) it1779 (- 1)) 0))
(assert (= (+ (* it1773 (- 1)) it1780) 0))
(assert (= (+ (* it1774 (- 1)) it1781) 0))
(assert (= (+ (* it1775 (- 1)) it1782 (- 1)) 0))
(assert (= (+ (* it1776 (- 1)) it1783) 0))
(assert (and (= (+ it1777 (- 18)) 0) (<= (+ it1782 (* it1780 (- 1)) 2) 0)))
(assert (= (+ it1784 (- 20)) 0))
(assert (= (+ (* it1778 (- 1)) it1785 (- 2)) 0))
(assert (= (+ (* it1779 (- 1)) it1786) 0))
(assert (= (+ it1787 (* it1780 (- 1))) 0))
(assert (= it1788 0))
(assert (= (+ (* it1782 (- 1)) it1789) 0))
(assert (= (+ it1790 (* it1783 (- 1))) 0))
(assert (let ((a!1 (* (* (exp 2 (+ it101 (- 1))) (+ 0 it1788)) (+ 0 2)))
      (a!3 (* (* (exp 2 (+ it101 (- 1))) (+ 0 it1788)) (+ 0 (- 2)))))
(let ((a!2 (+ (+ 0 (* it1787 (- 1)))
              (* (exp 2 (+ it101 (- 1))) (+ 0 2))
              a!1
              (+ 0 it1789)
  ...
  (and (>= a!2 (+ 0 0))
       (>= (+ it1784 (- 20)) 0)
       (>= a!4 (+ 0 0))
       (>= (+ it1787 (* it1788 (- 2)) (* it1789 (- 1)) (- 3)) 0)
       (>= (+ (* it1787 (- 1)) (* it1788 2) it1789 3) 0)
       (>= (+ it101 (- 1)) 0)
       (>= (+ (* it1784 (- 1)) 20) 0)))))
(check-sat)
