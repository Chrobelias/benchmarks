...
(assert (let ((a!1 (* (exp it511 2) (exp (exp 4 (+ it66 (- 1))) (+ 0 2))))
      (a!2 (* (* (exp it513 3) (exp 9 (+ it66 (- 1)))) (+ 0 (- 1))))
      (a!4 (* (* (exp 9 (+ it66 (- 1))) (+ 0 it512)) (+ 0 3)))
      (a!5 (* (* (exp it513 3) (exp 9 (+ it66 (- 1)))) (+ 0 (- 3))))
      (a!7 (> (+ (* (exp it513 5) (+ 0 (- 1)))
                 (* (exp it511 2) (+ 0 (- 1)))
                 (+ 0 it512))
              (+ 0 0))))
(let ((a!3 (+ (* (exp it513 5) (+ 0 (- 1)))
              (* a!1 (+ 0 (- 1)))
              (exp it513 3)
              (* (exp 9 (+ it66 (- 1))) (+ 0 it512))
              a!2))
      (a!6 (> (+ (* (exp it513 5) (+ 0 (- 1)))
                 (* a!1 (+ 0 (- 4)))
                 (exp it513 3)
