...
(assert (let ((a!1 (+ (* (+ 0 it1095) (** 2 (+ it134 (- 1))) (+ 0 (- 1)))
              (* (** 2 it134) (+ 0 (- 1)))
              (+ 0 it1110)
              (+ 0 1))))
  (= a!1 (+ 0 0))))
...
(assert (let ((a!1 (+ (* (** 2 it1112) (+ 0 (- 1)))
              (+ 0 it1141)
              (* (** 2 (+ it1112 (- 1))) (+ 0 it1143) (+ 0 (- 1)))))
...
(assert (and (>= (+ it1205 (- 2)) 0)
     (>= (+ it1205 (- 3)) 0)
     (= (+ it1202 (- 4)) 0)
     (= (+ it1204 (- 1)) 0)))
(assert (= (+ it1210 (- 3)) 0))
(assert (= (+ (* it1203 (- 1)) it1211 (- 2)) 0))
(assert (= (+ (* it1204 (- 1)) it1212) 0))
(assert (= (+ it1213 (* it1205 (- 1)) 1) 0))
(assert (= (+ (* it1204 (- 1)) it1214) 0))
(assert (= (+ (* it1204 (- 2)) it1215) 0))
(assert (let ((a!1 (+ (+ (+ it1213 (* it1130 (- 1))) (* it1144 (- 1))) (- 2)))
      (a!2 (+ (+ (+ it1213 (* it1130 (- 1))) (* it1212 (- 2))) (- 1)))
      (a!3 (+ (+ (+ it1213 (* it1130 (- 1))) (* it1144 (- 1))) (* it1212 (- 2))))
      (a!4 (+ (+ (+ it1213 (* it1130 (- 1))) (* it1212 (- 2))) 1))
      (a!5 (>= (+ (+ it1213 (* it1215 (- 1))) (- 1)) 0))
      (a!6 (>= (+ (+ it1213 (* it1130 (- 1))) (* it1212 (- 2))) 0))
      (a!7 (>= (+ (+ it1213 (* it1130 (- 1))) (- 1)) 0))
      (a!8 (>= (+ (+ it1213 (* it1130 (- 1))) (- 2)) 0))
      (a!9 (>= (+ (+ it1213 (* it1130 (- 1))) (- 3)) 0))
      (a!10 (+ (+ (+ it1213 (* it1130 (- 1))) (* it1144 (- 1))) (- 1))))
  (and (>= a!1 0)
       (>= (+ it1213 (* it1215 (- 1))) 0)
       (>= a!2 0)
       (>= (+ a!3 1) 0)
