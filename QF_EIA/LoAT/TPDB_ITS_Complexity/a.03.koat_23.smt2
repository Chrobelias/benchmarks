...
(assert (let ((a!1 (+ (+ 0 it63)
              (* (** 2 (+ it57 (- 1))) (+ 0 it25) (+ 0 (- 1))))))
  (= a!1 (+ 0 0))))
(assert (= (+ (* (** 2 it57) (+ 0 it25) (+ 0 (- 1))) (+ 0 it64)) (+ 0 0)))
(assert (let ((a!1 (>= (+ (+ (* it88 (- 1)) it62) (- 1)) 0))
      (a!2 (+ (+ (+ (* it88 (- 1)) it62) (* it61 (- 2))) 1))
      (a!3 (>= (+ (+ (* it88 (- 1)) it62) (- 2)) 0))
      (a!4 (>= (+ (+ it62 (* it64 (- 1))) (- 1)) 0))
      (a!5 (>= (+ (+ (* it88 (- 1)) it62) (* it61 (- 2))) 0)))
  (and (>= (+ it62 (* it64 (- 1))) 0)
       a!1
       (>= (+ it59 (- 3)) 0)
       (>= (+ it62 (- 3)) 0)
...
(assert (= (+ (* it88 (- 3)) it90 (* it60 (- 1))) 0))
(assert (= (+ it91 (* it61 (- 1))) 0))
(assert (= (+ it92 it88 (* it62 (- 1))) 0))
(assert (= (+ it93 (* it61 (- 1))) 0))
(assert (= (+ it94 (* it61 (- 2))) 0))
(assert (let ((a!1 (>= (+ (+ it92 (* it26 (- 1))) (- 1)) 0))
      (a!2 (>= (+ (+ it92 (* it26 (- 1))) (* it91 (- 2))) 0))
      (a!3 (+ (+ (+ it92 (* it26 (- 1))) (* it91 (- 2))) 1))
      (a!4 (>= (+ (+ it92 (* it94 (- 1))) (- 1)) 0))
      (a!5 (>= (+ (+ it92 (* it26 (- 1))) (- 2)) 0)))
  (and (>= (+ it92 (* it94 (- 1))) 0)
       (>= (+ it92 (- 2)) 0)
       ...
       a!5
       (>= (+ (* it91 (- 1)) 1) 0))))
(assert (= (+ (* it89 (- 1)) it105) 0))
(assert (= (+ it106 (* it26 (- 3)) (* it90 (- 1))) 0))
(assert (= (+ it107 (* it91 (- 1))) 0))
(assert (= (+ (* it92 (- 1)) it26 it108) 0))
(assert (= (+ it109 (* it91 (- 1))) 0))
(assert (= (+ it110 (* it91 (- 2))) 0))
(assert (let ((a!1 (>= (+ (+ (* it110 (- 1)) it108) (- 1)) 0)))
  (and (= 0 0)
       (>= (+ (* it107 (- 1)) 1) 0)
       (= 1 0)
       (>= (+ it107 (- 1)) 0)
