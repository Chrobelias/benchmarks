...
(assert (let ((a!1 (+ (* (** 2 it326) (+ 0 (- 2)))
              (+ 0 it374)
              (* (** 2 (+ it326 (- 1))) (+ 0 it375) (+ 0 (- 2)))
              (+ 0 (* it376 (- 1)))
              (+ 0 1))))
  (and (>= (+ (* it371 (- 1)) 20) 0)
       (> a!1 (+ 0 0))
       (> (+ it374 (* it375 (- 2)) (* it376 (- 1)) (- 3)) 0)
       (>= (+ it326 (- 1)) 0)
       (>= a!1 (+ 0 0))
       (>= (+ it371 (- 20)) 0)
       (>= (+ it374 (* it375 (- 2)) (* it376 (- 1)) (- 3)) 0))))
(assert (= (+ (* it371 (- 1)) it427) 0))
(assert (= (+ it428 (* it326 (- 6)) (* it372 (- 1))) 0))
(assert (= (+ it429 (* it373 (- 1))) 0))
(assert (= (+ (* it374 (- 1)) it430) 0))
(assert (let ((a!1 (+ (* (** 2 it326) (+ 0 it375) (+ 0 (- 1)))
              (* (** 2 (+ it326 1)) (+ 0 (- 1)))
              (+ 0 it431)
              (+ 0 2))))
  (= a!1 (+ 0 0))))
(assert (= (+ it432 (* it376 (- 1))) 0))
(assert (let ((a!1 (+ (* (** 2 it326) (+ 0 (- 2)))
              (+ 0 it433)
              (* (** 2 (+ it326 (- 1))) (+ 0 it375) (+ 0 (- 2)))
              (+ 0 2))))
  (= a!1 (+ 0 0))))
(assert (and (>= (+ it432 (* it430 (- 1)) (* it431 2) 3) 0)
     (>= (+ (* it432 (- 1)) it430 (* it431 (- 2)) (- 3)) 0)
     (>= (+ (* it427 (- 1)) 20) 0)
     (<= (+ (* it430 2) (* it431 (- 2))) 0)
     (<= (+ (* it430 (- 2)) (* it431 2)) 0)
     (>= (+ it432 it430 3) 0)
