...
(assert (and (= (+ it533 (- 26)) 0)
     (>= (+ it539 (- 1)) 0)
     (<= (+ (* it542 (- 1)) it539) 0)))
(assert (= (+ it545 (- 27)) 0))
(assert (= (+ it546 (* it534 (- 1)) (- 1)) 0))
(assert (= (+ (* it535 (- 1)) it547) 0))
(assert (= (+ it548 (* it536 (- 1))) 0))
(assert (= (+ it549 (* it537 (- 1))) 0))
(assert (= (+ (* it538 (- 1)) it550) 0))
(assert (= (+ it551 (* it539 (- 1))) 0))
(assert (= (+ it552 (* it540 (- 1))) 0))
(assert (= (+ (* it541 (- 1)) it553) 0))
(assert (= (+ it554 (* it542 (- 1))) 0))
(assert (and (= (+ it545 (- 27)) 0)
     (<= (+ (* it554 (- 1)) it553) 0)
     (>= (+ it553 (- 1)) 0)))
(assert (= (+ it557 (- 13)) 0))
(assert (= (+ it558 (* it546 (- 1)) (- 1)) 0))
(assert (= (+ it559 (* it547 (- 1))) 0))
(assert (= (+ it560 (* it548 (- 1))) 0))
(assert (= (+ it561 (* it549 (- 1))) 0))
(assert (= (+ it562 (* it550 (- 1))) 0))
(assert (= (+ (* it553 (- 1)) it563) 0))
(assert (= (+ it564 (* it552 (- 1))) 0))
(assert (= (+ it565 (* it553 (- 1))) 0))
(assert (= (+ (* it554 (- 1)) it566) 0))
(assert (let ((a!1 (>= (+ (+ it566 (* it563 (- 2))) (- 1)) 0)))
  (and (= 0 0)
       (>= (* it563 2) 0)
       a!1
       (>= (* it237 (- 1)) 0)
