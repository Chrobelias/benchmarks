...
(assert (let ((a!1 (+ (* (+ 0 it872) (** it488 3) (** it92 2) (+ 0 (- 24)))
              ...
              (* (** it488 2) (** it92 2) (+ 0 6)))))
  (= a!1 (+ 0 0))))
(assert (and (= (+ it953 (- 2)) 0) (> it955 0)))
(assert (= (+ it988 (- 2)) 0))
(assert (= (+ it989 (* it954 (- 1)) (- 1)) 0))
(assert (= (+ (* it955 (- 1)) it990 1) 0))
(assert (= (+ it991 (* it956 (- 3)) (* it957 (- 2))) 0))
(assert (= (+ it992 (* it956 5) (* it957 3)) 0))
(assert (let ((a!1 (+ (+ 0 (+ (* it958 (- 1)) it993))
              (* (** it955 2) (+ 0 (- 1))))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (> (+ (+ (* it960 (- 2)) it990) 1) 0))
      (a!2 (> (+ (+ (* it960 (- 2)) it990) 2) 0))
      (a!3 (> (+ (+ (* it961 (- 2)) (* it960 (- 2)) it990) 2) 0))
      (a!4 (> (+ (+ (* it961 (- 2)) (* it960 (- 2)) it990) 1) 0)))
  (and a!1
       a!2
       a!3
       (>= (+ it960 (- 1)) 0)
