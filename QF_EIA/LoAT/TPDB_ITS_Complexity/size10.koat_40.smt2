...
(assert (and (> (+ it212 it214) 0) (= (+ it209 (- 3)) 0)))
(assert (= (+ it255 (- 3)) 0))
(assert (= (+ (* it210 (- 1)) it256 (- 1)) 0))
(assert (= (+ it257 (* it211 (- 1))) 0))
(assert (= (+ (* it212 (- 1)) it258 1) 0))
(assert (= (+ (* it213 (- 1)) it259) 0))
(assert (= (+ it260 (* it214 (- 1)) 1) 0))
(assert (= (+ (* it215 (- 1)) it261) 0))
(check-sat)
