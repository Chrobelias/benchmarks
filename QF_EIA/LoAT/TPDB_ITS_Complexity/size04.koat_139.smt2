...
(assert (= (+ (+ 0 (* it552 3))
   ...
   (+ 0 0)))
(assert (and (= (+ it547 (- 2)) 0) (> it549 0) (> (+ it549 (- 1)) 0)))
(assert (= (+ it635 (- 2)) 0))
(assert (= (+ (* it548 (- 1)) it636 (- 2)) 0))
(assert (= (+ it637 (* it549 (- 1)) 2) 0))
(assert (= (+ it550 it638) 0))
(assert (= (+ it551 it639) 0))
(assert (let ((a!1 (+ (+ 0 (+ it640 (* it552 (- 1))))
              (* (exp (+ it549 (- 1)) 2) (+ 0 (- 1)))
              (* (exp it549 2) (+ 0 (- 1))))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (> (+ (+ it637 (* it553 (- 2)) (* it499 (- 2))) 1) 0))
      (a!2 (> (+ (+ it637 (* it553 (- 2)) (* it499 (- 2))) 2) 0))
      (a!3 (> (+ (+ it637 (* it499 (- 2))) 1) 0))
      (a!4 (> (+ (+ it637 (* it499 (- 2))) 2) 0)))
  (and (>= (+ (* it635 (- 1)) 2) 0)
       (>= (+ it499 (- 1)) 0)
       a!1
       (>= (+ it553 (- 1)) 0)
