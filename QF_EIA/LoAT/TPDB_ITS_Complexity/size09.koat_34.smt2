...
(assert (let ((a!1 (+ 0 (+ it7 (* it81 (+ it190 (- 1)) (- 2)) (* it81 (- 2)) 1))))
  (= (+ (* a!1 (** (- 1) it160) (+ 0 (- 2))) (+ 0 it196)) (+ 0 0))))
(assert (let ((a!1 (+ 0 (+ it7 (* it81 (+ it190 (- 1)) (- 2)) (* it81 (- 2)) 1))))
  (= (+ (* a!1 (** (- 1) it160) (+ 0 (- 3))) (+ 0 it197)) (+ 0 0))))
...
(assert (let ((a!1 (> (+ (+ (* it201 (- 2)) it220) 1) 0))
      (a!2 (> (+ (+ (* it201 (- 2)) it220) 2) 0)))
  (and (>= (+ it218 (- 2)) 0)
       (>= (+ (* it218 (- 1)) 2) 0)
       (>= (+ it201 (- 1)) 0)
       a!1
       a!2)))
(assert (= (+ (* it218 (- 1)) it255) 0))
(assert (= (+ it256 (* it201 (- 2)) (* it219 (- 1))) 0))
(assert (= (+ (* it201 2) it257 (* it220 (- 1))) 0))
(assert (= (+ (* (+ 0 it221) (** (- 1) it201) (+ 0 (- 1))) (+ 0 it258))
   (+ 0 0)))
(assert (= (+ (+ 0 it259) (* (** (- 1) it201) (+ 0 it222) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (+ 0 (* it201 (- 1)))
      (* (** it201 2) (+ 0 it220) (+ 0 12))
      (+ 0 (* it260 3))
      (+ 0 (* it201 it220 (- 6)))
      (* (** it201 2) (+ 0 6))
      (* (+ 0 it201) (** it220 2) (+ 0 (- 6)))
      ...
      (+ 0 (* it223 (- 3))))
   (+ 0 0)))
(assert (= (+ (* it224 (- 1)) it261) 0))
(assert (let ((a!1 (> (+ (+ (* it225 (- 2)) it261) 1) 0))
      (a!2 (> (+ (+ (* it225 (- 2)) it261) 2) 0))
      (a!3 (> (+ (+ it257 (* it15 (- 2))) 1) 0))
      (a!4 (> (+ (+ it257 (* it15 (- 2))) 2) 0)))
  (and (> it261 0)
       (>= (+ (* it255 (- 1)) 2) 0)
       (>= (+ it255 (- 2)) 0)
       (>= (+ it15 (- 1)) 0)
