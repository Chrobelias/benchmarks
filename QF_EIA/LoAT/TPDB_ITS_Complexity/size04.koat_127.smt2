...
(assert (and (= (+ it610 (- 3)) 0) (> (+ it613 it614 it615) 0)))
(assert (= (+ it619 (- 3)) 0))
(assert (= (+ it620 (* it611 (- 1)) (- 1)) 0))
(assert (= (+ it621 (* it612 (- 1))) 0))
(assert (= (+ (* it613 (- 1)) it622 1) 0))
(assert (= (+ it623 (* it614 (- 1)) 1) 0))
(assert (= (+ it624 (* it615 (- 1)) 1) 0))
(assert (and (>= (+ (* it619 (- 1)) 3) 0)
     (> (+ it623 it624 it622) 0)
     (>= (+ it619 (- 3)) 0)
     (= 1 0)))
(check-sat)
