...
(assert (and (> (+ it33 it34 it35) 0) (= (+ it30 (- 3)) 0)))
(assert (= (+ it66 (- 3)) 0))
(assert (= (+ (* it31 (- 1)) it67 (- 1)) 0))
(assert (= (+ it68 (* it32 (- 1))) 0))
(assert (= (+ (* it33 (- 1)) it69 1) 0))
(assert (= (+ (* it34 (- 1)) it70 1) 0))
(assert (= (+ it71 (* it35 (- 1)) 1) 0))
(assert (and (> (+ it71 it69 it70) 0)
     (>= (+ (* it66 (- 1)) 3) 0)
     (>= (+ it66 (- 3)) 0)
     (= 1 0)))
(check-sat)
