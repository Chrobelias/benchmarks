...
(assert (and (>= (+ it782 (* it783 2) (* it781 (- 1)) 2) 0) (= (+ it779 (- 7)) 0)))
(assert (= (+ it793 (- 5)) 0))
(assert (= (+ it794 (* it780 (- 1)) (- 2)) 0))
(assert (= (+ it795 (* it781 (- 1))) 0))
(assert (= (+ it796 (* it782 (- 1)) (- 1)) 0))
(assert (= (+ it797 (* it783 (- 1))) 0))
(assert (= (+ it798 (* it784 (- 1))) 0))
(assert (and (= (+ it793 (- 5)) 0) (>= (+ (* it796 (- 1)) it795 (- 2)) 0)))
(assert (= (+ it803 (- 7)) 0))
(assert (= (+ it804 (* it794 (- 1)) (- 2)) 0))
(assert (= (+ it805 (* it795 (- 1))) 0))
(assert (= (+ (* it796 (- 1)) it806) 0))
(assert (= it807 0))
(assert (= (+ it808 (* it798 (- 1))) 0))
(assert (let ((a!1 (>= (+ (+ it805 (* it806 (- 1)) (* it807 (- 2))) (- 4)) 0))
      (a!2 (>= (+ (+ (* it805 (- 1)) (* it806 (- 1))) (- 4)) 0))
      (a!3 (>= (+ (+ (* it805 (- 1)) (* it806 (- 1))) (- 3)) 0))
      (a!4 (>= (+ (+ it805 (* it806 (- 1)) (* it807 (- 2))) (- 3)) 0)))
  (and (>= (+ (* it803 (- 1)) 7) 0)
       a!1
       a!2
       a!3
