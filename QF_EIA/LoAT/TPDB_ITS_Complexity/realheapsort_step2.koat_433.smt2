...
(assert (and (= (+ it905 (- 7)) 0) (>= (+ (* it907 (- 1)) it908 (* it909 2) 2) 0)))
(assert (= (+ it917 (- 5)) 0))
(assert (= (+ (* it906 (- 1)) it918 (- 2)) 0))
(assert (= (+ (* it907 (- 1)) it919) 0))
(assert (= (+ (* it908 (- 1)) it920 (- 1)) 0))
(assert (= (+ it921 (* it909 (- 1))) 0))
(assert (= (+ (* it910 (- 1)) it922) 0))
(assert (and (= (+ it917 (- 5)) 0) (>= (+ (* it919 (- 1)) it920 1) 0)))
(assert (= (+ it927 (- 15)) 0))
(assert (= (+ it928 (* it918 (- 1)) (- 2)) 0))
(assert (= (+ (* it919 (- 1)) it929) 0))
(assert (= (+ (* it920 (- 1)) it930) 0))
(assert (= (+ it931 (* it921 (- 1))) 0))
(assert (= (+ it932 (* it922 (- 1))) 0))
(check-sat)
