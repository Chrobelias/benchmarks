...
(assert (and (>= (+ it1040 (- 2)) 0)
     (= (+ it1037 (- 4)) 0)
     (>= (+ it1040 (- 3)) 0)
     (= (+ it1039 (- 1)) 0)))
(assert (= (+ it1045 (- 3)) 0))
(assert (= (+ (* it1038 (- 1)) it1046 (- 2)) 0))
(assert (= (+ (* it1039 (- 1)) it1047) 0))
(assert (= (+ (* it1040 (- 1)) it1048 1) 0))
(assert (= (+ it1049 (* it1039 (- 1))) 0))
(assert (= (+ (* it1039 (- 2)) it1050) 0))
(assert (let ((a!1 (+ (+ (+ it1048 (* it941 (- 1))) (* it1047 (- 2))) 1))
      (a!2 (>= (+ (+ it1048 (* it941 (- 1))) (- 1)) 0))
      (a!3 (+ (+ (+ it1048 (* it941 (- 1))) (* it1047 (- 2))) (- 1)))
      (a!4 (>= (+ (+ it1048 (* it1050 (- 1))) (- 1)) 0))
      (a!5 (+ (+ (+ it1048 (* it941 (- 1))) (* it19 (- 1))) (- 2)))
      (a!6 (>= (+ (+ it1048 (* it941 (- 1))) (* it1047 (- 2))) 0))
      (a!7 (+ (+ (+ it1048 (* it941 (- 1))) (* it19 (- 1))) (- 1)))
      (a!8 (+ (+ (+ it1048 (* it941 (- 1))) (* it19 (- 1))) (* it1047 (- 2))))
      (a!9 (>= (+ (+ it1048 (* it941 (- 1))) (- 2)) 0))
      (a!10 (>= (+ (+ it1048 (* it941 (- 1))) (- 3)) 0)))
  (and (>= a!1 0)
       a!2
       (>= a!3 0)
       (>= (+ it1045 (- 3)) 0)
