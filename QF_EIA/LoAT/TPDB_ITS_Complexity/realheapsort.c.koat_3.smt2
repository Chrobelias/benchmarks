...
(assert (= (+ it678 (- 33)) 0))
(assert (= (+ it788 (- 27)) 0))
(assert (= (+ (* it679 (- 1)) it789 (- 2)) 0))
(assert (= (+ it790 (* it680 (- 1))) 0))
(assert (= (+ (* it681 (- 1)) it791) 0))
(assert (= (+ (* it682 (- 1)) it792) 0))
(assert (= (+ (* it683 (- 1)) it793) 0))
(assert (= (+ (* it687 (- 1)) it794) 0))
(assert (= (+ (* it685 (- 1)) it795) 0))
(assert (= (+ (* it686 (- 1)) it796) 0))
(assert (= (+ (* it687 (- 1)) it797) 0))
(assert (let ((a!1 (* (* (exp 2 (+ it624 (- 1))) (+ 0 it794)) (+ 0 2)))
      (a!3 (* (* (exp 2 (+ it624 (- 1))) (+ 0 it794)) (+ 0 (- 2)))))
(let ((a!2 (+ a!1
              (* (exp 2 (+ it624 (- 1))) (+ 0 2))
              (+ 0 (* it792 (- 1)))
              (+ 0 it796)
  ...
  (and (>= (+ it788 (- 27)) 0)
       ...
       (>= a!2 (+ 0 0))
       (>= a!4 (+ 0 0))
       (>= (+ (* it794 (- 2)) it792 (* it796 (- 1)) (- 3)) 0)
       (>= (+ (* it788 (- 1)) 27) 0)
       (>= (+ (* it794 2) (* it792 (- 1)) it796 3) 0)))))
(check-sat)
