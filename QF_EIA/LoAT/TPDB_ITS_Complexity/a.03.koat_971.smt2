...
(declare-fun it2699 () Int)
(declare-fun it2700 () Int)
(declare-fun it2701 () Int)
...
(assert (let ((a!1 (>= (+ (+ it2652 (* it2654 (- 1))) (- 1)) 0)))
  (and (= (+ it2649 (- 3)) 0) (>= (+ it2652 (* it2654 (- 1))) 0) a!1)))
(assert (= (+ it2696 (- 4)) 0))
(assert (= (+ (* it2650 (- 1)) it2697 (- 1)) 0))
(assert (= (+ (* it2651 (- 1)) it2698) 0))
(assert (= (+ (* it2652 (- 1)) it2699) 0))
(assert (= (+ (* it2653 (- 1)) it2700) 0))
(assert (= (+ (* it2654 (- 1)) it2701 (- 1)) 0))
(assert (let ((a!1 (>= (+ (+ it2699 (* it2698 (- 2))) (- 2)) 0))
      (a!2 (>= (+ (+ it2699 (* it2698 (- 2))) (- 1)) 0)))
  (and a!1
       (>= (+ it2699 (- 3)) 0)
       (>= (+ it2698 (- 1)) 0)
       (>= (+ (* it2696 (- 1)) 4) 0)
