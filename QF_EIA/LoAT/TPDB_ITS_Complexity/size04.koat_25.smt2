...
(assert (= (+ (* (+ 0 it3) (** it13 2) (+ 0 12))
      ...
      (+ 0 (* it13 (- 1))))
   (+ 0 0)))
(assert (let ((a!1 (> (+ (+ (* it92 (- 2)) it16) 1) 0))
      (a!2 (> (+ (+ (* it92 (- 2)) it16) 2) 0)))
  (and a!1
       (>= (+ it14 (- 2)) 0)
       (>= (+ it92 (- 1)) 0)
...
(assert (= (+ (* it15 (- 1)) (* it92 (- 2)) it94) 0))
(assert (= (+ it95 (* it92 2) (* it16 (- 1))) 0))
(assert (= (+ (+ 0 it96) (* (** (- 1) it92) (+ 0 it17) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (* (** (- 1) it92) (+ 0 it18) (+ 0 (- 1))) (+ 0 it97))
   (+ 0 0)))
(assert (= (+ (+ 0 (* it92 it16 (- 6)))
      (* (** it92 2) (+ 0 6))
      (* (+ 0 it92) (** it16 2) (+ 0 (- 6)))
      (+ 0 (* it92 (- 1)))
      (* (** it92 3) (+ 0 (- 8)))
