...
(assert (= (+ (+ 0 it869) (* (** (- 1) it13) (+ 0 it4) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (* (+ 0 it5) (** (- 1) it13) (+ 0 (- 1))) (+ 0 it870))
   (+ 0 0)))
(assert (= (+ (* (+ 0 it3) (** it13 2) (+ 0 12))
      (* (** it13 3) (+ 0 (- 8)))
      (* (** it13 2) (+ 0 6))
      (+ 0 (* it3 it13 (- 6)))
      (+ 0 (* it6 (- 3)))
...
(assert (let ((a!1 (* (+ 0 it869)
              (** (- 1) (+ (* it488 it92) (* it872 it488)))
              (+ 0 (- 1)))))
  (= (+ (+ 0 it956) a!1) (+ 0 0))))
(assert (let ((a!1 (* (** (- 1) (+ (* it488 it92) (* it872 it488)))
              (+ 0 it870)
              (+ 0 (- 1)))))
  (= (+ a!1 (+ 0 it957)) (+ 0 0))))
(assert (let ((a!1 (+ (* (+ 0 it872) (** it488 3) (** it92 2) (+ 0 (- 24)))
              (* (* (** it872 2) (** it488 2)) (+ 0 6))
              (+ 0 (* it958 3))
              (* (* (+ 0 it872) (** it488 2)) (+ 0 it92) (+ 0 12))
              (* (+ 0 it488) (** it868 2) (+ 0 it92) (+ 0 (- 6)))
              (* (* (+ 0 it872) (** it488 2))
                 (+ 0 it868)
                 (+ 0 it92)
                 (+ 0 24))
              (* (** it488 2) (+ 0 it868) (** it92 2) (+ 0 12))
              (+ 0 (* it488 it92 (- 1)))
              (* (** it872 3) (** it488 3) (+ 0 (- 8)))
              (* (* (** it872 2) (** it488 2)) (+ 0 it868) (+ 0 12))
              (* (** it488 3) (** it92 3) (+ 0 (- 8)))
              (+ 0 (* (* it872 it488) (- 1)))
              (+ 0 (* (* it872 it488) it868 (- 6)))
              (* (** it872 2) (** it488 3) (+ 0 it92) (+ 0 (- 24)))
              (+ 0 (* it488 it868 it92 (- 6)))
              (* (+ 0 (* it872 it488)) (** it868 2) (+ 0 (- 6)))
              (+ 0 (* it871 (- 3)))
              (* (** it488 2) (** it92 2) (+ 0 6)))))
  (= a!1 (+ 0 0))))
(assert (= (+ it953 (- 2)) 0))
...
(assert (and (>= (+ it56 (- 1)) 0)
     (>= (+ (* it1018 (- 1)) 3) 0)
     (>= (+ it1018 (- 3)) 0)
     (> (+ it1022 (* it56 (- 2)) it1021 2) 0)))
(assert (= (+ it1048 (* it1018 (- 1))) 0))
(assert (= (+ (* it1019 (- 1)) it1049 (* it56 (- 1))) 0))
(assert (= (+ (* it1020 (- 1)) it1050) 0))
(assert (= (+ it1051 it56 (* it1021 (- 1))) 0))
(assert (= (+ (* it1022 (- 1)) it1052 it56) 0))
(assert (= (+ (* it1023 (- 1)) it1053) 0))
(assert (and (= (+ it1048 (- 3)) 0) (> (+ it1051 it1052) 0)))
(assert (= (+ it1057 (- 3)) 0))
(assert (= (+ (* it1049 (- 1)) it1058 (- 1)) 0))
(assert (= (+ it1059 (* it1050 (- 1))) 0))
(assert (= (+ (* it1051 (- 1)) it1060 1) 0))
(assert (= (+ (* it1052 (- 1)) it1061 1) 0))
(assert (= (+ it1062 (* it1053 (- 1))) 0))
(assert (and (= 1 0)
     (>= (+ it1057 (- 3)) 0)
     (>= (+ (* it1057 (- 1)) 3) 0)
     (> (+ it1060 it1061) 0)))
