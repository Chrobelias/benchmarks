...
(assert (and (= (+ it323 (- 3)) 0) (> it329 0)))
(assert (= (+ it343 (- 2)) 0))
(assert (= (+ (* it324 (- 1)) it344 (- 1)) 0))
(assert (= (+ it345 (* it329 (- 1))) 0))
(assert (= (+ it346 (* it329 (- 2))) 0))
(assert (= (+ it347 (* it329 (- 3))) 0))
(assert (= (+ (* it325 (- 1)) it348) 0))
(assert (= (+ it349 (* it329 (- 1)) 1) 0))
(assert (let ((a!1 (> (+ (+ it349 (* it81 (- 2))) 1) 0))
      (a!2 (> (+ (+ it349 (* it81 (- 2))) 2) 0))
      (a!3 (> (+ (+ (* it15 (- 2)) it345) 1) 0))
      (a!4 (> (+ (+ (* it15 (- 2)) it345) 2) 0)))
  (and (= (+ (* it349 (- 1)) (* it81 2) it345 (- 1)) 0)
       (>= (+ it15 (- 1)) 0)
       (= (* it81 2) 0)
       (>= (+ it81 (- 1)) 0)
       a!1
