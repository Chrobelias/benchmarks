...
(assert (= (+ (+ 0 it19) (* (+ 0 it4) (** (- 1) it15) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (* (+ 0 it5) (** (- 1) it15) (+ 0 (- 1))) (+ 0 it20))
   (+ 0 0)))
(assert (= (+ (* (** it15 2) (+ 0 it3) (+ 0 12))
      (+ 0 (* it21 3))
      (+ 0 (* it15 it3 (- 6)))
      (+ 0 (* it15 (- 1)))
      (+ 0 (* it6 (- 3)))
...
(assert (= (+ it58 (- 2)) 0))
(assert (= (+ it59 (* it36 (- 1)) (- 1)) 0))
(assert (= (+ it60 (* it41 (- 1))) 0))
(assert (= (+ (* it41 (- 2)) it61) 0))
(assert (= (+ it62 (* it41 (- 3))) 0))
(assert (= (+ it63 (* it37 (- 1))) 0))
(assert (= (+ (* it41 (- 1)) it64 1) 0))
(assert (and (> it60 0)
     (>= (+ it58 (- 2)) 0)
     (> (+ it60 (- 1)) 0)
     (>= (+ (* it58 (- 1)) 2) 0)
