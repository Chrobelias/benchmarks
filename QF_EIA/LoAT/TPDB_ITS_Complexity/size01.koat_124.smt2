...
(assert (= (+ (+ 0 (* it446 (- 1)))
   ...
   (+ 0 0)))
(assert (and (> it497 0) (= (+ it495 (- 2)) 0)))
(assert (= (+ it776 (- 2)) 0))
(assert (= (+ (* it496 (- 1)) it777 (- 1)) 0))
(assert (= (+ it778 (* it497 (- 1)) 1) 0))
(assert (= (+ (* it499 (- 2)) it779 (* it498 (- 3))) 0))
(assert (= (+ (* it499 3) it780 (* it498 5)) 0))
(assert (let ((a!1 (+ (+ 0 (+ it781 (* it500 (- 1))))
              (* (exp it497 2) (+ 0 (- 1))))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (> (+ (+ it778 (* it501 (- 2))) 1) 0))
      (a!2 (> (+ (+ it778 (* it501 (- 2))) 2) 0))
      (a!3 (> (+ (+ it778 (* it447 (- 2)) (* it501 (- 2))) 2) 0))
      (a!4 (> (+ (+ it778 (* it447 (- 2)) (* it501 (- 2))) 1) 0)))
  (and a!1
       a!2
       (<= (+ (* it447 2) (* it501 2)) 0)
       a!3
