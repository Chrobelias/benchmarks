...
(assert (let ((a!1 (+ (+ 0 (* (* it3 it488) it92 (- 6)))
  ...
  (= a!1 (+ 0 0))))
(assert (and (> (+ it493 (- 1)) 0) (> it493 0) (= (+ it491 (- 2)) 0)))
(assert (= (+ it521 (- 2)) 0))
(assert (= (+ it522 (* it492 (- 1)) (- 2)) 0))
(assert (= (+ it523 (* it493 (- 1)) 2) 0))
(assert (= (+ it524 it494) 0))
(assert (= (+ it525 it495) 0))
(assert (let ((a!1 (+ (* (exp it493 2) (+ 0 (- 1)))
              (+ 0 (* it496 (- 1)))
              (* (exp (+ it493 (- 1)) 2) (+ 0 (- 1)))
              (+ 0 it526))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (> (+ (+ it523 (* it499 (- 2))) 1) 0))
      (a!2 (> (+ (+ it523 (* it498 (- 2)) (* it499 (- 2))) 1) 0))
      (a!3 (> (+ (+ it523 (* it499 (- 2))) 2) 0))
      (a!4 (> (+ (+ it523 (* it498 (- 2)) (* it499 (- 2))) 2) 0)))
  (and a!1
       a!2
       a!3
       (>= (+ it498 (- 1)) 0)
