...
(assert (and (= (+ it421 (- 3)) 0) (> (+ it425 it424) 0)))
(assert (= (+ it430 (- 3)) 0))
(assert (= (+ (* it422 (- 1)) it431 (- 1)) 0))
(assert (= (+ (* it423 (- 1)) it432) 0))
(assert (= (+ (* it424 (- 1)) it433 1) 0))
(assert (= (+ (* it425 (- 1)) it434 1) 0))
(assert (= (+ (* it426 (- 1)) it435) 0))
(assert (and (= 1 0)
     (>= (+ it430 (- 3)) 0)
     (> (+ it434 it433) 0)
     (>= (+ (* it430 (- 1)) 3) 0)))
