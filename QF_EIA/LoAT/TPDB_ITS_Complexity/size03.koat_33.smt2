...
(assert (let ((a!1 (+ (* (exp it127 3) (exp it152 3) (+ 0 (- 8)))
  ...
  (= a!1 (+ 0 0))))
(assert (and (= (+ it155 (- 2)) 0) (> it157 0)))
(assert (= (+ it185 (- 2)) 0))
(assert (= (+ (* it156 (- 1)) it186 (- 1)) 0))
(assert (= (+ it187 (* it157 (- 1)) 1) 0))
(assert (= (+ (* it158 (- 3)) it188 (* it159 (- 2))) 0))
(assert (= (+ (* it158 5) (* it159 3) it189) 0))
(assert (= (+ (+ 0 it190) (* (exp it157 2) (+ 0 (- 1))) (+ 0 (* it160 (- 1))))
   (+ 0 0)))
(assert (let ((a!1 (> (+ (+ it187 (* it162 (- 2)) (* it163 (- 2))) 1) 0))
      (a!2 (> (+ (+ it187 (* it162 (- 2)) (* it163 (- 2))) 2) 0))
      (a!3 (> (+ (+ it187 (* it163 (- 2))) 1) 0))
      (a!4 (> (+ (+ it187 (* it163 (- 2))) 2) 0)))
  (and (>= (+ (* it185 (- 1)) 2) 0)
       a!1
       a!2
       (>= (+ it162 (- 1)) 0)
