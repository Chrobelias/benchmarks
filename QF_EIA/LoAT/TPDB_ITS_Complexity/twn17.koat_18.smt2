...
(assert (let ((a!1 (* (* (exp it513 3) (exp 9 (+ it200 (- 1)))) (+ 0 (- 3))))
      (a!2 (* (* (exp 9 (+ it200 (- 1))) (+ 0 it512)) (+ 0 3)))
      (a!3 (* (exp it511 2) (exp (exp 4 (+ it200 (- 1))) (+ 0 2))))
      (a!5 (* (* (exp it513 3) (exp 9 (+ it200 (- 1)))) (+ 0 (- 1))))
      (a!7 (> (+ (* (exp it513 5) (+ 0 (- 1)))
                 (* (exp it511 2) (+ 0 (- 1)))
                 (+ 0 it512))
              (+ 0 0))))
(let ((a!4 (> (+ (* (exp it513 5) (+ 0 (- 1)))
                 a!1
                 a!2
                 (exp it513 3)
                 (* a!3 (+ 0 (- 4))))
