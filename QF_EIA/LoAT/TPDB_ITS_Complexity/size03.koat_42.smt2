...
(assert (= (+ (* (exp it163 2) (+ 0 6))
   ...
   (+ 0 0)))
(assert (let ((a!1 (> (+ (+ it213 (* it162 (- 2))) 1) 0))
      (a!2 (> (+ (+ it213 (* it162 (- 2))) 2) 0)))
  (and (>= (+ it211 (- 2)) 0)
       (>= (+ (* it211 (- 1)) 2) 0)
       a!1
       a!2
       (>= (+ it162 (- 1)) 0))))
(assert (= (+ it244 (* it211 (- 1))) 0))
(assert (= (+ (* it162 (- 2)) (* it212 (- 1)) it245) 0))
(assert (= (+ it246 (* it213 (- 1)) (* it162 2)) 0))
(assert (= (+ (+ 0 it247) (* (+ 0 it214) (exp (- 1) it162) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (* (+ 0 it215) (exp (- 1) it162) (+ 0 (- 1))) (+ 0 it248))
   (+ 0 0)))
(assert (= (+ (* (exp it213 2) (+ 0 it162) (+ 0 (- 6)))
      (+ 0 (* it249 3))
      (+ 0 (* it216 (- 3)))
      (+ 0 (* it162 (- 1)))
      (* (+ 0 it213) (exp it162 2) (+ 0 12))
      (* (exp it162 3) (+ 0 (- 8)))
      (* (exp it162 2) (+ 0 6))
      (+ 0 (* it213 it162 (- 6))))
   (+ 0 0)))
(assert (let ((a!1 (> (+ (+ it246 (* it250 (- 2)) (* it217 (- 2))) 2) 0))
      (a!2 (> (+ (+ it246 (* it217 (- 2))) 2) 0))
      (a!3 (> (+ (+ it246 (* it250 (- 2)) (* it217 (- 2))) 1) 0))
      (a!4 (> (+ (+ it246 (* it217 (- 2))) 1) 0)))
  (and (>= (+ it217 (- 1)) 0)
       a!1
       (>= (+ it250 (- 1)) 0)
       (>= (+ it244 (- 2)) 0)
