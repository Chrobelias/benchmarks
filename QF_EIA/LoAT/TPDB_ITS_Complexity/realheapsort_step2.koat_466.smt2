...
(assert (let ((a!1 (+ (* (** 2 it273) (+ 0 it828) (+ 0 (- 1)))
              (* (** 2 (+ it273 1)) (+ 0 (- 1)))
              (+ 0 it838)
              (+ 0 2))))
  (= a!1 (+ 0 0))))
...
(assert (= (+ it878 (- 13)) 0))
(assert (= (+ it937 (- 7)) 0))
(assert (= (+ it938 (* it879 (- 1)) (- 2)) 0))
(assert (= (+ it939 (* it880 (- 1))) 0))
(assert (= (+ (* it881 (- 1)) it940) 0))
(assert (= (+ (* it883 (- 1)) it941) 0))
(assert (= (+ it942 (* it883 (- 1))) 0))
(assert (and (>= (+ (* it939 (- 1)) it940 (* it941 2) 2) 0) (= (+ it937 (- 7)) 0)))
(assert (= (+ it949 (- 5)) 0))
(assert (= (+ (* it938 (- 1)) it950 (- 2)) 0))
(assert (= (+ (* it939 (- 1)) it951) 0))
(assert (= (+ (* it940 (- 1)) it952 (- 1)) 0))
(assert (= (+ it953 (* it941 (- 1))) 0))
(assert (= (+ (* it942 (- 1)) it954) 0))
(assert (and (>= (+ it951 (* it952 (- 1)) (- 2)) 0) (= (+ it949 (- 5)) 0)))
(assert (= (+ it959 (- 7)) 0))
(assert (= (+ (* it950 (- 1)) it960 (- 2)) 0))
(assert (= (+ it961 (* it951 (- 1))) 0))
(assert (= (+ it962 (* it952 (- 1))) 0))
(assert (= it963 0))
(assert (= (+ it964 (* it954 (- 1))) 0))
(assert (let ((a!1 (>= (+ (+ it961 (* it962 (- 1)) (* it963 (- 2))) (- 3)) 0))
      (a!2 (>= (+ (+ (* it961 (- 1)) (* it962 (- 1))) (- 4)) 0))
      (a!3 (>= (+ (+ it961 (* it962 (- 1)) (* it963 (- 2))) (- 4)) 0))
      (a!4 (>= (+ (+ (* it961 (- 1)) (* it962 (- 1))) (- 3)) 0)))
  (and a!1
       (>= (+ (* it959 (- 1)) 7) 0)
       (>= (+ it959 (- 7)) 0)
       a!2
