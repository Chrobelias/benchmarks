...
(assert (and (> it316 0) (= (+ it311 (- 3)) 0)))
(assert (= (+ it341 (- 3)) 0))
(assert (= (+ it342 (* it312 (- 1)) (- 1)) 0))
(assert (= (+ (* it313 (- 1)) it343) 0))
(assert (= (+ (* it314 (- 1)) it344) 0))
(assert (= (+ it345 (* it315 (- 1))) 0))
(assert (= (+ (* it316 (- 1)) it346 1) 0))
(assert (and (>= (+ it341 (- 3)) 0) (> it346 0) (>= (+ (* it341 (- 1)) 3) 0) (= 1 0)))
(check-sat)
