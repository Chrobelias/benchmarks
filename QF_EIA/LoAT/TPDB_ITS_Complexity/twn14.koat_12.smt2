...
(assert (let ((a!1 (> (+ (+ 0 it361)
                 (* (exp it360 2) (+ 0 (- 1)))
                 (* (exp it362 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!2 (* (* (exp it362 3) (exp 9 (+ it109 (- 1)))) (+ 0 (- 3))))
      (a!3 (* (exp (exp 4 (+ it109 (- 1))) (+ 0 2)) (exp it360 2)))
      (a!4 (* (* (+ 0 it361) (exp 9 (+ it109 (- 1)))) (+ 0 3)))
      (a!6 (* (* (exp it362 3) (exp 9 (+ it109 (- 1)))) (+ 0 (- 1)))))
(let ((a!5 (> (+ (exp it362 3)
                 a!2
                 (* a!3 (+ 0 (- 4)))
                 a!4
