...
(assert (and (>= (+ it218 (- 2)) 0)
     (= (+ it215 (- 4)) 0)
     (= (+ it217 (- 1)) 0)
     (>= (+ it218 (- 3)) 0)))
(assert (= (+ it223 (- 3)) 0))
(assert (= (+ it224 (* it216 (- 1)) (- 2)) 0))
(assert (= (+ it225 (* it217 (- 1))) 0))
(assert (= (+ it226 (* it218 (- 1)) 1) 0))
(assert (= (+ it227 (* it217 (- 1))) 0))
(assert (= (+ it228 (* it217 (- 2))) 0))
(assert (let ((a!1 (+ (+ (* it88 (- 1)) (* it225 (- 2))) (* it19 (- 1)) it226))
      (a!2 (+ (+ (+ (* it88 (- 1)) (* it225 (- 2))) it226) (- 1)))
      (a!3 (>= (+ (+ (* it88 (- 1)) (* it19 (- 1)) it226) (- 2)) 0))
      (a!4 (>= (+ (+ (* it88 (- 1)) (* it19 (- 1)) it226) (- 1)) 0))
      (a!5 (+ (+ (+ (* it88 (- 1)) (* it225 (- 2))) it226) 1))
      (a!6 (>= (+ (+ (* it88 (- 1)) (* it225 (- 2))) it226) 0))
      (a!7 (>= (+ (+ (* it88 (- 1)) it226) (- 1)) 0))
      (a!8 (>= (+ (+ (* it88 (- 1)) it226) (- 2)) 0))
      (a!9 (>= (+ (+ (* it88 (- 1)) it226) (- 3)) 0))
      (a!10 (>= (+ (+ (* it228 (- 1)) it226) (- 1)) 0)))
  (and (>= (+ (* it228 (- 1)) it226) 0)
       (= 0 0)
       (>= (+ it19 (- 1)) 0)
       (>= (+ it88 (- 1)) 0)
