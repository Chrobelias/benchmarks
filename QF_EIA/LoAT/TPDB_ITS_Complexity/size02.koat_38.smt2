...
(assert (let ((a!1 (+ (* (exp it117 3) (exp it13 2) (+ 0 it92) (+ 0 (- 24)))
  ...
  (= a!1 (+ 0 0))))
(assert (and (> it122 0) (> (+ it122 (- 1)) 0) (= (+ it120 (- 2)) 0)))
(assert (= (+ it176 (- 2)) 0))
(assert (= (+ (* it121 (- 1)) it177 (- 2)) 0))
(assert (= (+ (* it122 (- 1)) it178 2) 0))
(assert (= (+ it123 it179) 0))
(assert (= (+ it124 it180) 0))
(assert (let ((a!1 (+ (* (exp (+ it122 (- 1)) 2) (+ 0 (- 1)))
              (* (exp it122 2) (+ 0 (- 1)))
              (+ 0 (* it125 (- 1)))
              (+ 0 it181))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (> (+ (+ (* it127 (- 2)) (* it128 (- 2)) it178) 1) 0))
      (a!2 (> (+ (+ (* it127 (- 2)) (* it128 (- 2)) it178) 2) 0))
      (a!3 (> (+ (+ (* it128 (- 2)) it178) 1) 0))
      (a!4 (> (+ (+ (* it128 (- 2)) it178) 2) 0)))
  (and a!1
       (>= (+ (* it176 (- 1)) 2) 0)
       (<= (+ (* it127 2) (* it128 2)) 0)
       a!2
