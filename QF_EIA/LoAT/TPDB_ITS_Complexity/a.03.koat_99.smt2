...
(assert (let ((a!1 (>= (+ (+ (* it236 (- 1)) it234) (- 1)) 0))
      (a!2 (+ (+ (* it88 (- 1)) (* it233 (- 2))) (* it237 (- 1)) it234))
      (a!3 (+ (+ (+ (* it88 (- 1)) (* it233 (- 2))) it234) 1))
      (a!4 (>= (+ (+ (* it88 (- 1)) (* it233 (- 2))) it234) 0))
      (a!5 (>= (+ (+ (* it88 (- 1)) it234) (- 3)) 0))
      (a!6 (>= (+ (+ (* it88 (- 1)) it234) (- 1)) 0))
      (a!7 (>= (+ (+ (* it88 (- 1)) it234) (- 2)) 0))
      (a!8 (>= (+ (+ (* it88 (- 1)) (* it237 (- 1)) it234) (- 2)) 0))
      (a!9 (>= (+ (+ (* it88 (- 1)) (* it237 (- 1)) it234) (- 1)) 0))
      (a!10 (+ (+ (+ (* it88 (- 1)) (* it233 (- 2))) it234) (- 1))))
  (and a!1
       (>= (+ (* it233 (- 1)) 1) 0)
       (>= (+ it233 (- 1)) 0)
       (>= (+ it234 (- 2)) 0)
