...
(assert (let ((a!1 (+ (* (exp it92 2) (exp it117 3) (+ 0 it13) (+ 0 (- 24)))
  ...
  (= a!1 (+ 0 0))))
(assert (and (= (+ it120 (- 2)) 0) (> it122 0) (> (+ it122 (- 1)) 0)))
(assert (= (+ it176 (- 2)) 0))
(assert (= (+ (* it121 (- 1)) it177 (- 2)) 0))
(assert (= (+ it178 (* it122 (- 1)) 2) 0))
...
(assert (let ((a!1 (+ (+ 0 it181)
              ...
              (+ 0 (* it125 (- 1))))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (> (+ (+ it178 (* it127 (- 2)) (* it128 (- 2))) 2) 0))
      (a!2 (> (+ (+ it178 (* it127 (- 2)) (* it128 (- 2))) 1) 0))
      (a!3 (> (+ (+ it178 (* it128 (- 2))) 1) 0))
      (a!4 (> (+ (+ it178 (* it128 (- 2))) 2) 0)))
  (and a!1
       (>= (+ (* it176 (- 1)) 2) 0)
       (>= (+ it176 (- 2)) 0)
       (= (+ (* it127 2) (* it128 2)) 0)
