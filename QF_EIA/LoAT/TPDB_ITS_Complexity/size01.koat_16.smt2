...
(assert (let ((a!1 (+ (* (* (exp it48 2) (exp it73 2)) (+ 0 it3) (+ 0 12))
  ...
  (= a!1 (+ 0 0))))
(assert (and (> it78 0) (= (+ it76 (- 2)) 0)))
(assert (= (+ it106 (- 2)) 0))
(assert (= (+ (* it77 (- 1)) it107 (- 1)) 0))
(assert (= (+ (* it78 (- 1)) it108 1) 0))
(assert (= (+ it109 (* it80 (- 2)) (* it79 (- 3))) 0))
(assert (= (+ (* it80 3) it110 (* it79 5)) 0))
(assert (let ((a!1 (+ (+ 0 (+ (* it81 (- 1)) it111)) (* (exp it78 2) (+ 0 (- 1))))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (> (+ (+ (* it84 (- 2)) it108) 2) 0))
      (a!2 (> (+ (+ (* it83 (- 2)) (* it84 (- 2)) it108) 1) 0))
      (a!3 (> (+ (+ (* it83 (- 2)) (* it84 (- 2)) it108) 2) 0))
      (a!4 (> (+ (+ (* it84 (- 2)) it108) 1) 0)))
  (and a!1
       a!2
       (= (+ (* it83 2) (* it84 2)) 0)
       a!3
