...
(assert (let ((a!1 (+ (* (** 2 it273) (+ 0 it408) (+ 0 (- 1)))
              (+ 0 it418)
              (* (** 2 (+ it273 1)) (+ 0 (- 1)))
              (+ 0 2))))
  (= a!1 (+ 0 0))))
...
(assert (let ((a!1 (+ (* (** 2 (+ it420 1)) (+ 0 (- 1)))
              (* (+ 0 it466) (** 2 it420) (+ 0 (- 1)))
              (+ 0 it483)
              (+ 0 2))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (+ (* (+ 0 it466) (** 2 (+ it420 (- 1))) (+ 0 (- 2)))
              (* (** 2 it420) (+ 0 (- 2)))
              (+ 0 it484)
              (+ 0 2))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (* (* (** 2 (+ it87 (- 1))) (+ 0 it483)) (+ 0 (- 2))))
      (a!3 (* (* (** 2 (+ it87 (- 1))) (+ 0 it483)) (+ 0 2))))
(let ((a!2 (+ (* (** 2 (+ it87 (- 1))) (+ 0 (- 2)))
  ...
  (and (>= (+ (* it479 (- 1)) 7) 0)
       (>= a!2 (+ 0 0))
       (>= (+ it87 (- 1)) 0)
       (>= (+ it482 (* it483 2) (* it481 (- 1)) 3) 0)
       (>= a!4 (+ 0 0))
       (>= (+ (* it482 (- 1)) (* it483 (- 2)) it481 (- 3)) 0)
       (>= (+ it479 (- 7)) 0)))))
(check-sat)
