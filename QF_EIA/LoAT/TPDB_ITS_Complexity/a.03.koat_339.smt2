...
(assert (let ((a!1 (>= (+ (+ (* it540 (- 1)) it538) (- 1)) 0)))
  (and (>= (+ (* it540 (- 1)) it538) 0) a!1 (= (+ it535 (- 3)) 0))))
(assert (= (+ it570 (- 4)) 0))
(assert (= (+ it571 (* it536 (- 1)) (- 1)) 0))
(assert (= (+ it572 (* it537 (- 1))) 0))
(assert (= (+ it573 (* it538 (- 1))) 0))
(assert (= (+ it574 (* it539 (- 1))) 0))
(assert (= (+ it575 (* it540 (- 1))) 0))
(assert (let ((a!1 (>= (+ (+ (* it572 (- 2)) it573) (- 2)) 0))
      (a!2 (>= (+ (+ (* it572 (- 2)) it573) (- 1)) 0)))
  (and (>= (+ it572 (- 1)) 0)
       (>= (+ it573 (- 2)) 0)
       a!1
       (>= (+ it573 (- 3)) 0)
