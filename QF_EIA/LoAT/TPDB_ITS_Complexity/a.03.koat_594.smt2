...
(assert (let ((a!1 (>= (+ (+ it969 (* it968 (- 2))) (- 1)) 0))
  ...
  (and a!1
       ...
       (>= 1 0)
       (>= 0 0))))
(assert (= (+ (* it966 (- 1)) it982) 0))
(assert (= (+ (* it969 (- 3)) (* it967 (- 1)) (* it968 6) it983 3) 0))
(assert (= (+ it984 (* it968 (- 1))) 0))
(assert (= (+ it985 (* it968 (- 2)) (- 1)) 0))
(assert (= (+ (* it968 (- 1)) it986) 0))
(assert (= (+ it987 (* it968 (- 2))) 0))
(assert (and (>= (+ it985 (- 3)) 0)
     (= (+ it984 (- 1)) 0)
     (= (+ it982 (- 4)) 0)
     (>= (+ it985 (- 2)) 0)))
(assert (= (+ it990 (- 3)) 0))
(assert (= (+ it991 (* it983 (- 1)) (- 2)) 0))
(assert (= (+ (* it984 (- 1)) it992) 0))
(assert (= (+ (* it985 (- 1)) it993 1) 0))
(assert (= (+ it994 (* it984 (- 1))) 0))
(assert (= (+ (* it984 (- 2)) it995) 0))
(assert (let ((a!1 (>= (+ (+ (* it941 (- 1)) it993) (- 3)) 0))
      (a!2 (>= (+ (+ (* it995 (- 1)) it993) (- 1)) 0))
      (a!3 (>= (+ (+ (* it941 (- 1)) (* it19 (- 1)) it993) (- 2)) 0))
      (a!4 (+ (+ (* it992 (- 2)) (* it941 (- 1))) (* it19 (- 1)) it993))
      (a!5 (>= (+ (+ (* it941 (- 1)) (* it19 (- 1)) it993) (- 1)) 0))
      (a!6 (>= (+ (+ (* it941 (- 1)) it993) (- 1)) 0))
      (a!7 (>= (+ (+ (* it992 (- 2)) (* it941 (- 1))) it993) 0))
      (a!8 (>= (+ (+ (* it941 (- 1)) it993) (- 2)) 0))
      (a!9 (+ (+ (+ (* it992 (- 2)) (* it941 (- 1))) it993) 1))
      (a!10 (+ (+ (+ (* it992 (- 2)) (* it941 (- 1))) it993) (- 1))))
  (and a!1
       a!2
       (>= (+ it992 (- 1)) 0)
       (<= (+ it941 it19) 0)
