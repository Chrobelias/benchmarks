...
(assert (let ((a!1 (+ (+ 0 it280)
              ...
              (+ 0 2))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (+ (* (** 2 (+ it273 (- 1))) (+ 0 it175) (+ 0 (- 2)))
              (* (** 2 it273) (+ 0 (- 2)))
              (+ 0 it281)
              (+ 0 2))))
  (= a!1 (+ 0 0))))
...
(assert (and (= (+ it338 (- 8)) 0)
     (>= (+ (* it341 (- 1)) (* it342 (- 2)) it340 (- 4)) 0)))
(assert (= (+ it347 (- 11)) 0))
(assert (= (+ (* it339 (- 1)) it348 (- 1)) 0))
(assert (= (+ it349 (* it340 (- 1))) 0))
(assert (= (+ (* it341 (- 1)) it350) 0))
(assert (= (+ (* it342 (- 1)) it351) 0))
(assert (= (+ it352 (* it343 (- 1))) 0))
(assert (= (+ it347 (- 11)) 0))
(assert (= (+ it355 (- 13)) 0))
(assert (= (+ it356 (* it348 (- 1)) (- 2)) 0))
(assert (= (+ (* it349 (- 1)) it357) 0))
(assert (= (+ (* it350 (- 1)) it358) 0))
(assert (= (+ it359 (* it351 (- 1))) 0))
(assert (= (+ it360 (* it351 (- 2)) (- 1)) 0))
(assert (= (+ it355 (- 13)) 0))
(assert (= (+ it364 (- 7)) 0))
(assert (= (+ (* it356 (- 1)) it365 (- 1)) 0))
(assert (= (+ (* it357 (- 1)) it366) 0))
(assert (= (+ it367 (* it358 (- 1))) 0))
(assert (= (+ (* it357 (- 1)) it368) 0))
(assert (= (+ (* it360 (- 1)) it369) 0))
(assert (let ((a!1 (>= (+ (+ (* it367 (- 1)) (* it368 (- 2)) it366) (- 4)) 0))
      (a!2 (>= (+ (+ (* it367 (- 1)) (* it368 (- 2)) it366) (- 3)) 0))
      (a!3 (>= (+ (+ (* it367 (- 1)) (* it366 (- 1))) (- 4)) 0))
      (a!4 (>= (+ (+ (* it367 (- 1)) (* it366 (- 1))) (- 3)) 0)))
  (and a!1
       (>= (+ (* it364 (- 1)) 7) 0)
       a!2
       (>= (+ it68 (- 1)) 0)
