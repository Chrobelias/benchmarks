...
(assert (= (+ (+ 0 it646) (* (** (- 1) it603) (+ 0 it598) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (+ 0 it647) (* (** (- 1) it603) (+ 0 it599) (+ 0 (- 1))))
   (+ 0 0)))
(assert (let ((a!1 (+ (+ 0 (+ (* it600 (- 3)) (* it603 (- 1))))
              (* (** it603 2) (+ 0 it597) (+ 0 12))
              (* (** it603 2) (+ 0 6))
              (+ 0 (* it603 it597 (- 6)))
              (* (** it603 3) (+ 0 (- 8)))
              (+ 0 (* it648 3))
              (* (+ 0 it603) (** it597 2) (+ 0 (- 6))))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (> (+ (+ (* it649 (- 2)) (* it602 (- 2)) it645) 2) 0))
      (a!2 (> (+ (+ (* it649 (- 2)) (* it602 (- 2)) it645) 1) 0))
      (a!3 (> (+ (+ (* it602 (- 2)) it645) 1) 0))
      (a!4 (> (+ (+ (* it602 (- 2)) it645) 2) 0)))
  (and (>= (+ it643 (- 2)) 0)
       (>= (+ it649 (- 1)) 0)
       (>= (+ it602 (- 1)) 0)
       (= (+ (* it649 2) (* it602 2)) 0)
