...
(assert (let ((a!1 (+ (* (* (exp it48 2) (exp it436 2)) (+ 0 it3) (+ 0 12))
  ...
  (= a!1 (+ 0 0))))
(assert (and (= (+ it439 (- 2)) 0) (> it441 0)))
(assert (= (+ it469 (- 2)) 0))
(assert (= (+ (* it440 (- 1)) it470 (- 1)) 0))
(assert (= (+ it471 (* it441 (- 1)) 1) 0))
(assert (= (+ (* it443 (- 2)) it472 (* it442 (- 3))) 0))
(assert (= (+ (* it443 3) it473 (* it442 5)) 0))
(assert (let ((a!1 (+ (+ 0 (+ it474 (* it444 (- 1))))
              (* (exp it441 2) (+ 0 (- 1))))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (> (+ (+ (* it446 (- 2)) it471 (* it447 (- 2))) 2) 0))
      (a!2 (> (+ (+ it471 (* it447 (- 2))) 1) 0))
      (a!3 (> (+ (+ it471 (* it447 (- 2))) 2) 0))
      (a!4 (> (+ (+ (* it446 (- 2)) it471 (* it447 (- 2))) 1) 0)))
  (and (= 0 0)
       (<= (+ (* it446 2) (* it447 2)) 0)
       (= (+ (* it446 2) (* it447 2)) 0)
       a!1
