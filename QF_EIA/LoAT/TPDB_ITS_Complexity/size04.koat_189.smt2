...
(assert (= (+ it938 (- 2)) 0))
(assert (= (+ (* it733 (- 1)) it939 (- 1)) 0))
(assert (= (+ it940 (* it734 (- 1)) 1) 0))
(assert (= (+ (* it736 (- 2)) it941 (* it735 (- 3))) 0))
(assert (= (+ (* it736 3) (* it735 5) it942) 0))
(assert (let ((a!1 (+ (+ 0 (+ it943 (* it737 (- 1))))
              (* (exp it734 2) (+ 0 (- 1))))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (> (+ (+ (* it740 (- 2)) it940 (* it739 (- 2))) 1) 0))
      (a!2 (> (+ (+ (* it740 (- 2)) it940 (* it739 (- 2))) 2) 0))
      (a!3 (> (+ (+ it940 (* it739 (- 2))) 2) 0))
      (a!4 (> (+ (+ it940 (* it739 (- 2))) 1) 0)))
  (and (>= (+ it740 (- 1)) 0)
       (>= (+ it739 (- 1)) 0)
       (= (+ (* it740 2) (* it739 2)) 0)
       (<= (+ (* it740 2) (* it739 2)) 0)
