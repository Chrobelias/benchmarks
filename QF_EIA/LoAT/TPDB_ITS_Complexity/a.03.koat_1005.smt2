...
(declare-fun it2731 () Int)
(declare-fun it2732 () Int)
(declare-fun it2733 () Int)
(declare-fun it2734 () Int)
(declare-fun it2735 () Int)
(declare-fun it2736 () Int)
...
(assert (and (= (+ it2712 (- 3)) 0)
     ...
     (>= (+ it2717 (- 1)) 0)))
(assert (= (+ it2731 (- 3)) 0))
(assert (= (+ it2732 (* it2713 (- 1)) (- 1)) 0))
(assert (= (+ it2733 (* it2714 (- 1))) 0))
(assert (= (+ (* it2715 (- 1)) it2734) 0))
(assert (= (+ it2735 (* it2717 (- 1))) 0))
(assert (= (+ it2736 (* it2717 (- 2))) 0))
(check-sat)
