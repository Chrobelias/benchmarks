...
(assert (let ((a!1 (> (+ (+ 0 it545)
                 (* (exp it546 5) (+ 0 (- 1)))
                 (* (exp it544 2) (+ 0 (- 1))))
              (+ 0 0)))
      (a!2 (* (exp (exp 4 (+ it109 (- 1))) (+ 0 2)) (exp it544 2)))
      (a!3 (* (* (exp it546 3) (exp 9 (+ it109 (- 1)))) (+ 0 (- 3))))
      (a!4 (* (* (+ 0 it545) (exp 9 (+ it109 (- 1)))) (+ 0 3)))
      (a!6 (* (* (exp it546 3) (exp 9 (+ it109 (- 1)))) (+ 0 (- 1)))))
(let ((a!5 (> (+ (* a!2 (+ 0 (- 4)))
                 (exp it546 3)
                 a!3
                 (* (exp it546 5) (+ 0 (- 1)))
