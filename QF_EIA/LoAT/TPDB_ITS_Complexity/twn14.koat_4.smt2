...
(assert (let ((a!1 (< (+ (exp it115 2) (exp it117 5) (+ 0 (* it116 (- 1)))) (+ 0 0))))
  (and (= (+ it112 (- 3)) 0) (< it115 0) a!1)))
(assert (= (+ it143 (- 3)) 0))
(assert (= (+ (* it113 (- 1)) it144 (- 1)) 0))
(assert (= (+ (* it114 (- 1)) it145) 0))
(assert (= (+ (* it115 2) it146) 0))
(assert (= (+ (* (exp it117 3) (+ 0 2)) (+ 0 it147) (+ 0 (* it116 (- 3))))
   (+ 0 0)))
(assert (= (+ (* it117 (- 1)) it148) 0))
(assert (= (+ (* it118 (- 1)) it149) 0))
(assert (let ((a!1 (* (* (exp it148 3) (exp 9 (+ it109 (- 1)))) (+ 0 (- 3))))
      (a!2 (* (* (+ 0 it147) (exp 9 (+ it109 (- 1)))) (+ 0 3)))
      (a!3 (* (exp (exp 4 (+ it109 (- 1))) (+ 0 2)) (exp it146 2)))
      (a!5 (* (* (exp it148 3) (exp 9 (+ it109 (- 1)))) (+ 0 (- 1))))
      (a!7 (> (+ (+ 0 it147)
                 (* (exp it146 2) (+ 0 (- 1)))
                 (* (exp it148 5) (+ 0 (- 1))))
              (+ 0 0))))
(let ((a!4 (> (+ (* (exp it148 5) (+ 0 (- 1)))
                 a!1
                 a!2
                 (exp it148 3)
                 (* a!3 (+ 0 (- 4))))
