...
(declare-fun it2770 () Int)
(declare-fun it2771 () Int)
(declare-fun it2772 () Int)
(declare-fun it2773 () Int)
(declare-fun it2774 () Int)
(declare-fun it2775 () Int)
...
(assert (= (+ (* (+ 0 it1236) (** 2 it57) (+ 0 (- 1))) (+ 0 it2765))
   (+ 0 0)))
(assert (and (= (+ it2763 (* it2765 (- 1))) 0)
     (= (+ it2760 (- 3)) 0)
     (>= (+ it2765 (- 1)) 0)))
(assert (= (+ it2770 (- 3)) 0))
(assert (= (+ it2771 (* it2761 (- 1)) (- 1)) 0))
(assert (= (+ it2772 (* it2762 (- 1))) 0))
(assert (= (+ (* it2763 (- 1)) it2773) 0))
(assert (= (+ it2774 (* it2765 (- 1))) 0))
(assert (= (+ it2775 (* it2765 (- 2))) 0))
(check-sat)
