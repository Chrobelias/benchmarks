...
(assert (= (+ (* (exp it84 2) (+ 0 it78) (+ 0 12))
      ...
      (+ 0 (* it137 3)))
   (+ 0 0)))
(assert (and (> it134 0) (> (+ it134 (- 1)) 0) (= (+ it132 (- 2)) 0)))
(assert (= (+ it232 (- 2)) 0))
(assert (= (+ it233 (* it133 (- 1)) (- 2)) 0))
(assert (= (+ it234 (* it134 (- 1)) 2) 0))
(assert (= (+ it135 it235) 0))
(assert (= (+ it136 it236) 0))
(assert (let ((a!1 (+ (+ 0 it237)
              (* (exp (+ it134 (- 1)) 2) (+ 0 (- 1)))
              (* (exp it134 2) (+ 0 (- 1)))
              (+ 0 (* it137 (- 1))))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (> (+ (+ (* it138 (- 2)) (* it83 (- 2)) it234) 2) 0))
      (a!2 (> (+ (+ (* it138 (- 2)) it234) 1) 0))
      (a!3 (> (+ (+ (* it138 (- 2)) it234) 2) 0))
      (a!4 (> (+ (+ (* it138 (- 2)) (* it83 (- 2)) it234) 1) 0)))
  (and (>= (+ it138 (- 1)) 0)
       (>= (+ it83 (- 1)) 0)
       (<= (+ (* it138 2) (* it83 2)) 0)
       (= (+ (* it138 2) (* it83 2)) 0)
