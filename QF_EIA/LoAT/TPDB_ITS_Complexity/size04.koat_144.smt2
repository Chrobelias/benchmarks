...
(assert (= (+ (+ 0 (* it552 3))
   ...
   (+ 0 0)))
(assert (let ((a!1 (> (+ (+ (* it499 (- 2)) it549) 2) 0))
      (a!2 (> (+ (+ (* it499 (- 2)) it549) 1) 0)))
  (and (>= (+ it499 (- 1)) 0)
       a!1
       (>= (+ (* it547 (- 1)) 2) 0)
       (>= (+ it547 (- 2)) 0)
       a!2)))
(assert (= (+ (* it547 (- 1)) it665) 0))
(assert (= (+ it666 (* it548 (- 1)) (* it499 (- 2))) 0))
(assert (= (+ it667 (* it499 2) (* it549 (- 1))) 0))
(assert (= (+ (* (+ 0 it550) (exp (- 1) it499) (+ 0 (- 1))) (+ 0 it668))
   (+ 0 0)))
(assert (= (+ (+ 0 it669) (* (+ 0 it551) (exp (- 1) it499) (+ 0 (- 1))))
   (+ 0 0)))
(assert (let ((a!1 (+ (+ 0 (+ (* it552 (- 3)) (* it670 3)))
              (* (exp it499 2) (+ 0 it549) (+ 0 12))
              (+ 0 (* it499 it549 (- 6)))
              (+ 0 (* it499 (- 1)))
              (* (exp it499 2) (+ 0 6))
              (* (exp it499 3) (+ 0 (- 8)))
              (* (+ 0 it499) (exp it549 2) (+ 0 (- 6))))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (+ (+ (+ (* it553 (- 2)) it667) (* it671 (- 2))) 1))
      (a!2 (+ (+ (+ (* it553 (- 2)) it667) (* it671 (- 2))) 2))
      (a!3 (> (+ (+ (* it553 (- 2)) it667) 1) 0))
      (a!4 (> (+ (+ (* it553 (- 2)) it667) 2) 0)))
  (and (> a!1 0)
       (>= (+ it671 (- 1)) 0)
       (>= (+ it553 (- 1)) 0)
       (= (+ (* it553 2) (* it671 2)) 0)
