...
(let ((a!2 (+ a!1
              ...
              (* (* (+ 0 it117) (exp it1184 2))
                 ...
                 (+ 0 (- 6))))))
  (= a!2 (+ 0 0)))))
(assert (let ((a!1 (> (+ (+ (* it1210 (- 2)) it1204) 2) 0))
      (a!2 (> (+ (+ (* it1210 (- 2)) it1204) 1) 0)))
  (and (>= (+ it1210 (- 1)) 0)
       (>= (+ it1202 (- 2)) 0)
       a!1
       (>= (+ (* it1202 (- 1)) 2) 0)
       a!2)))
(assert (= (+ it1237 (* it1202 (- 1))) 0))
(assert (= (+ (* it1210 (- 2)) it1238 (* it1203 (- 1))) 0))
(assert (= (+ (* it1210 2) (* it1204 (- 1)) it1239) 0))
(assert (= (+ (+ 0 it1240) (* (exp (- 1) it1210) (+ 0 it1205) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (+ 0 it1241) (* (exp (- 1) it1210) (+ 0 it1206) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (+ 0 (* it1210 (- 1)))
      (* (exp it1210 2) (+ 0 it1204) (+ 0 12))
      (+ 0 (* it1207 (- 3)))
      (* (exp it1210 3) (+ 0 (- 8)))
      (* (+ 0 it1210) (exp it1204 2) (+ 0 (- 6)))
      (+ 0 (* it1242 3))
      (* (exp it1210 2) (+ 0 6))
      (+ 0 (* it1210 it1204 (- 6))))
   (+ 0 0)))
(assert (let ((a!1 (+ (+ (+ it1239 (* it1209 (- 2))) (* it1243 (- 2))) 1))
      (a!2 (> (+ (+ it1239 (* it1209 (- 2))) 1) 0))
      (a!3 (> (+ (+ it1239 (* it1209 (- 2))) 2) 0))
      (a!4 (+ (+ (+ it1239 (* it1209 (- 2))) (* it1243 (- 2))) 2)))
  (and (>= (+ (* it1237 (- 1)) 2) 0)
       (>= (+ it1237 (- 2)) 0)
       (>= (+ it1243 (- 1)) 0)
       (> a!1 0)
