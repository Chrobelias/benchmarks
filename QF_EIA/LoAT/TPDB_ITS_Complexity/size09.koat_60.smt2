...
(assert (let ((a!1 (> (+ (+ (* it444 (- 2)) it438) 2) 0))
      (a!2 (+ (* it440 (- 2)) it438 (* (* it444 it442) (- 2))))
      (a!4 (+ (* it440 (- 2))
              (* (+ it441 (- 1)) it440 (- 2))
              it438
              (* (* it444 it442) (- 2))))
      (a!6 (> (+ (+ (* it444 (- 2)) it438) 1) 0))
      (a!7 (> (+ (* it444 (+ it442 (- 1)) (- 2)) it438 (- 1)) 0))
      (a!9 (+ (* it444 (+ it442 (- 1)) (- 2)) (* it444 (- 2)) it438))
      (a!11 (+ (* it444 (+ it442 (- 1)) (- 2))
               (* it443 (- 2))
               (* it444 (- 2))
               it438))
      (a!12 (+ (+ it438 (* (* it444 it442) (- 2))) (- 1)))
      (a!13 (+ (* it440 it441 2) (* (* it444 it442) 2)))
      (a!14 (> (+ it438 (* (* it444 it442) (- 2))) 0))
      (a!15 (> (+ (* (+ it441 (- 1)) it440 (- 2))
                  it438
                  (* (* it444 it442) (- 2))
                  (- 1))
               0))
      (a!16 (> (+ (+ (* it443 (- 2)) (* it444 (- 2)) it438) 2) 0))
      (a!17 (> (+ (+ (* it443 (- 2)) (* it444 (- 2)) it438) 3) 0)))
(let ((a!3 (> (+ (+ a!2 (* it445 (- 2))) 2) 0))
      (a!5 (> (+ (+ a!4 (* it445 (- 2))) 2) 0))
      (a!8 (> (+ (+ a!4 (* it445 (- 2))) 3) 0))
      (a!10 (> (+ (+ a!2 (* it445 (- 2))) 3) 0)))
  (and a!1
       (>= (+ (* it432 (- 1)) 2) 0)
       (> (+ a!2 2) 0)
       a!3
