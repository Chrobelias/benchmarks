...
(assert (= (+ (* (** it840 2) (+ 0 (- 1))) (+ 0 it905) (+ 0 (* it843 (- 1))))
   (+ 0 0)))
(assert (let ((a!1 (> (+ (+ (* it844 (- 2)) it902) 2) 0))
      (a!2 (> (+ (+ (* it844 (- 2)) (* it13 (- 2)) it902) 1) 0))
      (a!3 (> (+ (+ (* it844 (- 2)) it902) 1) 0))
      (a!4 (> (+ (+ (* it844 (- 2)) (* it13 (- 2)) it902) 2) 0)))
  (and (= (+ (* it844 2) (* it13 2)) 0)
       (>= (+ it13 (- 1)) 0)
       a!1
       (>= (+ it844 (- 1)) 0)
       a!2
