...
(assert (= (+ (* (+ 0 it3) (** it13 2) (+ 0 12))
      ...
      (+ 0 (* it871 3)))
   (+ 0 0)))
(assert (and (= (+ it866 (- 2)) 0) (> it868 0)))
(assert (= (+ it1158 (- 2)) 0))
(assert (= (+ (* it867 (- 1)) it1159 (- 1)) 0))
(assert (= (+ it1160 (* it868 (- 1)) 1) 0))
(assert (= (+ (* it869 (- 3)) it1161 (* it870 (- 2))) 0))
(assert (= (+ (* it869 5) (* it870 3) it1162) 0))
(assert (= (+ (* (** it868 2) (+ 0 (- 1)))
      (+ 0 (* it871 (- 1)))
      (+ 0 it1163))
   (+ 0 0)))
(assert (let ((a!1 (> (+ (+ it1160 (* it872 (- 2)) (* it92 (- 2))) 1) 0))
      (a!2 (> (+ (+ it1160 (* it872 (- 2)) (* it92 (- 2))) 2) 0))
      (a!3 (> (+ (+ it1160 (* it92 (- 2))) 1) 0))
      (a!4 (> (+ (+ it1160 (* it92 (- 2))) 2) 0)))
  (and a!1
       (>= (+ it1158 (- 2)) 0)
       (>= (+ (* it1158 (- 1)) 2) 0)
       (<= (+ (* it872 2) (* it92 2)) 0)
