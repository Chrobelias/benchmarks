...
(assert (let ((a!1 (+ (* (+ 0 it488) (exp it3 2) (+ 0 it13) (+ 0 (- 6)))
  ...
  (= a!1 (+ 0 0))))
(assert (and (> (+ it493 (- 1)) 0) (= (+ it491 (- 2)) 0) (> it493 0)))
(assert (= (+ it521 (- 2)) 0))
(assert (= (+ (* it492 (- 1)) it522 (- 2)) 0))
(assert (= (+ (* it493 (- 1)) it523 2) 0))
(assert (= (+ it494 it524) 0))
(assert (= (+ it495 it525) 0))
(assert (let ((a!1 (+ (* (exp it493 2) (+ 0 (- 1)))
              (* (exp (+ it493 (- 1)) 2) (+ 0 (- 1)))
              (+ 0 (* it496 (- 1)))
              (+ 0 it526))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (> (+ (+ (* it498 (- 2)) (* it499 (- 2)) it523) 2) 0))
      (a!2 (> (+ (+ (* it499 (- 2)) it523) 2) 0))
      (a!3 (> (+ (+ (* it499 (- 2)) it523) 1) 0))
      (a!4 (> (+ (+ (* it498 (- 2)) (* it499 (- 2)) it523) 1) 0)))
  (and (>= (+ it521 (- 2)) 0)
       (<= (+ (* it498 2) (* it499 2)) 0)
       a!1
       (>= (+ it498 (- 1)) 0)
