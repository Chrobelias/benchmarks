...
(assert (let ((a!1 (> (+ (* (exp it206 5) (+ 0 (- 1)))
                 (+ 0 it205)
                 (* (exp it204 2) (+ 0 (- 1))))
              (+ 0 0)))
      (a!2 (* (exp (exp 4 (+ it68 (- 1))) (+ 0 2)) (exp it204 2)))
      (a!3 (* (* (exp it206 3) (exp 9 (+ it68 (- 1)))) (+ 0 (- 3))))
      (a!4 (* (* (exp 9 (+ it68 (- 1))) (+ 0 it205)) (+ 0 3)))
      (a!6 (* (* (exp it206 3) (exp 9 (+ it68 (- 1)))) (+ 0 (- 1)))))
(let ((a!5 (> (+ (* (exp it206 5) (+ 0 (- 1)))
                 (* a!2 (+ 0 (- 4)))
                 a!3
                 a!4
                 (exp it206 3))
