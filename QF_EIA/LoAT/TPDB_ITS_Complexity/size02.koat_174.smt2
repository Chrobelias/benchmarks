...
(assert (and (> (+ it762 (* it56 (- 2)) it761 2) 0)
     (>= (+ it56 (- 1)) 0)
     (>= (+ (* it758 (- 1)) 3) 0)
     (>= (+ it758 (- 3)) 0)))
(assert (= (+ it792 (* it758 (- 1))) 0))
(assert (= (+ (* it759 (- 1)) it793 (* it56 (- 1))) 0))
(assert (= (+ it794 (* it760 (- 1))) 0))
(assert (= (+ it56 it795 (* it761 (- 1))) 0))
(assert (= (+ (* it762 (- 1)) it56 it796) 0))
(assert (= (+ it797 (* it763 (- 1))) 0))
(assert (and (= (+ it792 (- 3)) 0) (> (+ it795 it796) 0)))
(assert (= (+ it801 (- 3)) 0))
(assert (= (+ (* it793 (- 1)) it802 (- 1)) 0))
(assert (= (+ (* it794 (- 1)) it803) 0))
(assert (= (+ it804 (* it795 (- 1)) 1) 0))
(assert (= (+ it805 (* it796 (- 1)) 1) 0))
(assert (= (+ (* it797 (- 1)) it806) 0))
(assert (and (>= (+ it801 (- 3)) 0)
     (= 1 0)
     (> (+ it804 it805) 0)
     (>= (+ (* it801 (- 1)) 3) 0)))
(check-sat)
