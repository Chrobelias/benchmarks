...
(assert (and (= (+ it1389 (- 3)) 0) (> (+ it1392 it1393) 0)))
(assert (= (+ it1424 (- 3)) 0))
(assert (= (+ it1425 (* it1390 (- 1)) (- 1)) 0))
(assert (= (+ (* it1391 (- 1)) it1426) 0))
(assert (= (+ (* it1392 (- 1)) it1427 1) 0))
(assert (= (+ it1428 (* it1393 (- 1)) 1) 0))
(assert (= (+ (* it1394 (- 1)) it1429) 0))
(assert (and (> (+ it1428 it1427) 0)
     (= 1 0)
     (>= (+ it1424 (- 3)) 0)
     (>= (+ (* it1424 (- 1)) 3) 0)))
(check-sat)
