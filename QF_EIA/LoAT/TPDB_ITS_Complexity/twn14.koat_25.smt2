...
(assert (let ((a!1 (* (* (exp 9 (+ it140 (- 1))) (exp it546 3)) (+ 0 (- 1))))
      (a!2 (* (exp it544 2) (exp (exp 4 (+ it140 (- 1))) (+ 0 2))))
      (a!4 (> (+ (+ 0 it545)
                 (* (exp it546 5) (+ 0 (- 1)))
                 (* (exp it544 2) (+ 0 (- 1))))
              (+ 0 0)))
      (a!5 (* (* (exp 9 (+ it140 (- 1))) (exp it546 3)) (+ 0 (- 3))))
      (a!6 (* (* (+ 0 it545) (exp 9 (+ it140 (- 1)))) (+ 0 3))))
(let ((a!3 (+ (exp it546 3)
              a!1
              (* (+ 0 it545) (exp 9 (+ it140 (- 1))))
              (* (exp it546 5) (+ 0 (- 1)))
              (* a!2 (+ 0 (- 1)))))
      (a!7 (> (+ (exp it546 3)
                 a!5
