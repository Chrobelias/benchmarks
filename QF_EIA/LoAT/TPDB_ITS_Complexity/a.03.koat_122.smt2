...
(assert (let ((a!1 (+ (* (+ 0 it159) (** 2 (+ it134 (- 1))) (+ 0 (- 1)))
              (* (** 2 it134) (+ 0 (- 1)))
              (+ 0 it174)
              (+ 0 1))))
  (= a!1 (+ 0 0))))
...
(assert (let ((a!1 (+ (* (+ 0 it236) (** 2 (+ it176 (- 1))) (+ 0 (- 1)))
              (* (** 2 it176) (+ 0 (- 1)))
              (+ 0 it253)
              (+ 0 1))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (+ (* (** 2 (+ it176 1)) (+ 0 (- 1)))
              (* (** 2 it176) (+ 0 it236) (+ 0 (- 1)))
              (+ 0 it254)
              (+ 0 2))))
  (= a!1 (+ 0 0))))
...
(assert (and (>= (+ it269 (- 2)) 0)
     (= (+ it266 (- 4)) 0)
     (>= (+ it269 (- 3)) 0)
     (= (+ it268 (- 1)) 0)))
(assert (= (+ it274 (- 3)) 0))
(assert (= (+ it275 (* it267 (- 1)) (- 2)) 0))
(assert (= (+ (* it268 (- 1)) it276) 0))
(assert (= (+ (* it269 (- 1)) it277 1) 0))
(assert (= (+ (* it268 (- 1)) it278) 0))
(assert (= (+ (* it268 (- 2)) it279) 0))
(assert (let ((a!1 (+ (+ (+ (* it88 (- 1)) it277) (* it237 (- 1))) (- 2)))
      (a!2 (+ (+ (* it276 (- 2)) (* it88 (- 1)) it277) (* it237 (- 1))))
      (a!3 (>= (+ (+ (* it88 (- 1)) it277) (- 3)) 0))
      (a!4 (>= (+ (+ (* it276 (- 2)) (* it88 (- 1)) it277) 1) 0))
      (a!5 (>= (+ (+ (* it276 (- 2)) (* it88 (- 1)) it277) (- 1)) 0))
      (a!6 (+ (+ (+ (* it88 (- 1)) it277) (* it237 (- 1))) (- 1)))
      (a!7 (>= (+ (+ (* it88 (- 1)) it277) (- 2)) 0))
      (a!8 (>= (+ (+ it277 (* it279 (- 1))) (- 1)) 0))
      (a!9 (>= (+ (+ (* it88 (- 1)) it277) (- 1)) 0)))
  (and (>= a!1 0)
       (= (+ (* it276 (- 2)) it279) 0)
       (= (+ it88 it237) 0)
       (>= (+ a!2 1) 0)
