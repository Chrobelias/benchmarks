...
(assert (and (>= (+ it202 (- 3)) 0)
     (>= (+ it56 (- 1)) 0)
     (>= (+ (* it202 (- 1)) 3) 0)
     (> (+ it205 it206 (* it56 (- 2)) 2) 0)))
(assert (= (+ (* it202 (- 1)) it236) 0))
(assert (= (+ it237 (* it203 (- 1)) (* it56 (- 1))) 0))
(assert (= (+ it238 (* it204 (- 1))) 0))
(assert (= (+ it239 (* it205 (- 1)) it56) 0))
(assert (= (+ it240 (* it206 (- 1)) it56) 0))
(assert (= (+ it241 (* it207 (- 1))) 0))
(assert (and (= (+ it236 (- 3)) 0) (> (+ it239 it240) 0)))
(assert (= (+ it245 (- 3)) 0))
(assert (= (+ (* it237 (- 1)) it246 (- 1)) 0))
(assert (= (+ it247 (* it238 (- 1))) 0))
(assert (= (+ (* it239 (- 1)) it248 1) 0))
(assert (= (+ (* it240 (- 1)) it249 1) 0))
