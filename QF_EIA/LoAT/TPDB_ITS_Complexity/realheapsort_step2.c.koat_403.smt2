...
(declare-fun it1849 () Int)
(declare-fun it1850 () Int)
(declare-fun it1851 () Int)
(declare-fun it1852 () Int)
(declare-fun it1853 () Int)
(declare-fun it1854 () Int)
(declare-fun it1855 () Int)
...
(assert (and (= (+ it1836 (- 20)) 0) (> (+ (* it1839 (- 1)) (* it1840 2) it1841 3) 0)))
(assert (= (+ it1845 (- 18)) 0))
(assert (= (+ (* it1837 (- 1)) it1846 (- 4)) 0))
(assert (= (+ (* it1841 (- 1)) it1847 (- 1)) 0))
(assert (= (+ (* it1839 (- 1)) it1848) 0))
(assert (= (+ (* it1840 (- 1)) it1849) 0))
(assert (= (+ (* it1841 (- 1)) it1850 (- 1)) 0))
(assert (= (+ it1851 (* it1842 (- 1))) 0))
(assert (and (= (+ it1845 (- 18)) 0) (<= (+ (* it1848 (- 1)) it1850 2) 0)))
(assert (= (+ it1852 (- 20)) 0))
(assert (= (+ (* it1846 (- 1)) it1853 (- 2)) 0))
(assert (= (+ (* it1847 (- 1)) it1854) 0))
(assert (= (+ (* it1848 (- 1)) it1855) 0))
(assert (= it1856 0))
(assert (= (+ (* it1850 (- 1)) it1857) 0))
(assert (= (+ (* it1851 (- 1)) it1858) 0))
(assert (let ((a!1 (* (* (exp 2 (+ it101 (- 1))) (+ 0 it1856)) (+ 0 (- 2))))
      (a!3 (* (* (exp 2 (+ it101 (- 1))) (+ 0 it1856)) (+ 0 2))))
(let ((a!2 (+ (+ 0 it1855)
              (* (exp 2 (+ it101 (- 1))) (+ 0 (- 2)))
              a!1
              (+ 0 (* it1857 (- 1)))
      ...
      (a!4 (+ (+ 0 (* it1855 (- 1)))
              ...
              (+ 0 it1857)
              (+ 0 1))))
  (and (>= (+ (* it1855 (- 1)) (* it1856 2) it1857 3) 0)
       (>= a!2 (+ 0 0))
       (>= (+ it101 (- 1)) 0)
       (>= a!4 (+ 0 0))
       (>= (+ (* it1852 (- 1)) 20) 0)
       (>= (+ it1852 (- 20)) 0)
       (>= (+ it1855 (* it1856 (- 2)) (* it1857 (- 1)) (- 3)) 0)))))
(check-sat)
