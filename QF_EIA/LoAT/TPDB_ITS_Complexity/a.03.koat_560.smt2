...
(assert (and (= (+ (* it940 (- 1)) it938) 0) (= (+ it935 (- 3)) 0)))
(assert (= (+ it950 (- 4)) 0))
(assert (= (+ it951 (* it936 (- 1)) (- 1)) 0))
(assert (= (+ (* it937 (- 1)) it952) 0))
(assert (= (+ it953 (* it938 (- 1))) 0))
(assert (= (+ it954 (* it939 (- 1))) 0))
(assert (= (+ it955 (* it940 (- 1))) 0))
(assert (let ((a!1 (>= (+ (+ it953 (* it952 (- 2))) (- 1)) 0))
      (a!2 (>= (+ (+ it953 (* it952 (- 2))) (- 2)) 0)))
  (and (>= (+ it953 (- 3)) 0)
       (>= (+ (* it952 (- 1)) 1) 0)
       a!1
       (>= (+ it950 (- 4)) 0)
