...
(assert (and (= (+ it505 (* it507 (- 1))) 0) (= (+ it502 (- 3)) 0)))
(assert (= (+ it526 (- 4)) 0))
(assert (= (+ it527 (* it503 (- 1)) (- 1)) 0))
(assert (= (+ (* it504 (- 1)) it528) 0))
(assert (= (+ (* it505 (- 1)) it529) 0))
(assert (= (+ it530 (* it506 (- 1))) 0))
(assert (= (+ it531 (* it507 (- 1))) 0))
(assert (let ((a!1 (>= (+ (+ (* it528 (- 2)) it529) (- 2)) 0))
      (a!2 (>= (+ (+ (* it528 (- 2)) it529) (- 1)) 0)))
  (and (>= (+ it529 (- 2)) 0)
       (>= (+ (* it528 (- 1)) 1) 0)
       (>= (+ (* it526 (- 1)) 4) 0)
       (>= (+ it528 (- 1)) 0)
