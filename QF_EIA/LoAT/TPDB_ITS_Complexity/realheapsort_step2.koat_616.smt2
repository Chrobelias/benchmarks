...
(assert (and (>= (+ it1335 (* it1336 2) (* it1334 (- 1)) 2) 0) (= (+ it1332 (- 7)) 0)))
(assert (= (+ it1342 (- 5)) 0))
(assert (= (+ it1343 (* it1333 (- 1)) (- 2)) 0))
(assert (= (+ it1344 (* it1334 (- 1))) 0))
(assert (= (+ (* it1335 (- 1)) it1345 (- 1)) 0))
(assert (= (+ (* it1336 (- 1)) it1346) 0))
(assert (= (+ it1347 (* it1337 (- 1))) 0))
(assert (and (= (+ it1342 (- 5)) 0) (>= (+ it1344 (* it1345 (- 1)) (- 2)) 0)))
(assert (= (+ it1352 (- 7)) 0))
(assert (= (+ (* it1343 (- 1)) it1353 (- 2)) 0))
(assert (= (+ (* it1344 (- 1)) it1354) 0))
(assert (= (+ it1355 (* it1345 (- 1))) 0))
(assert (= it1356 0))
(assert (= (+ (* it1347 (- 1)) it1357) 0))
(assert (let ((a!1 (>= (+ (+ (* it1355 (- 1)) (* it1356 (- 2)) it1354) (- 3)) 0))
      (a!2 (>= (+ (+ (* it1355 (- 1)) (* it1356 (- 2)) it1354) (- 4)) 0)))
  (and (>= (+ it1352 (- 7)) 0)
       a!1
       a!2
       (<= (+ (* it1356 2) 4) 0)
