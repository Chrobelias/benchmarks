...
(assert (= (+ (+ 0 (* it552 3))
   ...
   (+ 0 0)))
(assert (and (> it549 0) (= (+ it547 (- 2)) 0)))
(assert (= (+ it702 (- 2)) 0))
(assert (= (+ it703 (* it548 (- 1)) (- 1)) 0))
(assert (= (+ it704 (* it549 (- 1)) 1) 0))
(assert (= (+ (* it550 (- 3)) (* it551 (- 2)) it705) 0))
(assert (= (+ it706 (* it550 5) (* it551 3)) 0))
(assert (= (+ (+ 0 (* it552 (- 1))) (* (exp it549 2) (+ 0 (- 1))) (+ 0 it707))
   (+ 0 0)))
(assert (let ((a!1 (> (+ (+ (* it553 (- 2)) it704) 1) 0))
      (a!2 (> (+ (+ (* it553 (- 2)) it704) 2) 0))
      (a!3 (+ (+ (+ (* it553 (- 2)) it704) (* it499 (- 2))) 2))
      (a!4 (+ (+ (+ (* it553 (- 2)) it704) (* it499 (- 2))) 1)))
  (and (= (+ (* it553 2) (* it499 2)) 0)
       (<= (+ (* it553 2) (* it499 2)) 0)
       a!1
       a!2
       (>= (+ it499 (- 1)) 0)
