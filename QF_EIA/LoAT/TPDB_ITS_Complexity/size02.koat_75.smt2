...
(assert (= (+ it353 (- 2)) 0))
(assert (= (+ (* it254 (- 1)) it354 (- 1)) 0))
(assert (= (+ (* it255 (- 1)) it355 1) 0))
(assert (= (+ (* it257 (- 2)) it356 (* it256 (- 3))) 0))
(assert (= (+ (* it257 3) it357 (* it256 5)) 0))
(assert (= (+ (+ 0 (* it258 (- 1))) (* (exp it255 2) (+ 0 (- 1))) (+ 0 it358))
   (+ 0 0)))
(assert (let ((a!1 (> (+ (+ (* it127 (- 2)) (* it259 (- 2)) it355) 2) 0))
      (a!2 (> (+ (+ (* it259 (- 2)) it355) 1) 0))
      (a!3 (> (+ (+ (* it259 (- 2)) it355) 2) 0))
      (a!4 (> (+ (+ (* it127 (- 2)) (* it259 (- 2)) it355) 1) 0)))
  (and (>= (+ (* it353 (- 1)) 2) 0)
       (<= (+ (* it127 2) (* it259 2)) 0)
       a!1
       a!2
