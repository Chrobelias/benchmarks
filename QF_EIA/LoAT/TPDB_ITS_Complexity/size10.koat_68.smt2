...
(assert (and (= (+ it305 (- 3)) 0) (> (+ it310 it308) 0)))
(assert (= (+ it314 (- 3)) 0))
(assert (= (+ (* it306 (- 1)) it315 (- 1)) 0))
(assert (= (+ (* it307 (- 1)) it316) 0))
(assert (= (+ it317 (* it308 (- 1)) 1) 0))
(assert (= (+ (* it309 (- 1)) it318) 0))
(assert (= (+ (* it310 (- 1)) it319 1) 0))
(assert (= (+ it320 (* it311 (- 1))) 0))
(assert (and (>= (+ (* it314 (- 1)) 3) 0)
     (> (+ it317 it319) 0)
     (= 1 0)
     (>= (+ it314 (- 3)) 0)))
(check-sat)
