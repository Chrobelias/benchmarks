...
(assert (and (= (+ it1165 (- 20)) 0) (> (+ (* it1168 (- 1)) (* it1169 2) it1170 3) 0)))
(assert (= (+ it1175 (- 18)) 0))
(assert (= (+ it1176 (* it1166 (- 1)) (- 4)) 0))
(assert (= (+ it1177 (* it1170 (- 1)) (- 1)) 0))
(assert (= (+ (* it1168 (- 1)) it1178) 0))
(assert (= (+ it1179 (* it1169 (- 1))) 0))
(assert (= (+ it1180 (* it1170 (- 1)) (- 1)) 0))
(assert (= (+ (* it1171 (- 1)) it1181) 0))
(assert (and (= (+ it1175 (- 18)) 0) (<= (+ it1180 (* it1178 (- 1)) 2) 0)))
(assert (= (+ it1182 (- 20)) 0))
(assert (= (+ (* it1176 (- 1)) it1183 (- 2)) 0))
(assert (= (+ (* it1177 (- 1)) it1184) 0))
(assert (= (+ it1185 (* it1178 (- 1))) 0))
(assert (= it1186 0))
(assert (= (+ (* it1180 (- 1)) it1187) 0))
(assert (= (+ it1188 (* it1181 (- 1))) 0))
(assert (let ((a!1 (* (* (exp 2 (+ it101 (- 1))) (+ 0 it1186)) (+ 0 (- 2))))
      (a!3 (* (* (exp 2 (+ it101 (- 1))) (+ 0 it1186)) (+ 0 2))))
(let ((a!2 (+ (+ 0 it1185)
              (* (exp 2 (+ it101 (- 1))) (+ 0 (- 2)))
              a!1
              (+ 0 (* it1187 (- 1)))
  ...
  (and (>= (+ (* it1182 (- 1)) 20) 0)
       (>= (+ it1182 (- 20)) 0)
       (>= (+ (* it1185 (- 1)) (* it1186 2) it1187 3) 0)
       (>= a!2 (+ 0 0))
       (>= (+ it1185 (* it1186 (- 2)) (* it1187 (- 1)) (- 3)) 0)
       (>= a!4 (+ 0 0))
       (>= (+ it101 (- 1)) 0)))))
(check-sat)
