...
(assert (= (+ it688 (- 13)) 0))
(assert (= (+ it696 (- 7)) 0))
(assert (= (+ (* it689 (- 1)) it697 (- 1)) 0))
(assert (= (+ it698 (* it690 (- 1))) 0))
(assert (= (+ (* it691 (- 1)) it699) 0))
(assert (= (+ (* it690 (- 1)) it700) 0))
(assert (= (+ it701 (* it693 (- 1))) 0))
(assert (let ((a!1 (>= (+ (+ (* it698 (- 1)) (* it699 (- 1))) (- 4)) 0))
      (a!2 (>= (+ (+ (* it698 (- 1)) (* it699 (- 1))) (- 3)) 0))
      (a!3 (>= (+ (+ it698 (* it699 (- 1)) (* it700 (- 2))) (- 4)) 0))
      (a!4 (>= (+ (+ it698 (* it699 (- 1)) (* it700 (- 2))) (- 3)) 0)))
  (and a!1
       a!2
       a!3
       (>= (+ it696 (- 7)) 0)
