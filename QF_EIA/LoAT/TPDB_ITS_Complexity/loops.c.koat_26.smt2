...
(assert (= (+ it74 (- 1)) 0))
(assert (let ((a!1 (+ (* (** 2 (+ it80 (- 1))) (+ 0 it74) (+ 0 (- 1)))
              (+ 0 it73))))
  (and (> (+ it73 (* it74 (- 1))) 0)
       (> a!1 (+ 0 0))
       (>= (+ it70 (- 9)) 0)
...
(assert (= (+ (+ 0 it86) (* (** 2 it80) (+ 0 it74) (+ 0 (- 1)))) (+ 0 0)))
...
(assert (and (< (+ (* it103 (- 1)) 1) 0) (= (+ it100 (- 8)) 0)))
(assert (= (+ it109 (- 9)) 0))
(assert (= (+ it110 (* it101 (- 1)) (- 1)) 0))
(assert (= (+ it111 (* it102 (- 1))) 0))
(assert (= (+ (* it103 (- 1)) it112) 0))
(assert (= (+ it113 (- 1)) 0))
(assert (let ((a!1 (+ (* (+ 0 it113) (** 2 (+ it87 (- 1))) (+ 0 (- 1)))
              (+ 0 it112))))
  (and (>= (+ (* it109 (- 1)) 9) 0)
       (> a!1 (+ 0 0))
       (>= (+ it87 (- 1)) 0)
       (>= (+ it109 (- 9)) 0)
       (> (+ (* it113 (- 1)) it112) 0))))
(assert (= (+ (* it109 (- 1)) it120) 0))
(assert (= (+ (* it110 (- 1)) it121 (* it87 (- 2))) 0))
(assert (= (+ (* it111 (- 1)) it122) 0))
(assert (= (+ it123 (* it112 (- 1))) 0))
(assert (= (+ (* (+ 0 it113) (** 2 it87) (+ 0 (- 1))) (+ 0 it124))
   (+ 0 0)))
(assert (and (= (+ it120 (- 9)) 0) (>= (+ (* it123 (- 1)) it124) 0)))
(assert (= (+ it132 (- 6)) 0))
(assert (= (+ it133 (* it121 (- 1)) (- 2)) 0))
(assert (= (+ it134 (* it122 (- 1))) 0))
(assert (= (+ (* it123 (- 1)) it135 1) 0))
(assert (= (+ it136 (* it124 (- 1))) 0))
(assert (and (>= (+ (* it135 (- 1)) 1) 0)
     (>= (+ it132 (- 6)) 0)
     (>= it135 0)
     (= 1 0)
     (>= (+ (* it132 (- 1)) 6) 0)))
