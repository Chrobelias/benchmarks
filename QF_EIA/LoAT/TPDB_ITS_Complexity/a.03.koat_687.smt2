...
(assert (and (= (+ it1069 (- 4)) 0)
     (>= (+ it1072 (- 3)) 0)
     (= (+ it1071 (- 1)) 0)
     (>= (+ it1072 (- 2)) 0)))
(assert (= (+ it1077 (- 3)) 0))
(assert (= (+ (* it1070 (- 1)) it1078 (- 2)) 0))
(assert (= (+ it1079 (* it1071 (- 1))) 0))
(assert (= (+ (* it1072 (- 1)) it1080 1) 0))
(assert (= (+ it1081 (* it1071 (- 1))) 0))
(assert (= (+ it1082 (* it1071 (- 2))) 0))
(assert (let ((a!1 (+ (+ (+ it1080 (* it941 (- 1))) (* it19 (- 1))) (- 1)))
      (a!2 (+ (+ (+ it1080 (* it941 (- 1))) (* it19 (- 1))) (- 2)))
      (a!3 (>= (+ (+ it1080 (* it941 (- 1))) (- 2)) 0))
      (a!4 (>= (+ (+ (* it1082 (- 1)) it1080) (- 1)) 0))
      (a!5 (>= (+ (+ it1080 (* it941 (- 1))) (- 3)) 0))
      (a!6 (+ (+ (* it1079 (- 2)) it1080 (* it941 (- 1))) (* it19 (- 1))))
      (a!7 (>= (+ (+ it1080 (* it941 (- 1))) (- 1)) 0))
      (a!8 (>= (+ (+ (* it1079 (- 2)) it1080 (* it941 (- 1))) (- 1)) 0))
      (a!9 (>= (+ (+ (* it1079 (- 2)) it1080 (* it941 (- 1))) 1) 0)))
  (and (= (+ it1082 (* it1079 (- 2))) 0)
       (>= (+ it1080 (- 3)) 0)
       (>= a!1 0)
       (>= a!2 0)
       a!3
