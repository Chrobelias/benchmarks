...
(assert (and (> it215 0) (= (+ it209 (- 3)) 0)))
(assert (= (+ it232 (- 2)) 0))
(assert (= (+ (* it210 (- 1)) it233 (- 1)) 0))
(assert (= (+ it234 (* it215 (- 1))) 0))
(assert (= (+ (* it215 (- 2)) it235) 0))
(assert (= (+ (* it215 (- 3)) it236) 0))
(assert (= (+ it237 (* it211 (- 1))) 0))
(assert (= (+ (* it215 (- 1)) it238 1) 0))
(assert (let ((a!1 (> (+ (+ it238 (* it81 (- 2))) 1) 0))
      (a!2 (> (+ (+ it238 (* it81 (- 2))) 2) 0))
      (a!3 (> (+ (+ it234 (* it191 (- 2))) 1) 0))
      (a!4 (> (+ (+ it234 (* it191 (- 2))) 2) 0)))
  (and (>= (+ it191 (- 1)) 0)
       a!1
       a!2
       (= (* it81 2) 0)
