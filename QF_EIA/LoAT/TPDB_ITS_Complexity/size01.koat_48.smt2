...
(assert (= (+ (* (** (- 1) it13) (+ 0 it4) (+ 0 (- 1))) (+ 0 it291))
   (+ 0 0)))
(assert (= (+ (* (+ 0 it5) (** (- 1) it13) (+ 0 (- 1))) (+ 0 it292))
   (+ 0 0)))
(assert (= (+ (* (+ 0 it3) (** it13 2) (+ 0 12))
      ...
      (+ 0 (* it13 (- 1))))
   (+ 0 0)))
(assert (and (> it290 0) (= (+ it288 (- 2)) 0)))
(assert (= (+ it308 (- 2)) 0))
(assert (= (+ (* it289 (- 1)) it309 (- 1)) 0))
(assert (= (+ (* it290 (- 1)) it310 1) 0))
(assert (= (+ it311 (* it291 (- 3)) (* it292 (- 2))) 0))
(assert (= (+ it312 (* it291 5) (* it292 3)) 0))
(assert (= (+ (* (** it290 2) (+ 0 (- 1))) (+ 0 (* it293 (- 1))) (+ 0 it313))
   (+ 0 0)))
(assert (let ((a!1 (> (+ (+ (* it294 (- 2)) it310) 1) 0))
      (a!2 (> (+ (+ (* it48 (- 2)) (* it294 (- 2)) it310) 2) 0))
      (a!3 (> (+ (+ (* it48 (- 2)) (* it294 (- 2)) it310) 1) 0))
      (a!4 (> (+ (+ (* it294 (- 2)) it310) 2) 0)))
  (and (>= (+ (* it308 (- 1)) 2) 0)
       (>= (+ it294 (- 1)) 0)
       (= (+ (* it48 2) (* it294 2)) 0)
       a!1
