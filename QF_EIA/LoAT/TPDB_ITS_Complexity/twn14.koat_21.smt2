...
(assert (let ((a!1 (* (* (exp 9 (+ it140 (- 1))) (exp it448 3)) (+ 0 (- 1))))
      (a!2 (* (exp it446 2) (exp (exp 4 (+ it140 (- 1))) (+ 0 2))))
      (a!4 (> (+ (* (exp it448 5) (+ 0 (- 1)))
                 (+ 0 it447)
                 (* (exp it446 2) (+ 0 (- 1))))
              (+ 0 0)))
      (a!5 (* (* (exp 9 (+ it140 (- 1))) (exp it448 3)) (+ 0 (- 3))))
      (a!6 (* (* (exp 9 (+ it140 (- 1))) (+ 0 it447)) (+ 0 3))))
(let ((a!3 (+ a!1
              (* (exp it448 5) (+ 0 (- 1)))
              (* a!2 (+ 0 (- 1)))
              (* (exp 9 (+ it140 (- 1))) (+ 0 it447))
              (exp it448 3)))
      (a!7 (> (+ a!5
                 (* (exp it448 5) (+ 0 (- 1)))
                 (* a!2 (+ 0 (- 4)))
