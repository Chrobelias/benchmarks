...
(assert (let ((a!1 (>= (+ (+ (* it540 (- 1)) it538) (- 1)) 0)))
  (and a!1 (>= (+ (* it540 (- 1)) it538) 0) (= (+ it535 (- 3)) 0))))
(assert (= (+ it552 (- 4)) 0))
(assert (= (+ it553 (* it536 (- 1)) (- 1)) 0))
(assert (= (+ it554 (* it537 (- 1))) 0))
(assert (= (+ it555 (* it538 (- 1))) 0))
(assert (= (+ (* it539 (- 1)) it556) 0))
(assert (= (+ it557 (* it540 (- 1)) (- 1)) 0))
(assert (let ((a!1 (>= (+ (+ (* it554 (- 2)) it555) (- 2)) 0))
      (a!2 (>= (+ (+ (* it554 (- 2)) it555) (- 1)) 0)))
  (and (>= (+ it552 (- 4)) 0)
       (>= (+ it554 (- 1)) 0)
       a!1
       (>= (+ it555 (- 3)) 0)
