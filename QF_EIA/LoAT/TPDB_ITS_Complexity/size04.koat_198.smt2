...
(assert (= (+ it980 (- 2)) 0))
(assert (= (+ (* it492 (- 1)) it981 (- 1)) 0))
(assert (= (+ it982 (* it493 (- 1)) 1) 0))
(assert (= (+ (* it494 (- 3)) it983 (* it495 (- 2))) 0))
(assert (= (+ (* it494 5) (* it495 3) it984) 0))
(assert (= (+ (* (exp it493 2) (+ 0 (- 1))) (+ 0 (* it496 (- 1))) (+ 0 it985))
   (+ 0 0)))
(assert (let ((a!1 (> (+ (+ it982 (* it499 (- 2))) 1) 0))
      (a!2 (> (+ (+ it982 (* it498 (- 2)) (* it499 (- 2))) 2) 0))
      (a!3 (> (+ (+ it982 (* it498 (- 2)) (* it499 (- 2))) 1) 0))
      (a!4 (> (+ (+ it982 (* it499 (- 2))) 2) 0)))
  (and a!1
       a!2
       (<= (+ (* it498 2) (* it499 2)) 0)
       (>= (+ (* it980 (- 1)) 2) 0)
