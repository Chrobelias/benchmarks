...
(assert (= (+ it113 (- 1)) 0))
(assert (and (= (+ it109 (- 9)) 0) (< (+ it113 (* it112 (- 1))) 0)))
(assert (= (+ it139 (- 9)) 0))
(assert (= (+ (* it110 (- 1)) it140 (- 2)) 0))
(assert (= (+ (* it111 (- 1)) it141) 0))
(assert (= (+ it142 (* it112 (- 1))) 0))
(assert (= (+ (* it113 (- 2)) it143) 0))
(assert (and (> (+ it142 (* it143 (- 1))) 0)
     (>= (+ it139 (- 9)) 0)
     (<= it143 0)
     (>= (+ (* it139 (- 1)) 9) 0)))
(check-sat)
