...
(assert (let ((a!1 (+ (* (* (exp it48 2) (exp it73 2)) (+ 0 it3) (+ 0 12))
  ...
  (= a!1 (+ 0 0))))
(assert (and (> it78 0) (> (+ it78 (- 1)) 0) (= (+ it76 (- 2)) 0)))
(assert (= (+ it262 (- 2)) 0))
(assert (= (+ (* it77 (- 1)) it263 (- 2)) 0))
(assert (= (+ it264 (* it78 (- 1)) 2) 0))
(assert (= (+ it265 it79) 0))
(assert (= (+ it80 it266) 0))
(assert (let ((a!1 (+ (* (exp (+ it78 (- 1)) 2) (+ 0 (- 1)))
              (+ 0 (* it81 (- 1)))
              (* (exp it78 2) (+ 0 (- 1)))
              (+ 0 it267))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (> (+ (+ it264 (* it84 (- 2))) 1) 0))
      (a!2 (> (+ (+ it264 (* it83 (- 2)) (* it84 (- 2))) 1) 0))
      (a!3 (> (+ (+ it264 (* it83 (- 2)) (* it84 (- 2))) 2) 0))
      (a!4 (> (+ (+ it264 (* it84 (- 2))) 2) 0)))
  (and a!1
       (<= (+ (* it83 2) (* it84 2)) 0)
       (>= (+ it84 (- 1)) 0)
       (>= (+ it262 (- 2)) 0)
