...
(assert (and (>= (+ it429 (- 1)) 0) (> it432 0) (= (+ it423 (- 13)) 0)))
(assert (= (+ it442 (- 14)) 0))
(assert (= (+ (* it424 (- 1)) it443 (- 1)) 0))
(assert (= (+ (* it425 (- 1)) it444) 0))
(assert (= (+ it445 (* it426 (- 1))) 0))
(assert (= (+ (* it427 (- 1)) it446) 0))
(assert (= (+ (* it428 (- 1)) it447) 0))
(assert (= (+ it448 (* it429 (- 1))) 0))
(assert (= (+ (* it430 (- 1)) it449) 0))
(assert (= (+ it450 (* it431 (- 1))) 0))
(assert (= (+ it451 (* it432 (- 1))) 0))
(assert (and (> (+ (* it451 (- 1)) (* it448 2)) 0) (= (+ it442 (- 14)) 0)))
(assert (= (+ it456 (- 17)) 0))
(assert (= (+ (* it443 (- 1)) it457 (- 1)) 0))
(assert (= (+ (* it444 (- 1)) it458) 0))
(assert (= (+ it459 (* it448 (- 2))) 0))
(assert (= (+ it460 (* it448 (- 2)) (- 1)) 0))
(assert (= (+ (* it447 (- 1)) it461) 0))
(assert (= (+ it462 (* it448 (- 1))) 0))
(assert (= (+ it463 (* it448 (- 1))) 0))
(assert (= (+ (* it450 (- 1)) it464) 0))
(assert (= (+ (* it451 (- 1)) it465) 0))
(assert (and (> (+ it460 (* it465 (- 1))) 0) (= (+ it456 (- 17)) 0)))
(assert (= (+ it469 (- 22)) 0))
(assert (= (+ it470 (* it457 (- 1)) (- 1)) 0))
(assert (= (+ it471 (* it458 (- 1))) 0))
(assert (= (+ (* it459 (- 1)) it472) 0))
(assert (= (+ it473 (* it460 (- 1))) 0))
(assert (= (+ it474 (* it461 (- 1))) 0))
(assert (= (+ (* it462 (- 1)) it475) 0))
(assert (= (+ it476 (* it463 (- 1))) 0))
(assert (= (+ (* it463 (- 1)) it477) 0))
(assert (= (+ it478 (* it465 (- 1))) 0))
(assert (and (= (+ (* it477 (- 1)) it475) 0) (= (+ it469 (- 22)) 0)))
(assert (= (+ it482 (- 28)) 0))
(assert (= (+ it483 (* it470 (- 1)) (- 2)) 0))
(assert (= (+ it484 (* it471 (- 1))) 0))
(assert (= (+ it485 (* it472 (- 1))) 0))
(assert (= (+ it486 (* it473 (- 1))) 0))
(assert (= (+ it487 (* it474 (- 1))) 0))
(assert (= (+ it488 (* it475 (- 1))) 0))
(assert (= (+ it489 (* it476 (- 1))) 0))
(assert (= (+ it490 (* it477 (- 1))) 0))
(assert (= (+ it491 (* it478 (- 1))) 0))
(check-sat)
