...
(declare-fun it6565 () Int)
(declare-fun it6566 () Int)
(declare-fun it6567 () Int)
(declare-fun it6568 () Int)
(declare-fun it6569 () Int)
(declare-fun it6570 () Int)
(assert (= (+ i1 (- 1)) 0))
(assert (= (+ it62 (- 2)) 0))
...
(assert (= (+ it6557 (- 18)) 0))
(assert (= (+ it6565 (- 12)) 0))
(assert (= (+ it6566 (* it6558 (- 1)) (- 2)) 0))
(assert (= (+ (* it6559 (- 1)) it6567) 0))
(assert (= (+ it6568 (* it6560 (- 1))) 0))
(assert (= (+ (* it6562 (- 1)) it6569) 0))
(assert (= (+ (* it6562 (- 1)) it6570) 0))
(assert (and (>= (+ (* it6568 (- 1)) (* it6569 (- 2)) it6567 (- 3)) 0)
     (>= (+ it6568 (* it6569 2) (* it6567 (- 1)) 3) 0)
     (>= (+ it6568 it6567 3) 0)
     (<= (+ (* it6569 (- 2)) (* it6567 2)) 0)
     (>= (+ it6565 (- 12)) 0)
     (<= (+ (* it6569 2) (* it6567 (- 2))) 0)
     (>= (+ (* it6565 (- 1)) 12) 0)
     (>= (+ (* it6568 (- 1)) (* it6567 (- 1)) (- 3)) 0)))
(check-sat)
