...
(assert (= (+ (* it548 (- 1)) it666 (* it499 (- 2))) 0))
(assert (= (+ (* it499 2) (* it549 (- 1)) it667) 0))
(assert (= (+ (* (+ 0 it550) (exp (- 1) it499) (+ 0 (- 1))) (+ 0 it668))
   (+ 0 0)))
(assert (= (+ (* (+ 0 it551) (exp (- 1) it499) (+ 0 (- 1))) (+ 0 it669))
   (+ 0 0)))
(assert (= (+ (+ 0 (* it499 it549 (- 6)))
   ...
   (+ 0 0)))
(assert (let ((a!1 (> (+ (+ it667 (* it553 (- 2))) 1) 0))
      (a!2 (> (+ (+ it667 (* it553 (- 2))) 2) 0))
      (a!3 (> (+ (+ (* it671 (- 2)) it667 (* it553 (- 2))) 1) 0))
      (a!4 (> (+ (+ (* it671 (- 2)) it667 (* it553 (- 2))) 2) 0)))
  (and (>= (+ it553 (- 1)) 0)
       (<= (+ (* it671 2) (* it553 2)) 0)
       a!1
       a!2
