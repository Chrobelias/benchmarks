...
(assert (= (+ (+ 0 (* it446 (- 1)))
   ...
   (+ 0 0)))
(assert (and (= (+ it495 (- 2)) 0) (> it497 0) (> (+ it497 (- 1)) 0)))
(assert (= (+ it528 (- 2)) 0))
(assert (= (+ (* it496 (- 1)) it529 (- 2)) 0))
(assert (= (+ (* it497 (- 1)) it530 2) 0))
(assert (= (+ it498 it531) 0))
(assert (= (+ it499 it532) 0))
(assert (let ((a!1 (+ (* (exp (+ it497 (- 1)) 2) (+ 0 (- 1)))
              (+ 0 (* it500 (- 1)))
              (+ 0 it533)
              (* (exp it497 2) (+ 0 (- 1))))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (> (+ (+ it530 (* it501 (- 2))) 1) 0))
      (a!2 (> (+ (+ (* it447 (- 2)) it530 (* it501 (- 2))) 1) 0))
      (a!3 (> (+ (+ (* it447 (- 2)) it530 (* it501 (- 2))) 2) 0))
      (a!4 (> (+ (+ it530 (* it501 (- 2))) 2) 0)))
  (and (>= (+ it447 (- 1)) 0)
       (>= (+ it501 (- 1)) 0)
       (= 0 0)
       (<= (+ (* it447 2) (* it501 2)) 0)
