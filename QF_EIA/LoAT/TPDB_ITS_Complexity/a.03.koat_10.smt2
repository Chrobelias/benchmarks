...
(assert (let ((a!1 (>= (+ (+ it62 (* it64 (- 1))) (- 1)) 0)))
  (and (>= (+ it62 (* it64 (- 1))) 0) a!1 (= (+ it59 (- 3)) 0))))
(assert (= (+ it72 (- 4)) 0))
(assert (= (+ it73 (* it60 (- 1)) (- 1)) 0))
(assert (= (+ it74 (* it61 (- 1))) 0))
(assert (= (+ it75 (* it62 (- 1))) 0))
(assert (= (+ it76 (* it63 (- 1))) 0))
(assert (= (+ it77 (* it64 (- 1))) 0))
(assert (and (= (+ it74 (- 1)) 0)
     (>= (+ it75 (- 3)) 0)
     (>= (+ it75 (- 2)) 0)
     (= (+ it72 (- 4)) 0)))
...
(assert (= (+ (* it75 (- 1)) it83 1) 0))
(assert (= (+ (* it74 (- 1)) it84) 0))
(assert (= (+ it85 (* it74 (- 2))) 0))
(assert (let ((a!1 (>= (+ (+ (* it85 (- 1)) it83) (- 1)) 0)))
  (and (= 0 0)
       (>= (+ (* it80 (- 1)) 3) 0)
       (>= (+ it85 (- 1)) 0)
       (= (* it85 (- 1)) 0)
