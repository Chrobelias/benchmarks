...
(assert (let ((a!1 (+ (+ (+ it867 (* it88 (- 1))) (* it19 (- 1))) (- 2)))
      (a!2 (+ (+ (+ it867 (* it88 (- 1))) (* it866 (- 2))) 1))
      (a!3 (>= (+ (+ it867 (* it88 (- 1))) (* it866 (- 2))) 0))
      (a!4 (+ (+ (+ it867 (* it88 (- 1))) (* it19 (- 1))) (* it866 (- 2))))
      (a!5 (>= (+ (+ it867 (* it88 (- 1))) (- 3)) 0))
      (a!6 (+ (+ (+ it867 (* it88 (- 1))) (* it866 (- 2))) (- 1)))
      (a!7 (>= (+ (+ it867 (* it869 (- 1))) (- 1)) 0))
      (a!8 (+ (+ (+ it867 (* it88 (- 1))) (* it19 (- 1))) (- 1)))
      (a!9 (>= (+ (+ it867 (* it88 (- 1))) (- 1)) 0))
      (a!10 (>= (+ (+ it867 (* it88 (- 1))) (- 2)) 0)))
  (and (>= (+ (* it866 (- 1)) 1) 0)
       (>= (+ it867 (- 2)) 0)
       (>= (+ it864 (- 3)) 0)
       (>= (+ it866 (- 1)) 0)
