...
(assert (let ((a!1 (> (+ (+ it290 (* it15 (- 2))) 2) 0))
      (a!2 (> (+ (+ it290 (* it15 (- 2))) 1) 0)))
  (and a!1
       (>= (+ (* it288 (- 1)) 2) 0)
       (>= (+ it15 (- 1)) 0)
       a!2
       (>= (+ it288 (- 2)) 0))))
(assert (= (+ (* it288 (- 1)) it361) 0))
(assert (= (+ it362 (* it289 (- 1)) (* it15 (- 2))) 0))
(assert (= (+ it363 (* it290 (- 1)) (* it15 2)) 0))
(assert (= (+ (* (exp (- 1) it15) (+ 0 it291) (+ 0 (- 1))) (+ 0 it364))
   (+ 0 0)))
(assert (= (+ (* (exp (- 1) it15) (+ 0 it292) (+ 0 (- 1))) (+ 0 it365))
   (+ 0 0)))
(assert (= (+ (* (+ 0 it290) (exp it15 2) (+ 0 12))
      (+ 0 (* it293 (- 3)))
      (+ 0 (* it366 3))
      (+ 0 (* it290 it15 (- 6)))
      (* (exp it290 2) (+ 0 it15) (+ 0 (- 6)))
      (+ 0 (* it15 (- 1)))
      (* (exp it15 2) (+ 0 6))
      (* (exp it15 3) (+ 0 (- 8))))
   (+ 0 0)))
(assert (= (+ (* it294 (- 1)) it367) 0))
(assert (let ((a!1 (> (+ (+ it367 (* it81 (- 2))) 2) 0))
      (a!2 (> (+ (+ it363 (* it191 (- 2))) 1) 0))
      (a!3 (> (+ (+ it363 (* it191 (- 2))) 2) 0))
      (a!4 (> (+ (+ it367 (* it81 (- 2))) 1) 0)))
  (and (> (+ it367 (- 1)) 0)
       (>= (+ it191 (- 1)) 0)
       (= (* it81 2) 0)
       a!1
