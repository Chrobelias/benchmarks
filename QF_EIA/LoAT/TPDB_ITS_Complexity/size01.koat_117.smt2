...
(assert (let ((a!1 (* (** (- 1) (+ (* it73 it447) (* it73 it501)))
              (+ 0 it498)
              (+ 0 (- 1)))))
  (= (+ (+ 0 it598) a!1) (+ 0 0))))
(assert (let ((a!1 (* (** (- 1) (+ (* it73 it447) (* it73 it501)))
              ...
              (+ 0 (- 1)))))
  (= (+ a!1 (+ 0 it599)) (+ 0 0))))
(assert (let ((a!1 (+ (* (* (** it73 2) (** it447 2)) (+ 0 6))
              (* (** it73 3) (** it501 3) (+ 0 (- 8)))
              (* (* (** it73 2) (+ 0 it447)) (+ 0 it501) (+ 0 12))
              (+ 0 (* it600 3))
              (+ 0 (* it73 it497 it501 (- 6)))
              (* (+ 0 (* it73 it447)) (** it497 2) (+ 0 (- 6)))
              (* (** it73 3) (** it447 2) (+ 0 it501) (+ 0 (- 24)))
              (+ 0 (* (* it73 it447) it497 (- 6)))
              (* (** it73 2) (** it501 2) (+ 0 6))
              (* (** it73 3) (** it447 3) (+ 0 (- 8)))
              (* (* (** it73 2) (** it447 2)) (+ 0 it497) (+ 0 12))
              (+ 0 (* it500 (- 3)))
              (+ 0 (* (* it73 it447) (- 1)))
              (* (** it73 2) (+ 0 it497) (** it501 2) (+ 0 12))
              (* (+ 0 it73) (** it497 2) (+ 0 it501) (+ 0 (- 6)))
              (* (** it73 3) (+ 0 it447) (** it501 2) (+ 0 (- 24)))
              (* (* (** it73 2) (+ 0 it447))
                 (+ 0 it497)
                 (+ 0 it501)
                 (+ 0 24))
              (+ 0 (* it73 it501 (- 1))))))
  (= a!1 (+ 0 0))))
(assert (and (> it597 0) (= (+ it595 (- 2)) 0)))
(assert (= (+ it734 (- 2)) 0))
(assert (= (+ (* it596 (- 1)) it735 (- 1)) 0))
(assert (= (+ (* it597 (- 1)) it736 1) 0))
(assert (= (+ (* it598 (- 3)) it737 (* it599 (- 2))) 0))
(assert (= (+ (* it598 5) (* it599 3) it738) 0))
(assert (let ((a!1 (+ (+ 0 (+ (* it600 (- 1)) it739))
              (* (** it597 2) (+ 0 (- 1))))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (> (+ (+ it736 (* it602 (- 2))) 1) 0))
      (a!2 (> (+ (+ (* it603 (- 2)) it736 (* it602 (- 2))) 2) 0))
      (a!3 (> (+ (+ it736 (* it602 (- 2))) 2) 0))
      (a!4 (> (+ (+ (* it603 (- 2)) it736 (* it602 (- 2))) 1) 0)))
  (and (<= (+ (* it603 2) (* it602 2)) 0)
       (>= (+ it603 (- 1)) 0)
       (>= (+ it602 (- 1)) 0)
       (= (+ (* it603 2) (* it602 2)) 0)
       (= 0 0)
