...
(assert (= (+ (+ 0 it861) (* (+ 0 it841) (exp (- 1) it13) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (+ 0 it862) (* (+ 0 it842) (exp (- 1) it13) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (* (exp it13 3) (+ 0 (- 8)))
      (* (+ 0 it13) (exp it840 2) (+ 0 (- 6)))
      (* (exp it13 2) (+ 0 6))
      (+ 0 (* it13 it840 (- 6)))
      (* (exp it13 2) (+ 0 it840) (+ 0 12))
      (+ 0 (* it13 (- 1)))
      (+ 0 (* it863 3))
      (+ 0 (* it843 (- 3))))
   (+ 0 0)))
(assert (let ((a!1 (> (+ (+ (* it864 (- 2)) (* it844 (- 2)) it860) 2) 0))
      (a!2 (> (+ (+ (* it844 (- 2)) it860) 2) 0))
      (a!3 (> (+ (+ (* it844 (- 2)) it860) 1) 0))
      (a!4 (> (+ (+ (* it864 (- 2)) (* it844 (- 2)) it860) 1) 0)))
  (and a!1
       (>= (+ it864 (- 1)) 0)
       (= (+ (* it864 2) (* it844 2)) 0)
       a!2
