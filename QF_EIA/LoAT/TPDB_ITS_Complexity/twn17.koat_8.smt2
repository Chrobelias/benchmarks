...
(assert (let ((a!1 (* (* (exp it338 3) (exp 9 (+ it200 (- 1)))) (+ 0 (- 1))))
      (a!2 (* (exp it336 2) (exp (exp 4 (+ it200 (- 1))) (+ 0 2))))
      (a!4 (> (+ (+ 0 it337)
                 (* (exp it336 2) (+ 0 (- 1)))
                 (* (exp it338 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!5 (* (* (+ 0 it337) (exp 9 (+ it200 (- 1)))) (+ 0 3)))
      (a!6 (* (* (exp it338 3) (exp 9 (+ it200 (- 1)))) (+ 0 (- 3)))))
(let ((a!3 (+ (* (+ 0 it337) (exp 9 (+ it200 (- 1))))
              a!1
              (exp it338 3)
              (* (exp it338 5) (+ 0 (- 1)))
              (* a!2 (+ 0 (- 1)))))
