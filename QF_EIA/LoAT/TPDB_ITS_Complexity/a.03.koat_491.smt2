...
(assert (= (+ it887 (- 4)) 0))
(assert (= (+ it888 (* it865 (- 1)) (- 1)) 0))
(assert (= (+ it889 (* it866 (- 1))) 0))
(assert (= (+ (* it867 (- 1)) it890) 0))
(assert (= (+ it891 (* it868 (- 1))) 0))
(assert (= (+ it892 (* it869 (- 1))) 0))
(assert (let ((a!1 (>= (+ (+ (* it889 (- 2)) it890) (- 1)) 0))
      (a!2 (>= (+ (+ (* it889 (- 2)) it890) (- 2)) 0)))
  (and a!1
       (>= (+ it890 (- 3)) 0)
       a!2
       (>= (+ (* it887 (- 1)) 4) 0)
