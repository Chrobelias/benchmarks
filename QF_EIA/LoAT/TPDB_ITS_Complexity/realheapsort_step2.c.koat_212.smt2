...
(assert (and (> (+ it1054 (* it1052 (- 1)) (* it1053 2) 3) 0) (= (+ it1049 (- 20)) 0)))
(assert (= (+ it1056 (- 18)) 0))
(assert (= (+ it1057 (* it1050 (- 1)) (- 4)) 0))
(assert (= (+ it1058 (* it1054 (- 1)) (- 1)) 0))
(assert (= (+ it1059 (* it1052 (- 1))) 0))
(assert (= (+ it1060 (* it1053 (- 1))) 0))
(assert (= (+ (* it1054 (- 1)) it1061 (- 1)) 0))
(assert (= (+ it1062 (* it1055 (- 1))) 0))
(assert (and (= (+ it1056 (- 18)) 0) (<= (+ (* it1059 (- 1)) it1061 2) 0)))
(assert (= (+ it1064 (- 20)) 0))
(assert (= (+ it1065 (* it1057 (- 1)) (- 2)) 0))
(assert (= (+ (* it1058 (- 1)) it1066) 0))
(assert (= (+ (* it1059 (- 1)) it1067) 0))
(assert (= it1068 0))
(assert (= (+ it1069 (* it1061 (- 1))) 0))
(assert (= (+ (* it1062 (- 1)) it1070) 0))
(assert (let ((a!1 (* (* (+ 0 it1068) (** 2 (+ it101 (- 1)))) (+ 0 (- 2))))
      (a!3 (* (* (+ 0 it1068) (** 2 (+ it101 (- 1)))) (+ 0 2))))
(let ((a!2 (+ (* (** 2 (+ it101 (- 1))) (+ 0 (- 2)))
  ...
  (and (>= a!2 (+ 0 0))
       ...
       (>= (+ it1064 (- 20)) 0)
       (>= (+ (* it1064 (- 1)) 20) 0)
       (>= (+ (* it1068 2) it1069 (* it1067 (- 1)) 3) 0)
       (>= (+ (* it1068 (- 2)) (* it1069 (- 1)) it1067 (- 3)) 0)
       (>= (+ it101 (- 1)) 0)))))
(check-sat)
