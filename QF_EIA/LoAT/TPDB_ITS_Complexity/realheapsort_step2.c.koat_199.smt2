...
(assert (and (= (+ it865 (- 20)) 0) (> (+ (* it869 2) it870 (* it868 (- 1)) 3) 0)))
(assert (= (+ it874 (- 18)) 0))
(assert (= (+ (* it866 (- 1)) it875 (- 4)) 0))
(assert (= (+ it876 (* it870 (- 1)) (- 1)) 0))
(assert (= (+ it877 (* it868 (- 1))) 0))
(assert (= (+ (* it869 (- 1)) it878) 0))
(assert (= (+ it879 (* it870 (- 1)) (- 1)) 0))
(assert (= (+ it880 (* it871 (- 1))) 0))
(assert (and (= (+ it874 (- 18)) 0) (<= (+ it879 (* it877 (- 1)) 2) 0)))
(assert (= (+ it881 (- 20)) 0))
(assert (= (+ it882 (* it875 (- 1)) (- 2)) 0))
(assert (= (+ (* it876 (- 1)) it883) 0))
(assert (= (+ (* it877 (- 1)) it884) 0))
(assert (= it885 0))
(assert (= (+ (* it879 (- 1)) it886) 0))
(assert (= (+ (* it880 (- 1)) it887) 0))
(assert (let ((a!1 (* (* (exp 2 (+ it101 (- 1))) (+ 0 it885)) (+ 0 (- 2))))
      (a!3 (* (* (exp 2 (+ it101 (- 1))) (+ 0 it885)) (+ 0 2))))
(let ((a!2 (+ (+ 0 (* it886 (- 1)))
              (* (exp 2 (+ it101 (- 1))) (+ 0 (- 2)))
              a!1
              (+ 0 it884)
      ...
      (a!4 (+ (+ 0 it886)
              ...
              (+ 0 1))))
  (and (>= a!2 (+ 0 0))
       (>= (+ it886 (* it884 (- 1)) (* it885 2) 3) 0)
       (>= (+ it881 (- 20)) 0)
       (>= (+ (* it881 (- 1)) 20) 0)
       (>= a!4 (+ 0 0))
       (>= (+ (* it886 (- 1)) it884 (* it885 (- 2)) (- 3)) 0)
       (>= (+ it101 (- 1)) 0)))))
(check-sat)
