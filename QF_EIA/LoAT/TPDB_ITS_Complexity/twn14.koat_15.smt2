...
(assert (let ((a!1 (* (* (exp 9 (+ it109 (- 1))) (exp it392 3)) (+ 0 (- 3))))
      (a!2 (* (* (+ 0 it391) (exp 9 (+ it109 (- 1)))) (+ 0 3)))
      (a!3 (* (exp (exp 4 (+ it109 (- 1))) (+ 0 2)) (exp it390 2)))
      (a!5 (> (+ (+ 0 it391)
                 (* (exp it392 5) (+ 0 (- 1)))
                 (* (exp it390 2) (+ 0 (- 1))))
              (+ 0 0)))
      (a!6 (* (* (exp 9 (+ it109 (- 1))) (exp it392 3)) (+ 0 (- 1)))))
(let ((a!4 (> (+ (exp it392 3)
                 a!1
                 a!2
                 (* a!3 (+ 0 (- 4)))
