...
(declare-fun it2752 () Int)
(declare-fun it2753 () Int)
...
(assert (= (+ (+ 0 it2566) (* (exp 2 it57) (+ 0 it1242) (+ 0 (- 1))))
   (+ 0 0)))
(assert (and (>= (+ it2566 (- 1)) 0)
     (= (+ it2561 (- 3)) 0)
     (= (+ (* it2566 (- 1)) it2564) 0)))
(assert (= (+ it2750 (- 3)) 0))
(assert (= (+ (* it2562 (- 1)) it2751 (- 1)) 0))
(assert (= (+ it2752 (* it2563 (- 1))) 0))
(assert (= (+ it2753 (* it2564 (- 1))) 0))
(assert (= (+ (* it2566 (- 1)) it2754) 0))
(assert (= (+ it2755 (* it2566 (- 2))) 0))
(check-sat)
