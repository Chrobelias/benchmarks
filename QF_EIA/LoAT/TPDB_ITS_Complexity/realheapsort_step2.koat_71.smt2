...
(assert (let ((a!1 (>= (+ (+ it328 (* it329 (- 1)) (* it330 (- 2))) (- 3)) 0))
      (a!2 (+ (+ 0 it328)
              (* (** 2 (+ it282 (- 1))) (+ 0 it330) (+ 0 (- 2)))
              (+ 0 (* it329 (- 1)))
              (* (** 2 it282) (+ 0 (- 2)))))
      (a!3 (>= (+ (+ it328 (* it329 (- 1)) (* it330 (- 2))) (- 4)) 0)))
  (and a!1
       (>= (+ it326 (- 7)) 0)
       (>= a!2 (+ 0 0))
       (>= (+ (* it326 (- 1)) 7) 0)
       ...
       (>= (+ it282 (- 1)) 0)
       (>= (+ a!2 (+ 0 1)) (+ 0 0)))))
(assert (= (+ it377 (* it326 (- 1))) 0))
(assert (= (+ it378 (* it282 (- 6)) (* it327 (- 1))) 0))
(assert (= (+ (* it328 (- 1)) it379) 0))
(assert (= (+ (* it329 (- 1)) it380) 0))
(assert (let ((a!1 (+ (+ 0 it381)
              (* (** 2 it282) (+ 0 it330) (+ 0 (- 1)))
              (* (** 2 (+ it282 1)) (+ 0 (- 1)))
              (+ 0 2))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (+ (* (** 2 (+ it282 (- 1))) (+ 0 it330) (+ 0 (- 2)))
              (+ 0 it382)
              (* (** 2 it282) (+ 0 (- 2)))
              (+ 0 2))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (>= (+ (+ (* it379 (- 1)) (* it380 (- 1))) (- 3)) 0))
      (a!2 (>= (+ (+ (* it381 (- 2)) it379 (* it380 (- 1))) (- 3)) 0))
      (a!3 (>= (+ (+ (* it379 (- 1)) (* it380 (- 1))) (- 4)) 0))
      (a!4 (>= (+ (+ (* it381 (- 2)) it379 (* it380 (- 1))) (- 4)) 0)))
  (and (>= (+ (* it377 (- 1)) 7) 0)
       (>= (+ it377 (- 7)) 0)
       a!1
       a!2
