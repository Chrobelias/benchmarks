...
(assert (= (+ it275 (- 2)) 0))
(assert (= (+ (* it266 (- 1)) it276 (- 1)) 0))
(assert (= (+ (* it271 (- 1)) it277) 0))
(assert (= (+ it278 (* it271 (- 2))) 0))
(assert (= (+ it279 (* it271 (- 3))) 0))
(assert (= (+ (* it267 (- 1)) it280) 0))
(assert (= (+ it281 (* it271 (- 1)) 1) 0))
(assert (let ((a!1 (> (+ (+ it281 (* it81 (- 2))) 1) 0))
      (a!2 (> (+ (+ it281 (* it81 (- 2))) 2) 0))
      (a!3 (> (+ (+ it277 (* it191 (- 2))) 1) 0))
      (a!4 (> (+ (+ it277 (* it191 (- 2))) 2) 0)))
  (and (> it281 0)
       (= (+ (* it281 (- 1)) (* it81 2) it277 (- 1)) 0)
       a!1
       a!2
       (= (* it81 2) 0)
       a!3
