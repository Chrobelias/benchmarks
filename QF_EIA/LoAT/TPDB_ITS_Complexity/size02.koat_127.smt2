...
(assert (and (> (+ it583 (* it56 (- 2)) it584 2) 0)
     (>= (+ (* it580 (- 1)) 3) 0)
     (>= (+ it56 (- 1)) 0)
     (>= (+ it580 (- 3)) 0)))
(assert (= (+ (* it580 (- 1)) it610) 0))
(assert (= (+ it611 (* it56 (- 1)) (* it581 (- 1))) 0))
(assert (= (+ (* it582 (- 1)) it612) 0))
(assert (= (+ (* it583 (- 1)) it56 it613) 0))
(assert (= (+ it56 (* it584 (- 1)) it614) 0))
(assert (= (+ (* it585 (- 1)) it615) 0))
(assert (and (= (+ it610 (- 3)) 0) (> (+ it613 it614) 0)))
(assert (= (+ it619 (- 3)) 0))
(assert (= (+ (* it611 (- 1)) it620 (- 1)) 0))
(assert (= (+ (* it612 (- 1)) it621) 0))
(assert (= (+ (* it613 (- 1)) it622 1) 0))
(assert (= (+ it623 (* it614 (- 1)) 1) 0))
(assert (= (+ (* it615 (- 1)) it624) 0))
(assert (and (> (+ it623 it622) 0)
     (>= (+ it619 (- 3)) 0)
     (>= (+ (* it619 (- 1)) 3) 0)
     (= 1 0)))
(check-sat)
