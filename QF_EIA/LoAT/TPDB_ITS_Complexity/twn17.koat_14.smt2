...
(assert (let ((a!1 (> (+ (+ 0 it557)
                 ...
                 (* (exp it558 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!2 (* (* (exp it558 3) (exp 9 (+ it200 (- 1)))) (+ 0 (- 1))))
      (a!3 (* (exp it556 2) (exp (exp 4 (+ it200 (- 1))) (+ 0 2))))
      (a!5 (* (* (+ 0 it557) (exp 9 (+ it200 (- 1)))) (+ 0 3)))
      (a!6 (* (* (exp it558 3) (exp 9 (+ it200 (- 1)))) (+ 0 (- 3)))))
(let ((a!4 (+ (* (+ 0 it557) (exp 9 (+ it200 (- 1))))
              a!2
              (exp it558 3)
              (* (exp it558 5) (+ 0 (- 1)))
              (* a!3 (+ 0 (- 1)))))
