...
(assert (let ((a!1 (< (+ (** it513 5) (** it511 2) (+ 0 (* it512 (- 1)))) (+ 0 0))))
  (and a!1 (> it511 0) (= (+ it508 (- 3)) 0))))
(assert (= (+ it522 (- 3)) 0))
(assert (= (+ it523 (* it509 (- 1)) (- 1)) 0))
(assert (= (+ it524 (* it510 (- 1))) 0))
(assert (= (+ (* it511 2) it525) 0))
(assert (let ((a!1 (+ (+ 0 (+ it526 (* it512 (- 3)))) (* (** it513 3) (+ 0 2)))))
  (= a!1 (+ 0 0))))
(assert (= (+ (* it513 (- 1)) it527) 0))
(assert (= (+ (* it514 (- 1)) it528) 0))
(assert (let ((a!1 (< (+ (** it525 2) (+ 0 (* it526 (- 1))) (** it527 5)) (+ 0 0))))
  (and (< it525 0) a!1 (= (+ it522 (- 3)) 0))))
(assert (= (+ it538 (- 3)) 0))
(assert (= (+ (* it523 (- 1)) it539 (- 1)) 0))
(assert (= (+ it540 (* it524 (- 1))) 0))
(assert (= (+ it541 (* it525 2)) 0))
(assert (let ((a!1 (+ (+ 0 (+ (* it526 (- 3)) it542)) (* (** it527 3) (+ 0 2)))))
  (= a!1 (+ 0 0))))
(assert (= (+ (* it527 (- 1)) it543) 0))
(assert (= (+ it544 (* it528 (- 1))) 0))
(assert (let ((a!1 (< (+ (** it541 2) (** it543 5) (+ 0 (* it542 (- 1)))) (+ 0 0))))
  (and a!1 (= (+ it538 (- 3)) 0) (> it541 0))))
(assert (= (+ it553 (- 3)) 0))
(assert (= (+ it554 (* it539 (- 1)) (- 1)) 0))
(assert (= (+ (* it540 (- 1)) it555) 0))
(assert (= (+ (* it541 2) it556) 0))
(assert (= (+ (+ 0 it557) (* (** it543 3) (+ 0 2)) (+ 0 (* it542 (- 3))))
   (+ 0 0)))
(assert (= (+ it558 (* it543 (- 1))) 0))
(assert (= (+ (* it544 (- 1)) it559) 0))
(assert (let ((a!1 (> (+ (+ 0 it557)
                 (* (** it556 2) (+ 0 (- 1)))
                 (* (** it558 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!2 (* (* (** it558 3) (** 9 (+ it200 (- 1)))) (+ 0 (- 1))))
      (a!3 (* (** it556 2) (** (** 4 (+ it200 (- 1))) (+ 0 2))))
      (a!5 (* (* (+ 0 it557) (** 9 (+ it200 (- 1)))) (+ 0 3)))
      (a!6 (* (* (** it558 3) (** 9 (+ it200 (- 1)))) (+ 0 (- 3)))))
(let ((a!4 (+ (* (+ 0 it557) (** 9 (+ it200 (- 1))))
              a!2
              (** it558 3)
              (* (** it558 5) (+ 0 (- 1)))
              (* a!3 (+ 0 (- 1)))))
