...
(assert (= (+ (* (** 2 it4) (+ 0 it3) (+ 0 (- 1))) (+ 0 it12)) (+ 0 0)))
(assert (= it13 0))
...
(assert (and (> it23 0) (= (+ it21 (- 3)) 0)))
(assert (= (+ it38 (- 3)) 0))
(assert (= (+ (* it22 (- 1)) it39 (- 1)) 0))
(assert (= (+ (* it23 (- 1)) it40 1) 0))
(assert (= (+ it41 (* it24 (- 1))) 0))
(assert (and (>= (+ it38 (- 3)) 0) (> it40 0) (= 1 0) (>= (+ (* it38 (- 1)) 3) 0)))
(check-sat)
