...
(assert (let ((a!1 (> (+ (+ 0 it175)
                 ...
                 (* (exp it176 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!2 (* (* (exp 9 (+ it200 (- 1))) (exp it176 3)) (+ 0 (- 1))))
      (a!3 (* (exp it174 2) (exp (exp 4 (+ it200 (- 1))) (+ 0 2))))
      (a!5 (* (* (+ 0 it175) (exp 9 (+ it200 (- 1)))) (+ 0 3)))
      (a!6 (* (* (exp 9 (+ it200 (- 1))) (exp it176 3)) (+ 0 (- 3)))))
(let ((a!4 (+ (* (+ 0 it175) (exp 9 (+ it200 (- 1))))
              (exp it176 3)
              a!2
              (* (exp it176 5) (+ 0 (- 1)))
              (* a!3 (+ 0 (- 1)))))
