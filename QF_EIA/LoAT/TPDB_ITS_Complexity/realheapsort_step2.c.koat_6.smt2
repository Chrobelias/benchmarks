...
(assert (and (> (+ it225 (* it223 (- 1)) (* it224 2) 3) 0) (= (+ it220 (- 20)) 0)))
(assert (= (+ it227 (- 18)) 0))
(assert (= (+ it228 (* it221 (- 1)) (- 4)) 0))
(assert (= (+ (* it225 (- 1)) it229 (- 1)) 0))
(assert (= (+ (* it223 (- 1)) it230) 0))
(assert (= (+ (* it224 (- 1)) it231) 0))
(assert (= (+ (* it225 (- 1)) it232 (- 1)) 0))
(assert (= (+ (* it226 (- 1)) it233) 0))
(assert (and (<= (+ it232 (* it230 (- 1)) 2) 0) (= (+ it227 (- 18)) 0)))
(assert (= (+ it234 (- 20)) 0))
(assert (= (+ (* it228 (- 1)) it235 (- 2)) 0))
(assert (= (+ (* it229 (- 1)) it236) 0))
(assert (= (+ (* it230 (- 1)) it237) 0))
(assert (= it238 0))
(assert (= (+ (* it232 (- 1)) it239) 0))
(assert (= (+ (* it233 (- 1)) it240) 0))
(assert (let ((a!1 (* (* (+ 0 it238) (** 2 (+ it101 (- 1)))) (+ 0 (- 2))))
      (a!3 (* (* (+ 0 it238) (** 2 (+ it101 (- 1)))) (+ 0 2))))
(let ((a!2 (+ (* (** 2 (+ it101 (- 1))) (+ 0 (- 2)))
      ...
      (a!4 (+ (* (** 2 (+ it101 (- 1))) (+ 0 2))
              ...
              a!3
              (+ 0 1))))
  (and (>= (+ (* it238 (- 2)) (* it239 (- 1)) it237 (- 3)) 0)
       (>= a!2 (+ 0 0))
       (>= a!4 (+ 0 0))
       (>= (+ (* it234 (- 1)) 20) 0)
       (>= (+ (* it238 2) it239 (* it237 (- 1)) 3) 0)
       (>= (+ it234 (- 20)) 0)
       (>= (+ it101 (- 1)) 0)))))
(check-sat)
