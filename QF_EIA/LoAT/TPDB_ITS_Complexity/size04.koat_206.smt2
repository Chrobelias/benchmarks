...
(assert (= (+ it1032 (- 3)) 0))
(assert (= (+ it1033 (* it1007 (- 1)) (- 1)) 0))
(assert (= (+ (* it1008 (- 1)) it1034) 0))
(assert (= (+ it1035 (* it1009 (- 1)) 1) 0))
(assert (= (+ it1036 (* it1010 (- 1)) 1) 0))
(assert (= (+ (* it1011 (- 1)) it1037 1) 0))
(assert (and (>= (+ it1032 (- 3)) 0)
     (> (+ it1035 it1036 it1037) 0)
     (>= (+ (* it1032 (- 1)) 3) 0)
     (= 1 0)))
(check-sat)
