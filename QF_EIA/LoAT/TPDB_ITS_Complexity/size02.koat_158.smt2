...
(assert (let ((a!1 (+ (+ 0 (* (* it3 it488) it92 (- 6)))
  ...
  (= a!1 (+ 0 0))))
(assert (and (> it493 0) (= (+ it491 (- 2)) 0)))
(assert (= (+ it732 (- 2)) 0))
(assert (= (+ it733 (* it492 (- 1)) (- 1)) 0))
(assert (= (+ (* it493 (- 1)) it734 1) 0))
(assert (= (+ it735 (* it494 (- 3)) (* it495 (- 2))) 0))
(assert (= (+ it736 (* it494 5) (* it495 3)) 0))
(assert (= (+ (* (exp it493 2) (+ 0 (- 1))) (+ 0 (* it496 (- 1))) (+ 0 it737))
   (+ 0 0)))
(assert (let ((a!1 (> (+ (+ (* it498 (- 2)) (* it499 (- 2)) it734) 1) 0))
      (a!2 (> (+ (+ (* it499 (- 2)) it734) 1) 0))
      (a!3 (> (+ (+ (* it499 (- 2)) it734) 2) 0))
      (a!4 (> (+ (+ (* it498 (- 2)) (* it499 (- 2)) it734) 2) 0)))
  (and a!1
       (>= (+ (* it732 (- 1)) 2) 0)
       (>= (+ it732 (- 2)) 0)
       (>= (+ it499 (- 1)) 0)
