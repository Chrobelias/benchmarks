...
(assert (let ((a!1 (> (+ (+ (* it83 (- 2)) it134) 1) 0))
  ...
  (and a!1
       ...
       (>= (+ it83 (- 1)) 0)
       a!2)))
(assert (= (+ (* it132 (- 1)) it165) 0))
(assert (= (+ (* it83 (- 2)) (* it133 (- 1)) it166) 0))
(assert (= (+ (* it83 2) it167 (* it134 (- 1))) 0))
(assert (= (+ (+ 0 it168) (* (+ 0 it135) (exp (- 1) it83) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (* (exp (- 1) it83) (+ 0 it136) (+ 0 (- 1))) (+ 0 it169))
   (+ 0 0)))
(assert (let ((a!1 (+ (+ 0 (+ (* it170 3) (* it83 (- 1))))
              (* (exp it83 2) (+ 0 it134) (+ 0 12))
              (+ 0 (* it83 it134 (- 6)))
              (* (exp it83 2) (+ 0 6))
              (+ 0 (* it137 (- 3)))
              (* (exp it83 3) (+ 0 (- 8)))
              (* (+ 0 it83) (exp it134 2) (+ 0 (- 6))))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (+ (+ (+ (* it138 (- 2)) it167) (* it171 (- 2))) 2))
      (a!2 (> (+ (+ (* it138 (- 2)) it167) 1) 0))
      (a!3 (> (+ (+ (* it138 (- 2)) it167) 2) 0))
      (a!4 (+ (+ (+ (* it138 (- 2)) it167) (* it171 (- 2))) 1)))
  (and (<= (+ (* it138 2) (* it171 2)) 0)
       (= (+ (* it138 2) (* it171 2)) 0)
       (> a!1 0)
       a!2
       a!3
