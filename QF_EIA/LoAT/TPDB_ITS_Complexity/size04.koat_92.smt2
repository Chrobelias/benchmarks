...
(assert (and (= (+ it383 (- 3)) 0) (> (+ it386 it388 it387) 0)))
(assert (= (+ it430 (- 3)) 0))
(assert (= (+ (* it384 (- 1)) it431 (- 1)) 0))
(assert (= (+ (* it385 (- 1)) it432) 0))
(assert (= (+ (* it386 (- 1)) it433 1) 0))
(assert (= (+ (* it387 (- 1)) it434 1) 0))
(assert (= (+ (* it388 (- 1)) it435 1) 0))
(assert (and (>= (+ (* it430 (- 1)) 3) 0)
     (> (+ it433 it434 it435) 0)
     (= 1 0)
     (>= (+ it430 (- 3)) 0)))
(check-sat)
