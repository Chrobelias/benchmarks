...
(assert (let ((a!1 (+ (* (** 2 it273) (+ 0 (- 2)))
              (+ 0 it1210)
              (+ 0 (* it1211 (- 1)))
              (* (** 2 (+ it273 (- 1))) (+ 0 it1212) (+ 0 (- 2)))))
...
(assert (let ((a!1 (+ (* (** 2 it273) (+ 0 it1212) (+ 0 (- 1)))
              (+ 0 it1222)
              (* (** 2 (+ it273 1)) (+ 0 (- 1)))
              (+ 0 2))))
  (= a!1 (+ 0 0))))
...
(assert (and (>= (+ (* it1278 (- 1)) it1279 (* it1280 2) 2) 0) (= (+ it1276 (- 7)) 0)))
(assert (= (+ it1290 (- 5)) 0))
(assert (= (+ it1291 (* it1277 (- 1)) (- 2)) 0))
(assert (= (+ (* it1278 (- 1)) it1292) 0))
(assert (= (+ it1293 (* it1279 (- 1)) (- 1)) 0))
(assert (= (+ it1294 (* it1280 (- 1))) 0))
(assert (= (+ (* it1281 (- 1)) it1295) 0))
(assert (and (>= (+ (* it1293 (- 1)) it1292 (- 2)) 0) (= (+ it1290 (- 5)) 0)))
(assert (= (+ it1300 (- 7)) 0))
(assert (= (+ it1301 (* it1291 (- 1)) (- 2)) 0))
(assert (= (+ it1302 (* it1292 (- 1))) 0))
(assert (= (+ (* it1293 (- 1)) it1303) 0))
(assert (= it1304 0))
(assert (= (+ it1305 (* it1295 (- 1))) 0))
(assert (and (= (+ it1300 (- 7)) 0) (>= (+ (* it1302 (- 1)) it1303 (* it1304 2) 2) 0)))
(assert (= (+ it1313 (- 5)) 0))
(assert (= (+ (* it1301 (- 1)) it1314 (- 2)) 0))
(assert (= (+ (* it1302 (- 1)) it1315) 0))
(assert (= (+ (* it1303 (- 1)) it1316 (- 1)) 0))
(assert (= (+ it1317 (* it1304 (- 1))) 0))
(assert (= (+ (* it1305 (- 1)) it1318) 0))
(assert (and (= (+ it1313 (- 5)) 0) (>= (+ (* it1315 (- 1)) it1316 1) 0)))
(assert (= (+ it1323 (- 15)) 0))
(assert (= (+ (* it1314 (- 1)) it1324 (- 2)) 0))
(assert (= (+ it1325 (* it1315 (- 1))) 0))
(assert (= (+ it1326 (* it1316 (- 1))) 0))
(assert (= (+ (* it1317 (- 1)) it1327) 0))
(assert (= (+ it1328 (* it1318 (- 1))) 0))
(check-sat)
