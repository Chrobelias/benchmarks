...
(assert (= (+ (* (exp it128 2) (+ 0 6))
   ...
   (+ 0 0)))
(assert (and (> (+ it255 (- 1)) 0) (= (+ it253 (- 2)) 0) (> it255 0)))
(assert (= (+ it323 (- 2)) 0))
(assert (= (+ (* it254 (- 1)) it324 (- 2)) 0))
(assert (= (+ (* it255 (- 1)) it325 2) 0))
(assert (= (+ it326 it256) 0))
(assert (= (+ it257 it327) 0))
(assert (let ((a!1 (+ (* (exp (+ it255 (- 1)) 2) (+ 0 (- 1)))
              (+ 0 (* it258 (- 1)))
              (* (exp it255 2) (+ 0 (- 1)))
              (+ 0 it328))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (> (+ (+ (* it127 (- 2)) (* it259 (- 2)) it325) 2) 0))
      (a!2 (> (+ (+ (* it259 (- 2)) it325) 1) 0))
      (a!3 (> (+ (+ (* it259 (- 2)) it325) 2) 0))
      (a!4 (> (+ (+ (* it127 (- 2)) (* it259 (- 2)) it325) 1) 0)))
  (and a!1
       a!2
       a!3
       a!4
