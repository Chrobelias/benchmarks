...
(assert (and (= (+ it1006 (- 3)) 0) (= (+ (* it1011 (- 1)) it1009) 0)))
(assert (= (+ it1019 (- 4)) 0))
(assert (= (+ it1020 (* it1007 (- 1)) (- 1)) 0))
(assert (= (+ (* it1008 (- 1)) it1021) 0))
(assert (= (+ (* it1009 (- 1)) it1022) 0))
(assert (= (+ it1023 (* it1010 (- 1))) 0))
(assert (= (+ (* it1011 (- 1)) it1024) 0))
(assert (let ((a!1 (>= (+ (+ (* it1021 (- 2)) it1022) (- 1)) 0))
      (a!2 (>= (+ (+ (* it1021 (- 2)) it1022) (- 2)) 0)))
  (and (>= (+ (* it1021 (- 1)) 1) 0)
       (>= (+ it1019 (- 4)) 0)
       (>= (+ (* it1019 (- 1)) 4) 0)
       a!1
