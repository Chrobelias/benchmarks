...
(declare-fun it6522 () Int)
(declare-fun it6523 () Int)
(declare-fun it6524 () Int)
(declare-fun it6525 () Int)
(declare-fun it6526 () Int)
(declare-fun it6527 () Int)
(declare-fun it6530 () Int)
(declare-fun it6531 () Int)
(declare-fun it6532 () Int)
(declare-fun it6533 () Int)
(declare-fun it6534 () Int)
(declare-fun it6535 () Int)
(declare-fun it6538 () Int)
(declare-fun it6539 () Int)
(declare-fun it6540 () Int)
(declare-fun it6541 () Int)
(declare-fun it6542 () Int)
(declare-fun it6543 () Int)
(assert (= (+ i1 (- 1)) 0))
(assert (= (+ it62 (- 2)) 0))
...
(assert (= (+ (+ 0 it6491)
      (* (** 2 it6485) (+ 0 (- 1)))
      (* (+ 0 it4259) (** 2 it6485) (+ 0 (- 1)))
      (+ 0 1))
   (+ 0 0)))
(assert (let ((a!1 (+ (* (** 2 (+ it6485 (- 1))) (+ 0 (- 2)))
              (* (+ 0 it4259) (** 2 (+ it6485 (- 1))) (+ 0 (- 2)))
              (+ 0 it6492)
              (+ 0 1))))
  (= a!1 (+ 0 0))))
(assert (and (>= (+ (* it6491 (- 2)) it6489 (* it6490 (- 1)) (- 3)) 0)
     (= (+ it6487 (- 12)) 0)))
(assert (= (+ it6522 (- 13)) 0))
(assert (= (+ (* it6488 (- 1)) it6523 (- 1)) 0))
(assert (= (+ (* it6489 (- 1)) it6524) 0))
(assert (= (+ it6525 (* it6490 (- 1))) 0))
(assert (= (+ (* it6491 (- 1)) it6526) 0))
(assert (= (+ it6527 (* it6492 (- 1))) 0))
(assert (and (= (+ (* it6525 (- 1)) (* it6526 (- 2)) it6524 (- 3)) 0)
     (= (+ it6522 (- 13)) 0)))
(assert (= (+ it6530 (- 18)) 0))
(assert (= (+ (* it6523 (- 1)) it6531 (- 2)) 0))
(assert (= (+ it6532 (* it6524 (- 1))) 0))
(assert (= (+ (* it6525 (- 1)) it6533) 0))
(assert (= (+ (* it6526 (- 1)) it6534) 0))
(assert (= (+ it6535 (* it6526 (- 2)) (- 1)) 0))
(assert (= (+ it6530 (- 18)) 0))
(assert (= (+ it6538 (- 12)) 0))
(assert (= (+ it6539 (* it6531 (- 1)) (- 2)) 0))
(assert (= (+ (* it6532 (- 1)) it6540) 0))
(assert (= (+ it6541 (* it6533 (- 1))) 0))
(assert (= (+ (* it6535 (- 1)) it6542) 0))
(assert (= (+ (* it6535 (- 1)) it6543) 0))
(assert (and (>= (+ (* it6541 (- 1)) (* it6542 (- 2)) it6540 (- 3)) 0)
     (>= (+ (* it6541 (- 1)) (* it6540 (- 1)) (- 3)) 0)
     (>= (+ it6541 (* it6542 2) (* it6540 (- 1)) 3) 0)
     (>= (+ it6541 it6540 3) 0)
     (<= (+ (* it6542 (- 2)) (* it6540 2)) 0)
     (>= (+ it6538 (- 12)) 0)
     (<= (+ (* it6542 2) (* it6540 (- 2))) 0)
