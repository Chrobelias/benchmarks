...
(declare-fun it2676 () Int)
(declare-fun it2677 () Int)
(declare-fun it2678 () Int)
(declare-fun it2679 () Int)
(declare-fun it2680 () Int)
(declare-fun it2681 () Int)
...
(assert (and (= (+ (* it2663 (- 1)) it2661) 0) (= (+ it2658 (- 3)) 0)))
(assert (= (+ it2676 (- 4)) 0))
(assert (= (+ (* it2659 (- 1)) it2677 (- 1)) 0))
(assert (= (+ it2678 (* it2660 (- 1))) 0))
(assert (= (+ it2679 (* it2661 (- 1))) 0))
(assert (= (+ (* it2662 (- 1)) it2680) 0))
(assert (= (+ it2681 (* it2663 (- 1))) 0))
(assert (let ((a!1 (>= (+ (+ (* it2678 (- 2)) it2679) (- 2)) 0))
      (a!2 (>= (+ (+ (* it2678 (- 2)) it2679) (- 1)) 0)))
  (and (>= (+ it2679 (- 3)) 0)
       a!1
       (>= (+ it2678 (- 1)) 0)
       (>= (+ (* it2676 (- 1)) 4) 0)
