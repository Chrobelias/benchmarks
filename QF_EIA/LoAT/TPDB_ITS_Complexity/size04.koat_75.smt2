...
(assert (= (+ (* (+ 0 it123) (** (- 1) it128) (+ 0 (- 1))) (+ 0 it256))
   (+ 0 0)))
(assert (= (+ (* (+ 0 it124) (** (- 1) it128) (+ 0 (- 1))) (+ 0 it257))
   (+ 0 0)))
(assert (= (+ (+ 0 (* it258 3))
      ...
      (+ 0 (* it128 it122 (- 6))))
   (+ 0 0)))
(assert (and (> it255 0) (= (+ it253 (- 2)) 0)))
(assert (= (+ it353 (- 2)) 0))
(assert (= (+ it354 (* it254 (- 1)) (- 1)) 0))
(assert (= (+ (* it255 (- 1)) it355 1) 0))
(assert (= (+ (* it256 (- 3)) (* it257 (- 2)) it356) 0))
(assert (= (+ it357 (* it256 5) (* it257 3)) 0))
(assert (= (+ (+ 0 (* it258 (- 1))) (* (** it255 2) (+ 0 (- 1))) (+ 0 it358))
   (+ 0 0)))
(assert (let ((a!1 (> (+ (+ (* it259 (- 2)) it355) 1) 0))
      (a!2 (> (+ (+ (* it259 (- 2)) it355) 2) 0))
      (a!3 (> (+ (+ (* it259 (- 2)) (* it127 (- 2)) it355) 1) 0))
      (a!4 (> (+ (+ (* it259 (- 2)) (* it127 (- 2)) it355) 2) 0)))
  (and a!1
       a!2
       (>= (+ it353 (- 2)) 0)
       a!3
