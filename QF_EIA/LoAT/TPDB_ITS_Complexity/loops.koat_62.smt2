...
(assert (= (+ it146 (- 1)) 0))
(assert (let ((a!1 (+ (* (** 2 (+ it27 (- 1))) (+ 0 it146) (+ 0 (- 1)))
              (+ 0 it145)
              (+ 0 (- 1)))))
...
(assert (= (+ (* (** 2 it27) (+ 0 it146) (+ 0 (- 1))) (+ 0 it152))
   (+ 0 0)))
...
(assert (let ((a!1 (+ (+ 0 it177)
  ...
  (and (>= (+ (* it175 (- 1)) 6) 0)
       ...
       (>= (+ it177 (* it178 (- 1)) (- 1)) 0)
       (>= a!1 (+ 0 0)))))
(assert (= (+ it183 (* it175 (- 1))) 0))
(assert (= (+ (* it176 (- 1)) (* it153 (- 2)) it184) 0))
(assert (= (+ (* it177 (- 1)) it185) 0))
(assert (= (+ (+ 0 it186) (* (** 2 it153) (+ 0 it178) (+ 0 (- 1))))
   (+ 0 0)))
(assert (and (= (+ it183 (- 6)) 0) (>= (+ (* it186 (- 1)) it185 (- 1)) 0)))
(assert (= (+ it192 (- 6)) 0))
(assert (= (+ it193 (* it184 (- 1)) (- 2)) 0))
(assert (= (+ it194 (* it185 (- 1))) 0))
(assert (= (+ (* it186 (- 2)) it195) 0))
(assert (and (>= (+ (* it192 (- 1)) 6) 0)
     (<= it195 0)
     (>= (+ it194 (* it195 (- 1)) (- 1)) 0)
     (>= (+ it192 (- 6)) 0)))
(check-sat)
