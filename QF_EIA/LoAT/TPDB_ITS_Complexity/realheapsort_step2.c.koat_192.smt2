...
(assert (and (= (+ it790 (- 21)) 0) (= (+ (* it794 2) it795 (* it793 (- 1)) 3) 0)))
(assert (= (+ it800 (- 26)) 0))
(assert (= (+ (* it791 (- 1)) it801 (- 2)) 0))
(assert (= (+ it802 (* it792 (- 1))) 0))
(assert (= (+ it803 (* it793 (- 1))) 0))
(assert (= (+ (* it794 (- 1)) it804) 0))
(assert (= (+ it805 (* it795 (- 1))) 0))
(assert (= (+ (* it794 (- 2)) it806 (- 1)) 0))
(assert (= (+ it800 (- 26)) 0))
(assert (= (+ it811 (- 20)) 0))
(assert (= (+ (* it801 (- 1)) it812 (- 2)) 0))
(assert (= (+ (* it802 (- 1)) it813) 0))
(assert (= (+ (* it803 (- 1)) it814) 0))
(assert (= (+ (* it806 (- 1)) it815) 0))
(assert (= (+ (* it805 (- 1)) it816) 0))
(assert (= (+ (* it806 (- 1)) it817) 0))
(assert (and (<= (+ (* it814 (- 2)) (* it815 2)) 0)
     (<= (+ (* it814 2) (* it815 (- 2))) 0)
     (>= (+ (* it816 (- 1)) (* it814 (- 1)) (- 3)) 0)
     (>= (+ it811 (- 20)) 0)
     (>= (+ (* it811 (- 1)) 20) 0)
     (>= (+ it816 it814 3) 0)
     (>= (+ it816 (* it814 (- 1)) (* it815 2) 3) 0)
     (>= (+ (* it816 (- 1)) it814 (* it815 (- 2)) (- 3)) 0)))
(check-sat)
