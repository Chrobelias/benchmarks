...
(assert (let ((a!1 (* (exp (exp 4 (+ it140 (- 1))) (+ 0 2)) (exp it382 2)))
      (a!2 (* (* (exp 9 (+ it140 (- 1))) (exp it384 3)) (+ 0 (- 1))))
      (a!4 (> (+ (* (exp it382 2) (+ 0 (- 1)))
                 (+ 0 it383)
                 (* (exp it384 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!5 (* (* (exp 9 (+ it140 (- 1))) (exp it384 3)) (+ 0 (- 3))))
      (a!6 (* (* (exp 9 (+ it140 (- 1))) (+ 0 it383)) (+ 0 3))))
(let ((a!3 (+ (* a!1 (+ 0 (- 1)))
              (* (exp it384 5) (+ 0 (- 1)))
              a!2
              (* (exp 9 (+ it140 (- 1))) (+ 0 it383))
              (exp it384 3)))
      (a!7 (> (+ (* a!1 (+ 0 (- 4)))
                 (* (exp it384 5) (+ 0 (- 1)))
                 a!5
