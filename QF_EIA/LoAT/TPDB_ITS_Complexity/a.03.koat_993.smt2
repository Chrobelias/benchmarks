...
(declare-fun it2725 () Int)
(declare-fun it2726 () Int)
(declare-fun it2727 () Int)
(declare-fun it2728 () Int)
...
(assert (and (= (+ it2712 (- 3)) 0) (= (+ it2715 (* it2717 (- 1))) 0)))
(assert (= (+ it2723 (- 4)) 0))
(assert (= (+ it2724 (* it2713 (- 1)) (- 1)) 0))
(assert (= (+ it2725 (* it2714 (- 1))) 0))
(assert (= (+ (* it2715 (- 1)) it2726) 0))
(assert (= (+ it2727 (* it2716 (- 1))) 0))
(assert (= (+ it2728 (* it2717 (- 1))) 0))
(assert (let ((a!1 (>= (+ (+ (* it2725 (- 2)) it2726) (- 2)) 0))
      (a!2 (>= (+ (+ (* it2725 (- 2)) it2726) (- 1)) 0)))
  (and (>= (+ it2726 (- 2)) 0)
       (>= (+ it2726 (- 3)) 0)
       (>= (+ (* it2725 (- 1)) 1) 0)
       (= 0 0)
