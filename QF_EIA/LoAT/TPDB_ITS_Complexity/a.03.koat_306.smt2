...
(assert (let ((a!1 (>= (+ (+ (* it88 (- 1)) (* it19 (- 1)) it538) (- 2)) 0))
      (a!2 (+ (+ (+ (* it88 (- 1)) (* it537 (- 2))) it538) 1))
      (a!3 (+ (+ (+ (* it88 (- 1)) (* it537 (- 2))) it538) (- 1)))
      (a!4 (>= (+ (+ (* it540 (- 1)) it538) (- 1)) 0))
      (a!5 (>= (+ (+ (* it88 (- 1)) it538) (- 3)) 0))
      (a!6 (>= (+ (+ (* it88 (- 1)) (* it19 (- 1)) it538) (- 1)) 0))
      (a!7 (+ (+ (* it88 (- 1)) (* it537 (- 2))) (* it19 (- 1)) it538))
      (a!8 (>= (+ (+ (* it88 (- 1)) it538) (- 2)) 0))
      (a!9 (>= (+ (+ (* it88 (- 1)) it538) (- 1)) 0))
      (a!10 (>= (+ (+ (* it88 (- 1)) (* it537 (- 2))) it538) 0)))
  (and (>= (+ it538 (- 2)) 0)
       (>= (+ (* it535 (- 1)) 3) 0)
       (>= (+ it538 (- 3)) 0)
       a!1
