...
(let ((a!2 (+ a!1
              ...
              (+ 0 (* (* it553 it117) (- 1))))))
  (= a!2 (+ 0 0)))))
(assert (and (> it734 0) (> (+ it734 (- 1)) 0) (= (+ it732 (- 2)) 0)))
(assert (= (+ it896 (- 2)) 0))
(assert (= (+ (* it733 (- 1)) it897 (- 2)) 0))
(assert (= (+ (* it734 (- 1)) it898 2) 0))
(assert (= (+ it899 it735) 0))
(assert (= (+ it736 it900) 0))
(assert (let ((a!1 (+ (* (exp (+ it734 (- 1)) 2) (+ 0 (- 1)))
              (+ 0 (* it737 (- 1)))
              (* (exp it734 2) (+ 0 (- 1)))
              (+ 0 it901))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (> (+ (+ (* it740 (- 2)) it898 (* it739 (- 2))) 1) 0))
      (a!2 (> (+ (+ (* it740 (- 2)) it898 (* it739 (- 2))) 2) 0))
      (a!3 (> (+ (+ it898 (* it739 (- 2))) 1) 0))
      (a!4 (> (+ (+ it898 (* it739 (- 2))) 2) 0)))
  (and (>= (+ it896 (- 2)) 0)
       a!1
       a!2
       (>= (+ (* it896 (- 1)) 2) 0)
