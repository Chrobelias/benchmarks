...
(assert (let ((a!1 (>= (+ (+ (* it403 (- 1)) it401) (- 1)) 0))
      (a!2 (>= (+ (+ (* it400 (- 2)) (* it88 (- 1)) it401) (- 1)) 0))
      (a!3 (+ (+ (* it400 (- 2)) (* it88 (- 1)) it401) (* it19 (- 1))))
      (a!4 (>= (+ (+ (* it88 (- 1)) it401) (- 2)) 0))
      (a!5 (+ (+ (+ (* it88 (- 1)) it401) (* it19 (- 1))) (- 1)))
      (a!6 (>= (+ (+ (* it88 (- 1)) it401) (- 3)) 0))
      (a!7 (>= (+ (+ (* it400 (- 2)) (* it88 (- 1)) it401) 1) 0))
      (a!8 (+ (+ (+ (* it88 (- 1)) it401) (* it19 (- 1))) (- 2)))
      (a!9 (>= (+ (+ (* it88 (- 1)) it401) (- 1)) 0)))
  (and (>= (+ (* it403 (- 1)) it401) 0)
       (>= (+ it401 (- 3)) 0)
       a!1
       (>= (+ it398 (- 3)) 0)
