...
(assert (and (= (+ it390 (- 4)) 0)
     ...
     (>= (+ it393 (- 3)) 0)))
(assert (= (+ it477 (- 3)) 0))
(assert (= (+ it478 (* it391 (- 1)) (- 2)) 0))
(assert (= (+ it479 (* it392 (- 1))) 0))
(assert (= (+ it480 (* it393 (- 1)) 1) 0))
(assert (= (+ it481 (* it392 (- 1))) 0))
(assert (= (+ it482 (* it392 (- 2))) 0))
(assert (let ((a!1 (>= (+ (+ (* it482 (- 1)) it480) (- 1)) 0))
      (a!2 (+ (+ (* it88 (- 1)) (* it479 (- 2))) (* it19 (- 1)) it480))
      (a!3 (>= (+ (+ (* it88 (- 1)) it480) (- 1)) 0))
      (a!4 (>= (+ (+ (* it88 (- 1)) (* it479 (- 2))) it480) 0))
      (a!5 (+ (+ (+ (* it88 (- 1)) (* it479 (- 2))) it480) (- 1)))
      (a!6 (>= (+ (+ (* it88 (- 1)) (* it19 (- 1)) it480) (- 1)) 0))
      (a!7 (>= (+ (+ (* it88 (- 1)) it480) (- 3)) 0))
      (a!8 (>= (+ (+ (* it88 (- 1)) it480) (- 2)) 0))
      (a!9 (+ (+ (+ (* it88 (- 1)) (* it479 (- 2))) it480) 1))
      (a!10 (>= (+ (+ (* it88 (- 1)) (* it19 (- 1)) it480) (- 2)) 0)))
  (and (>= (+ (* it477 (- 1)) 3) 0)
       (>= (+ (* it482 (- 1)) it480) 0)
       (>= (+ it477 (- 3)) 0)
       a!1
