...
(assert (= (+ (* (** (- 1) it92) (+ 0 it4) (+ 0 (- 1))) (+ 0 it1066))
   (+ 0 0)))
(assert (= (+ (+ 0 it1067) (* (** (- 1) it92) (+ 0 it5) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (* (+ 0 it92) (** it3 2) (+ 0 (- 6)))
      (+ 0 (* it92 it3 (- 6)))
      (* (** it92 2) (+ 0 6))
      (+ 0 (* it92 (- 1)))
      (* (** it92 3) (+ 0 (- 8)))
...
(assert (let ((a!1 (* (** (- 1) (+ (* it117 it1069) (* it117 it13)))
              (+ 0 it1066)
              (+ 0 (- 1)))))
  (= (+ a!1 (+ 0 it1110)) (+ 0 0))))
(assert (let ((a!1 (* (+ 0 it1067)
              (** (- 1) (+ (* it117 it1069) (* it117 it13)))
              (+ 0 (- 1)))))
  (= (+ (+ 0 it1111) a!1) (+ 0 0))))
...
(let ((a!2 (+ a!1
              (* (* (+ 0 it1065) (** it117 2))
                 ...
                 (+ 0 it1069)
                 (+ 0 24))
              (* (** it117 2) (+ 0 it13) (+ 0 it1069) (+ 0 12))
              (+ 0 (* (* it1065 it117) it13 (- 6)))
              (+ 0 (* it117 it13 (- 1)))
              (+ 0 (* it1112 3))
              (* (** it117 3) (** it13 2) (+ 0 it1069) (+ 0 (- 24)))
              (* (* (+ 0 it1065) (** it117 2)) (** it1069 2) (+ 0 12))
              (+ 0 (* it1068 (- 3)))
              (* (** it117 2) (** it1069 2) (+ 0 6))
              (* (* (+ 0 it1065) (** it117 2)) (** it13 2) (+ 0 12))
              (* (** it117 2) (** it13 2) (+ 0 6))
              (* (* (** it1065 2) (+ 0 it117))
                 (+ 0 it1069)
                 (+ 0 (- 6)))
              (* (** it117 3) (** it13 3) (+ 0 (- 8)))
              (* (** it117 3) (+ 0 it13) (** it1069 2) (+ 0 (- 24)))
              (* (* (** it1065 2) (+ 0 it117))
                 (+ 0 it13)
                 (+ 0 (- 6)))
              (* (** it117 3) (** it1069 3) (+ 0 (- 8))))))
  (= a!2 (+ 0 0)))))
(assert (let ((a!1 (> (+ (+ (* it1115 (- 2)) it1109) 1) 0))
  ...
  (and (>= (+ it1107 (- 2)) 0)
       ...
       a!2
       (>= (+ (* it1107 (- 1)) 2) 0))))
(assert (= (+ it1142 (* it1107 (- 1))) 0))
(assert (= (+ (* it1115 (- 2)) it1143 (* it1108 (- 1))) 0))
(assert (= (+ (* it1115 2) (* it1109 (- 1)) it1144) 0))
(assert (= (+ (+ 0 it1145) (* (** (- 1) it1115) (+ 0 it1110) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (* (** (- 1) it1115) (+ 0 it1111) (+ 0 (- 1))) (+ 0 it1146))
   (+ 0 0)))
(assert (= (+ (* (** it1115 2) (+ 0 it1109) (+ 0 12))
      (+ 0 (* it1115 (- 1)))
      (+ 0 (* it1112 (- 3)))
      (* (+ 0 it1115) (** it1109 2) (+ 0 (- 6)))
      (+ 0 (* it1147 3))
      (* (** it1115 2) (+ 0 6))
      (+ 0 (* it1115 it1109 (- 6)))
      (* (** it1115 3) (+ 0 (- 8))))
   (+ 0 0)))
(assert (let ((a!1 (> (+ (+ (* it1148 (- 2)) it1144 (* it1114 (- 2))) 1) 0))
      (a!2 (> (+ (+ it1144 (* it1114 (- 2))) 1) 0))
      (a!3 (> (+ (+ (* it1148 (- 2)) it1144 (* it1114 (- 2))) 2) 0))
      (a!4 (> (+ (+ it1144 (* it1114 (- 2))) 2) 0)))
  (and (>= (+ (* it1142 (- 1)) 2) 0)
       (>= (+ it1142 (- 2)) 0)
       a!1
       (>= (+ it1148 (- 1)) 0)
