...
(assert (and (> (+ it328 it326) 0) (= (+ it323 (- 3)) 0)))
(assert (= (+ it334 (- 3)) 0))
(assert (= (+ (* it324 (- 1)) it335 (- 1)) 0))
(assert (= (+ (* it325 (- 1)) it336) 0))
(assert (= (+ (* it326 (- 1)) it337 1) 0))
(assert (= (+ (* it327 (- 1)) it338) 0))
(assert (= (+ it339 (* it328 (- 1)) 1) 0))
(assert (= (+ it340 (* it329 (- 1))) 0))
(assert (and (>= (+ it334 (- 3)) 0)
     (> (+ it339 it337) 0)
     (>= (+ (* it334 (- 1)) 3) 0)
     (= 1 0)))
(check-sat)
