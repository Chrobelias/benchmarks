...
(assert (let ((a!1 (< (+ (+ 0 (* it104 (- 1))) (exp it103 2) (exp it105 5)) (+ 0 0))))
  (and (= (+ it100 (- 3)) 0) a!1 (< it103 0))))
(assert (= (+ it131 (- 3)) 0))
(assert (= (+ (* it101 (- 1)) it132 (- 2)) 0))
(assert (= (+ it133 (* it102 (- 1))) 0))
(assert (= (+ (* it103 2) it134) 0))
(assert (= (+ (* (exp it105 3) (+ 0 2)) (+ 0 (* it104 (- 3))) (+ 0 it135))
   (+ 0 0)))
(assert (= (+ it136 (* it105 (- 1))) 0))
(assert (= (+ (* it106 (- 1)) it137) 0))
(assert (let ((a!1 (< (+ (exp it136 5) (exp it134 2) (+ 0 (* it135 (- 1)))) (+ 0 0))))
  (and (> it134 0) (= (+ it131 (- 3)) 0) a!1)))
(assert (= (+ it139 (- 3)) 0))
(assert (= (+ it140 (* it132 (- 1)) (- 2)) 0))
(assert (= (+ (* it133 (- 1)) it141) 0))
(assert (= (+ (* it134 2) it142) 0))
(assert (= (+ (+ 0 it143) (* (exp it136 3) (+ 0 2)) (+ 0 (* it135 (- 3))))
   (+ 0 0)))
(assert (= (+ (* it136 (- 1)) it144) 0))
(assert (= (+ it145 (* it137 (- 1))) 0))
(assert (let ((a!1 (* (* (exp 9 (+ it128 (- 1))) (exp it144 3)) (+ 0 (- 1))))
      (a!2 (* (exp it142 2) (exp (exp 4 (+ it128 (- 1))) (+ 0 2))))
      (a!4 (> (+ (+ 0 it143)
                 (* (exp it144 5) (+ 0 (- 1)))
                 (* (exp it142 2) (+ 0 (- 1))))
              (+ 0 0)))
      (a!5 (* (* (exp 9 (+ it128 (- 1))) (+ 0 it143)) (+ 0 3)))
      (a!6 (* (* (exp 9 (+ it128 (- 1))) (exp it144 3)) (+ 0 (- 3)))))
(let ((a!3 (+ (exp it144 3)
              (* (exp 9 (+ it128 (- 1))) (+ 0 it143))
              a!1
              (* (exp it144 5) (+ 0 (- 1)))
              (* a!2 (+ 0 (- 1)))))
      (a!7 (> (+ (exp it144 3)
