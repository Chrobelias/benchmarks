...
(assert (let ((a!1 (< (+ (** it136 5) (** it134 2) (+ 0 (* it135 (- 1)))) (+ 0 0))))
  (and (> it134 0) (= (+ it131 (- 3)) 0) a!1)))
(assert (= (+ it139 (- 3)) 0))
(assert (= (+ it140 (* it132 (- 1)) (- 2)) 0))
(assert (= (+ (* it133 (- 1)) it141) 0))
(assert (= (+ (* it134 2) it142) 0))
(assert (= (+ (+ 0 it143) (* (** it136 3) (+ 0 2)) (+ 0 (* it135 (- 3))))
   (+ 0 0)))
(assert (= (+ (* it136 (- 1)) it144) 0))
(assert (= (+ it145 (* it137 (- 1))) 0))
(assert (let ((a!1 (* (* (** 9 (+ it128 (- 1))) (** it144 3)) (+ 0 (- 1))))
      (a!2 (* (** it142 2) (** (** 4 (+ it128 (- 1))) (+ 0 2))))
      (a!4 (> (+ (+ 0 it143)
                 (* (** it144 5) (+ 0 (- 1)))
                 (* (** it142 2) (+ 0 (- 1))))
              (+ 0 0)))
      (a!5 (* (* (** 9 (+ it128 (- 1))) (+ 0 it143)) (+ 0 3)))
      (a!6 (* (* (** 9 (+ it128 (- 1))) (** it144 3)) (+ 0 (- 3)))))
(let ((a!3 (+ (** it144 3)
              (* (** 9 (+ it128 (- 1))) (+ 0 it143))
              a!1
              (* (** it144 5) (+ 0 (- 1)))
