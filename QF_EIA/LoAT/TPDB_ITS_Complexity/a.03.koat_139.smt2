...
(assert (let ((a!1 (>= (+ (+ (* it303 (- 1)) it301) (- 1)) 0))
      (a!2 (+ (+ (+ (* it88 (- 1)) it301) (* it237 (- 1))) (- 2)))
      (a!3 (>= (+ (+ (* it88 (- 1)) it301) (- 2)) 0))
      (a!4 (>= (+ (+ (* it88 (- 1)) it301) (- 3)) 0))
      (a!5 (+ (+ (* it88 (- 1)) (* it300 (- 2)) it301) (* it237 (- 1))))
      (a!6 (>= (+ (+ (* it88 (- 1)) (* it300 (- 2)) it301) (- 1)) 0))
      (a!7 (+ (+ (+ (* it88 (- 1)) it301) (* it237 (- 1))) (- 1)))
      (a!8 (>= (+ (+ (* it88 (- 1)) (* it300 (- 2)) it301) 1) 0))
      (a!9 (>= (+ (+ (* it88 (- 1)) it301) (- 1)) 0)))
  (and (>= (+ (* it303 (- 1)) it301) 0)
       (>= (+ it301 (- 2)) 0)
       a!1
       (>= (+ it300 (- 1)) 0)
