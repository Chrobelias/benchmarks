...
(assert (= (+ (* (exp (- 1) it443) (+ 0 it435) (+ 0 (- 1))) (+ 0 it537))
   (+ 0 0)))
(assert (= (+ (+ 0 it538) (* (exp (- 1) it443) (+ 0 it436) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (* (+ 0 it443) (exp it434 2) (+ 0 (- 6)))
      (+ 0 (* it443 (- 1)))
      (+ 0 (* it437 (- 3)))
      (+ 0 (* it443 it434 (- 6)))
      (+ 0 (* it539 3))
      (* (exp it443 2) (+ 0 6))
      (* (exp it443 2) (+ 0 it434) (+ 0 12))
      (* (exp it443 3) (+ 0 (- 8))))
   (+ 0 0)))
(assert (= (+ (* it438 (- 1)) it540) 0))
(assert (let ((a!1 (> (+ (+ (* it444 (- 2)) it540) 1) 0))
      (a!2 (> (+ (+ (* it444 (- 2)) it540) 2) 0))
      (a!3 (+ (+ (* it440 (- 2)) (* (* it444 it442) (- 2))) it540))
      (a!4 (+ (* it440 (- 2))
              (* (+ it441 (- 1)) it440 (- 2))
              (* (* it444 it442) (- 2))))
      (a!5 (+ (* it440 it441 2) (* (* it444 it442) 2)))
      (a!6 (+ (+ (* it440 (- 2)) (* (* it444 it442) (- 2)))
              (* it445 (- 2))
              it540))
      (a!8 (+ (* it444 (+ it442 (- 1)) (- 2)) (* it444 (- 2)) it540))
      (a!9 (> (+ (* it444 (+ it442 (- 1)) (- 2)) it540 (- 1)) 0))
      (a!10 (+ (* it444 (+ it442 (- 1)) (- 2))
               (* it541 (- 2))
               (* it444 (- 2))
               it540))
      (a!12 (> (+ (+ (* it541 (- 2)) (* it444 (- 2)) it540) 2) 0))
      (a!13 (> (+ (* (* it444 it442) (- 2)) it540) 0))
      (a!14 (> (+ (* (+ it441 (- 1)) it440 (- 2))
                  (* (* it444 it442) (- 2))
                  it540
                  (- 1))
               0))
      (a!15 (> (+ (+ (* it541 (- 2)) (* it444 (- 2)) it540) 3) 0))
      (a!16 (+ (+ (* (* it444 it442) (- 2)) it540) (- 1))))
(let ((a!7 (> (+ (+ a!4 (* it445 (- 2)) it540) 3) 0))
      (a!11 (> (+ (+ a!4 (* it445 (- 2)) it540) 2) 0)))
  (and a!1
       a!2
       (> (+ a!3 1) 0)
       (> (+ (+ a!4 it540) 2) 0)
