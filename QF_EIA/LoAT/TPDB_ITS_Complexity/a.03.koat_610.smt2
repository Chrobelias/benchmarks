...
(assert (let ((a!1 (>= (+ (+ it969 (* it968 (- 2))) (- 1)) 0))
      (a!2 (>= (+ (+ it969 (* it968 (- 2))) (- 2)) 0)))
  (and (>= (+ it969 (- 2)) 0)
       (>= (+ it969 (- 3)) 0)
       a!1
       (>= (+ it966 (- 4)) 0)
       ...
       (>= 1 0)
       (>= 0 0))))
(assert (= (+ it998 (* it966 (- 1))) 0))
(assert (= (+ (* it969 (- 3)) it999 (* it967 (- 1)) (* it968 6) 3) 0))
(assert (= (+ it1000 (* it968 (- 1))) 0))
(assert (= (+ it1001 (* it968 (- 2)) (- 1)) 0))
(assert (= (+ it1002 (* it968 (- 1))) 0))
(assert (= (+ it1003 (* it968 (- 2)) (- 1)) 0))
(assert (and (= (+ it1000 (- 1)) 0)
     (>= (+ it1001 (- 2)) 0)
     (= (+ it998 (- 4)) 0)
     (>= (+ it1001 (- 3)) 0)))
(assert (= (+ it1006 (- 3)) 0))
(assert (= (+ (* it999 (- 1)) it1007 (- 2)) 0))
(assert (= (+ it1008 (* it1000 (- 1))) 0))
(assert (= (+ (* it1001 (- 1)) it1009 1) 0))
(assert (= (+ it1010 (* it1000 (- 1))) 0))
(assert (= (+ it1011 (* it1000 (- 2))) 0))
(assert (let ((a!1 (+ (+ (+ it1009 (* it941 (- 1))) (* it19 (- 1))) (- 2)))
      (a!2 (+ (+ (+ it1009 (* it941 (- 1))) (* it19 (- 1))) (- 1)))
      (a!3 (>= (+ (+ it1009 (* it941 (- 1))) (- 3)) 0))
      (a!4 (>= (+ (+ (* it1008 (- 2)) it1009 (* it941 (- 1))) (- 1)) 0))
      (a!5 (+ (+ (* it1008 (- 2)) it1009 (* it941 (- 1))) (* it19 (- 1))))
      (a!6 (>= (+ (+ it1009 (* it941 (- 1))) (- 1)) 0))
      (a!7 (>= (+ (+ (* it1011 (- 1)) it1009) (- 1)) 0))
      (a!8 (>= (+ (+ (* it1008 (- 2)) it1009 (* it941 (- 1))) 1) 0))
      (a!9 (>= (+ (+ it1009 (* it941 (- 1))) (- 2)) 0)))
  (and (>= a!1 0)
       (>= a!2 0)
       a!3
       (>= (+ it1009 (- 3)) 0)
