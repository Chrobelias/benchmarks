...
(assert (let ((a!1 (+ (* (exp it117 3) (exp it13 2) (+ 0 it92) (+ 0 (- 24)))
  ...
  (= a!1 (+ 0 0))))
(assert (and (= (+ it120 (- 2)) 0) (> it122 0)))
(assert (= (+ it150 (- 2)) 0))
(assert (= (+ (* it121 (- 1)) it151 (- 1)) 0))
(assert (= (+ it152 (* it122 (- 1)) 1) 0))
(assert (= (+ (* it124 (- 2)) it153 (* it123 (- 3))) 0))
(assert (= (+ (* it124 3) it154 (* it123 5)) 0))
(assert (= (+ (* (exp it122 2) (+ 0 (- 1))) (+ 0 (* it125 (- 1))) (+ 0 it155))
   (+ 0 0)))
(assert (let ((a!1 (> (+ (+ (* it127 (- 2)) it152 (* it128 (- 2))) 2) 0))
      (a!2 (> (+ (+ (* it127 (- 2)) it152 (* it128 (- 2))) 1) 0))
