...
(assert (= (+ (* it7 (- 1))
   ...
   0))
(assert (let ((a!1 (+ (+ (+ it604 (* it611 (- 2))) (* it612 (- 2))) 2))
      (a!2 (+ (* it613 (- 2)) it604 (* it608 (- 2)) (* it610 it612 (- 2))))
      (a!4 (+ (+ (+ it604 (* it611 (- 2))) (* it612 (- 2))) 3))
      (a!5 (+ (+ it604 (* it610 it612 (- 2))) (* (+ it609 (- 1)) it608 (- 2))))
      (a!7 (+ (+ it604 (* it608 (- 2)) (* it610 it612 (- 2)))
              (* (+ it607 (- 1)) it608 it609 (- 2))
              (* it610 (+ it607 (- 1)) it612 (- 2))))
      (a!8 (+ (+ it604 (* it612 (- 2)))
              (* (+ it607 (- 1)) it608 it609 (- 2))
              (* it610 (+ it607 (- 1)) it612 (- 2))))
      (a!9 (+ (+ (+ it604 (* it611 (- 2))) (* it612 (- 2)))
              (* (+ it607 (- 1)) it608 it609 (- 2))
              (* it610 (+ it607 (- 1)) it612 (- 2))))
      (a!10 (+ (+ it604 (* it608 (- 2)) (* it610 it612 (- 2)))
               (* (+ it609 (- 1)) it608 (- 2))))
      (a!13 (> (+ (+ it604 (* it610 it612 (- 2))) (- 1)) 0))
      (a!15 (+ (* it610 it607 it612 2) (* it607 it608 it609 2)))
      (a!16 (> (+ (+ it604 (* it608 (- 2)) (* it610 it612 (- 2))) 1) 0))
      (a!17 (+ (+ it604 (* (+ it610 (- 1)) it612 (- 2))) (- 1)))
      (a!18 (+ (+ it604 (* (+ it610 (- 1)) it612 (- 2))) (* it612 (- 2))))
      (a!20 (> (+ (+ it604 (* it612 (- 2))) 2) 0))
      (a!21 (+ (+ it604 (* it610 it612 (- 2)))
               (* (+ it607 (- 1)) it608 it609 (- 2))
               (* it610 (+ it607 (- 1)) it612 (- 2))))
      (a!22 (> (+ it604
                  (* (+ it607 (- 1)) it608 it609 (- 2))
      ...
      (a!23 (+ (+ it604 (* it611 (- 2)))
               (* (+ it610 (- 1)) it612 (- 2))
               (* it612 (- 2))))
      (a!25 (> (+ (+ it604 (* it608 (- 2)) (* it610 it612 (- 2))) 2) 0))
      (a!26 (> (+ (+ it604 (* it612 (- 2))) 1) 0))
      (a!28 (+ (+ it604 (* (+ it610 (- 1)) it612 (- 2)))
               (* (+ it607 (- 1)) it608 it609 (- 2))
               (* it610 (+ it607 (- 1)) it612 (- 2))
               (- 1))))
(let ((a!3 (+ (+ a!2 (* (+ it609 (- 1)) it608 (- 2)))
              (* (+ it607 (- 1)) it608 it609 (- 2))
              (* it610 (+ it607 (- 1)) it612 (- 2))))
      (a!6 (> (+ a!5
                 (* (+ it607 (- 1)) it608 it609 (- 2))
      ...
      (a!24 (+ a!23
               (* (+ it607 (- 1)) it608 it609 (- 2))
               (* it610 (+ it607 (- 1)) it612 (- 2))))
      (a!27 (+ (+ a!2 (* (+ it609 (- 1)) it608 (- 2))) 2)))
(let ((a!29 (> (+ (+ a!3 (* it606 (- 2))) 2) 0))
      (a!30 (> (+ (+ a!3 (* it606 (- 2))) 3) 0)))
  (and (> a!1 0)
       (> (+ a!3 2) 0)
       (> (+ it604 (- 1)) 0)
       (>= (+ it613 (- 1)) 0)
