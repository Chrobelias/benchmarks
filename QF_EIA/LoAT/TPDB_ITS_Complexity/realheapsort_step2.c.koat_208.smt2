...
(assert (and (> (+ (* it1009 (- 1)) (* it1010 2) it1011 3) 0) (= (+ it1006 (- 20)) 0)))
(assert (= (+ it1013 (- 18)) 0))
(assert (= (+ (* it1007 (- 1)) it1014 (- 4)) 0))
(assert (= (+ it1015 (* it1011 (- 1)) (- 1)) 0))
(assert (= (+ (* it1009 (- 1)) it1016) 0))
(assert (= (+ (* it1010 (- 1)) it1017) 0))
(assert (= (+ it1018 (* it1011 (- 1)) (- 1)) 0))
(assert (= (+ (* it1012 (- 1)) it1019) 0))
(assert (and (= (+ it1013 (- 18)) 0) (<= (+ it1018 (* it1016 (- 1)) 2) 0)))
(assert (= (+ it1021 (- 20)) 0))
(assert (= (+ it1022 (* it1014 (- 1)) (- 2)) 0))
(assert (= (+ (* it1015 (- 1)) it1023) 0))
(assert (= (+ (* it1016 (- 1)) it1024) 0))
(assert (= it1025 0))
(assert (= (+ (* it1018 (- 1)) it1026) 0))
(assert (= (+ (* it1019 (- 1)) it1027) 0))
(assert (let ((a!1 (* (* (+ 0 it1025) (** 2 (+ it101 (- 1)))) (+ 0 (- 2))))
      (a!3 (* (* (+ 0 it1025) (** 2 (+ it101 (- 1)))) (+ 0 2))))
(let ((a!2 (+ (* (** 2 (+ it101 (- 1))) (+ 0 (- 2)))
              (+ 0 (* it1026 (- 1)))
              (+ 0 it1024)
              a!1
              (+ 0 (- 1))))
  ...
  (and (>= (+ it1021 (- 20)) 0)
       ...
       (>= a!4 (+ 0 0))
       (>= (+ (* it1021 (- 1)) 20) 0)
       (>= (+ (* it1025 (- 2)) (* it1026 (- 1)) it1024 (- 3)) 0)
       (>= (+ (* it1025 2) it1026 (* it1024 (- 1)) 3) 0)
       (>= (+ it101 (- 1)) 0)))))
(check-sat)
