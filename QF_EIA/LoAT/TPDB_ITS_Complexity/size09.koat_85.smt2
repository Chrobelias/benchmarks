...
(assert (= (+ (* it7 (- 1))
   ...
   0))
(assert (let ((a!1 (+ it604 (* it608 (- 2)) (* (* it610 it612) (- 2))))
      (a!3 (+ (+ it604 (* (+ it610 (- 1)) it612 (- 2))) (- 1)))
      (a!4 (+ (+ (+ it604 (* it611 (- 2))) (* it612 (- 2))) 3))
      (a!5 (> (+ it604 (* (* it610 it612) (- 2))) 0))
      (a!6 (+ (* it613 (- 2)) it604 (* it608 (- 2)) (* (* it610 it612) (- 2))))
      (a!8 (+ (+ it604 (* (* it610 it612) (- 2))) (- 1)))
      (a!9 (> (+ (+ it604 (* it612 (- 2))) 1) 0))
      (a!10 (+ (* it608 it609 2) (* (* it610 it612) 2)))
      (a!12 (+ (+ it604 (* it611 (- 2)))
               (* (+ it610 (- 1)) it612 (- 2))
               (* it612 (- 2))))
      (a!14 (+ (+ it604 (* (+ it610 (- 1)) it612 (- 2))) (* it612 (- 2))))
      (a!15 (+ (+ (+ it604 (* it611 (- 2))) (* it612 (- 2))) 2))
      (a!16 (+ (+ it604 (* (* it610 it612) (- 2)))
               (* (+ it609 (- 1)) it608 (- 2))
               (- 1)))
      (a!17 (> (+ (+ it604 (* it612 (- 2))) 2) 0)))
(let ((a!2 (+ (+ a!1 (* (+ it609 (- 1)) it608 (- 2))) 1))
      (a!7 (+ (+ a!6 (* (+ it609 (- 1)) it608 (- 2))) 3))
      (a!11 (+ (+ a!6 (* (+ it609 (- 1)) it608 (- 2))) 2))
      (a!13 (+ (+ a!1 (* (+ it609 (- 1)) it608 (- 2))) 2)))
  (and (> (+ a!1 1) 0)
       (> a!2 0)
       (> it604 0)
       (>= (+ it608 (- 1)) 0)
