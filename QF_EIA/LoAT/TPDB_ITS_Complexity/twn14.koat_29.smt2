...
(assert (let ((a!1 (< (+ (** it563 5) (** it561 2) (+ 0 (* it562 (- 1)))) (+ 0 0))))
  (and a!1 (= (+ it558 (- 3)) 0) (> it561 0))))
(assert (= (+ it573 (- 3)) 0))
(assert (= (+ it574 (* it559 (- 1)) (- 1)) 0))
(assert (= (+ it575 (* it560 (- 1))) 0))
(assert (= (+ it576 (* it561 2)) 0))
(assert (= (+ (+ 0 it577) (* (** it563 3) (+ 0 2)) (+ 0 (* it562 (- 3))))
   (+ 0 0)))
(assert (= (+ it578 (* it563 (- 1))) 0))
(assert (= (+ it579 (* it564 (- 1))) 0))
(assert (let ((a!1 (* (** (** 4 (+ it109 (- 1))) (+ 0 2)) (** it576 2)))
      (a!2 (* (* (** it578 3) (** 9 (+ it109 (- 1)))) (+ 0 (- 1))))
      (a!4 (> (+ (* (** it578 5) (+ 0 (- 1)))
                 (* (** it576 2) (+ 0 (- 1)))
                 (+ 0 it577))
              (+ 0 0)))
      (a!5 (* (* (** 9 (+ it109 (- 1))) (+ 0 it577)) (+ 0 3)))
      (a!6 (* (* (** it578 3) (** 9 (+ it109 (- 1)))) (+ 0 (- 3)))))
(let ((a!3 (+ (* (** 9 (+ it109 (- 1))) (+ 0 it577))
              (* (** it578 5) (+ 0 (- 1)))
              (* a!1 (+ 0 (- 1)))
              (** it578 3)
              a!2))
