...
(assert (let ((a!1 (* (exp (exp 4 (+ it109 (- 1))) (+ 0 2)) (exp it576 2)))
      (a!2 (* (* (exp it578 3) (exp 9 (+ it109 (- 1)))) (+ 0 (- 1))))
      (a!4 (> (+ (* (exp it578 5) (+ 0 (- 1)))
                 (* (exp it576 2) (+ 0 (- 1)))
                 (+ 0 it577))
              (+ 0 0)))
      (a!5 (* (* (exp 9 (+ it109 (- 1))) (+ 0 it577)) (+ 0 3)))
      (a!6 (* (* (exp it578 3) (exp 9 (+ it109 (- 1)))) (+ 0 (- 3)))))
(let ((a!3 (+ (* (exp 9 (+ it109 (- 1))) (+ 0 it577))
              (* (exp it578 5) (+ 0 (- 1)))
              (* a!1 (+ 0 (- 1)))
              (exp it578 3)
              a!2))
