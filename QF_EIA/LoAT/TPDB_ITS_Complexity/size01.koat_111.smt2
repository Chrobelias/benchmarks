...
(assert (let ((a!1 (+ (* (* (** it73 2) (** it447 2)) (+ 0 6))
              ...
              (+ 0 (* it73 it501 (- 1))))))
  (= a!1 (+ 0 0))))
(assert (and (> it597 0) (> (+ it597 (- 1)) 0) (= (+ it595 (- 2)) 0)))
(assert (= (+ it692 (- 2)) 0))
(assert (= (+ it693 (* it596 (- 1)) (- 2)) 0))
(assert (= (+ (* it597 (- 1)) it694 2) 0))
(assert (= (+ it695 it598) 0))
(assert (= (+ it696 it599) 0))
(assert (let ((a!1 (+ (+ 0 (* it600 (- 1)))
              (* (** (+ it597 (- 1)) 2) (+ 0 (- 1)))
              (+ 0 it697)
              (* (** it597 2) (+ 0 (- 1))))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (> (+ (+ it694 (* it602 (- 2))) 2) 0))
      (a!2 (> (+ (+ (* it603 (- 2)) it694 (* it602 (- 2))) 2) 0))
      (a!3 (> (+ (+ (* it603 (- 2)) it694 (* it602 (- 2))) 1) 0))
      (a!4 (> (+ (+ it694 (* it602 (- 2))) 1) 0)))
  (and (>= (+ it692 (- 2)) 0)
       (>= (+ (* it692 (- 1)) 2) 0)
       (= 0 0)
       a!1
