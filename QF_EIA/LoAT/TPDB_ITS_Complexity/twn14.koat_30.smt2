...
(assert (let ((a!1 (< (+ (+ 0 (* it553 (- 1))) (exp it554 5) (exp it552 2)) (+ 0 0))))
  (and (< it552 0) (= (+ it549 (- 3)) 0) a!1)))
(assert (= (+ it558 (- 3)) 0))
(assert (= (+ (* it550 (- 1)) it559 (- 1)) 0))
(assert (= (+ it560 (* it551 (- 1))) 0))
(assert (= (+ it561 (* it552 2)) 0))
(assert (= (+ (+ 0 (* it553 (- 3))) (* (exp it554 3) (+ 0 2)) (+ 0 it562))
   (+ 0 0)))
(assert (= (+ it563 (* it554 (- 1))) 0))
(assert (= (+ it564 (* it555 (- 1))) 0))
(assert (let ((a!1 (< (+ (exp it563 5) (exp it561 2) (+ 0 (* it562 (- 1)))) (+ 0 0))))
  (and a!1 (= (+ it558 (- 3)) 0) (> it561 0))))
(assert (= (+ it573 (- 3)) 0))
(assert (= (+ it574 (* it559 (- 1)) (- 1)) 0))
(assert (= (+ it575 (* it560 (- 1))) 0))
(assert (= (+ it576 (* it561 2)) 0))
(assert (= (+ (+ 0 it577) (* (exp it563 3) (+ 0 2)) (+ 0 (* it562 (- 3))))
   (+ 0 0)))
(assert (= (+ it578 (* it563 (- 1))) 0))
(assert (= (+ it579 (* it564 (- 1))) 0))
(assert (let ((a!1 (* (exp it576 2) (exp (exp 4 (+ it140 (- 1))) (+ 0 2))))
      (a!2 (* (* (exp 9 (+ it140 (- 1))) (exp it578 3)) (+ 0 (- 3))))
      (a!3 (* (* (exp 9 (+ it140 (- 1))) (+ 0 it577)) (+ 0 3)))
      (a!5 (* (* (exp 9 (+ it140 (- 1))) (exp it578 3)) (+ 0 (- 1))))
      (a!7 (> (+ (* (exp it578 5) (+ 0 (- 1)))
                 (* (exp it576 2) (+ 0 (- 1)))
                 (+ 0 it577))
              (+ 0 0))))
(let ((a!4 (> (+ (* (exp it578 5) (+ 0 (- 1)))
                 (* a!1 (+ 0 (- 4)))
                 a!2
                 a!3
                 (exp it578 3))
