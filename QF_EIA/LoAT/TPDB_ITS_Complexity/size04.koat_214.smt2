...
(assert (and (> (+ it1045 it1043 it1044) 0) (= (+ it1040 (- 3)) 0)))
(assert (= (+ it1049 (- 3)) 0))
(assert (= (+ it1050 (* it1041 (- 1)) (- 1)) 0))
(assert (= (+ (* it1042 (- 1)) it1051) 0))
(assert (= (+ it1052 (* it1043 (- 1)) 1) 0))
(assert (= (+ it1053 (* it1044 (- 1)) 1) 0))
(assert (= (+ (* it1045 (- 1)) it1054 1) 0))
(assert (and (>= (+ (* it1049 (- 1)) 3) 0)
     (>= (+ it1049 (- 3)) 0)
     (= 1 0)
     (> (+ it1052 it1053 it1054) 0)))
(check-sat)
