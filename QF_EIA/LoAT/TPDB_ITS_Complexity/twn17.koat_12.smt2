...
(assert (let ((a!1 (* (* (exp 9 (+ it200 (- 1))) (exp it527 3)) (+ 0 (- 3))))
      (a!2 (* (exp it525 2) (exp (exp 4 (+ it200 (- 1))) (+ 0 2))))
      (a!3 (* (* (+ 0 it526) (exp 9 (+ it200 (- 1)))) (+ 0 3)))
      (a!5 (* (* (exp 9 (+ it200 (- 1))) (exp it527 3)) (+ 0 (- 1))))
      (a!7 (> (+ (* (exp it525 2) (+ 0 (- 1)))
                 (+ 0 it526)
                 (* (exp it527 5) (+ 0 (- 1))))
              (+ 0 0))))
(let ((a!4 (> (+ (* (exp it527 5) (+ 0 (- 1)))
                 a!1
                 (* a!2 (+ 0 (- 4)))
                 (exp it527 3)
                 a!3)
