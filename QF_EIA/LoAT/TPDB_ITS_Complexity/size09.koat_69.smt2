...
(assert (and (> it434 0) (> (+ it434 (- 1)) 0) (= (+ it432 (- 2)) 0)))
(assert (= (+ it487 (- 2)) 0))
(assert (= (+ it488 (* it433 (- 1)) (- 2)) 0))
(assert (= (+ (* it434 (- 1)) it489 2) 0))
(assert (= (+ it435 it490) 0))
(assert (= (+ it491 it436) 0))
(assert (let ((a!1 (+ (* (exp it434 2) (+ 0 (- 1)))
              (+ 0 (* it437 (- 1)))
              (+ 0 it492)
              (* (exp (+ it434 (- 1)) 2) (+ 0 (- 1))))))
  (= a!1 (+ 0 0))))
(assert (= (+ (* it438 (- 1)) it493) 0))
(assert (let ((a!1 (+ (* it440 (- 2)) (* (* it444 it442) (- 2)) it493))
      (a!3 (+ (* it440 (- 2))
              (* (+ it441 (- 1)) it440 (- 2))
              (* (* it444 it442) (- 2))
              it493))
      (a!5 (+ (* it440 it441 2) (* (* it444 it442) 2)))
      (a!6 (> (+ (+ (* it444 (- 2)) it493) 1) 0))
      (a!7 (> (+ (+ (* it444 (- 2)) it493) 2) 0))
      (a!9 (+ (* it444 (+ it442 (- 1)) (- 2))
              (* it443 (- 2))
              (* it444 (- 2))
              it493))
      (a!10 (> (+ (* (* it444 it442) (- 2)) it493) 0))
      (a!11 (> (+ (* (+ it441 (- 1)) it440 (- 2))
                  (* (* it444 it442) (- 2))
                  it493
                  (- 1))
               0))
      (a!12 (> (+ (+ (* it443 (- 2)) (* it444 (- 2)) it493) 3) 0))
      (a!13 (+ (+ (* (* it444 it442) (- 2)) it493) (- 1)))
      (a!14 (+ (* it444 (+ it442 (- 1)) (- 2)) (* it444 (- 2)) it493))
      (a!15 (> (+ (* it444 (+ it442 (- 1)) (- 2)) it493 (- 1)) 0))
      (a!17 (> (+ (+ (* it443 (- 2)) (* it444 (- 2)) it493) 2) 0)))
(let ((a!2 (> (+ (+ a!1 (* it445 (- 2))) 3) 0))
      (a!4 (> (+ (+ a!3 (* it445 (- 2))) 3) 0))
      (a!8 (> (+ (+ a!1 (* it445 (- 2))) 2) 0))
      (a!16 (> (+ (+ a!3 (* it445 (- 2))) 2) 0)))
  (and a!2
       (>= (+ (* it487 (- 1)) 2) 0)
       (>= (+ it487 (- 2)) 0)
       (> (+ a!3 1) 0)
