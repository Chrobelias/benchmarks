...
(assert (let ((a!1 (>= (+ (+ (* it1143 (- 1)) it1141) (- 1)) 0)))
  (and (= (+ it1138 (- 3)) 0)
       a!1
       (>= (+ (* it1143 (- 1)) it1141) 0)
       (>= (+ it1143 (- 1)) 0))))
(assert (= (+ it1162 (- 3)) 0))
(assert (= (+ (* it1139 (- 1)) it1163 (- 1)) 0))
(assert (= (+ (* it1140 (- 1)) it1164) 0))
(assert (= (+ it1165 (* it1141 (- 1))) 0))
(assert (= (+ (* it1143 (- 1)) it1166 (- 1)) 0))
(assert (= (+ (* it1143 (- 2)) it1167 (- 2)) 0))
(assert (let ((a!1 (>= (+ (+ it1165 (* it1130 (- 1))) (- 1)) 0))
      (a!2 (+ (+ (+ it1165 (* it1130 (- 1))) (* it1144 (- 1))) (* it1164 (- 2))))
      (a!3 (>= (+ (+ it1165 (* it1130 (- 1))) (* it1164 (- 2))) 0))
      (a!4 (+ (+ (+ it1165 (* it1130 (- 1))) (* it1164 (- 2))) (- 1)))
      (a!5 (>= (+ (+ it1165 (* it1167 (- 1))) (- 1)) 0))
      (a!6 (+ (+ (+ it1165 (* it1130 (- 1))) (* it1164 (- 2))) 1))
      (a!7 (>= (+ (+ it1165 (* it1130 (- 1))) (- 3)) 0))
      (a!8 (+ (+ (+ it1165 (* it1130 (- 1))) (* it1144 (- 1))) (- 2)))
      (a!9 (>= (+ (+ it1165 (* it1130 (- 1))) (- 2)) 0))
      (a!10 (+ (+ (+ it1165 (* it1130 (- 1))) (* it1144 (- 1))) (- 1))))
  (and (= (+ it1130 it1144) 0)
       a!1
       (>= (+ it1165 (- 3)) 0)
       (>= (+ it1165 (- 2)) 0)
