...
(assert (let ((a!1 (>= (+ (+ (* it88 (- 1)) it547) (- 1)) 0))
      (a!2 (>= (+ (+ (* it88 (- 1)) it547) (- 3)) 0))
      (a!3 (+ (+ (+ (* it88 (- 1)) it547) (* it546 (- 2))) 1))
      (a!4 (>= (+ (+ (* it88 (- 1)) it547) (- 2)) 0))
      (a!5 (+ (+ (+ (* it88 (- 1)) it547) (* it19 (- 1))) (- 1)))
      (a!6 (+ (+ (+ (* it88 (- 1)) it547) (* it19 (- 1))) (- 2)))
      (a!7 (+ (+ (+ (* it88 (- 1)) it547) (* it546 (- 2))) (- 1)))
      (a!8 (+ (+ (+ (* it88 (- 1)) it547) (* it19 (- 1))) (* it546 (- 2))))
      (a!9 (>= (+ (+ (* it88 (- 1)) it547) (* it546 (- 2))) 0))
      (a!10 (>= (+ (+ it547 (* it549 (- 1))) (- 1)) 0)))
  (and (>= (+ it546 (- 1)) 0)
       a!1
       a!2
       (>= a!3 0)
