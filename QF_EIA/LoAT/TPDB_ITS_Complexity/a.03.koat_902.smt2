...
(declare-fun it2640 () Int)
(declare-fun it2641 () Int)
(declare-fun it2642 () Int)
(declare-fun it2643 () Int)
(declare-fun it2644 () Int)
(declare-fun it2645 () Int)
...
(assert (and (= (+ (* it2627 (- 1)) it2625) 0) (= (+ it2622 (- 3)) 0)))
(assert (= (+ it2640 (- 4)) 0))
(assert (= (+ it2641 (* it2623 (- 1)) (- 1)) 0))
(assert (= (+ (* it2624 (- 1)) it2642) 0))
(assert (= (+ (* it2625 (- 1)) it2643) 0))
(assert (= (+ it2644 (* it2626 (- 1))) 0))
(assert (= (+ (* it2627 (- 1)) it2645) 0))
(assert (let ((a!1 (>= (+ (+ (* it2642 (- 2)) it2643) (- 1)) 0))
      (a!2 (>= (+ (+ (* it2642 (- 2)) it2643) (- 2)) 0)))
  (and (>= (+ (* it2640 (- 1)) 4) 0)
       a!1
       (>= (+ (* it2642 (- 1)) 1) 0)
       (= 0 0)
