...
(assert (let ((a!1 (* (exp (exp 4 (+ it66 (- 1))) (+ 0 2)) (exp it556 2)))
      (a!2 (* (* (exp 9 (+ it66 (- 1))) (exp it558 3)) (+ 0 (- 1))))
      (a!4 (> (+ (+ 0 it557)
                 (* (exp it556 2) (+ 0 (- 1)))
                 (* (exp it558 5) (+ 0 (- 1))))
              (+ 0 0)))
      (a!5 (* (* (+ 0 it557) (exp 9 (+ it66 (- 1)))) (+ 0 3)))
      (a!6 (* (* (exp 9 (+ it66 (- 1))) (exp it558 3)) (+ 0 (- 3)))))
(let ((a!3 (+ (* a!1 (+ 0 (- 1)))
              (exp it558 3)
              (* (+ 0 it557) (exp 9 (+ it66 (- 1))))
              (* (exp it558 5) (+ 0 (- 1)))
              a!2))
      (a!7 (> (+ (* a!1 (+ 0 (- 4)))
                 (exp it558 3)
