...
(assert (= (+ it446 (* it3 (- 1)) (* it92 2)) 0))
(assert (= (+ (* (exp (- 1) it92) (+ 0 it4) (+ 0 (- 1))) (+ 0 it447))
   (+ 0 0)))
(assert (= (+ (* (+ 0 it5) (exp (- 1) it92) (+ 0 (- 1))) (+ 0 it448))
   (+ 0 0)))
(assert (= (+ (+ 0 (* it3 it92 (- 6)))
...
(assert (= (+ (* it445 (- 1)) (* it13 (- 2)) it465) 0))
(assert (= (+ it466 (* it446 (- 1)) (* it13 2)) 0))
(assert (= (+ (* (+ 0 it447) (exp (- 1) it13) (+ 0 (- 1))) (+ 0 it467))
   (+ 0 0)))
(assert (= (+ (* (+ 0 it448) (exp (- 1) it13) (+ 0 (- 1))) (+ 0 it468))
   (+ 0 0)))
(assert (= (+ (* (+ 0 it446) (exp it13 2) (+ 0 12))
      (* (exp it13 3) (+ 0 (- 8)))
      (* (exp it13 2) (+ 0 6))
      (+ 0 (* it469 3))
      (+ 0 (* it446 it13 (- 6)))
      (* (exp it446 2) (+ 0 it13) (+ 0 (- 6)))
      (+ 0 (* it13 (- 1)))
      (+ 0 (* it449 (- 3))))
   (+ 0 0)))
(assert (and (>= (+ it464 (- 2)) 0)
     (> (+ it466 (- 1)) 0)
     (>= (+ (* it464 (- 1)) 2) 0)
     (> it466 0)
     (= 2 0)))
