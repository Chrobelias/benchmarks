...
(assert (= (+ it281 (- 2)) 0))
(assert (= (+ it282 (* it212 (- 1)) (- 2)) 0))
(assert (= (+ (* it213 (- 1)) it283 2) 0))
(assert (= (+ it214 it284) 0))
(assert (= (+ it285 it215) 0))
(assert (let ((a!1 (+ (* (exp it213 2) (+ 0 (- 1)))
              (+ 0 (* it216 (- 1)))
              (+ 0 it286)
              (* (exp (+ it213 (- 1)) 2) (+ 0 (- 1))))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (> (+ (+ it283 (* it217 (- 2))) 1) 0))
      (a!2 (> (+ (+ it283 (* it217 (- 2))) 2) 0))
      (a!3 (> (+ (+ (* it162 (- 2)) it283 (* it217 (- 2))) 1) 0))
      (a!4 (> (+ (+ (* it162 (- 2)) it283 (* it217 (- 2))) 2) 0)))
  (and a!1
       a!2
       (>= (+ it281 (- 2)) 0)
       a!3
