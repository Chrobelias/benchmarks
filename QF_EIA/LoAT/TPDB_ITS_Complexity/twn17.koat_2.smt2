...
(assert (= (+ it48 (* it6 (- 1))) 0))
(assert (= (+ (* it7 (- 1)) it49) 0))
(assert (let ((a!1 (< (+ (+ 0 (* it47 (- 1))) (** it46 2) (** it48 5)) (+ 0 0))))
  (and (> it46 0) (= (+ it43 (- 3)) 0) a!1)))
(assert (= (+ it69 (- 3)) 0))
(assert (= (+ (* it44 (- 1)) it70 (- 1)) 0))
(assert (= (+ (* it45 (- 1)) it71) 0))
(assert (= (+ (* it46 2) it72) 0))
(assert (let ((a!1 (+ (+ 0 (+ (* it47 (- 3)) it73)) (* (** it48 3) (+ 0 2)))))
  (= a!1 (+ 0 0))))
(assert (= (+ (* it48 (- 1)) it74) 0))
(assert (= (+ (* it49 (- 1)) it75) 0))
(assert (let ((a!1 (* (* (+ 0 it73) (** 9 (+ it66 (- 1)))) (+ 0 3)))
      (a!2 (* (** (** 4 (+ it66 (- 1))) (+ 0 2)) (** it72 2)))
      (a!3 (* (* (** 9 (+ it66 (- 1))) (** it74 3)) (+ 0 (- 3))))
      (a!5 (* (* (** 9 (+ it66 (- 1))) (** it74 3)) (+ 0 (- 1))))
      (a!7 (> (+ (+ 0 it73)
                 (* (** it72 2) (+ 0 (- 1)))
                 (* (** it74 5) (+ 0 (- 1))))
              (+ 0 0))))
