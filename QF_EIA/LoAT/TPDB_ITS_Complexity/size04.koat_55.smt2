...
(assert (and (> (+ it206 it207 it205) 0) (= (+ it202 (- 3)) 0)))
(assert (= (+ it245 (- 3)) 0))
(assert (= (+ (* it203 (- 1)) it246 (- 1)) 0))
(assert (= (+ (* it204 (- 1)) it247) 0))
(assert (= (+ it248 (* it205 (- 1)) 1) 0))
(assert (= (+ (* it206 (- 1)) it249 1) 0))
(assert (= (+ (* it207 (- 1)) it250 1) 0))
(assert (and (> (+ it248 it249 it250) 0)
     (>= (+ it245 (- 3)) 0)
     (>= (+ (* it245 (- 1)) 3) 0)
     (= 1 0)))
(check-sat)
