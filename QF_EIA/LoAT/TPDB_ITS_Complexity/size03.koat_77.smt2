...
(assert (= (+ it155 (- 2)) 0))
(assert (= (+ it489 (- 3)) 0))
(assert (= (+ it490 (* it156 (- 1)) (- 1)) 0))
(assert (= (+ it491 (* it157 (- 1))) 0))
(assert (= (+ it492 (* it158 (- 1))) 0))
(assert (= (+ (* it159 (- 1)) it493) 0))
(assert (= (+ (* it160 (- 1)) it494) 0))
(assert (and (>= (+ it489 (- 3)) 0) (>= (+ (* it489 (- 1)) 3) 0) (> it494 0) (= 1 0)))
(check-sat)
