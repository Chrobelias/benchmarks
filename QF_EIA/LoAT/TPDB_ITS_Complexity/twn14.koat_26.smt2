...
(assert (let ((a!1 (* (* (exp it554 3) (exp 9 (+ it109 (- 1)))) (+ 0 (- 1))))
      (a!2 (* (exp (exp 4 (+ it109 (- 1))) (+ 0 2)) (exp it552 2)))
      (a!4 (> (+ (+ 0 it553)
                 (* (exp it554 5) (+ 0 (- 1)))
                 (* (exp it552 2) (+ 0 (- 1))))
              (+ 0 0)))
      (a!5 (* (* (exp it554 3) (exp 9 (+ it109 (- 1)))) (+ 0 (- 3))))
      (a!6 (* (* (+ 0 it553) (exp 9 (+ it109 (- 1)))) (+ 0 3))))
(let ((a!3 (+ a!1
              (* (+ 0 it553) (exp 9 (+ it109 (- 1))))
              (* (exp it554 5) (+ 0 (- 1)))
              (exp it554 3)
              (* a!2 (+ 0 (- 1)))))
      (a!7 (> (+ a!5
