...
(assert (and (> (+ (* it1644 (- 1)) (* it1645 2) it1646 3) 0) (= (+ it1641 (- 20)) 0)))
(assert (= (+ it1655 (- 18)) 0))
(assert (= (+ it1656 (* it1642 (- 1)) (- 4)) 0))
(assert (= (+ it1657 (* it1646 (- 1)) (- 1)) 0))
(assert (= (+ (* it1644 (- 1)) it1658) 0))
(assert (= (+ it1659 (* it1645 (- 1))) 0))
(assert (= (+ it1660 (* it1646 (- 1)) (- 1)) 0))
(assert (= (+ (* it1647 (- 1)) it1661) 0))
(assert (and (> (+ it1660 (* it1658 (- 1)) 2) 0) (= (+ it1655 (- 18)) 0)))
(assert (= (+ it1666 (- 30)) 0))
(assert (= (+ it1667 (* it1656 (- 1)) (- 2)) 0))
(assert (= (+ it1668 (* it1657 (- 1))) 0))
(assert (= (+ it1669 (* it1658 (- 1))) 0))
(assert (= (+ it1670 (* it1659 (- 1))) 0))
(assert (= (+ it1671 (* it1660 (- 1))) 0))
(assert (= (+ it1672 (* it1661 (- 1))) 0))
(check-sat)
