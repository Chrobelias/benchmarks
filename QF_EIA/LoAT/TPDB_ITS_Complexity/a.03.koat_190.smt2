...
(assert (let ((a!1 (>= (+ (+ (* it403 (- 1)) it401) (- 1)) 0)))
  (and (>= (+ (* it403 (- 1)) it401) 0)
       ...
       (>= (+ it403 (- 1)) 0))))
(assert (= (+ it418 (- 3)) 0))
(assert (= (+ it419 (* it399 (- 1)) (- 1)) 0))
(assert (= (+ (* it400 (- 1)) it420) 0))
(assert (= (+ it421 (* it401 (- 1))) 0))
(assert (= (+ (* it403 (- 1)) it422) 0))
(assert (= (+ (* it403 (- 2)) it423) 0))
(assert (let ((a!1 (+ (+ (+ it421 (* it88 (- 1))) (* it19 (- 1))) (- 2)))
      (a!2 (+ (+ (+ it421 (* it88 (- 1))) (* it19 (- 1))) (* it420 (- 2))))
      (a!3 (>= (+ (+ it421 (* it423 (- 1))) (- 1)) 0))
      (a!4 (>= (+ (+ it421 (* it88 (- 1))) (- 3)) 0))
      (a!5 (>= (+ (+ it421 (* it88 (- 1))) (- 1)) 0))
      (a!6 (+ (+ (+ it421 (* it88 (- 1))) (* it19 (- 1))) (- 1)))
      (a!7 (+ (+ (+ it421 (* it88 (- 1))) (* it420 (- 2))) 1))
      (a!8 (>= (+ (+ it421 (* it88 (- 1))) (- 2)) 0))
      (a!9 (+ (+ (+ it421 (* it88 (- 1))) (* it420 (- 2))) (- 1)))
      (a!10 (>= (+ (+ it421 (* it88 (- 1))) (* it420 (- 2))) 0)))
  (and (>= a!1 0)
       (>= (+ it421 (- 2)) 0)
       (>= (+ a!2 1) 0)
       (>= a!2 0)
