...
(assert (let ((a!1 (* (exp it541 2) (exp (exp 4 (+ it66 (- 1))) (+ 0 2))))
      (a!2 (* (* (exp 9 (+ it66 (- 1))) (+ 0 it542)) (+ 0 3)))
      (a!3 (* (* (exp 9 (+ it66 (- 1))) (exp it543 3)) (+ 0 (- 3))))
      (a!5 (* (* (exp 9 (+ it66 (- 1))) (exp it543 3)) (+ 0 (- 1))))
      (a!7 (> (+ (* (exp it541 2) (+ 0 (- 1)))
                 (* (exp it543 5) (+ 0 (- 1)))
                 (+ 0 it542))
              (+ 0 0))))
