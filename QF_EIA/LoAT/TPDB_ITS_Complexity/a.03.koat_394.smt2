...
(assert (let ((a!1 (>= (+ (+ (* it88 (- 1)) it538) (- 2)) 0))
      (a!2 (>= (+ (+ (* it88 (- 1)) it538) (- 1)) 0))
      (a!3 (>= (+ (+ (* it540 (- 1)) it538) (- 1)) 0))
      (a!4 (>= (+ (+ (* it88 (- 1)) (* it537 (- 2)) it538) 1) 0)))
  (and a!1
       (>= (+ it538 (- 2)) 0)
       a!2
       (>= (+ (* it540 (- 1)) it538) 0)
       ...
       (>= (+ it538 (- 3)) 0)
       (>= (+ it88 (- 1)) 0)
       (>= (+ (* it88 (- 1)) (* it537 (- 2)) it538) 0)
       a!4
       (>= (+ (* it537 (- 1)) 1) 0))))
(assert (= (+ it606 (* it535 (- 1))) 0))
(assert (= (+ (* it536 (- 1)) (* it88 (- 3)) it607) 0))
(assert (= (+ (* it537 (- 1)) it608) 0))
(assert (= (+ it88 (* it538 (- 1)) it609) 0))
(assert (= (+ it610 (* it537 (- 1))) 0))
(assert (= (+ (* it537 (- 2)) it611) 0))
(assert (and (= (+ (* it611 (- 1)) it609) 0) (= (+ it606 (- 3)) 0)))
(assert (= (+ it624 (- 4)) 0))
(assert (= (+ (* it607 (- 1)) it625 (- 1)) 0))
(assert (= (+ it626 (* it608 (- 1))) 0))
(assert (= (+ it627 (* it609 (- 1))) 0))
(assert (= (+ (* it610 (- 1)) it628) 0))
(assert (= (+ it629 (* it611 (- 1))) 0))
(assert (let ((a!1 (>= (+ (+ (* it626 (- 2)) it627) (- 2)) 0))
      (a!2 (>= (+ (+ (* it626 (- 2)) it627) (- 1)) 0)))
  (and (>= (+ it627 (- 3)) 0)
       a!1
       (>= (+ (* it626 (- 1)) 1) 0)
       (>= (+ it626 (- 1)) 0)
