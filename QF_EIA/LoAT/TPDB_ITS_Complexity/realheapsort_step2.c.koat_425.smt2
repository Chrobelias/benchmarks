...
(declare-fun it2110 () Int)
(declare-fun it2111 () Int)
(declare-fun it2112 () Int)
(declare-fun it2114 () Int)
(declare-fun it2115 () Int)
(declare-fun it2116 () Int)
(declare-fun it2117 () Int)
(declare-fun it2118 () Int)
(declare-fun it2119 () Int)
...
(assert (and (> (+ it2100 (* it2098 (- 1)) (* it2099 2) 3) 0) (= (+ it2095 (- 20)) 0)))
(assert (= (+ it2106 (- 18)) 0))
(assert (= (+ it2107 (* it2096 (- 1)) (- 4)) 0))
(assert (= (+ (* it2100 (- 1)) it2108 (- 1)) 0))
(assert (= (+ it2109 (* it2098 (- 1))) 0))
(assert (= (+ it2110 (* it2099 (- 1))) 0))
(assert (= (+ (* it2100 (- 1)) it2111 (- 1)) 0))
(assert (= (+ it2112 (* it2101 (- 1))) 0))
(assert (and (= (+ it2106 (- 18)) 0) (<= (+ (* it2109 (- 1)) it2111 2) 0)))
(assert (= (+ it2114 (- 20)) 0))
(assert (= (+ (* it2107 (- 1)) it2115 (- 2)) 0))
(assert (= (+ it2116 (* it2108 (- 1))) 0))
(assert (= (+ (* it2109 (- 1)) it2117) 0))
(assert (= it2118 0))
(assert (= (+ it2119 (* it2111 (- 1))) 0))
(assert (= (+ (* it2112 (- 1)) it2120) 0))
(assert (let ((a!1 (* (* (+ 0 it2118) (exp 2 (+ it101 (- 1)))) (+ 0 2)))
      (a!3 (* (* (+ 0 it2118) (exp 2 (+ it101 (- 1)))) (+ 0 (- 2)))))
(let ((a!2 (+ a!1
              (* (exp 2 (+ it101 (- 1))) (+ 0 2))
              (+ 0 it2119)
              (+ 0 (* it2117 (- 1)))
      ...
      (a!4 (+ a!3
              ...
              (+ 0 (- 1)))))
  (and (>= a!2 (+ 0 0))
       (>= (+ (* it2118 (- 2)) (* it2119 (- 1)) it2117 (- 3)) 0)
       (>= (+ it101 (- 1)) 0)
       (>= a!4 (+ 0 0))
       (>= (+ (* it2118 2) it2119 (* it2117 (- 1)) 3) 0)
       (>= (+ (* it2114 (- 1)) 20) 0)
       (>= (+ it2114 (- 20)) 0)))))
(check-sat)
