...
(assert (and (> it311 0) (= (+ it305 (- 3)) 0)))
(assert (= (+ it352 (- 2)) 0))
(assert (= (+ (* it306 (- 1)) it353 (- 1)) 0))
(assert (= (+ it354 (* it311 (- 1))) 0))
(assert (= (+ it355 (* it311 (- 2))) 0))
(assert (= (+ (* it311 (- 3)) it356) 0))
(assert (= (+ it357 (* it307 (- 1))) 0))
(assert (= (+ it358 (* it311 (- 1)) 1) 0))
(assert (let ((a!1 (> (+ (+ it354 (* it191 (- 2))) 1) 0))
      (a!2 (> (+ (+ it354 (* it191 (- 2))) 2) 0))
      (a!3 (> (+ (+ it358 (* it81 (- 2))) 1) 0))
      (a!4 (> (+ (+ it358 (* it81 (- 2))) 2) 0)))
  (and a!1
       a!2
       (> (+ it358 (- 1)) 0)
       (= (* it81 2) 0)
