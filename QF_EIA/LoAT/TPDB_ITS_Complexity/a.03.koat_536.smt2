...
(assert (let ((a!1 (>= (+ (+ it838 (* it840 (- 1))) (- 1)) 0)))
  (and (= (+ it835 (- 3)) 0)
       ...
       (>= (+ it838 (* it840 (- 1))) 0))))
(assert (= (+ it919 (- 3)) 0))
(assert (= (+ it920 (* it836 (- 1)) (- 1)) 0))
(assert (= (+ it921 (* it837 (- 1))) 0))
(assert (= (+ (* it838 (- 1)) it922) 0))
(assert (= (+ it923 (* it840 (- 1)) (- 1)) 0))
(assert (= (+ it924 (* it840 (- 2)) (- 2)) 0))
(assert (let ((a!1 (+ (+ (* it88 (- 1)) (* it19 (- 1))) (* it921 (- 2)) it922))
      (a!2 (>= (+ (+ (* it88 (- 1)) it922) (- 1)) 0))
      (a!3 (+ (+ (+ (* it88 (- 1)) (* it19 (- 1))) it922) (- 2)))
      (a!4 (>= (+ (+ (* it924 (- 1)) it922) (- 1)) 0))
      (a!5 (>= (+ (+ (* it88 (- 1)) it922) (- 3)) 0))
      (a!6 (>= (+ (+ (* it88 (- 1)) (* it921 (- 2)) it922) 1) 0))
      (a!7 (+ (+ (+ (* it88 (- 1)) (* it19 (- 1))) it922) (- 1)))
      (a!8 (>= (+ (+ (* it88 (- 1)) (* it921 (- 2)) it922) (- 1)) 0))
      (a!9 (>= (+ (+ (* it88 (- 1)) it922) (- 2)) 0)))
  (and (>= (+ it919 (- 3)) 0)
       (>= (+ (* it919 (- 1)) 3) 0)
       (>= (+ (* it924 (- 1)) it922) 0)
       (>= (+ it922 (- 3)) 0)
       (>= (+ (* it88 (- 1)) (* it921 (- 2)) it922) 0)
       (>= (+ a!1 1) 0)
       a!2
       (>= a!3 0)
       (>= a!1 0)
