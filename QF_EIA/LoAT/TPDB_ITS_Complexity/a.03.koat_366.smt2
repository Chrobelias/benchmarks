...
(assert (= (+ it598 (- 4)) 0))
(assert (= (+ (* it579 (- 1)) it599 (- 1)) 0))
(assert (= (+ (* it580 (- 1)) it600) 0))
(assert (= (+ it601 (* it581 (- 1))) 0))
(assert (= (+ (* it582 (- 1)) it602) 0))
(assert (= (+ (* it583 (- 1)) it603) 0))
(assert (let ((a!1 (>= (+ (+ it601 (* it600 (- 2))) (- 1)) 0))
      (a!2 (>= (+ (+ it601 (* it600 (- 2))) (- 2)) 0)))
  (and (>= (+ it601 (- 2)) 0)
       a!1
       (>= (+ (* it600 (- 1)) 1) 0)
       (>= (+ it600 (- 1)) 0)
