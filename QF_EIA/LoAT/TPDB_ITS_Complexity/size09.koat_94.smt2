...
(assert (= (+ (* (exp it600 2) (+ 0 (- 1))) (+ 0 it669) (+ 0 (* it603 (- 1))))
   (+ 0 0)))
(assert (= (+ (* it604 (- 1)) it670) 0))
(assert (let ((a!1 (> (+ (+ (* it613 (- 2)) it666) 2) 0))
      (a!2 (> (+ (+ (* it612 (- 2)) it670) 2) 0))
      (a!3 (> (+ (+ (* it613 (- 2)) it666) 1) 0))
      (a!4 (> (+ (+ (* it612 (- 2)) it670) 1) 0)))
  (and (>= (+ it612 (- 1)) 0)
       (>= (+ it613 (- 1)) 0)
       (>= (+ it664 (- 2)) 0)
       a!1
