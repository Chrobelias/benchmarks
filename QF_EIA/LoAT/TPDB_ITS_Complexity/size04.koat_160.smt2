...
(let ((a!2 (+ a!1
              ...
              (+ 0 (* (* it553 it117) (- 1))))))
  (= a!2 (+ 0 0)))))
(assert (let ((a!1 (> (+ (+ (* it740 (- 2)) it734) 2) 0))
      (a!2 (> (+ (+ (* it740 (- 2)) it734) 1) 0)))
  (and (>= (+ it740 (- 1)) 0)
       a!1
       (>= (+ it732 (- 2)) 0)
       a!2
       (>= (+ (* it732 (- 1)) 2) 0))))
(assert (= (+ it780 (* it732 (- 1))) 0))
(assert (= (+ (* it733 (- 1)) (* it740 (- 2)) it781) 0))
(assert (= (+ it782 (* it740 2) (* it734 (- 1))) 0))
(assert (= (+ (* (exp (- 1) it740) (+ 0 it735) (+ 0 (- 1))) (+ 0 it783))
   (+ 0 0)))
(assert (= (+ (+ 0 it784) (* (+ 0 it736) (exp (- 1) it740) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (* (exp it740 3) (+ 0 (- 8)))
      (* (exp it740 2) (+ 0 6))
      (* (+ 0 it740) (exp it734 2) (+ 0 (- 6)))
      (+ 0 (* it740 it734 (- 6)))
      (+ 0 (* it740 (- 1)))
      (+ 0 (* it737 (- 3)))
      (* (exp it740 2) (+ 0 it734) (+ 0 12))
      (+ 0 (* it785 3)))
   (+ 0 0)))
(assert (let ((a!1 (> (+ (+ it782 (* it786 (- 2)) (* it739 (- 2))) 2) 0))
      (a!2 (> (+ (+ it782 (* it739 (- 2))) 1) 0))
      (a!3 (> (+ (+ it782 (* it739 (- 2))) 2) 0))
      (a!4 (> (+ (+ it782 (* it786 (- 2)) (* it739 (- 2))) 1) 0)))
  (and a!1
       a!2
       a!3
       (= 0 0)
