...
(assert (= (+ it1056 (- 13)) 0))
(assert (= (+ it1063 (- 7)) 0))
(assert (= (+ (* it1057 (- 1)) it1064 (- 2)) 0))
(assert (= (+ it1065 (* it1058 (- 1))) 0))
(assert (= (+ (* it1059 (- 1)) it1066) 0))
(assert (= (+ it1067 (* it1061 (- 1))) 0))
(assert (= (+ (* it1061 (- 1)) it1068) 0))
(assert (and (= (+ it1063 (- 7)) 0) (>= (+ (* it1065 (- 1)) it1066 (* it1067 2) 2) 0)))
(assert (= (+ it1073 (- 5)) 0))
(assert (= (+ it1074 (* it1064 (- 1)) (- 2)) 0))
(assert (= (+ (* it1065 (- 1)) it1075) 0))
(assert (= (+ (* it1066 (- 1)) it1076 (- 1)) 0))
(assert (= (+ it1077 (* it1067 (- 1))) 0))
(assert (= (+ it1078 (* it1068 (- 1))) 0))
(assert (and (= (+ it1073 (- 5)) 0) (>= (+ it1075 (* it1076 (- 1)) (- 2)) 0)))
(assert (= (+ it1080 (- 7)) 0))
(assert (= (+ (* it1074 (- 1)) it1081 (- 2)) 0))
(assert (= (+ (* it1075 (- 1)) it1082) 0))
(assert (= (+ (* it1076 (- 1)) it1083) 0))
(assert (= it1084 0))
(assert (= (+ (* it1078 (- 1)) it1085) 0))
(assert (let ((a!1 (* (* (** 2 (+ it87 (- 1))) (+ 0 it1084)) (+ 0 2)))
      (a!3 (* (* (** 2 (+ it87 (- 1))) (+ 0 it1084)) (+ 0 (- 2)))))
(let ((a!2 (+ (* (** 2 (+ it87 (- 1))) (+ 0 2))
      ...
      (a!4 (+ (* (** 2 (+ it87 (- 1))) (+ 0 (- 2)))
              ...
              (+ 0 (- 1)))))
  (and (>= a!2 (+ 0 0))
       (>= (+ (* it1084 2) (* it1082 (- 1)) it1083 3) 0)
       (>= a!4 (+ 0 0))
       (>= (+ (* it1084 (- 2)) it1082 (* it1083 (- 1)) (- 3)) 0)
       (>= (+ (* it1080 (- 1)) 7) 0)
       (>= (+ it1080 (- 7)) 0)
       (>= (+ it87 (- 1)) 0)))))
(check-sat)
