...
(assert (= (+ (+ 0 (* it48 (- 1)))
      ...
      (+ 0 (* it48 it3 (- 6))))
   (+ 0 0)))
(assert (and (> (+ it840 (- 1)) 0) (> it840 0) (= (+ it838 (- 2)) 0)))
(assert (= (+ it882 (- 2)) 0))
(assert (= (+ it883 (* it839 (- 1)) (- 2)) 0))
(assert (= (+ it884 (* it840 (- 1)) 2) 0))
(assert (= (+ it841 it885) 0))
(assert (= (+ it886 it842) 0))
(assert (let ((a!1 (+ (* (** (+ it840 (- 1)) 2) (+ 0 (- 1)))
              (* (** it840 2) (+ 0 (- 1)))
              (+ 0 it887)
              (+ 0 (* it843 (- 1))))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (> (+ (+ (* it844 (- 2)) it884 (* it13 (- 2))) 1) 0))
      (a!2 (> (+ (+ it884 (* it13 (- 2))) 1) 0))
      (a!3 (> (+ (+ (* it844 (- 2)) it884 (* it13 (- 2))) 2) 0))
      (a!4 (> (+ (+ it884 (* it13 (- 2))) 2) 0)))
  (and (>= (+ it13 (- 1)) 0)
       (>= (+ it882 (- 2)) 0)
       a!1
       a!2
