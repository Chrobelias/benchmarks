...
(assert (and (= (+ it1053 (- 4)) 0)
     ...
     (= (+ it1055 (- 1)) 0)))
(assert (= (+ it1061 (- 3)) 0))
(assert (= (+ (* it1054 (- 1)) it1062 (- 2)) 0))
(assert (= (+ it1063 (* it1055 (- 1))) 0))
(assert (= (+ (* it1056 (- 1)) it1064 1) 0))
(assert (= (+ it1065 (* it1055 (- 1))) 0))
(assert (= (+ it1066 (* it1055 (- 2))) 0))
(assert (let ((a!1 (>= (+ (+ (* it1066 (- 1)) it1064) (- 1)) 0))
      (a!2 (>= (+ (+ (* it1063 (- 2)) (* it941 (- 1))) it1064) 0))
      (a!3 (+ (+ (+ (* it1063 (- 2)) (* it941 (- 1))) it1064) 1))
      (a!4 (+ (+ (* it1063 (- 2)) (* it941 (- 1))) (* it19 (- 1)) it1064))
      (a!5 (>= (+ (+ (* it941 (- 1)) it1064) (- 3)) 0))
      (a!6 (>= (+ (+ (* it941 (- 1)) it1064) (- 2)) 0))
      (a!7 (+ (+ (+ (* it1063 (- 2)) (* it941 (- 1))) it1064) (- 1)))
      (a!8 (>= (+ (+ (* it941 (- 1)) it1064) (- 1)) 0))
      (a!9 (>= (+ (+ (* it941 (- 1)) (* it19 (- 1)) it1064) (- 2)) 0))
      (a!10 (>= (+ (+ (* it941 (- 1)) (* it19 (- 1)) it1064) (- 1)) 0)))
  (and (>= (+ it1063 (- 1)) 0)
       (>= (+ it1061 (- 3)) 0)
       a!1
       a!2
