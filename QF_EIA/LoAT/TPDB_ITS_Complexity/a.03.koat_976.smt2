...
(declare-fun it2704 () Int)
(declare-fun it2705 () Int)
...
(assert (let ((a!1 (>= (+ (+ it2652 (* it2654 (- 1))) (- 1)) 0)))
  (and a!1 (= (+ it2649 (- 3)) 0) (>= (+ it2652 (* it2654 (- 1))) 0))))
(assert (= (+ it2704 (- 4)) 0))
(assert (= (+ (* it2650 (- 1)) it2705 (- 1)) 0))
(assert (= (+ it2706 (* it2651 (- 1))) 0))
(assert (= (+ (* it2652 (- 1)) it2707) 0))
(assert (= (+ (* it2653 (- 1)) it2708) 0))
(assert (= (+ it2709 (* it2654 (- 1))) 0))
(assert (let ((a!1 (>= (+ (+ (* it2706 (- 2)) it2707) (- 2)) 0))
      (a!2 (>= (+ (+ (* it2706 (- 2)) it2707) (- 1)) 0)))
  (and (>= (+ it2707 (- 3)) 0)
       (>= (+ it2707 (- 2)) 0)
       a!1
       (>= (+ (* it2704 (- 1)) 4) 0)
