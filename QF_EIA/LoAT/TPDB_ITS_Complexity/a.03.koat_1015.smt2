...
(declare-fun it2744 () Int)
(declare-fun it2745 () Int)
...
(assert (let ((a!1 (>= (+ (+ it2652 (* it2654 (- 1))) (- 1)) 0)))
  (and (>= (+ it2652 (* it2654 (- 1))) 0)
       (>= (+ it2654 (- 1)) 0)
       (= (+ it2649 (- 3)) 0)
       a!1)))
(assert (= (+ it2740 (- 3)) 0))
(assert (= (+ (* it2650 (- 1)) it2741 (- 1)) 0))
(assert (= (+ it2742 (* it2651 (- 1))) 0))
(assert (= (+ it2743 (* it2652 (- 1))) 0))
(assert (= (+ it2744 (* it2654 (- 1))) 0))
(assert (= (+ it2745 (* it2654 (- 2))) 0))
(assert (let ((a!1 (>= (+ (+ it2743 (* it19 (- 1))) (- 3)) 0))
      (a!2 (>= (+ (+ it2743 (* it88 (- 1)) (* it19 (- 1))) (- 1)) 0))
      (a!3 (+ (+ (+ it2743 (* it19 (- 1))) (* it2742 (- 2))) (- 1)))
      (a!4 (>= (+ (+ it2743 (* it2745 (- 1))) (- 1)) 0))
      (a!5 (>= (+ (+ it2743 (* it88 (- 1)) (* it19 (- 1))) (- 2)) 0))
      (a!6 (+ (+ it2743 (* it88 (- 1)) (* it19 (- 1))) (* it2742 (- 2))))
      (a!7 (>= (+ (+ it2743 (* it19 (- 1))) (- 1)) 0))
      (a!8 (>= (+ (+ it2743 (* it19 (- 1))) (- 2)) 0))
      (a!9 (+ (+ (+ it2743 (* it19 (- 1))) (* it2742 (- 2))) 1))
      (a!10 (>= (+ (+ it2743 (* it19 (- 1))) (* it2742 (- 2))) 0)))
  (and (>= (+ it2743 (- 3)) 0)
       a!1
       a!2
       (>= a!3 0)
