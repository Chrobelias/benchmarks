...
(assert (let ((a!1 (> (+ (+ (* it447 (- 2)) it497) 2) 0))
  ...
  (and a!1
       ...
       (>= (+ (* it495 (- 1)) 2) 0)
       a!2)))
(assert (= (+ (* it495 (- 1)) it558) 0))
(assert (= (+ (* it496 (- 1)) (* it447 (- 2)) it559) 0))
(assert (= (+ (* it447 2) (* it497 (- 1)) it560) 0))
(assert (= (+ (+ 0 it561) (* (exp (- 1) it447) (+ 0 it498) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (* (exp (- 1) it447) (+ 0 it499) (+ 0 (- 1))) (+ 0 it562))
   (+ 0 0)))
(assert (= (+ (* (exp it447 2) (+ 0 6))
      (* (exp it447 3) (+ 0 (- 8)))
      (+ 0 (* it447 (- 1)))
      (* (exp it447 2) (+ 0 it497) (+ 0 12))
      (+ 0 (* it500 (- 3)))
      (+ 0 (* it447 it497 (- 6)))
      (+ 0 (* it563 3))
      (* (+ 0 it447) (exp it497 2) (+ 0 (- 6))))
   (+ 0 0)))
(assert (let ((a!1 (> (+ (+ (* it564 (- 2)) (* it501 (- 2)) it560) 2) 0))
      (a!2 (> (+ (+ (* it501 (- 2)) it560) 1) 0))
      (a!3 (> (+ (+ (* it501 (- 2)) it560) 2) 0))
      (a!4 (> (+ (+ (* it564 (- 2)) (* it501 (- 2)) it560) 1) 0)))
  (and (<= (+ (* it564 2) (* it501 2)) 0)
       (= (+ (* it564 2) (* it501 2)) 0)
       a!1
       a!2
       a!3
