...
(assert (= (+ (+ 0 it2566) (* (exp 2 it57) (+ 0 it1242) (+ 0 (- 1))))
   (+ 0 0)))
(assert (let ((a!1 (+ (* it88 (- 1)) (* it2563 (- 2)) (* it19 (- 1)) it2564))
      (a!2 (>= (+ (+ (* it88 (- 1)) (* it19 (- 1)) it2564) (- 2)) 0))
      (a!3 (>= (+ (+ (* it2563 (- 2)) (* it19 (- 1)) it2564) (- 1)) 0))
      (a!4 (>= (+ (+ (* it19 (- 1)) it2564) (- 2)) 0))
      (a!5 (>= (+ (+ (* it88 (- 1)) (* it19 (- 1)) it2564) (- 1)) 0))
      (a!6 (>= (+ (+ (* it2563 (- 2)) (* it19 (- 1)) it2564) 1) 0))
      (a!7 (>= (+ (+ (* it19 (- 1)) it2564) (- 1)) 0))
      (a!8 (>= (+ (+ (* it19 (- 1)) it2564) (- 3)) 0))
      (a!9 (>= (+ (+ (* it2566 (- 1)) it2564) (- 1)) 0)))
  (and (>= a!1 0)
       (>= (+ (* it2563 (- 2)) (* it19 (- 1)) it2564) 0)
       (>= (+ it2564 (- 3)) 0)
       a!2
       (>= (+ it2564 (- 2)) 0)
       (= (+ it2566 (* it2563 (- 2))) 0)
