...
(assert (let ((a!1 (>= (+ (+ (* it482 (- 1)) it480) (- 1)) 0)))
  (and a!1 (= (+ it477 (- 3)) 0) (>= (+ (* it482 (- 1)) it480) 0))))
(assert (= (+ it485 (- 4)) 0))
(assert (= (+ (* it478 (- 1)) it486 (- 1)) 0))
(assert (= (+ it487 (* it479 (- 1))) 0))
(assert (= (+ it488 (* it480 (- 1))) 0))
(assert (= (+ (* it481 (- 1)) it489) 0))
(assert (= (+ it490 (* it482 (- 1)) (- 1)) 0))
(assert (let ((a!1 (>= (+ (+ (* it487 (- 2)) it488) (- 1)) 0))
      (a!2 (>= (+ (+ (* it487 (- 2)) it488) (- 2)) 0)))
  (and (>= (+ it485 (- 4)) 0)
       (>= (+ (* it487 (- 1)) 1) 0)
       a!1
       (>= (+ it487 (- 1)) 0)
