...
(let ((a!2 (+ a!1
              ...
              (* (* (+ 0 it117) (exp it1184 2))
                 ...
                 (+ 0 (- 6))))))
  (= a!2 (+ 0 0)))))
(assert (and (= (+ it1202 (- 2)) 0) (> it1204 0) (> (+ it1204 (- 1)) 0)))
(assert (= (+ it1274 (- 2)) 0))
(assert (= (+ it1275 (* it1203 (- 1)) (- 2)) 0))
(assert (= (+ (* it1204 (- 1)) it1276 2) 0))
(assert (= (+ it1277 it1205) 0))
(assert (= (+ it1278 it1206) 0))
(assert (let ((a!1 (+ (+ 0 (* it1207 (- 1)))
              (* (exp (+ it1204 (- 1)) 2) (+ 0 (- 1)))
              (+ 0 it1279)
              (* (exp it1204 2) (+ 0 (- 1))))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (> (+ (+ (* it1210 (- 2)) (* it1209 (- 2)) it1276) 1) 0))
      (a!2 (> (+ (+ (* it1210 (- 2)) (* it1209 (- 2)) it1276) 2) 0))
      (a!3 (> (+ (+ (* it1210 (- 2)) it1276) 1) 0))
      (a!4 (> (+ (+ (* it1210 (- 2)) it1276) 2) 0)))
  (and (>= (+ it1274 (- 2)) 0)
       (>= (+ it1210 (- 1)) 0)
       (<= (+ (* it1210 2) (* it1209 2)) 0)
       (>= (+ it1209 (- 1)) 0)
