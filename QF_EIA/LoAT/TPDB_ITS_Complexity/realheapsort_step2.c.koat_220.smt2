...
(assert (and (> (+ (* it1128 2) it1129 (* it1127 (- 1)) 3) 0) (= (+ it1124 (- 20)) 0)))
(assert (= (+ it1132 (- 18)) 0))
(assert (= (+ (* it1125 (- 1)) it1133 (- 4)) 0))
(assert (= (+ (* it1129 (- 1)) it1134 (- 1)) 0))
(assert (= (+ it1135 (* it1127 (- 1))) 0))
(assert (= (+ (* it1128 (- 1)) it1136) 0))
(assert (= (+ (* it1129 (- 1)) it1137 (- 1)) 0))
(assert (= (+ it1138 (* it1130 (- 1))) 0))
(assert (and (= (+ it1132 (- 18)) 0) (<= (+ (* it1135 (- 1)) it1137 2) 0)))
(assert (= (+ it1139 (- 20)) 0))
(assert (= (+ (* it1133 (- 1)) it1140 (- 2)) 0))
(assert (= (+ it1141 (* it1134 (- 1))) 0))
(assert (= (+ (* it1135 (- 1)) it1142) 0))
(assert (= it1143 0))
(assert (= (+ it1144 (* it1137 (- 1))) 0))
(assert (= (+ (* it1138 (- 1)) it1145) 0))
(assert (let ((a!1 (* (* (exp 2 (+ it101 (- 1))) (+ 0 it1143)) (+ 0 (- 2))))
      (a!3 (* (* (exp 2 (+ it101 (- 1))) (+ 0 it1143)) (+ 0 2))))
(let ((a!2 (+ (+ 0 (* it1144 (- 1)))
              (* (exp 2 (+ it101 (- 1))) (+ 0 (- 2)))
              (+ 0 it1142)
              a!1
      ...
      (a!4 (+ (+ 0 it1144)
              ...
              (+ 0 1))))
  (and (>= (+ (* it1139 (- 1)) 20) 0)
       (>= (+ (* it1144 (- 1)) it1142 (* it1143 (- 2)) (- 3)) 0)
       (>= (+ it1139 (- 20)) 0)
       (>= a!2 (+ 0 0))
       (>= a!4 (+ 0 0))
       (>= (+ it1144 (* it1142 (- 1)) (* it1143 2) 3) 0)
       (>= (+ it101 (- 1)) 0)))))
(check-sat)
