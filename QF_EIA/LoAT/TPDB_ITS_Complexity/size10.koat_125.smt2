...
(assert (let ((a!1 (> (+ (+ it396 (* it284 (- 2))) (- 1)) 0))
      (a!2 (> (+ (+ (* it81 (- 2)) it396 (* it284 (- 2))) 2) 0))
      (a!3 (> (+ (+ it396 (* it284 (- 2))) 2) 0))
      (a!4 (> (+ (+ it396 (* it284 (- 2))) 1) 0))
      (a!5 (> (+ (+ (* it81 (- 2)) it396 (* it284 (- 2))) 1) 0)))
  (and (= (+ it393 (* it81 4) (* it396 (- 2)) (* it284 4) (- 2)) 0)
       (> (+ (* it285 (- 2)) it392 (* it396 2) 2) 0)
       (>= (+ (* it390 (- 1)) 2) 0)
       a!1
       (= (+ it392 (* it81 2) (* it396 (- 1)) (* it284 2) (- 1)) 0)
       a!2
       a!3
       ...
       (<= (+ (* it81 2) (* it284 2)) 0)
       (= (+ (* it81 2) (* it284 2)) 0)
       (= (+ it395 (* it81 2) (* it396 (- 1)) (* it284 2) (- 2)) 0)
       (>= (+ it264 (- 1)) 0)
       (= 0 0)
