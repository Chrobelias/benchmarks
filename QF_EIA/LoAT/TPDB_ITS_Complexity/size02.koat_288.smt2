...
(assert (and (= (+ it1334 (- 3)) 0) (> (+ it1338 it1337) 0)))
(assert (= (+ it1364 (- 3)) 0))
(assert (= (+ it1365 (* it1335 (- 1)) (- 1)) 0))
(assert (= (+ it1366 (* it1336 (- 1))) 0))
(assert (= (+ it1367 (* it1337 (- 1)) 1) 0))
(assert (= (+ (* it1338 (- 1)) it1368 1) 0))
(assert (= (+ (* it1339 (- 1)) it1369) 0))
(assert (and (> (+ it1367 it1368) 0)
     (>= (+ it1364 (- 3)) 0)
     (= 1 0)
     (>= (+ (* it1364 (- 1)) 3) 0)))
(check-sat)
