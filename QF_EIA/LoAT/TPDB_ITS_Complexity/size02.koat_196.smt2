...
(assert (and (> (+ it889 it890) 0) (= (+ it886 (- 3)) 0)))
(assert (= (+ it921 (- 3)) 0))
(assert (= (+ (* it887 (- 1)) it922 (- 1)) 0))
(assert (= (+ (* it888 (- 1)) it923) 0))
(assert (= (+ it924 (* it889 (- 1)) 1) 0))
(assert (= (+ it925 (* it890 (- 1)) 1) 0))
(assert (= (+ (* it891 (- 1)) it926) 0))
(assert (and (>= (+ (* it921 (- 1)) 3) 0)
     (= 1 0)
     (>= (+ it921 (- 3)) 0)
     (> (+ it924 it925) 0)))
(check-sat)
