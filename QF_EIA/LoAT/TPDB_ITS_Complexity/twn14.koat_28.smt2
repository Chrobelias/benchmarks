...
(assert (let ((a!1 (* (* (exp 9 (+ it109 (- 1))) (+ 0 it562)) (+ 0 3)))
      (a!2 (* (exp (exp 4 (+ it109 (- 1))) (+ 0 2)) (exp it561 2)))
      (a!3 (* (* (exp it563 3) (exp 9 (+ it109 (- 1)))) (+ 0 (- 3))))
      (a!5 (> (+ (* (exp it563 5) (+ 0 (- 1)))
                 (* (exp it561 2) (+ 0 (- 1)))
                 (+ 0 it562))
              (+ 0 0)))
      (a!6 (* (* (exp it563 3) (exp 9 (+ it109 (- 1)))) (+ 0 (- 1)))))
