...
(assert (and (> (+ (* it1733 2) it1734 (* it1732 (- 1)) 3) 0) (= (+ it1729 (- 20)) 0)))
(assert (= (+ it1739 (- 18)) 0))
(assert (= (+ (* it1730 (- 1)) it1740 (- 4)) 0))
(assert (= (+ it1741 (* it1734 (- 1)) (- 1)) 0))
(assert (= (+ it1742 (* it1732 (- 1))) 0))
(assert (= (+ (* it1733 (- 1)) it1743) 0))
(assert (= (+ (* it1734 (- 1)) it1744 (- 1)) 0))
(assert (= (+ it1745 (* it1735 (- 1))) 0))
(assert (and (<= (+ (* it1742 (- 1)) it1744 2) 0) (= (+ it1739 (- 18)) 0)))
(assert (= (+ it1746 (- 20)) 0))
(assert (= (+ (* it1740 (- 1)) it1747 (- 2)) 0))
(assert (= (+ (* it1741 (- 1)) it1748) 0))
(assert (= (+ (* it1742 (- 1)) it1749) 0))
(assert (= it1750 0))
(assert (= (+ it1751 (* it1744 (- 1))) 0))
(assert (= (+ (* it1745 (- 1)) it1752) 0))
(assert (let ((a!1 (* (* (exp 2 (+ it101 (- 1))) (+ 0 it1750)) (+ 0 2)))
      (a!3 (* (* (exp 2 (+ it101 (- 1))) (+ 0 it1750)) (+ 0 (- 2)))))
(let ((a!2 (+ (+ 0 it1751)
              a!1
              (* (exp 2 (+ it101 (- 1))) (+ 0 2))
              (+ 0 (* it1749 (- 1)))
      ...
      (a!4 (+ (+ 0 (* it1751 (- 1)))
              ...
              (+ 0 (- 1)))))
  (and (>= (+ (* it1746 (- 1)) 20) 0)
       (>= (+ it1751 (* it1749 (- 1)) (* it1750 2) 3) 0)
       (>= (+ it1746 (- 20)) 0)
       (>= (+ it101 (- 1)) 0)
       (>= a!2 (+ 0 0))
       (>= (+ (* it1751 (- 1)) it1749 (* it1750 (- 2)) (- 3)) 0)
       (>= a!4 (+ 0 0))))))
(check-sat)
