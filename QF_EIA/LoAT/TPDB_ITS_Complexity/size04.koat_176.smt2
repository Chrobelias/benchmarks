...
(assert (and (= (+ it879 (- 3)) 0) (> (+ it884 it882 it883) 0)))
(assert (= (+ it888 (- 3)) 0))
(assert (= (+ (* it880 (- 1)) it889 (- 1)) 0))
(assert (= (+ it890 (* it881 (- 1))) 0))
(assert (= (+ (* it882 (- 1)) it891 1) 0))
(assert (= (+ it892 (* it883 (- 1)) 1) 0))
(assert (= (+ (* it884 (- 1)) it893 1) 0))
(assert (and (>= (+ (* it888 (- 1)) 3) 0)
     (>= (+ it888 (- 3)) 0)
     (= 1 0)
     (> (+ it891 it892 it893) 0)))
(check-sat)
