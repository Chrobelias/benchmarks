...
(assert (let ((a!1 (+ 0 (+ (* it202 2)
                       ...
                       (* (+ it373 (- 1)) it202 2)
                       (- 1)))))
  (= (+ (* (** (- 1) it15) a!1 (+ 0 2)) (+ 0 it379)) (+ 0 0))))
(assert (let ((a!1 (+ 0 (+ (* it202 2)
                       (* it199 (- 1))
                       (* (+ it373 (- 1)) it202 2)
                       (- 1)))))
  (= (+ (* (** (- 1) it15) a!1 (+ 0 3)) (+ 0 it380)) (+ 0 0))))
...
(assert (let ((a!1 (> (+ (+ (* it201 (- 2)) it382 (* it384 (- 2))) 2) 0))
      (a!2 (> (+ (+ it382 (* it384 (- 2))) 2) 0))
      (a!3 (> (+ (+ (* it201 (- 2)) it382 (* it384 (- 2))) 3) 0))
      (a!4 (> (+ (+ it382 (* it384 (- 2))) 1) 0)))
  (and a!1
       a!2
       (> it382 0)
       (>= (+ it384 (- 1)) 0)
