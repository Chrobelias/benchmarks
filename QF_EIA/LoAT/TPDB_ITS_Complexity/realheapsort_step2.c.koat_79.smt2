...
(assert (and (> (+ it550 (* it548 (- 1)) (* it549 2) 3) 0) (= (+ it545 (- 20)) 0)))
(assert (= (+ it552 (- 18)) 0))
(assert (= (+ (* it546 (- 1)) it553 (- 4)) 0))
(assert (= (+ (* it550 (- 1)) it554 (- 1)) 0))
(assert (= (+ (* it548 (- 1)) it555) 0))
(assert (= (+ (* it549 (- 1)) it556) 0))
(assert (= (+ (* it550 (- 1)) it557 (- 1)) 0))
(assert (= (+ (* it551 (- 1)) it558) 0))
(assert (and (= (+ it552 (- 18)) 0) (<= (+ it557 (* it555 (- 1)) 2) 0)))
(assert (= (+ it560 (- 20)) 0))
(assert (= (+ it561 (* it553 (- 1)) (- 2)) 0))
(assert (= (+ (* it554 (- 1)) it562) 0))
(assert (= (+ it563 (* it555 (- 1))) 0))
(assert (= it564 0))
(assert (= (+ (* it557 (- 1)) it565) 0))
(assert (= (+ (* it558 (- 1)) it566) 0))
(assert (let ((a!1 (* (* (exp 2 (+ it101 (- 1))) (+ 0 it564)) (+ 0 (- 2))))
      (a!3 (* (* (exp 2 (+ it101 (- 1))) (+ 0 it564)) (+ 0 2))))
(let ((a!2 (+ (+ 0 it563)
              a!1
              (* (exp 2 (+ it101 (- 1))) (+ 0 (- 2)))
              (+ 0 (* it565 (- 1)))
      ...
      (a!4 (+ (+ 0 (* it563 (- 1)))
              ...
              (+ 0 1))))
  (and (>= a!2 (+ 0 0))
       (>= (+ it563 (* it564 (- 2)) (* it565 (- 1)) (- 3)) 0)
       (>= a!4 (+ 0 0))
       (>= (+ (* it563 (- 1)) (* it564 2) it565 3) 0)
       (>= (+ it101 (- 1)) 0)
       (>= (+ it560 (- 20)) 0)
       (>= (+ (* it560 (- 1)) 20) 0)))))
(check-sat)
