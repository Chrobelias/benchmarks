...
(assert (= (+ (* (** (- 1) it48) (+ 0 it291) (+ 0 (- 1))) (+ 0 it347))
   (+ 0 0)))
(assert (= (+ (+ 0 it348) (* (** (- 1) it48) (+ 0 it292) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (* (+ 0 it48) (** it290 2) (+ 0 (- 6)))
      (+ 0 (* it48 (- 1)))
      (+ 0 (* it293 (- 3)))
      (+ 0 (* it349 3))
      (+ 0 (* it48 it290 (- 6)))
      ...
      (* (** it48 3) (+ 0 (- 8))))
   (+ 0 0)))
(assert (let ((a!1 (> (+ (+ it346 (* it350 (- 2)) (* it294 (- 2))) 1) 0))
      (a!2 (> (+ (+ it346 (* it294 (- 2))) 1) 0))
      (a!3 (> (+ (+ it346 (* it294 (- 2))) 2) 0))
      (a!4 (> (+ (+ it346 (* it350 (- 2)) (* it294 (- 2))) 2) 0)))
  (and a!1
       a!2
       a!3
       (<= (+ (* it350 2) (* it294 2)) 0)
