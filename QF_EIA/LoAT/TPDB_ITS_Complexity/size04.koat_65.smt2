...
(assert (= (+ (* (** (- 1) it127) (+ 0 it256) (+ 0 (- 1))) (+ 0 it289))
   (+ 0 0)))
(assert (= (+ (+ 0 it290) (* (** (- 1) it127) (+ 0 it257) (+ 0 (- 1))))
   (+ 0 0)))
(assert (let ((a!1 (+ (+ 0 (+ (* it258 (- 3)) (* it255 it127 (- 6))))
              (* (+ 0 it255) (** it127 2) (+ 0 12))
              (* (** it127 2) (+ 0 6))
              (* (** it127 3) (+ 0 (- 8)))
              (+ 0 (* it127 (- 1)))
              (+ 0 (* it291 3))
              (* (** it255 2) (+ 0 it127) (+ 0 (- 6))))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (+ (+ (+ (* it259 (- 2)) it288) (* it292 (- 2))) 2))
      (a!2 (+ (+ (+ (* it259 (- 2)) it288) (* it292 (- 2))) 1))
      (a!3 (> (+ (+ (* it259 (- 2)) it288) 1) 0))
      (a!4 (> (+ (+ (* it259 (- 2)) it288) 2) 0)))
  (and (> a!1 0)
       (>= (+ (* it286 (- 1)) 2) 0)
       (>= (+ it286 (- 2)) 0)
       (> a!2 0)
