...
(assert (and (> (+ it832 it833 it834) 0) (= (+ it829 (- 3)) 0)))
(assert (= (+ it871 (- 3)) 0))
(assert (= (+ it872 (* it830 (- 1)) (- 1)) 0))
(assert (= (+ it873 (* it831 (- 1))) 0))
(assert (= (+ (* it832 (- 1)) it874 1) 0))
(assert (= (+ it875 (* it833 (- 1)) 1) 0))
(assert (= (+ it876 (* it834 (- 1)) 1) 0))
(assert (and (> (+ it875 it876 it874) 0)
     (>= (+ it871 (- 3)) 0)
     (= 1 0)
     (>= (+ (* it871 (- 1)) 3) 0)))
(check-sat)
