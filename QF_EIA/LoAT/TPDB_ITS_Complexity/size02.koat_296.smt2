...
(assert (and (= (+ it1372 (- 3)) 0) (> (+ it1375 it1376) 0)))
(assert (= (+ it1381 (- 3)) 0))
(assert (= (+ (* it1373 (- 1)) it1382 (- 1)) 0))
(assert (= (+ (* it1374 (- 1)) it1383) 0))
(assert (= (+ (* it1375 (- 1)) it1384 1) 0))
(assert (= (+ (* it1376 (- 1)) it1385 1) 0))
(assert (= (+ (* it1377 (- 1)) it1386) 0))
(assert (and (>= (+ it1381 (- 3)) 0)
     (> (+ it1384 it1385) 0)
     (= 1 0)
     (>= (+ (* it1381 (- 1)) 3) 0)))
(check-sat)
