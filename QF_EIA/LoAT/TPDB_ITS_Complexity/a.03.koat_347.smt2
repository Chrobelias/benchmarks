...
(assert (let ((a!1 (+ (+ (* it88 (- 1)) (* it580 (- 2))) (* it584 (- 1)) it581))
      (a!2 (>= (+ (+ (* it88 (- 1)) (* it584 (- 1)) it581) (- 2)) 0))
      (a!3 (>= (+ (+ (* it88 (- 1)) it581) (- 3)) 0))
      (a!4 (>= (+ (+ (* it88 (- 1)) it581) (- 2)) 0))
      (a!5 (+ (+ (+ (* it88 (- 1)) (* it580 (- 2))) it581) (- 1)))
      (a!6 (+ (+ (+ (* it88 (- 1)) (* it580 (- 2))) it581) 1))
      (a!7 (>= (+ (+ (* it583 (- 1)) it581) (- 1)) 0))
      (a!8 (>= (+ (+ (* it88 (- 1)) (* it584 (- 1)) it581) (- 1)) 0))
      (a!9 (>= (+ (+ (* it88 (- 1)) (* it580 (- 2))) it581) 0))
      (a!10 (>= (+ (+ (* it88 (- 1)) it581) (- 1)) 0)))
  (and (>= (+ it578 (- 3)) 0)
       (= (+ it583 (* it580 (- 2))) 0)
       (>= (+ a!1 1) 0)
       (>= (+ it581 (- 3)) 0)
