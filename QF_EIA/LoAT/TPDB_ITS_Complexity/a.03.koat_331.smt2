...
(assert (let ((a!1 (>= (+ (+ (* it540 (- 1)) it538) (- 1)) 0)))
  (and a!1
       ...
       (>= (+ (* it540 (- 1)) it538) 0))))
(assert (= (+ it560 (- 3)) 0))
(assert (= (+ (* it536 (- 1)) it561 (- 1)) 0))
(assert (= (+ (* it537 (- 1)) it562) 0))
(assert (= (+ (* it538 (- 1)) it563) 0))
(assert (= (+ it564 (* it540 (- 1))) 0))
(assert (= (+ (* it540 (- 2)) it565) 0))
(assert (let ((a!1 (>= (+ (+ (* it88 (- 1)) (* it19 (- 1)) it563) (- 2)) 0))
      (a!2 (+ (+ (+ (* it88 (- 1)) (* it562 (- 2))) it563) (- 1)))
      (a!3 (+ (+ (* it88 (- 1)) (* it562 (- 2))) (* it19 (- 1)) it563))
      (a!4 (>= (+ (+ (* it88 (- 1)) it563) (- 3)) 0))
      (a!5 (>= (+ (+ (* it88 (- 1)) (* it19 (- 1)) it563) (- 1)) 0))
      (a!6 (>= (+ (+ (* it88 (- 1)) (* it562 (- 2))) it563) 0))
      (a!7 (+ (+ (+ (* it88 (- 1)) (* it562 (- 2))) it563) 1))
      (a!8 (>= (+ (+ (* it88 (- 1)) it563) (- 2)) 0))
      (a!9 (>= (+ (+ (* it88 (- 1)) it563) (- 1)) 0))
      (a!10 (>= (+ (+ (* it565 (- 1)) it563) (- 1)) 0)))
  (and a!1
       (>= a!2 0)
       (>= (+ a!3 1) 0)
       (>= (+ it562 (- 1)) 0)
