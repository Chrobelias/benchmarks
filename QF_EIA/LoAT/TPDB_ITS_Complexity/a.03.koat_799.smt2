...
(assert (let ((a!1 (+ (+ 0 it1308)
              ...
              (+ 0 1))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (+ (* (** 2 it134) (+ 0 it1242) (+ 0 (- 1)))
              (* (** 2 (+ it134 1)) (+ 0 (- 1)))
              (+ 0 it1309)
              (+ 0 2))))
  (= a!1 (+ 0 0))))
(assert (let ((a!1 (>= (+ (+ it1307 (* it19 (- 1))) (- 2)) 0))
      (a!2 (>= (+ (+ it1307 (* it19 (- 1))) (- 1)) 0))
      (a!3 (+ (+ (+ it1307 (* it19 (- 1))) (* it1306 (- 2))) 1))
      (a!4 (>= (+ (+ it1307 (* it1309 (- 1))) (- 1)) 0))
      (a!5 (>= (+ (+ it1307 (* it19 (- 1))) (* it1306 (- 2))) 0)))
  (and (>= (+ it1304 (- 3)) 0)
       (>= (+ it1307 (- 3)) 0)
       (>= (+ it1306 (- 1)) 0)
       a!1
