...
(assert (let ((a!1 (> (+ (* (exp it563 5) (+ 0 (- 1)))
                 (* (exp it561 2) (+ 0 (- 1)))
                 (+ 0 it562))
              (+ 0 0)))
      (a!2 (* (* (exp 9 (+ it140 (- 1))) (exp it563 3)) (+ 0 (- 1))))
      (a!3 (* (exp it561 2) (exp (exp 4 (+ it140 (- 1))) (+ 0 2))))
      (a!5 (* (* (exp 9 (+ it140 (- 1))) (exp it563 3)) (+ 0 (- 3))))
      (a!6 (* (* (exp 9 (+ it140 (- 1))) (+ 0 it562)) (+ 0 3))))
(let ((a!4 (+ (* (exp it563 5) (+ 0 (- 1)))
              a!2
              (* a!3 (+ 0 (- 1)))
              (* (exp 9 (+ it140 (- 1))) (+ 0 it562))
              (exp it563 3)))
      (a!7 (> (+ (* (exp it563 5) (+ 0 (- 1)))
                 a!5
                 (* a!3 (+ 0 (- 4)))
