...
(assert (and (>= (+ it321 (- 1)) 0)
     (= (+ it315 (- 26)) 0)
     (<= (+ (* it324 (- 1)) it321) 0)))
(assert (= (+ it327 (- 27)) 0))
(assert (= (+ (* it316 (- 1)) it328 (- 1)) 0))
(assert (= (+ it329 (* it317 (- 1))) 0))
(assert (= (+ (* it318 (- 1)) it330) 0))
(assert (= (+ (* it319 (- 1)) it331) 0))
(assert (= (+ it332 (* it320 (- 1))) 0))
(assert (= (+ (* it321 (- 1)) it333) 0))
(assert (= (+ (* it322 (- 1)) it334) 0))
(assert (= (+ it335 (* it323 (- 1))) 0))
(assert (= (+ (* it324 (- 1)) it336) 0))
(assert (and (<= (+ it335 (* it336 (- 1))) 0)
     (>= (+ it335 (- 1)) 0)
     (= (+ it327 (- 27)) 0)))
(assert (= (+ it339 (- 13)) 0))
(assert (= (+ it340 (* it328 (- 1)) (- 1)) 0))
(assert (= (+ it341 (* it329 (- 1))) 0))
(assert (= (+ it342 (* it330 (- 1))) 0))
(assert (= (+ it343 (* it331 (- 1))) 0))
(assert (= (+ it344 (* it332 (- 1))) 0))
(assert (= (+ (* it335 (- 1)) it345) 0))
(assert (= (+ it346 (* it334 (- 1))) 0))
(assert (= (+ it347 (* it335 (- 1))) 0))
(assert (= (+ it348 (* it336 (- 1))) 0))
(assert (let ((a!1 (>= (+ (+ it348 (* it345 (- 2))) (- 1)) 0)))
  (and (= 0 0)
       (> it299 0)
       (> it348 0)
       (>= (+ it345 (- 1)) 0)
