...
(declare-fun it2279 () Int)
(declare-fun it2280 () Int)
(declare-fun it2281 () Int)
(declare-fun it2282 () Int)
(declare-fun it42 () Int)
(declare-fun it2283 () Int)
(declare-fun it41 () Int)
(declare-fun it2284 () Int)
(declare-fun it2286 () Int)
(declare-fun it2289 () Int)
(declare-fun it2290 () Int)
(declare-fun it2291 () Int)
(declare-fun it2292 () Int)
(declare-fun it2287 () Int)
(declare-fun it2293 () Int)
(declare-fun it2288 () Int)
(declare-fun it2294 () Int)
(declare-fun it2295 () Int)
...
(assert (and (> it45 0)
     (> (+ it2273 (* it2272 (- 1))) 0)
     (>= (+ it479 (- 1)) 0)
     (> (+ it2273 (* it479 (- 1)) (* it2272 (- 1)) 1) 0)
     (>= (+ it2270 (- 5)) 0)
     (>= (+ (* it2270 (- 1)) 5) 0)
     (> it2271 0)
     (> (+ it2273 1) 0)
     (>= (+ (* it45 (- 1)) it2271) 0)))
(assert (= (+ it2279 (* it2270 (- 1))) 0))
(assert (= (+ (* it45 (- 1)) it2280) 0))
(assert (= (+ (* it479 (- 1)) it2281 (* it2272 (- 1))) 0))
(assert (= (+ (* it2273 (- 1)) it2282) 0))
(assert (= (+ it2283 (* it42 (- 1))) 0))
(assert (= (+ it2284 (* it41 (- 1))) 0))
(assert (and (> (+ (* it2281 (- 1)) it2282) 0)
     (= (+ it2279 (- 5)) 0)
     (<= (+ it2286 (* it2280 (- 1))) 0)
     (> it2280 0)
     (> (+ it2282 1) 0)
     (> it2286 0)))
(assert (= (+ it2289 (- 5)) 0))
(assert (= (+ (* it2286 (- 1)) it2290) 0))
(assert (= (+ (* it2281 (- 1)) it2291 (- 1)) 0))
(assert (= (+ it2292 (* it2282 (- 1))) 0))
(assert (= (+ it2293 (* it2287 (- 1))) 0))
(assert (= (+ it2294 (* it2288 (- 1))) 0))
(assert (and (> (+ it2292 1) 0)
     (> (+ it2292 (* it2291 (- 1))) 0)
     (>= (+ it2289 (- 5)) 0)
     (>= (+ (* it2289 (- 1)) 5) 0)
     (> it2295 0)
