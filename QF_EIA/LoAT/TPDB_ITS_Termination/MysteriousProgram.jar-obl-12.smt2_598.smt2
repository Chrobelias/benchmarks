...
(assert (let ((a!1 (>= (+ (+ (* it2599 (- 1)) (* it2593 (- 1)) it2600) (- 1)) 0))
      (a!2 (>= (+ (+ (* it2593 (- 1)) it2600) (- 2)) 0))
      (a!3 (>= (+ (* it2597 (+ it2598 (- 1)) (- 1))
                  (* it2593 (- 1))
                  it2600
                  (* it2599 (+ it2598 (- 1)) (- 1))
                  (- 2))
               0))
      (a!4 (>= (+ (+ (* it2593 (- 1)) it2595) (- 1)) 0))
      (a!5 (+ (* it2597 (+ it2598 (- 1)) (- 1))
              (* it2599 (- 1))
              (* it2593 (- 1))
              it2600))
      (a!7 (>= (+ (+ (* it2599 (- 1)) (* it2593 (- 1)) it2600)
                  (* it2597 (- 1))
                  (- 1))
               0))
      (a!10 (> (+ (+ (* it2593 (- 1)) it2595) (- 1)) 0))
      (a!11 (>= (+ (+ (* it2599 (- 1)) (* it2593 (- 1)) it2600) (- 2)) 0))
      (a!12 (>= (+ (+ (* it2593 (- 1)) it2595) (- 2)) 0)))
(let ((a!6 (+ (+ a!5 (* it2599 (+ it2598 (- 1)) (- 1))) (- 1)))
      (a!8 (>= (+ a!5 (* it2597 (- 1)) (* it2599 (+ it2598 (- 1)) (- 1)) (- 1))
               0))
      (a!9 (+ (+ a!5 (* it2599 (+ it2598 (- 1)) (- 1))) (- 2))))
  (and (> it110 0)
       (> it109 0)
       (>= (+ it2599 (- 1)) 0)
       (>= (+ (* it2590 (- 1)) 6) 0)
