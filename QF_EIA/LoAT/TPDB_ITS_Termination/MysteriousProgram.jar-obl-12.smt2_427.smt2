...
(assert (let ((a!1 (+ (+ (* it2511 (- 1)) it2506 (* it628 (- 1))) (* it396 (- 1))))
      (a!2 (>= (+ (+ (* it2511 (- 1)) it2506 (* it628 (- 1))) (- 1)) 0))
      (a!3 (>= (+ (+ (* it2511 (- 1)) it2506 (* it628 (- 1))) (- 2)) 0))
      (a!4 (> (+ (+ (* it2511 (- 1)) it2513) (- 1)) 0)))
  (and (<= (+ (* it2507 (- 1)) it2509) 0)
       (= (+ (* it2506 (- 1)) it2513) 0)
       (> (+ it2506 1) 0)
       (>= a!1 0)
       (> it2507 0)
       (>= (+ (* it2507 (- 1)) it2510) 0)
       (> (+ (* it2511 (- 1)) it2506 (* it628 (- 1))) 0)
       (>= (+ it2508 (- 6)) 0)
       a!2
       (>= (+ it2510 (- 1)) 0)
       (> (+ it2513 (- 1)) 0)
