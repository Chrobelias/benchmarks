...
(assert (let ((a!1 (> (+ (+ (* it732 (- 1)) (* it2502 (- 1)))
                 (* it732 (+ it996 (- 1)) (- 1))
                 (* (+ it996 (- 1)) it375 (- 1))
                 it2506
                 (* it375 (- 1))
      ...
      (a!3 (+ (* it2502 (- 1))
              (* it732 (+ it996 (- 1)) (- 1))
              (* (+ it996 (- 1)) it375 (- 1))))
      (a!5 (> (+ (+ (* it732 (- 1)) (* it2502 (- 1)))
                 (* it1364 (- 1))
                 it2506
                 (* it375 (- 1))
                 2)
              0))
      (a!7 (> (+ (+ (* it2502 (- 1)) it2506) (* it375 (- 1))) 0))
      (a!8 (> (+ (+ (* it2502 (- 1)) (* it996 it732 (- 1)))
                 (* it1364 (- 1))
                 it2506
                 (* it996 it375 (- 1))
                 1)
      ...
      (a!11 (> (+ (+ (* it2502 (- 1)) (* it1364 (- 1)) it2506) (- 1)) 0))
      (a!12 (> (+ (+ (* it732 (- 1)) (* it2502 (- 1))) it2506 (* it375 (- 1)) 1)
               0))
      (a!13 (+ (+ (+ (* it2502 (- 1)) it2506) (* it375 (- 1))) 1)))
(let ((a!4 (+ (+ a!3 (* it1364 (- 1)) it2506) (* it375 (- 1))))
      (a!6 (> (+ (+ a!3 (* it1364 (- 1)) it2506) 1) 0))
      (a!9 (> (+ (+ (+ a!3 it2506) (* it375 (- 1))) 1) 0)))
  (and (= (+ it2504 (* it2506 (- 1))) 0)
       a!1
       a!2
       (> (+ (+ a!3 it2506) (* it375 (- 1))) 0)
       (> (+ it2506 (- 1)) 0)
       (> (+ a!4 2) 0)
       (>= (+ it996 (- 1)) 0)
       (<= (+ it2501 (* it1416 (- 1))) 0)
       ...
       (>= (+ (* it1416 (- 1)) it2500) 0)
       (> it2500 0)
       (> (+ (* it2502 (- 1)) (* it1364 (- 1)) it2506) 0)
       a!7
       (>= (+ (* it1416 (- 1)) it2503) 0)
       (> it2501 0)
       a!8
       (> (+ (* it2502 (- 1)) (* it678 (- 1)) (* it1364 (- 1)) it2506) 0)
       (>= (+ it1364 (- 1)) 0)
       (<= (+ (* it1416 (- 1)) it2500) 0)
       (> it2503 0)
       (> (+ it2506 1) 0)
