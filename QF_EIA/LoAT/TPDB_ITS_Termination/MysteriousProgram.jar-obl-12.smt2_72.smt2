...
(assert (let ((a!1 (> (+ (+ it127 (* it363 (- 1))) (* it375 (- 1)) 1) 0)))
  (and (>= (+ it361 (- 1)) 0)
       ...
       (> (+ it127 (* it362 (- 1))) 0)
       (>= (+ it375 (- 1)) 0))))
(assert (= (+ it378 (* it360 (- 1))) 0))
(assert (= (+ (* it140 (- 1)) it379) 0))
(assert (= (+ (* it362 (- 1)) it380) 0))
(assert (= (+ it381 (* it363 (- 1)) (* it375 (- 1))) 0))
(assert (= (+ it382 (* it363 (- 1)) (* it375 (- 1))) 0))
(assert (= (+ (* it127 (- 1)) it383) 0))
(assert (and (> it107 0)
     (> it110 0)
     (> it109 0)
     (> (+ (* it381 (- 1)) it383) 0)
     ...
     (= (+ it378 (- 10)) 0)))
(assert (= (+ it387 (- 6)) 0))
(assert (= (+ (* it110 (- 1)) it388) 0))
(assert (= (+ it389 (* it109 (- 1))) 0))
(assert (= (+ it390 (* it380 (- 1)) (- 1)) 0))
(assert (= (+ (* it107 (- 1)) it391) 0))
(assert (= (+ (* it383 (- 1)) it392) 0))
(assert (let ((a!1 (> (+ (+ (* it390 (- 1)) it392) (- 1)) 0))
      (a!2 (>= (+ (+ it358 (* it390 (- 1))) (- 2)) 0))
      (a!3 (>= (+ (+ it358 (* it390 (- 1))) (- 1)) 0)))
  (and (> it105 0)
       (> it104 0)
       (> it359 0)
       (= (- 1) 0)
