...
(assert (let ((a!1 (+ (* it310 (- 1))
              ...
              it117
              (* it2429 (- 1))))
      (a!2 (> (+ (+ (* it310 (- 1)) it117 (* it2429 (- 1))) (* it292 (- 1)) 1)
              0))
      (a!3 (> (+ (* it292 (+ it577 (- 1)) (- 1))
                 (* it310 (+ it577 (- 1)) (- 1))
                 it117
                 (* it2429 (- 1)))
              0))
      (a!4 (> (+ (+ (* it310 (- 1)) it117 (* it2429 (- 1))) 1) 0))
      (a!5 (> (+ (+ it2431 (* it2429 (- 1))) (- 1)) 0)))
  (and (> it105 0)
       (> it104 0)
       (> it102 0)
       (> (+ it117 1) 0)
       ...
       (>= (+ it2427 (* it102 (- 1))) 0)
       (>= (+ it2428 (* it105 (- 1))) 0)
       (> (+ (* it310 it577 (- 1)) (* it292 it577 (- 1)) it117 (* it2429 (- 1)))
          0)
       (> (+ (* it310 (- 1)) it117 (* it2429 (- 1))) 0)
       (<= (+ it2431 (* it117 (- 1))) 0)
       (>= (+ it2430 (* it102 (- 1))) 0)
       (> it2430 0)
       (>= (+ it2426 (- 6)) 0)
