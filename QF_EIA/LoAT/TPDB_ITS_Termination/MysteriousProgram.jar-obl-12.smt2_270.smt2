...
(assert (let ((a!1 (>= (+ (+ (* it2403 (- 1)) it2401) 1) 0))
      (a!2 (> (+ (+ it776 (* it2341 (- 1))) 1) 0))
      (a!3 (> (+ (+ (* it2403 (- 1)) it2341) 1) 0))
      (a!4 (>= (+ (+ it776 (* it2341 (- 1))) (- 1)) 0))
      (a!5 (>= (+ (+ (* it2403 (- 1)) it2341) (- 1)) 0))
      (a!6 (>= (+ (+ it2403 (* it2401 (- 1))) (- 1)) 0))
      (a!7 (<= (+ (+ (* it2403 (- 1)) it2401) it776 (* it2341 (- 1))) 0))
      (a!8 (<= (+ (+ it2403 (* it2401 (- 1))) (* it776 (- 1)) it2341) 0)))
  (and (<= (+ it2400 (* it778 (- 1))) 0)
       (<= (+ (* it779 (- 1)) it2402) 0)
       a!1
       (>= (+ it2402 (- 1)) 0)
       (>= (+ it2406 (- 1)) 0)
