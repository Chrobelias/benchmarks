...
(assert (let ((a!1 (+ (+ (* it2401 (- 1)) (* it628 (- 1)) it2341) (* it396 (- 1))))
      (a!2 (> (+ (+ it2403 (* it2401 (- 1))) (- 1)) 0))
      (a!3 (>= (+ (+ (* it2401 (- 1)) (* it628 (- 1)) it2341) (- 1)) 0))
      (a!4 (>= (+ (+ (* it2401 (- 1)) (* it628 (- 1)) it2341) (- 2)) 0)))
  (and (> (+ it2401 1) 0)
       (>= (+ it2406 (- 1)) 0)
       (>= (+ (* it2406 (- 1)) it2400) 0)
       (> it2399 0)
