...
(assert (let ((a!1 (> (+ (+ it2543 (* it2541 (- 1))) 1) 0))
      (a!2 (> (+ (+ (* it2543 (- 1)) it776) 1) 0))
      (a!3 (>= (+ (+ it2543 (* it2541 (- 1))) (- 1)) 0))
      (a!4 (>= (+ (+ (* it2543 (- 1)) it776) (- 1)) 0)))
  (and (> it110 0)
       (> it109 0)
       (> (+ it2543 (- 1)) 0)
       (> (+ it2543 1) 0)
       ...
       (>= (+ (* it778 (- 1)) it2544) 0)
       (<= (+ it2540 (* it779 (- 1))) 0)
       (<= (+ (* it2539 (- 1)) it2543 (* it776 (- 1)) it2541) 0)
       (<= (+ it2539 (* it2543 (- 1)) it776 (* it2541 (- 1))) 0)
       (>= (+ it2540 (* it2544 (- 1))) 0)
       (> it2537 0)
       (>= (+ it2538 (* it109 (- 1))) 0)
       (>= (+ (* it2543 (- 1)) it776) 0)
