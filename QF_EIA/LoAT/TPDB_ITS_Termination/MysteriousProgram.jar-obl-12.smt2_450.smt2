...
(assert (let ((a!1 (> (+ (+ it2533 (* it2531 (- 1))) (- 1)) 0))
      (a!2 (+ (* it310 it577 (- 1)) (* it292 it577 (- 1)) it627)))
(let ((a!3 (+ a!2 (* it628 (- 1)) (* it1134 (- 1)) (* it2531 (- 1))))
      (a!4 (>= (+ (+ a!2 (* it1134 (- 1)) (* it2531 (- 1))) (- 1)) 0))
      (a!5 (>= (+ (+ a!2 (* it1134 (- 1)) (* it2531 (- 1))) (- 2)) 0)))
  (and (> it2529 0)
       (>= (+ it2529 (- 1)) 0)
       (>= (+ (* it2535 (- 1)) it2529) 0)
       (> (+ it1134 it2531 1) 0)
       ...
       (= (+ it2533 (* it627 (- 1))) 0)
       (>= (+ (* it2535 (- 1)) it2532) 0)
       (> (+ it627 (* it1134 (- 1)) (* it2531 (- 1))) 0)
       (<= (+ (* it628 (- 1)) (* it1134 (- 1))) 0)
       (> it2533 0)
       (<= (+ it628 it1134) 0)
       (> (+ it627 (* it628 (- 1)) (* it1134 (- 1)) (* it2531 (- 1))) 0)
       (>= (+ it2528 (- 6)) 0)
       (> it2530 0)
       (> (+ it2533 (- 1)) 0)
       (>= (+ a!3 (- 1)) 0)))))
