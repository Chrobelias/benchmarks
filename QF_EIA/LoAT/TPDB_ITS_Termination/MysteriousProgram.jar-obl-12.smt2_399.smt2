...
(assert (let ((a!1 (+ (+ (+ (* it2504 (- 1)) (* it310 (- 1))) it117) 1))
      (a!2 (+ (+ (* it2504 (- 1)) (* it310 (- 1)))
              (* it292 (+ it577 (- 1)) (- 1))
              (* it310 (+ it577 (- 1)) (- 1))
              it117))
      (a!3 (+ (+ (+ (* it2504 (- 1)) (* it310 (- 1))) it117) 2))
      (a!4 (> (+ (* it2504 (- 1))
                 (* it292 (+ it577 (- 1)) (- 1))
                 (* it310 (+ it577 (- 1)) (- 1))
                 it117
                 1)
              0))
      (a!5 (+ (+ (+ (* it2504 (- 1)) (* it310 (- 1))) it117) (* it292 (- 1)) 2))
      (a!6 (>= (+ (+ (* it2504 (- 1)) it117) (- 2)) 0))
      (a!7 (+ (* (+ it1741 (- 1)) it1743 (- 1))
              (* it1742 (- 1))
              (* it117 (- 1))))
      (a!10 (> (+ (+ (* it2504 (- 1)) it117) (- 1)) 0))
      (a!11 (+ (+ (+ (* it1742 (- 1)) (* it117 (- 1))) it1744) 1))
      (a!13 (+ (+ (+ (* it1742 (- 1)) (* it117 (- 1))) it1744) 2))
      (a!14 (> (+ (* (+ it1741 (- 1)) it1743 (- 1))
                  (* it117 (- 1))
                  (* (+ it1741 (- 1)) it1742 (- 1))
                  it1744
                  1)
               0))
      (a!15 (> (+ (+ it2504 (* it2502 (- 1))) (- 1)) 0))
      (a!16 (>= (+ (+ it2504 (* it2502 (- 1))) (- 2)) 0))
      (a!17 (> (+ (+ (* it1742 (- 1)) (* it117 (- 1)))
                  (* it1743 (- 1))
                  it1744
                  2)
               0))
      (a!18 (> (+ (+ (* it2504 (- 1)) it117) 1) 0)))
(let ((a!8 (+ (+ a!7 (* (+ it1741 (- 1)) it1742 (- 1)) it1744) 2))
  ...
  (and (> it105 0)
       ...
       (> a!13 0)
       a!14
       (<= (+ it2504 it117 (* it2502 (- 1)) (* it1744 (- 1))) 0)
       (>= (+ (* it104 (- 1)) it2503) 0)
       a!15
       (>= (+ (* it102 (- 1)) it2503) 0)
       a!16
