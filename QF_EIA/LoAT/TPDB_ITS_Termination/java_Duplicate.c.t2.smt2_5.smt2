...
(assert (= (+ (* (** 2 it115) (+ 0 it97) (+ 0 (- 1))) (+ 0 it122))
   (+ 0 0)))
(assert (= (+ it123 (* it115 (- 1)) (* it98 (- 1))) 0))
(assert (and (= (+ it117 (- 4)) 0) (<= (+ it123 (* it122 (- 1))) 0)))
(assert (= (+ it126 (- 2)) 0))
(assert (= (+ it127 (* it122 (- 1))) 0))
(assert (= (+ (* it123 (- 1)) it128) 0))
(assert (= (+ it129 (* it8 (- 1))) 0))
(assert (= (+ (* it7 (- 1)) it130) 0))
(assert (= (+ (* it8 (- 1)) it131) 0))
(assert (= (+ it132 (* it7 (- 1))) 0))
(check-sat)
