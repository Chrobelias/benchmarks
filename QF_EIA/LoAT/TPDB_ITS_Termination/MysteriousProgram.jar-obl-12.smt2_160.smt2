...
(assert (let ((a!1 (+ (+ it127 (* it2310 (- 1)))
              (* it732 (+ it996 (- 1)) (- 1))
              (* (+ it996 (- 1)) it375 (- 1))))
      (a!2 (> (+ (+ (* it2310 (- 1)) it2312) (- 1)) 0))
      (a!3 (+ (+ it127 (* it2310 (- 1))) (* it996 it732 (- 1))))
      (a!8 (+ (+ (+ it127 (* it2310 (- 1))) (* it732 (- 1)))
              (* it1364 (- 1))
              (* it375 (- 1))
              2))
      (a!9 (> (+ (+ it127 (* it2310 (- 1))) (* it375 (- 1))) 0))
      (a!10 (> (+ (+ it127 (* it2310 (- 1))) (* it1364 (- 1))) 0))
      (a!11 (+ (+ (+ it127 (* it2310 (- 1))) (* it732 (- 1)))
               (* it732 (+ it996 (- 1)) (- 1))
               (* (+ it996 (- 1)) it375 (- 1))
               (* it375 (- 1))
               1))
      (a!12 (> (+ (+ it127 (* it2310 (- 1))) (* it678 (- 1)) (* it1364 (- 1)))
               0))
      (a!13 (+ (+ (+ it127 (* it2310 (- 1))) (* it1364 (- 1))) (- 1)))
      (a!14 (+ (+ (+ it127 (* it2310 (- 1))) (* it732 (- 1))) (* it375 (- 1)) 1))
      (a!15 (+ (+ (+ it127 (* it2310 (- 1))) (* it375 (- 1))) 1)))
(let ((a!4 (> (+ (+ a!1 (* it1364 (- 1))) 1) 0))
      (a!5 (> (+ (+ a!1 (* it375 (- 1))) 1) 0))
      (a!6 (+ (+ (+ a!1 (* it1364 (- 1))) (* it375 (- 1))) 1))
      (a!7 (+ (+ (+ a!1 (* it1364 (- 1))) (* it375 (- 1))) 2)))
  (and (> (+ it127 1) 0)
       (> (+ it127 (- 1)) 0)
       (> (+ a!1 (* it375 (- 1))) 0)
       a!2
       ...
       (> a!1 0)
       (> (+ it2310 it1364 1) 0)
       (> (+ a!3 (* it1364 (- 1)) (* it996 it375 (- 1)) 1) 0)
       (> (+ it2312 (- 1)) 0)
       (= (+ (* it127 (- 1)) it2312) 0)
       a!4
       a!5
