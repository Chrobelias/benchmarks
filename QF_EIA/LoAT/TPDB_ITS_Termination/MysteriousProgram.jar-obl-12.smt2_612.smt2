...
(assert (let ((a!1 (> (+ (+ (* it2593 (- 1)) it2595) (- 1)) 0))
      (a!2 (+ (+ (* it2593 (- 1)) (* it346 (- 1)) it117) (- 1)))
      (a!3 (> (+ (+ (* it2593 (- 1)) (* it346 (- 1)) it117) (* it678 (- 1))) 0))
      (a!4 (> (+ (+ (* it2593 (- 1)) (* it346 (- 1)) it117) 1) 0))
      (a!5 (>= (+ (+ (* it2593 (- 1)) it117) (- 2)) 0))
      (a!6 (>= (+ (+ (* it2593 (- 1)) it117) (- 1)) 0)))
  (and (> (+ it117 1) 0)
       (>= (+ it346 (- 1)) 0)
       (>= (+ (* it2601 (- 1)) it2592) 0)
       (> it2601 0)
