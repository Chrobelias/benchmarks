...
(assert (let ((a!1 (> (+ (+ (* it310 (- 1)) (* it2593 (- 1)) it117) (* it292 (- 1)) 1)
              0))
      (a!2 (+ (* it310 (- 1))
              (* it292 (+ it577 (- 1)) (- 1))
              (* it2593 (- 1))
              (* it310 (+ it577 (- 1)) (- 1))
              it117))
      (a!3 (> (+ (+ (* it310 (- 1)) (* it2593 (- 1)) it117) 1) 0))
      (a!4 (> (+ (* it292 (+ it577 (- 1)) (- 1))
                 (* it2593 (- 1))
                 (* it310 (+ it577 (- 1)) (- 1))
                 it117)
              0))
      (a!5 (> (+ (+ (* it2593 (- 1)) it2595) (- 1)) 0)))
  (and (> it105 0)
       (> it104 0)
       (> it102 0)
       (> (+ it117 1) 0)
       ...
       (>= (+ it2591 (* it102 (- 1))) 0)
       (>= (+ it2594 (* it102 (- 1))) 0)
       (> (+ (* it310 it577 (- 1)) (* it2593 (- 1)) (* it292 it577 (- 1)) it117)
          0)
       (>= (+ it2591 (- 1)) 0)
       (>= (+ (* it104 (- 1)) it2591) 0)
       (= (+ (* it117 (- 1)) it2595) 0)
