...
(assert (let ((a!1 (+ (* it310 it577 (- 1))
      ...
      (a!2 (+ (* it310 (- 1))
              ...
              (* it310 (+ it577 (- 1)) (- 1))
              it117))
      (a!4 (> (+ (+ (* it2593 (- 1)) it117 (* it2494 (- 1))) (* it1571 (- 1)))
              0))
      (a!5 (+ (* it292 (+ it577 (- 1)) (- 1))
              (* it2593 (- 1))
              (* it310 (+ it577 (- 1)) (- 1))
              it117
              (* it2494 (- 1))))
      (a!7 (+ (+ (* it310 (- 1)) (* it2593 (- 1)) it117) (* it2494 (- 1))))
      (a!8 (> (+ (+ (* it2593 (- 1)) it2595) (- 1)) 0))
      (a!9 (>= (+ (+ (* it2593 (- 1)) it2595) (- 2)) 0))
      (a!11 (>= (+ (+ (* it2593 (- 1)) it2595) (- 1)) 0))
      (a!12 (+ (+ (* it310 (- 1)) (* it2593 (- 1)) it117)
               (* it292 (- 1))
               (* it2494 (- 1)))))
(let ((a!3 (> (+ (+ a!2 (* it292 (- 1)) (* it2494 (- 1))) (* it1571 (- 1)) 2) 0))
      (a!6 (> (+ (+ a!2 (* it2494 (- 1))) (* it1571 (- 1)) 1) 0))
      (a!10 (> (+ (+ a!2 (* it2494 (- 1))) 1) 0))
      (a!13 (> (+ (+ a!7 (* it1571 (- 1))) 1) 0))
      (a!14 (> (+ (+ a!2 (* it292 (- 1)) (* it2494 (- 1))) 1) 0))
      (a!15 (> (+ (+ a!7 (* it1571 (- 1))) 2) 0)))
  (and (> it102 0)
       (> (+ it117 1) 0)
       (>= (+ it102 (- 1)) 0)
       (<= (+ (* it117 (- 1)) it2595) 0)
