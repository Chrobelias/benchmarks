...
(declare-fun it2323 () Int)
(declare-fun it2324 () Int)
(declare-fun it2325 () Int)
(declare-fun it2326 () Int)
(declare-fun it2327 () Int)
(declare-fun it2328 () Int)
(declare-fun it2330 () Int)
...
(assert (and (> it140 0)
     ...
     (> (+ it2321 (* it2318 (- 1))) 0)))
(assert (= (+ it2323 (- 10)) 0))
(assert (= (+ (* it140 (- 1)) it2324) 0))
(assert (= (+ (* it2318 (- 1)) it2325) 0))
(assert (= (+ (* it2319 (- 1)) it2326 (- 1)) 0))
(assert (= (+ (* it2319 (- 1)) it2327 (- 1)) 0))
(assert (= (+ (* it127 (- 1)) it2328) 0))
(assert (let ((a!1 (+ (+ (+ (* it2326 (- 1)) (* it732 (- 1))) it2328) 1))
      (a!2 (+ (+ (+ (* it2326 (- 1)) (* it732 (- 1))) it2330) (* it375 (- 1)) 1))
      (a!3 (> (+ (+ (* it2326 (- 1)) (* it732 (- 1))) it2328) 0))
      (a!4 (> (+ (+ (* it2326 (- 1)) (* it732 (- 1))) it2330) 0)))
  (and (> (+ it2330 (- 1)) 0)
       (> (+ it2325 1) 0)
       (> (+ it2328 (- 1)) 0)
       (> a!1 0)
