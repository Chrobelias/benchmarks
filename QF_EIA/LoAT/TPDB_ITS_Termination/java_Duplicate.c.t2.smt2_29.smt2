...
(assert (let ((a!1 (+ (* (+ 0 it224) (** 2 (+ it115 (- 1))) (+ 0 (- 1)))
              (+ 0 it247))))
  (= a!1 (+ 0 0))))
(assert (= (+ (* it115 (- 1)) (* it225 (- 1)) it248 1) 0))
(assert (= (+ it249 (* it222 (- 1))) 0))
(assert (= (+ it250 (* it223 (- 1))) 0))
(assert (= (+ (* (** 2 it115) (+ 0 it224) (+ 0 (- 1))) (+ 0 it251))
   (+ 0 0)))
(assert (= (+ (* it115 (- 1)) it252 (* it225 (- 1))) 0))
(assert (and (<= (+ (* it252 (- 1)) it251 1) 0)
     (= (+ it246 (- 4)) 0)
     (<= (+ (* it251 (- 1)) 3) 0)))
(assert (= (+ it264 (- 4)) 0))
(assert (= (+ it265 (* it251 (- 1))) 0))
(assert (= (+ (* it252 (- 1)) it266) 0))
(assert (= (+ (* it249 (- 1)) it267) 0))
(assert (= (+ it268 (* it250 (- 1))) 0))
(assert (= (+ it269 (* it251 (- 2))) 0))
(assert (= (+ (* it252 (- 1)) it270 (- 1)) 0))
(assert (and (>= (+ (* it269 (- 1)) it270 (- 1)) 0)
     (>= (+ (* it264 (- 1)) 4) 0)
     (>= (+ it269 (- 3)) 0)
     (>= (+ it264 (- 4)) 0)
     (< (+ it269 (- 1)) 0)))
