...
(assert (let ((a!1 (+ (+ (* it2553 (- 1)) (* it628 (- 1))) (* it396 (- 1)) it2560))
      (a!2 (> (+ (+ (* it2553 (- 1)) (* it628 (- 1))) it2560) 0))
      (a!3 (+ (+ (+ (* it2553 (- 1)) (* it628 (- 1))) it2560) (- 2)))
      (a!4 (> (+ (+ it2555 (* it2553 (- 1))) (- 1)) 0))
      (a!5 (+ (+ (+ (* it2553 (- 1)) (* it628 (- 1))) it2560) (- 1))))
  (and (> (+ it2560 1) 0)
       (>= (+ it2551 (- 1)) 0)
       (> it2555 0)
       (> it2552 0)
