...
(assert (let ((a!1 (+ (* it310 (- 1))
              ...
              (* it310 (+ it577 (- 1)) (- 1))
              it117))
      (a!3 (> (+ (+ it2533 (* it2531 (- 1))) (- 1)) 0))
      (a!4 (> (+ (* it292 (+ it577 (- 1)) (- 1))
                 (* it310 (+ it577 (- 1)) (- 1))
                 it117
                 (* it2531 (- 1)))
              0))
      (a!5 (> (+ (+ (* it310 (- 1)) it117) (* it2531 (- 1))) 0))
      (a!6 (+ (+ (+ (* it310 (- 1)) it117) (* it2531 (- 1))) 1))
      (a!7 (> (+ (+ (* it310 (- 1)) it117) (* it292 (- 1)) (* it2531 (- 1)) 1)
              0)))
(let ((a!2 (> (+ (+ a!1 (* it2531 (- 1))) 1) 0)))
  (and (> it105 0)
       (> it104 0)
       (> (+ it117 1) 0)
       (>= (+ it2530 (- 1)) 0)
       ...
       (<= (+ (* it104 (- 1)) it2530) 0)
       (> (+ it2533 (- 1)) 0)
       (> (+ (* it310 it577 (- 1)) (* it292 it577 (- 1)) it117 (* it2531 (- 1)))
          0)
       (> it2535 0)
       (<= (+ it2529 (* it105 (- 1))) 0)
       (> it2533 0)))))
