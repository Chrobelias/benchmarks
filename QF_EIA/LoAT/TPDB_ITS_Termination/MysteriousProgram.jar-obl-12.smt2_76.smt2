...
(assert (let ((a!1 (>= (+ (+ it127 (* it354 (- 1))) (- 2)) 0))
  ...
  (and (> (+ it354 1) 0)
       ...
       (>= (+ it352 (* it107 (- 1))) 0)
       (>= (+ it352 (- 1)) 0))))
(assert (= (+ (* it351 (- 1)) it401) 0))
(assert (= (+ (* it107 (- 1)) it402) 0))
(assert (= (+ it403 (* it107 (- 1))) 0))
(assert (= (+ it404 (* it396 (- 1)) (* it354 (- 1))) 0))
(assert (= (+ (* it107 (- 1)) it405) 0))
(assert (= (+ (* it127 (- 1)) it406) 0))
(assert (let ((a!1 (>= (+ (+ it358 (* it404 (- 1))) (- 2)) 0))
      (a!2 (> (+ (+ it406 (* it404 (- 1))) (- 1)) 0))
      (a!3 (>= (+ (+ it358 (* it404 (- 1))) (- 1)) 0)))
  (and (> it105 0)
       (> it104 0)
       a!1
       (> it403 0)
