...
(assert (let ((a!1 (> (+ (+ (* it2565 (- 1)) it2567) (- 1)) 0))
      (a!2 (>= (+ (+ (* it2565 (- 1)) it2572) (- 1)) 0))
      (a!3 (> (+ (+ (* it2565 (- 1)) (* it346 (- 1)) it2572) 1) 0))
      (a!4 (+ (+ (* it2565 (- 1)) (* it346 (- 1)) it2572) (- 1)))
      (a!5 (> (+ (+ (* it2565 (- 1)) (* it346 (- 1)) it2572) (* it678 (- 1))) 0))
      (a!6 (>= (+ (+ (* it2565 (- 1)) it2572) (- 2)) 0)))
  (and (>= (+ it346 (- 1)) 0)
       (>= (+ (* it2561 (- 1)) it2563) 0)
       (> (+ it2572 (- 1)) 0)
       (= (+ (* it2572 (- 1)) it2567) 0)
       (>= (+ (* it2565 (- 1)) (* it346 (- 1)) it2572) 0)
       (> (+ (* it2565 (- 1)) it2572) 0)
       (>= (+ it2562 (- 6)) 0)
       (> (+ (* it2565 (- 1)) (* it346 (- 1)) it2572) 0)
       a!1
