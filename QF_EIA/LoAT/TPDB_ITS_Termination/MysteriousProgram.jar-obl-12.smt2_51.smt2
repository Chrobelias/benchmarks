...
(assert (and (>= (+ it279 (- 1)) 0)
     ...
     (> (+ (* it281 (- 1)) it283) 0)
     (> (+ (* it281 (- 1)) it117) 0)))
(assert (= (+ it328 (* it278 (- 1))) 0))
(assert (= (+ it329 (* it135 (- 1))) 0))
(assert (= (+ (* it280 (- 1)) it330) 0))
(assert (= (+ it331 (* it310 (- 1)) (* it281 (- 1))) 0))
(assert (= (+ (* it310 (- 1)) (* it281 (- 1)) it332) 0))
(assert (= (+ (* it117 (- 1)) it333) 0))
(assert (let ((a!1 (> (+ (+ (* it331 (- 1)) it336 (* it292 (- 1))) (* it334 (- 1)) 1) 0))
      (a!2 (> (+ (+ (* it331 (- 1)) it333) (* it292 (- 1))) 0))
      (a!3 (+ (+ (+ (* it331 (- 1)) it333) (* it292 (- 1))) 1)))
  (and (> (+ it336 (- 1)) 0)
       (>= (+ it328 (- 9)) 0)
       (> (+ it333 (- 1)) 0)
       (> (+ it333 (* it330 (- 1))) 0)
