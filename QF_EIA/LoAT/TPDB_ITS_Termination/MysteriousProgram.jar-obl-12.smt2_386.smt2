...
(assert (let ((a!1 (+ (+ (* it346 (- 1)) it117 (* it2487 (- 1))) (- 1)))
      (a!2 (> (+ (+ (* it346 (- 1)) it117 (* it2487 (- 1))) 1) 0))
      (a!3 (> (+ (+ (* it2487 (- 1)) it2489) (- 1)) 0))
      (a!4 (>= (+ (+ it117 (* it2487 (- 1))) (- 2)) 0))
      (a!5 (> (+ (+ (* it346 (- 1)) it117 (* it2487 (- 1))) (* it678 (- 1))) 0))
      (a!6 (>= (+ (+ it117 (* it2487 (- 1))) (- 1)) 0)))
  (and (> (+ it117 1) 0)
       (>= (+ it346 (- 1)) 0)
       (>= (+ it2485 (- 1)) 0)
       (<= (+ (* it2492 (- 1)) it2485) 0)
       (>= a!1 0)
       (>= (+ (* it346 (- 1)) it117 (* it2487 (- 1))) 0)
       (>= (+ (* it2484 (- 1)) 6) 0)
       a!2
       a!3
       (> (+ it346 it2487 1) 0)
