...
(assert (let ((a!1 (>= (+ (+ (* it2539 (- 1)) it2543) (- 2)) 0))
      (a!2 (+ (* it2539 (- 1))
              (* it1871 (+ it996 (- 1)) (- 1))
              it2543
              (* (+ it996 (- 1)) it375 (- 1))))
      (a!3 (>= (+ (+ (* it2539 (- 1)) it2541) (- 1)) 0))
      (a!5 (>= (+ (+ (* it1871 (- 1)) (* it2539 (- 1)))
                  it2543
                  (* it375 (- 1))
                  (- 1))
               0))
      (a!6 (>= (+ (+ (* it1871 (- 1)) (* it2539 (- 1)))
                  (* it1871 (+ it996 (- 1)) (- 1))
                  it2543
                  (* (+ it996 (- 1)) it375 (- 1))
                  (* it375 (- 1))
      ...
      (a!7 (>= (+ (+ (* it2539 (- 1)) it2543)
                  ...
                  (- 2))
               0))
      (a!8 (>= (+ (+ (* it2539 (- 1)) it2541) (- 2)) 0))
      (a!9 (+ (+ (+ (* it2539 (- 1)) it2543) (* it375 (- 1))) (- 1)))
      (a!11 (> (+ (+ (* it2539 (- 1)) it2541) (- 1)) 0))
      (a!12 (+ (+ (+ (* it2539 (- 1)) it2543) (* it375 (- 1))) (- 2))))
(let ((a!4 (>= (+ (+ a!2 (* it375 (- 1))) (- 1)) 0))
      (a!10 (>= (+ (+ a!2 (* it375 (- 1))) (- 2)) 0)))
  (and (> it110 0)
       (> it109 0)
       (>= (+ (* it2544 (- 1)) it2538) 0)
       (>= (+ it2536 (- 6)) 0)
