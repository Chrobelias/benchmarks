...
(assert (let ((a!1 (>= (+ (+ it2467 (* it2489 (- 1))) (- 1)) 0))
      (a!2 (>= (+ (+ (* it2467 (- 1)) it776) (- 1)) 0))
      (a!3 (> (+ (+ it2467 (* it2489 (- 1))) 1) 0))
      (a!4 (> (+ (+ (* it2467 (- 1)) it776) 1) 0)))
  (and (>= (+ it2485 (- 1)) 0)
       (>= (+ (* it777 (- 1)) it2492) 0)
       (>= (+ (* it777 (- 1)) it2490) 0)
       (> it2485 0)
       (> it2490 0)
       (<= (+ (* it2487 (- 1)) it2467 it2489 (* it776 (- 1))) 0)
       (<= (+ (* it777 (- 1)) it2485) 0)
       (>= (+ (* it778 (- 1)) it2490) 0)
       (>= (+ it2491 (* it779 (- 1))) 0)
       (>= (+ it2492 (* it779 (- 1))) 0)
       ...
       (>= (+ (* it2467 (- 1)) it2489 1) 0)
       (>= (+ it2491 (* it778 (- 1))) 0)
       (<= (+ it2487 (* it2467 (- 1)) (* it2489 (- 1)) it776) 0)
       (= (+ it2489 (* it776 (- 1))) 0)
       (<= (+ it2486 (* it778 (- 1))) 0)
       (> (+ it776 (- 1)) 0)
       (> it779 0)
