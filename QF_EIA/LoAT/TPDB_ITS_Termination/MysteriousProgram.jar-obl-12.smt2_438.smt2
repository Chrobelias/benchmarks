...
(assert (let ((a!1 (>= (+ (+ (* it2511 (- 1)) it2518) (- 2)) 0))
      (a!2 (> (+ (+ (* it2511 (- 1)) (* it346 (- 1)) it2518) (* it678 (- 1))) 0))
      (a!3 (+ (+ (* it2511 (- 1)) (* it346 (- 1)) it2518) (- 1)))
      (a!4 (> (+ (+ (* it2511 (- 1)) (* it346 (- 1)) it2518) 1) 0))
      (a!5 (> (+ (+ (* it2511 (- 1)) it2513) (- 1)) 0))
      (a!6 (>= (+ (+ (* it2511 (- 1)) it2518) (- 1)) 0)))
  (and (> (+ it2511 1) 0)
       a!1
       (>= (+ it346 (- 1)) 0)
       (> (+ (* it2511 (- 1)) it2518) 0)
       (> (+ (* it2511 (- 1)) (* it346 (- 1)) it2518) 0)
       (>= (+ (* it2507 (- 1)) it2512) 0)
       a!2
       (>= (+ it2510 (- 1)) 0)
       (> it2518 0)
