...
(assert (let ((a!1 (>= (+ (+ it2600 (* it2595 (- 1))) (- 1)) 0))
      (a!2 (>= (+ (+ (* it2600 (- 1)) it776) (- 1)) 0))
      (a!3 (> (+ (+ it2600 (* it2595 (- 1))) 1) 0))
      (a!4 (> (+ (+ (* it2600 (- 1)) it776) 1) 0)))
  (and (> it110 0)
       (> it109 0)
       (>= (+ it2600 (* it2595 (- 1))) 0)
       (> it2591 0)
       (>= (+ it2590 (- 6)) 0)
       a!1
       (<= (+ (* it2593 (- 1)) it2600 (* it776 (- 1)) it2595) 0)
       (>= (+ (* it777 (- 1)) it2601) 0)
       (>= (+ (* it110 (- 1)) it2594) 0)
       (>= (+ it2593 (* it2595 (- 1)) 1) 0)
       (>= (+ (* it779 (- 1)) it2601) 0)
       ...
       (>= (+ it2594 (* it109 (- 1))) 0)
       (>= (+ (* it2600 (- 1)) it2595 1) 0)
       (<= (+ it2593 (* it2600 (- 1)) it776 (* it2595 (- 1))) 0)
       (> it2601 0)
       (>= (+ it2594 (* it2601 (- 1))) 0)
       (> it2594 0))))
(check-sat)
