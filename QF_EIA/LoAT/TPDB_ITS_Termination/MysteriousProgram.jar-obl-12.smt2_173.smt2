...
(assert (let ((a!1 (+ (+ (* it2310 (- 1)) it1133) (* it996 it732 (- 1))))
      (a!3 (> (+ (+ (* it2310 (- 1)) it1133) (* it1571 (- 1))) 0))
      (a!5 (> (+ (+ (* it2310 (- 1)) it2312) (- 1)) 0))
      (a!6 (+ (+ (* it2310 (- 1)) it1133) (* it1134 (- 1)) (* it1571 (- 1)))))
(let ((a!2 (>= (+ (+ a!1 (* it996 it375 (- 1)) (* it1571 (- 1))) (- 1)) 0))
      (a!4 (+ a!1 (* it1134 (- 1)) (* it996 it375 (- 1)) (* it1571 (- 1))))
      (a!7 (>= (+ (+ a!1 (* it996 it375 (- 1)) (* it1571 (- 1))) (- 2)) 0)))
  (and (> it107 0)
       a!2
       (<= (+ (* it107 (- 1)) it2309) 0)
       (>= (+ it996 (- 1)) 0)
