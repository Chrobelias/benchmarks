...
(assert (let ((a!1 (+ it127 (* it1871 (+ it996 (- 1)) (- 1)) (* it2310 (- 1))))
      (a!3 (+ (+ (+ (* it1871 (- 1)) it127) (* it2310 (- 1)))
              (* it1872 (- 1))
              (* it375 (- 1))))
      (a!6 (> (+ (+ (* it2310 (- 1)) it2312) (- 1)) 0))
      (a!7 (>= (+ (+ it127 (* it2310 (- 1))) (- 2)) 0))
      (a!8 (+ (+ (* it1871 (- 1)) it127)
              (* it1871 (+ it996 (- 1)) (- 1))
              (* it2310 (- 1))))
      (a!10 (>= (+ (+ it127 (* it2310 (- 1)))
                   ...
                   (- 2))
                0))
      (a!11 (>= (+ (+ (* it2310 (- 1)) it2312) (- 1)) 0))
      (a!12 (+ (+ (+ it127 (* it2310 (- 1))) (* it375 (- 1))) (- 1)))
      (a!13 (> (+ (+ it127 (* it2310 (- 1))) (* it1872 (- 1))) 0))
      (a!14 (>= (+ (+ (* it2310 (- 1)) it2312) (- 2)) 0))
      (a!16 (+ (+ (+ it127 (* it2310 (- 1))) (* it1872 (- 1)))
               (* it996 it375 (- 1))
               (* it1871 it996 (- 1))
               (- 1)))
      (a!17 (+ (+ (+ it127 (* it2310 (- 1))) (* it1872 (- 1))) (- 1)))
      (a!18 (+ (+ (+ it127 (* it2310 (- 1))) (* it1872 (- 1)))
               (* it375 (- 1))
               (- 1)))
      (a!19 (+ (+ (+ (* it1871 (- 1)) it127) (* it2310 (- 1)))
               (* it375 (- 1))
               (- 1)))
      (a!20 (>= (+ (+ it127 (* it2310 (- 1))) (* it1872 (- 1))) 0))
      (a!21 (+ (+ (+ it127 (* it2310 (- 1))) (* it375 (- 1))) (- 2))))
(let ((a!2 (+ (+ a!1 (* (+ it996 (- 1)) it375 (- 1))) (* it375 (- 1))))
      (a!4 (+ a!1 (* it1872 (- 1)) (* (+ it996 (- 1)) it375 (- 1))))
      (a!5 (+ (+ a!1 (* (+ it996 (- 1)) it375 (- 1))) (- 2)))
      (a!9 (>= (+ a!8 (* (+ it996 (- 1)) it375 (- 1)) (* it375 (- 1)) (- 1)) 0))
      (a!15 (>= (+ a!8
                   (* it1872 (- 1))
                   (* (+ it996 (- 1)) it375 (- 1))
                   (* it375 (- 1)))
