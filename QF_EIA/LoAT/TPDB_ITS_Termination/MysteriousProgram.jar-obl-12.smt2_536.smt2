...
(assert (let ((a!1 (+ (+ (* it2565 (- 1)) (* it1908 (- 1))) (* it396 (- 1)) it2560))
      (a!2 (+ (+ (+ (* it2565 (- 1)) (* it1908 (- 1))) it2567) (- 1)))
      (a!3 (+ (+ (+ (* it2565 (- 1)) (* it1908 (- 1))) it2560) (- 2)))
      (a!4 (> (+ (+ (* it2565 (- 1)) (* it1908 (- 1))) it2567) 0))
      (a!5 (> (+ (+ (* it2565 (- 1)) (* it1908 (- 1))) it2560) 0))
      (a!6 (> (+ (+ (* it2565 (- 1)) it2567) (- 1)) 0))
      (a!7 (+ (+ (+ (* it2565 (- 1)) (* it1908 (- 1))) it2560) (- 1))))
  (and (> it2563 0)
       (<= (+ (* it1908 (- 1)) (* it396 (- 1))) 0)
       (> (+ (* it2565 (- 1)) it2567) 0)
       (<= (+ it1908 it396) 0)
