...
(assert (let ((a!1 (+ (* it732 (+ it2558 (- 1)) (- 1)) (* it2565 (- 1))))
      ...
      (a!5 (> (+ (+ (* it2565 (- 1)) it2567) (- 1)) 0))
      (a!6 (> (+ (* it732 (+ it2558 (- 1)) (- 1))
                 (* it732 (- 1))
                 (* it2565 (- 1))
                 (* it2559 (- 1))
                 it2560
                 ...
                 1)
              0)))
(let ((a!2 (+ a!1 (* it2559 (- 1)) it2560 (* (+ it2558 (- 1)) it2559 (- 1))))
      (a!3 (> (+ a!1 it2560 (* (+ it2558 (- 1)) it2559 (- 1))) 0)))
  (and (> it110 0)
       (> it109 0)
       (>= (+ it2559 (- 1)) 0)
       (> (+ it2565 1) 0)
       ...
       (>= (+ it2564 (* it110 (- 1))) 0)
       (> (+ it2560 (- 1)) 0)
       (> (+ (* it732 (- 1)) (* it2565 (- 1)) (* it2559 (- 1)) it2560 1) 0)
       (>= (+ it2562 (- 6)) 0)
       (> (+ it2567 (- 1)) 0)
       (> (+ (* it2558 it2559 (- 1))
             (* it2565 (- 1))
