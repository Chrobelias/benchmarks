...
(declare-fun it2529 () Int)
(declare-fun it2530 () Int)
...
(declare-fun it2538 () Int)
(declare-fun it2539 () Int)
...
(assert (let ((a!1 (> (+ (+ (* it2310 (- 1)) it2312) (- 1)) 0)))
  (and (> it102 0)
       (>= (+ it102 (- 1)) 0)
       (>= (+ it2308 (- 1)) 0)
       (> it2308 0)
       ...
       (>= (+ (* it2307 (- 1)) 6) 0)
       (>= (+ it2311 (- 1)) 0))))
(assert (= (+ (* it2307 (- 1)) it2528) 0))
(assert (= (+ it2529 (* it102 (- 1))) 0))
(assert (= (+ it2530 (* it102 (- 1))) 0))
(assert (= (+ (* it2310 (- 1)) (* it1908 (- 1)) it2531) 0))
(assert (= (+ it2532 (* it102 (- 1))) 0))
(assert (= (+ it2533 (* it2312 (- 1))) 0))
(assert (let ((a!1 (>= (+ (+ it127 (* it2531 (- 1))) (- 1)) 0))
      (a!2 (> (+ (+ it2533 (* it2531 (- 1))) (- 1)) 0))
      (a!3 (> (+ (+ it127 (* it2531 (- 1))) (* it396 (- 1))) 0))
      (a!4 (>= (+ (+ it127 (* it2531 (- 1))) (- 2)) 0))
      (a!5 (+ (+ (+ it127 (* it2531 (- 1))) (* it396 (- 1))) (- 1)))
      (a!6 (>= (+ (+ it127 (* it2531 (- 1))) (* it396 (- 1))) 0)))
  (and (> it107 0)
       (> (+ it127 1) 0)
       (> (+ it127 (- 1)) 0)
       (> (+ it2533 (* it2531 (- 1))) 0)
       ...
       a!6
       (>= (+ it2530 (- 1)) 0))))
(assert (= (+ it2536 (* it2528 (- 1))) 0))
(assert (= (+ (* it107 (- 1)) it2537) 0))
(assert (= (+ (* it107 (- 1)) it2538) 0))
(assert (= (+ it2539 (* it2531 (- 1)) (* it396 (- 1))) 0))
(assert (= (+ (* it107 (- 1)) it2540) 0))
(assert (= (+ (* it127 (- 1)) it2541) 0))
(assert (let ((a!1 (+ (+ (+ (* it310 (- 1)) it117) (* it2541 (- 1))) 1))
      (a!2 (+ (* it310 (- 1))
              (* it292 (+ it577 (- 1)) (- 1))
              (* it310 (+ it577 (- 1)) (- 1))
              it117))
      (a!5 (>= (+ (+ (* it2539 (- 1)) it2541) (- 2)) 0))
      (a!6 (> (+ (+ it117 (* it2541 (- 1))) 1) 0))
      (a!7 (> (+ (+ (* it2539 (- 1)) it2541) (- 1)) 0))
      (a!8 (> (+ (* it292 (+ it577 (- 1)) (- 1))
                 (* it310 (+ it577 (- 1)) (- 1))
                 it117
                 (* it2541 (- 1))
                 1)
              0))
      (a!9 (> (+ (+ it117 (* it2541 (- 1))) (- 1)) 0))
      (a!10 (+ (* (+ it1741 (- 1)) it1743 (- 1))
               (* it1742 (- 1))
               (* it117 (- 1))))
      (a!13 (+ (+ (+ (* it1742 (- 1)) (* it117 (- 1))) it1744) 1))
      (a!15 (+ (+ (+ (* it1742 (- 1)) (* it117 (- 1))) it1744) 2))
      (a!16 (> (+ (* (+ it1741 (- 1)) it1743 (- 1))
                  (* it117 (- 1))
                  (* (+ it1741 (- 1)) it1742 (- 1))
                  it1744
                  1)
               0))
      (a!17 (> (+ (+ (* it310 (- 1)) it117) (* it292 (- 1)) (* it2541 (- 1)) 2)
               0))
      (a!18 (>= (+ (+ it117 (* it2541 (- 1))) (- 2)) 0))
      (a!19 (> (+ (+ (* it1742 (- 1)) (* it117 (- 1)))
                  (* it1743 (- 1))
                  it1744
                  2)
               0))
      (a!20 (+ (+ (+ (* it310 (- 1)) it117) (* it2541 (- 1))) 2)))
(let ((a!3 (> (+ (+ a!2 (* it2541 (- 1))) 2) 0))
      (a!4 (> (+ (+ a!2 (* it2541 (- 1))) 1) 0))
      (a!11 (+ (+ a!10 (* (+ it1741 (- 1)) it1742 (- 1)) it1744) 2))
      (a!12 (> (+ a!10
                  (* it1743 (- 1))
                  (* (+ it1741 (- 1)) it1742 (- 1))
                  it1744
                  2)
               0))
      (a!14 (+ (+ a!10 (* (+ it1741 (- 1)) it1742 (- 1)) it1744) 1)))
  (and (> it105 0)
       (> it104 0)
       (> (+ it117 1) 0)
       (> a!1 0)
       ...
       (> (+ (* it2539 (- 1)) it2541) 0)
       (> it2540 0)
       (<= (+ (* it2539 (- 1)) it117 it2541 (* it1744 (- 1))) 0)
       (> it117 0)
       (>= (+ it1741 (- 1)) 0)
       (> (+ it1744 (- 1)) 0)
       (> (+ (* it117 (- 1)) it1744 1) 0)
