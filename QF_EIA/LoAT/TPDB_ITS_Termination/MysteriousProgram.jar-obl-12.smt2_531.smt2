...
(assert (let ((a!1 (+ (* it310 (- 1))
              (* it292 (+ it577 (- 1)) (- 1))
              (* it310 (+ it577 (- 1)) (- 1))
              it117
              (* it2553 (- 1))))
      (a!2 (+ (+ (* it310 (- 1)) it117 (* it2553 (- 1))) (* it1571 (- 1))))
      (a!3 (+ (* it292 (+ it577 (- 1)) (- 1))
              (* it310 (+ it577 (- 1)) (- 1))
              it117
              (* it2553 (- 1))))
      (a!5 (> (+ (+ it117 (* it2553 (- 1))) (* it1571 (- 1))) 0))
      (a!6 (+ (* it310 it577 (- 1))
              (* it292 it577 (- 1))
              it117
              (* it2553 (- 1))))
      (a!8 (+ (+ (* it310 (- 1)) it117 (* it2553 (- 1))) (* it292 (- 1))))
      (a!9 (> (+ (+ it2555 (* it2553 (- 1))) (- 1)) 0))
      (a!10 (> (+ (+ (* it310 (- 1)) it117 (* it2553 (- 1))) 1) 0)))
(let ((a!4 (> (+ (+ a!1 (* it292 (- 1))) 1) 0))
      (a!7 (> (+ (+ a!1 (* it292 (- 1))) (* it1571 (- 1)) 2) 0)))
  (and (> it102 0)
       (> (+ it117 1) 0)
       (> (+ it2555 (* it2553 (- 1))) 0)
       (> a!1 0)
