...
(assert (let ((a!1 (+ (* it310 (- 1))
              ...
              (* it310 (+ it577 (- 1)) (- 1))
              it117))
      (a!3 (> (+ (+ (* it310 (- 1)) it117) (* it292 (- 1)) (* it2312 (- 1)) 2)
              0))
      (a!4 (+ (+ (+ (* it310 (- 1)) it117) (* it2312 (- 1))) 1))
      (a!5 (> (+ (+ it117 (* it2312 (- 1))) 1) 0))
      (a!6 (+ (+ (+ (* it310 (- 1)) it117) (* it2312 (- 1))) 2))
      (a!7 (>= (+ (+ (* it2310 (- 1)) it2312) (- 2)) 0))
      (a!8 (> (+ (* it292 (+ it577 (- 1)) (- 1))
                 (* it310 (+ it577 (- 1)) (- 1))
                 it117
                 (* it2312 (- 1))
      ...
      (a!15 (> (+ (* (+ it1741 (- 1)) it1743 (- 1))
                  ...
                  1)
               0))
      (a!16 (> (+ (+ (* it2310 (- 1)) it2312) (- 1)) 0))
      (a!17 (> (+ (+ it117 (* it2312 (- 1))) (- 1)) 0))
      (a!18 (>= (+ (+ it117 (* it2312 (- 1))) (- 2)) 0))
      (a!20 (> (+ (+ (* it1742 (- 1)) (* it117 (- 1)))
                  (* it1743 (- 1))
                  it1744
                  2)
               0)))
(let ((a!2 (> (+ (+ a!1 (* it2312 (- 1))) 2) 0))
      (a!10 (+ (+ a!9 (* (+ it1741 (- 1)) it1742 (- 1)) it1744) 2))
      (a!11 (> (+ a!9
                  (* it1743 (- 1))
                  (* (+ it1741 (- 1)) it1742 (- 1))
                  it1744
                  2)
               0))
      (a!13 (+ (+ a!9 (* (+ it1741 (- 1)) it1742 (- 1)) it1744) 1))
      (a!19 (> (+ (+ a!1 (* it2312 (- 1))) 1) 0)))
  (and (> it105 0)
       (> it104 0)
       (> it102 0)
       (> (+ it117 1) 0)
       ...
       (>= (+ it2311 (* it105 (- 1))) 0)
       (<= (+ (* it1745 (- 1)) it2308) 0)
       (> (+ a!1 (* it292 (- 1)) (* it2312 (- 1)) 2) 0)
       a!2
       (<= (+ it2312 (* it1744 (- 1))) 0)
       (<= (+ (* it1746 (- 1)) it2309) 0)
       (<= (+ (* it2310 (- 1)) it117 it2312 (* it1744 (- 1))) 0)
       a!3
       (= (+ it2312 (* it1744 (- 1))) 0)
       (>= (+ (* it102 (- 1)) it2309) 0)
       (<= (+ it2311 (* it1747 (- 1))) 0)
