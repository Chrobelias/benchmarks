...
(assert (let ((a!1 (> (+ (+ (* it310 (- 1)) (* it2533 (- 1)) it117) 1) 0))
      (a!2 (>= (+ (+ (* it2533 (- 1)) it117) (- 2)) 0))
      (a!3 (+ (* it310 (- 1))
              (* it292 (+ it577 (- 1)) (- 1))
              (* it310 (+ it577 (- 1)) (- 1))
              (* it2533 (- 1))
              it117))
      (a!4 (> (+ (+ (* it310 (- 1)) (* it2533 (- 1)) it117) 2) 0))
      (a!5 (> (+ (* it292 (+ it577 (- 1)) (- 1))
                 (* it310 (+ it577 (- 1)) (- 1))
                 (* it2533 (- 1))
                 it117
                 1)
              0))
      (a!6 (>= (+ (+ it2533 (* it2531 (- 1))) (- 2)) 0))
      (a!7 (+ (* (+ it1741 (- 1)) it1743 (- 1))
              (* it1742 (- 1))
              (* it117 (- 1))))
      (a!10 (> (+ (+ (* it310 (- 1)) (* it2533 (- 1)) it117) (* it292 (- 1)) 2)
               0))
      (a!11 (+ (+ (+ (* it1742 (- 1)) (* it117 (- 1))) it1744) 1))
      (a!12 (> (+ (+ it2533 (* it2531 (- 1))) (- 1)) 0))
      (a!14 (> (+ (+ (* it2533 (- 1)) it117) (- 1)) 0))
      ...
      (a!16 (> (+ (* (+ it1741 (- 1)) it1743 (- 1))
                  ...
                  1)
               0))
      (a!17 (> (+ (+ (* it1742 (- 1)) (* it117 (- 1)))
                  (* it1743 (- 1))
                  it1744
                  2)
               0))
      (a!18 (> (+ (+ (* it2533 (- 1)) it117) 1) 0)))
(let ((a!8 (+ (+ a!7 (* (+ it1741 (- 1)) it1742 (- 1)) it1744) 2))
      (a!9 (> (+ a!7
                 ...
                 2)
              0))
      (a!13 (+ (+ a!7 (* (+ it1741 (- 1)) it1742 (- 1)) it1744) 1)))
  (and (> it105 0)
       (> it104 0)
       (> (+ it117 1) 0)
       a!1
       ...
       (>= (+ it2535 (* it1745 (- 1))) 0)
       (> (+ a!3 1) 0)
       (<= (+ it2533 it117 (* it2531 (- 1)) (* it1744 (- 1))) 0)
       a!17
       (>= (+ it105 (* it1747 (- 1))) 0)
       (>= (+ it1742 (- 1)) 0)
       (> (+ it2533 (* it2531 (- 1))) 0)
