...
(assert (let ((a!1 (+ (+ it127 (* it2533 (- 1)))
              (* it732 (+ it996 (- 1)) (- 1))
              (* (+ it996 (- 1)) it375 (- 1))))
      (a!3 (+ (+ (+ it127 (* it2533 (- 1))) (* it375 (- 1))) 1))
      (a!4 (> (+ (+ it127 (* it732 (- 1)) (* it2533 (- 1)))
                 (* it732 (+ it996 (- 1)) (- 1))
                 (* (+ it996 (- 1)) it375 (- 1))
                 (* it375 (- 1))
                 2)
              0))
      (a!5 (>= (+ (+ it2533 (* it2531 (- 1))) (- 2)) 0))
      (a!6 (> (+ (+ it2533 (* it2531 (- 1))) (- 1)) 0))
      (a!7 (+ (* it127 (- 1)) (* it1055 (+ it1053 (- 1)) (- 1))))
      (a!9 (> (+ (+ (* it127 (- 1)) (* it1054 (- 1)))
                 (* it1055 (+ it1053 (- 1)) (- 1))
                 (* it1055 (- 1))
                 (* it1054 (+ it1053 (- 1)) (- 1))
                 it1056
                 2)
              0))
      (a!10 (> (+ (+ (* it127 (- 1)) (* it1055 (- 1)) it1056) 2) 0))
      (a!11 (> (+ (+ (* it127 (- 1)) (* it1054 (- 1)))
                  (* it1055 (- 1))
                  it1056
                  2)
               0))
      (a!12 (> (+ (+ (* it127 (- 1)) (* it1055 (- 1)) it1056) 1) 0))
      (a!14 (> (+ (+ it127 (* it2533 (- 1)))
                  (* it996 it732 (- 1))
                  (* it996 it375 (- 1))
                  1)
               0))
      (a!15 (> (+ (+ it127 (* it732 (- 1)) (* it2533 (- 1))) (* it375 (- 1)) 2)
               0))
      (a!16 (> (+ (+ it127 (* it2533 (- 1))) (- 1)) 0))
      (a!18 (+ (+ (+ it127 (* it2533 (- 1))) (* it375 (- 1))) 2))
      (a!19 (>= (+ (+ it127 (* it2533 (- 1))) (- 2)) 0))
      (a!20 (> (+ (+ it127 (* it2533 (- 1))) 1) 0)))
(let ((a!2 (> (+ (+ a!1 (* it375 (- 1))) 1) 0))
      (a!8 (+ a!7 (* it1055 (- 1)) (* it1054 (+ it1053 (- 1)) (- 1)) it1056))
      (a!13 (> (+ a!7 (* it1054 (+ it1053 (- 1)) (- 1)) it1056 1) 0))
      (a!17 (> (+ (+ a!1 (* it375 (- 1))) 2) 0)))
  (and (> it110 0)
       (> it109 0)
       (> (+ it127 1) 0)
       (>= (+ it2528 (- 6)) 0)
       ...
       (>= (+ it375 (- 1)) 0)
       (> it2530 0)
       (<= (+ it127 it2533 (* it1056 (- 1)) (* it2531 (- 1))) 0)
       (>= (+ it127 (- 1)) 0)
       (>= (+ it110 (- 1)) 0)
       (>= (+ it2533 (- 1)) 0)
       (>= (+ it2532 (* it110 (- 1))) 0)
