...
(assert (let ((a!1 (>= (+ (+ (* it2539 (- 1)) it117) (- 2)) 0))
      (a!2 (> (+ (+ (* it2539 (- 1)) (* it346 (- 1)) it117) 1) 0))
      (a!3 (>= (+ (+ (* it2539 (- 1)) it117) (- 1)) 0))
      (a!4 (> (+ (+ (* it2539 (- 1)) (* it346 (- 1)) it117) (* it678 (- 1))) 0))
      (a!5 (> (+ (+ (* it2539 (- 1)) it2541) (- 1)) 0))
      (a!6 (+ (+ (* it2539 (- 1)) (* it346 (- 1)) it117) (- 1))))
  (and (> (+ it117 1) 0)
       (> (+ it2539 1) 0)
       (<= (+ (* it2544 (- 1)) it2538) 0)
       (>= (+ it346 (- 1)) 0)
       (>= (+ (* it2539 (- 1)) (* it346 (- 1)) it117) 0)
       (>= (+ it2540 (* it2544 (- 1))) 0)
       (>= (+ it2537 (- 1)) 0)
       a!1
       (>= (+ it2540 (- 1)) 0)
