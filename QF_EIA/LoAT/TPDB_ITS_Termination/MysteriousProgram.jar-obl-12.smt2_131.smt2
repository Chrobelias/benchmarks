...
(declare-fun it2258 () Int)
(declare-fun it2261 () Int)
(declare-fun it2262 () Int)
(declare-fun it2263 () Int)
(declare-fun it2264 () Int)
(declare-fun it2259 () Int)
(declare-fun it2265 () Int)
(declare-fun it2260 () Int)
(declare-fun it2266 () Int)
(declare-fun it2267 () Int)
...
(assert (and (> it2252 0)
     ...
     (> (+ it2254 (- 1)) 0)))
(assert (= (+ it2261 (- 4)) 0))
(assert (= (+ (* it2258 (- 1)) it2262) 0))
(assert (= (+ (* it2253 (- 1)) it2263 (- 1)) 0))
(assert (= (+ it2264 (* it2254 (- 1))) 0))
(assert (= (+ it2265 (* it2259 (- 1))) 0))
(assert (= (+ it2266 (* it2260 (- 1))) 0))
(assert (and (>= (+ (* it2261 (- 1)) 4) 0)
     (>= (+ it2262 (* it2267 (- 1))) 0)
     (<= (+ it2262 (* it2267 (- 1))) 0)
     (> (+ it2264 (* it2263 (- 1))) 0)
     (> (+ it2264 (- 1)) 0)
