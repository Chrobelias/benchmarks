...
(assert (and (<= (+ it2184 (* it2178 (- 1))) 0)
     ...
     (> (+ it2180 (* it2179 (- 1))) 0)))
(assert (= (+ it2187 (- 3)) 0))
(assert (= (+ (* it2184 (- 1)) it2188) 0))
(assert (= (+ (* it2179 (- 1)) it2189 (- 1)) 0))
(assert (= (+ (* it2180 (- 1)) it2190) 0))
(assert (= (+ it2191 (* it2185 (- 1))) 0))
(assert (= (+ (* it2186 (- 1)) it2192) 0))
(assert (and (> (+ it2190 1) 0)
     (>= (+ (* it2187 (- 1)) 3) 0)
     (>= (+ (* it2193 (- 1)) it2188) 0)
     (<= (+ (* it2193 (- 1)) it2188) 0)
     (> (+ it2189 1) 0)
