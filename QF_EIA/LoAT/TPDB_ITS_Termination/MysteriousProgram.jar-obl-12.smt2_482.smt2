...
(assert (let ((a!1 (+ (+ (* it2539 (- 1)) it2543)
              (* it732 (+ it996 (- 1)) (- 1))
              (* (+ it996 (- 1)) it375 (- 1))))
      (a!4 (> (+ (+ (* it2539 (- 1)) it2543) (* it1364 (- 1))) 0))
      (a!5 (+ (+ (* it2539 (- 1)) it2543) (* it996 it732 (- 1))))
      (a!6 (+ (+ (+ (* it2539 (- 1)) it2543) (* it1364 (- 1))) (- 1)))
      (a!7 (> (+ (+ (* it2539 (- 1)) (* it732 (- 1)) it2543)
                 (* it1364 (- 1))
                 (* it375 (- 1))
                 2)
              0))
      (a!8 (> (+ (+ (* it2539 (- 1)) it2543) (* it375 (- 1))) 0))
      (a!10 (> (+ (+ (* it2539 (- 1)) (* it732 (- 1)) it2543)
                  (* it732 (+ it996 (- 1)) (- 1))
                  (* (+ it996 (- 1)) it375 (- 1))
                  (* it375 (- 1))
                  1)
               0))
      (a!11 (> (+ (+ (* it2539 (- 1)) it2541) (- 1)) 0))
      (a!12 (> (+ (+ (* it2539 (- 1)) (* it732 (- 1)) it2543) (* it375 (- 1)) 1)
               0))
      (a!14 (+ (+ (+ (* it2539 (- 1)) it2543) (* it375 (- 1))) 1))
      (a!15 (> (+ (+ (* it2539 (- 1)) it2543) (* it678 (- 1)) (* it1364 (- 1)))
               0)))
(let ((a!2 (> (+ (+ a!1 (* it1364 (- 1))) 1) 0))
      (a!3 (+ (+ (+ a!1 (* it1364 (- 1))) (* it375 (- 1))) 1))
      (a!9 (> (+ (+ a!1 (* it375 (- 1))) 1) 0))
      (a!13 (+ (+ (+ a!1 (* it1364 (- 1))) (* it375 (- 1))) 2)))
  (and (>= (+ (* it2536 (- 1)) 6) 0)
       a!2
       (> a!1 0)
       (>= (+ it996 (- 1)) 0)
       ...
       a!9
       (>= (+ it2540 (- 1)) 0)
       (> (+ a!5 (* it1364 (- 1)) (* it996 it375 (- 1)) 1) 0)
       a!10
       (>= (+ it1364 (- 1)) 0)
       (>= (+ (* it1416 (- 1)) it2538) 0)
       a!11
