...
(assert (let ((a!1 (+ it127
      ...
      (a!4 (> (+ (+ it127 (* it732 (- 1)))
                 ...
                 2)
              0))
      (a!5 (+ (* it127 (- 1)) (* it1055 (+ it1053 (- 1)) (- 1))))
      (a!7 (> (+ (+ (* it127 (- 1)) (* it1054 (- 1)))
                 (* it1055 (+ it1053 (- 1)) (- 1))
                 (* it1055 (- 1))
                 (* it1054 (+ it1053 (- 1)) (- 1))
                 it1056
                 2)
              0))
      (a!8 (> (+ (+ (* it127 (- 1)) (* it1055 (- 1)) it1056) 2) 0))
      (a!9 (> (+ (+ (* it127 (- 1)) (* it1054 (- 1))) (* it1055 (- 1)) it1056 2)
              0))
      (a!10 (> (+ (+ (* it127 (- 1)) (* it1055 (- 1)) it1056) 1) 0))
      (a!11 (+ (+ (+ it127 (* it2587 (- 1))) (* it375 (- 1))) 1))
      (a!13 (> (+ (+ it127 (* it732 (- 1))) (* it2587 (- 1)) (* it375 (- 1)) 2)
               0))
      (a!14 (> (+ (+ it127 (* it2587 (- 1)))
                  (* it996 it732 (- 1))
                  (* it996 it375 (- 1))
                  1)
               0))
      (a!15 (>= (+ (+ (* it2585 (- 1)) it2587) (- 2)) 0))
      (a!16 (>= (+ (+ it127 (* it2587 (- 1))) (- 2)) 0))
      (a!17 (> (+ (+ (* it2585 (- 1)) it2587) (- 1)) 0))
      (a!18 (> (+ (+ it127 (* it2587 (- 1))) (- 1)) 0))
      (a!19 (> (+ (+ it127 (* it2587 (- 1))) 1) 0)))
(let ((a!2 (> (+ (+ a!1 (* it375 (- 1))) 1) 0))
      (a!6 (+ a!5 (* it1055 (- 1)) (* it1054 (+ it1053 (- 1)) (- 1)) it1056))
      (a!12 (> (+ a!5 (* it1054 (+ it1053 (- 1)) (- 1)) it1056 1) 0))
      (a!20 (> (+ (+ a!1 (* it375 (- 1))) 2) 0)))
  (and (> it110 0)
       (> it109 0)
       (> (+ it127 1) 0)
       a!2
       ...
       (<= (+ (* it1057 (- 1)) it2583) 0)
       (> (+ it127 (* it2587 (- 1))) 0)
       (<= (+ it127 (* it2585 (- 1)) it2587 (* it1056 (- 1))) 0)
       (>= (+ it2586 (- 1)) 0)
       (<= (+ it2587 (* it1056 (- 1))) 0)
       (> a!3 0)
       a!4
