...
(assert (let ((a!1 (+ (+ (+ (* it2565 (- 1)) (* it346 (- 1))) it2560) (- 2)))
      (a!2 (+ (+ (* it2565 (- 1)) (* it346 (- 1))) (* it396 (- 1)) it2560))
      (a!3 (> (+ (+ (* it2565 (- 1)) it2567) (- 1)) 0))
      (a!4 (+ (+ (+ (* it2565 (- 1)) (* it346 (- 1))) it2560) (- 1)))
      (a!5 (> (+ (+ (* it2565 (- 1)) (* it346 (- 1))) it2560) 0)))
  (and (>= (+ it2564 (* it2561 (- 1))) 0)
       (>= (+ it346 (- 1)) 0)
       (> it2563 0)
       (>= (+ it2561 (- 1)) 0)
       (> (+ it2565 it346 1) 0)
