...
(assert (let ((a!1 (> (+ (+ it2506 (* it2513 (- 1))) 1) 0))
      (a!2 (>= (+ (+ it2506 (* it2513 (- 1))) (- 1)) 0))
      (a!3 (>= (+ (+ (* it2506 (- 1)) it776) (- 1)) 0))
      (a!4 (> (+ (+ (* it2506 (- 1)) it776) 1) 0)))
  (and (> it110 0)
       (> it109 0)
       (> (+ it2513 1) 0)
       (>= (+ (* it2511 (- 1)) it2513 (- 1)) 0)
       ...
       (> (+ it2506 1) 0)
       (> it2513 0)
       (<= (+ (* it2511 (- 1)) it2506 (* it776 (- 1)) it2513) 0)
       (> it2512 0)
       (> it2509 0)
       (> (+ it2506 (- 1)) 0)
       (>= (+ it2508 (- 6)) 0)
       ...
       (>= (+ (* it778 (- 1)) it109) 0)
       (>= (+ it2509 (* it109 (- 1))) 0)
       (<= (+ it2511 (* it2506 (- 1)) it776 (* it2513 (- 1))) 0)
       (= 0 0)
       (>= (+ it2510 (- 1)) 0)
       (>= (+ it2510 (* it109 (- 1))) 0)
       (>= (+ it2511 (* it2513 (- 1)) 1) 0)
