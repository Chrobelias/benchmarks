...
(assert (let ((a!1 (+ (+ (+ (* it2565 (- 1)) it2572) (* it2570 (- 1))) 1))
      (a!2 (> (+ (+ (* it2565 (- 1)) it2567) (- 1)) 0))
      (a!3 (> (+ (+ (* it2565 (- 1)) it2572) (* it2570 (- 1))) 0))
      (a!4 (> (+ (* (+ it2569 (- 1)) it2570 (- 1))
                 (* it2571 (- 1))
                 (* it2565 (- 1))
                 it2572
                 (* (+ it2569 (- 1)) it2571 (- 1))
                 ...
                 1)
              0))
      (a!5 (+ (* (+ it2569 (- 1)) it2570 (- 1))
              (* it2565 (- 1))
              it2572
              (* (+ it2569 (- 1)) it2571 (- 1)))))
(let ((a!6 (> (+ (+ a!5 (* it2570 (- 1))) 1) 0)))
  (and (> it105 0)
       (> it104 0)
       (>= (+ (* it2562 (- 1)) 6) 0)
       (> (+ (* it2565 (- 1)) it2572) 0)
       ...
       (<= (+ (* it2572 (- 1)) it2567) 0)
       (>= (+ (* it104 (- 1)) it2563) 0)
       (> (+ (* it2571 (- 1)) (* it2565 (- 1)) it2572 (* it2570 (- 1)) 1) 0)
       a!6
       (> a!5 0)
       (>= (+ it2564 (- 1)) 0)
       (> it2573 0)
