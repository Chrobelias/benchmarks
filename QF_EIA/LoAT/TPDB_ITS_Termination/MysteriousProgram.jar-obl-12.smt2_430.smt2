...
(assert (let ((a!1 (+ (+ (* it2511 (- 1)) (* it346 (- 1)) it2506) (* it396 (- 1))))
      (a!2 (> (+ (+ (* it2511 (- 1)) it2513) (- 1)) 0))
      (a!3 (>= (+ (+ (* it2511 (- 1)) (* it346 (- 1)) it2506) (- 1)) 0))
      (a!4 (>= (+ (+ (* it2511 (- 1)) (* it346 (- 1)) it2506) (- 2)) 0)))
  (and (= (+ (* it2506 (- 1)) it2513) 0)
       (> it2513 0)
       (>= (+ it346 (- 1)) 0)
       (> (+ it2513 (- 1)) 0)
       (> it2512 0)
