...
(assert (let ((a!1 (> (+ (+ (* it2310 (- 1)) it2312) (- 1)) 0))
      (a!2 (>= (+ (+ it127 (* it2310 (- 1)) (* it1908 (- 1))) (- 1)) 0))
      (a!3 (+ (+ it127 (* it2310 (- 1)) (* it1908 (- 1))) (* it396 (- 1))))
      (a!4 (> (+ (+ (* it2310 (- 1)) (* it1908 (- 1)) it2312) (- 1)) 0))
      (a!5 (>= (+ (+ it127 (* it2310 (- 1)) (* it1908 (- 1))) (- 2)) 0)))
  (and (> it107 0)
       (> (+ it127 1) 0)
       a!1
       (> (+ it127 (- 1)) 0)
