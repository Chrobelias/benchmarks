...
(assert (let ((a!1 (>= (+ (+ it127 (* it2531 (- 1))) (- 2)) 0))
      ...
      (a!5 (>= (+ (+ (* it1871 (- 1)) it127)
                  ...
                  (- 1))
               0))
      (a!6 (+ (+ (+ it127 (* it2531 (- 1))) (* it375 (- 1))) (- 2)))
      (a!7 (+ it127
              (* it1871 (+ it996 (- 1)) (- 1))
              (* (+ it996 (- 1)) it375 (- 1))
              (* it2531 (- 1))))
      (a!9 (>= (+ (+ it2533 (* it2531 (- 1))) (- 1)) 0))
      (a!10 (>= (+ (+ it127 (* it2531 (- 1)))
                   (* it996 it375 (- 1))
                   (* it1871 it996 (- 1))
                   (- 2))
                0))
      (a!11 (+ (+ (+ it127 (* it2531 (- 1))) (* it375 (- 1))) (- 1))))
(let ((a!8 (>= (+ (+ a!7 (* it375 (- 1))) (- 1)) 0))
      (a!12 (>= (+ (+ a!7 (* it375 (- 1))) (- 2)) 0)))
  (and (> it107 0)
       (> it110 0)
       (> it109 0)
       (> (+ it127 1) 0)
