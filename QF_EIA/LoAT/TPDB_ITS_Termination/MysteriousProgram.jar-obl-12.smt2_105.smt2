...
(assert (and (> it35 0)
     ...
     (> (+ (* it2198 (- 1)) it2199) 0)))
(assert (= (+ it2205 (- 4)) 0))
(assert (= (+ it2206 (* it35 (- 1))) 0))
(assert (= (+ (* it2198 (- 1)) it2207 (- 1)) 0))
(assert (= (+ it2208 (* it2199 (- 1))) 0))
(assert (= (+ (* it32 (- 1)) it2209) 0))
(assert (= (+ it2210 (* it31 (- 1))) 0))
(assert (and (> (+ it2208 (- 1)) 0)
     (>= (+ it2205 (- 4)) 0)
     (>= (+ (* it2205 (- 1)) 4) 0)
     (>= (+ (* it2211 (- 1)) it2206) 0)
     (<= (+ (* it2211 (- 1)) it2206) 0)
