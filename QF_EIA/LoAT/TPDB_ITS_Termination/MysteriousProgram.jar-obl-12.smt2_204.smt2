...
(declare-fun it2350 () Int)
(declare-fun it2351 () Int)
(declare-fun it2352 () Int)
(declare-fun it2353 () Int)
(declare-fun it2354 () Int)
(declare-fun it2355 () Int)
...
(assert (and (> it140 0)
     ...
     (> (+ it2336 1) 0)))
(assert (= (+ it2350 (- 10)) 0))
(assert (= (+ (* it140 (- 1)) it2351) 0))
(assert (= (+ (* it2333 (- 1)) it2352) 0))
(assert (= (+ (* it2334 (- 1)) it2353 (- 1)) 0))
(assert (= (+ it2354 (* it2334 (- 1)) (- 1)) 0))
(assert (= (+ (* it2336 (- 1)) it2355) 0))
(assert (let ((a!1 (> (+ (+ (* it2339 (- 1)) (* it2340 (- 1)))
                 it2341
                 (* it2353 (- 1))
                 1)
              0))
      (a!2 (> (+ (+ (* it2339 (- 1)) it2355 (* it2353 (- 1))) 1) 0)))
  (and (> it2351 0)
       (> (+ it2352 1) 0)
       (> (+ it2355 (* it2352 (- 1))) 0)
       (<= (+ it2351 (* it1281 (- 1))) 0)
       ...
       (>= (+ it2354 (* it2353 (- 1))) 0)
       (>= (+ it2351 (- 1)) 0)
       (> (+ (* it2339 (- 1)) it2355 (* it2353 (- 1))) 0)
       (> (+ (* it2339 (- 1)) it2341 (* it2353 (- 1))) 0)
       (>= (+ it2339 (- 1)) 0)
       (> it1281 0)
       (= 0 0)
       (> (+ it2355 (* it2353 (- 1))) 0)
