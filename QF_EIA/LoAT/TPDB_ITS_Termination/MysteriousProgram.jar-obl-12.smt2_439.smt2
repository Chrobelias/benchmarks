...
(assert (let ((a!1 (+ (+ (+ (* it2511 (- 1)) it2518) (* it2516 (- 1))) 1))
      (a!2 (> (+ (+ (* it2511 (- 1)) it2518) (* it2516 (- 1))) 0))
      (a!3 (+ (* it2516 (+ it2515 (- 1)) (- 1))
              (* it2511 (- 1))
              (* it2517 (+ it2515 (- 1)) (- 1))
              it2518))
      (a!5 (> (+ (* it2517 (- 1))
...
(let ((a!4 (> (+ (+ a!3 (* it2516 (- 1))) 1) 0)))
  (and (> it105 0)
       ...
       a!5
       (> (+ it2513 (- 1)) 0)
       (> (+ (* it2517 (- 1)) (* it2511 (- 1)) it2518 (* it2516 (- 1)) 1) 0)
       (>= (+ it2509 (* it105 (- 1))) 0)
       (>= (+ it2516 (- 1)) 0)
       (<= (+ it2509 (* it105 (- 1))) 0)
       a!6
