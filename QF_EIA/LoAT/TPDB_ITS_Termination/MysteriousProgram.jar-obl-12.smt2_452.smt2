...
(assert (let ((a!1 (> (+ (+ it127 (* it2533 (- 1))) 1) 0))
      (a!2 (>= (+ (+ it127 (* it2533 (- 1))) (- 1)) 0))
      (a!3 (>= (+ (+ (* it127 (- 1)) it776) (- 1)) 0))
      (a!4 (> (+ (+ (* it127 (- 1)) it776) 1) 0)))
  (and (> it107 0)
       (> it110 0)
       (> it109 0)
       (> (+ it127 1) 0)
       ...
       (> (+ it127 (- 1)) 0)
       (>= (+ it2532 (* it109 (- 1))) 0)
       (<= (+ it127 it2533 (* it776 (- 1)) (* it2531 (- 1))) 0)
       (>= (+ it2529 (* it107 (- 1))) 0)
       (= (+ it2533 (* it776 (- 1))) 0)
       (>= (+ (* it110 (- 1)) it2530) 0)
       (> it2533 0)
       ...
       (> it2532 0)
       (<= (+ it2533 (* it776 (- 1))) 0)
       (<= (+ (* it127 (- 1)) (* it2533 (- 1)) it776 it2531) 0)
       (>= (+ it107 (- 1)) 0)
       (>= (+ it2529 (* it110 (- 1))) 0)
       (>= (+ it2533 (- 1)) 0)
       a!3
