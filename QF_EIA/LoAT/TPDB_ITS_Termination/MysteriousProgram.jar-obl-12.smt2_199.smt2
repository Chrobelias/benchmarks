...
(declare-fun it2342 () Int)
(declare-fun it2343 () Int)
(declare-fun it2344 () Int)
(declare-fun it2345 () Int)
(declare-fun it2346 () Int)
(declare-fun it2347 () Int)
(declare-fun it2340 () Int)
(declare-fun it2339 () Int)
(declare-fun it2349 () Int)
...
(assert (and (> it140 0)
     ...
     (> (+ it2336 (- 1)) 0)))
(assert (= (+ it2342 (- 10)) 0))
(assert (= (+ (* it140 (- 1)) it2343) 0))
(assert (= (+ it2344 (* it2333 (- 1))) 0))
(assert (= (+ it2345 (* it2334 (- 1)) (- 1)) 0))
(assert (= (+ (* it2334 (- 1)) it2346 (- 1)) 0))
(assert (= (+ it2347 (* it2341 (- 1))) 0))
(assert (let ((a!1 (> (+ (+ (* it2345 (- 1)) (* it2340 (- 1)) it2349) 1) 0)))
  (and (>= (+ it2343 (* it2338 (- 1))) 0)
       (>= (+ it2339 (- 1)) 0)
       (> (+ it2344 1) 0)
       a!1
       (> (+ it2347 (- 1)) 0)
       ...
       (>= (+ it2340 (- 1)) 0)
       (> (+ it2347 (* it2344 (- 1))) 0)
       (> (+ (* it2345 (- 1)) (* it2340 (- 1)) it2349) 0)
       (> (+ (* it2339 (- 1)) (* it2345 (- 1)) (* it2340 (- 1)) it2349 1) 0)
       (> it2343 0)
       (>= (+ it2345 (* it2346 (- 1))) 0)
       (= 0 0)
       (= (+ it2347 (* it2349 (- 1))) 0)
