...
(assert (let ((a!1 (> (+ (+ it2555 (* it2553 (- 1))) (- 1)) 0))
      (a!2 (>= (+ (+ it2555 (* it2553 (- 1))) (- 2)) 0))
      (a!3 (+ (* (+ it2558 (- 1)) it2557 (- 1))
              (* it2559 (- 1))
              (* it2553 (- 1))
              it2560
              (* (+ it2558 (- 1)) it2559 (- 1))))
      (a!4 (>= (+ (+ (* it2553 (- 1)) it2560) (- 2)) 0))
      (a!5 (>= (+ (* (+ it2558 (- 1)) it2557 (- 1))
                  (* it2553 (- 1))
                  it2560
                  (* (+ it2558 (- 1)) it2559 (- 1))
                  (- 2))
               0))
      (a!6 (>= (+ (+ (* it2559 (- 1)) (* it2553 (- 1)) it2560)
                  (* it2557 (- 1))
                  (- 1))
               0))
      (a!7 (>= (+ (+ it2555 (* it2553 (- 1))) (- 1)) 0))
      (a!8 (>= (+ (+ (* it2559 (- 1)) (* it2553 (- 1)) it2560) (- 2)) 0))
      (a!9 (>= (+ (+ (* it2559 (- 1)) (* it2553 (- 1)) it2560) (- 1)) 0)))
  (and (> it110 0)
       (> it109 0)
       (>= (+ it2554 (* it109 (- 1))) 0)
       (> (+ it2555 1) 0)
