...
(assert (let ((a!1 (>= (+ (+ it117 (* it2401 (- 1))) (- 2)) 0))
      (a!2 (> (+ (+ (* it346 (- 1)) it117 (* it2401 (- 1))) 1) 0))
      (a!3 (+ (+ (* it346 (- 1)) it117 (* it2401 (- 1))) (- 1)))
      (a!4 (> (+ (+ (* it346 (- 1)) it117 (* it2401 (- 1))) (* it678 (- 1))) 0))
      (a!5 (> (+ (+ it2403 (* it2401 (- 1))) (- 1)) 0))
      (a!6 (>= (+ (+ it117 (* it2401 (- 1))) (- 1)) 0)))
  (and (> (+ it117 1) 0)
       (>= (+ it346 (- 1)) 0)
       (>= (+ (* it2406 (- 1)) it2402) 0)
       (> it2400 0)
