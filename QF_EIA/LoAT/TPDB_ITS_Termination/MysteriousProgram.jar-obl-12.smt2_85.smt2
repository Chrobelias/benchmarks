...
(declare-fun it2160 () Int)
(declare-fun it2161 () Int)
(declare-fun it2162 () Int)
(declare-fun it2163 () Int)
...
(assert (and (> it2151 0)
     ...
     (= (+ it2150 (- 2)) 0)))
(assert (= (+ it2160 (- 2)) 0))
(assert (= (+ it2161 (* it2157 (- 1))) 0))
(assert (= (+ (* it2152 (- 2)) it2162) 0))
(assert (= (+ (* it2153 (- 1)) it2163 (- 1)) 0))
(assert (= (+ (* it2154 (- 1)) it2164) 0))
(assert (= (+ it2165 (* it2158 (- 1))) 0))
(assert (and (> it2166 0)
     (> it2161 0)
     (>= (+ (* it2160 (- 1)) 2) 0)
     (>= (+ it2160 (- 2)) 0)
