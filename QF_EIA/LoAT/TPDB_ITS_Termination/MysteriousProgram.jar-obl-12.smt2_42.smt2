...
(assert (and (> (+ it117 1) 0)
     (> (+ it117 (* it297 (- 1))) 0)
     (> (+ (* it310 (- 1)) it117 (* it297 (- 1)) 1) 0)
     (>= (+ it294 (- 9)) 0)
     (>= (+ (* it294 (- 1)) 9) 0)
     (> (+ it299 (- 1)) 0)
     (> (+ it299 (* it297 (- 1))) 0)
     ...
     (> it295 0)
     (>= (+ it310 (- 1)) 0)))
(assert (= (+ it313 (* it294 (- 1))) 0))
(assert (= (+ it314 (* it301 (- 1))) 0))
(assert (= (+ (* it296 (- 1)) it315) 0))
(assert (= (+ (* it310 (- 1)) it316 (* it297 (- 1))) 0))
(assert (= (+ (* it310 (- 1)) it317 (* it297 (- 1))) 0))
(assert (= (+ (* it117 (- 1)) it318) 0))
(assert (and (>= (+ it316 (* it317 (- 1))) 0)
     (> (+ it315 1) 0)
     (= (- 1) 0)
     (>= (+ it313 (- 9)) 0)
     (> it320 0)
