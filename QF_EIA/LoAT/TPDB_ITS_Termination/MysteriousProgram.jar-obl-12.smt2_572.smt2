...
(assert (let ((a!1 (+ (+ it127 (* it2585 (- 1)))
              (* it732 (+ it996 (- 1)) (- 1))
              (* (+ it996 (- 1)) it375 (- 1))))
      (a!4 (> (+ (+ (* it2585 (- 1)) it2587) (- 1)) 0))
      (a!5 (+ (+ it127 (* it2585 (- 1))) (* it996 it732 (- 1))))
      (a!6 (+ (+ (+ it127 (* it2585 (- 1))) (* it375 (- 1))) 1))
      (a!7 (> (+ (+ it127 (* it2585 (- 1))) (* it678 (- 1)) (* it1364 (- 1))) 0))
      (a!8 (> (+ (+ it127 (* it2585 (- 1))) (* it375 (- 1))) 0))
      (a!9 (+ (+ (+ it127 (* it2585 (- 1))) (* it1364 (- 1))) (- 1)))
      (a!10 (> (+ (+ it127 (* it2585 (- 1))) (* it1364 (- 1))) 0))
      (a!12 (+ (+ (+ it127 (* it2585 (- 1))) (* it732 (- 1)))
               (* it732 (+ it996 (- 1)) (- 1))
               (* (+ it996 (- 1)) it375 (- 1))
               (* it375 (- 1))
               1))
      (a!14 (+ (+ (+ it127 (* it2585 (- 1))) (* it732 (- 1))) (* it375 (- 1)) 1))
      (a!15 (+ (+ (+ it127 (* it2585 (- 1))) (* it732 (- 1)))
               (* it1364 (- 1))
               (* it375 (- 1))
               2)))
(let ((a!2 (> (+ (+ a!1 (* it375 (- 1))) 1) 0))
      (a!3 (+ (+ (+ a!1 (* it1364 (- 1))) (* it375 (- 1))) 1))
      (a!11 (+ (+ (+ a!1 (* it1364 (- 1))) (* it375 (- 1))) 2))
      (a!13 (> (+ (+ a!1 (* it1364 (- 1))) 1) 0)))
  (and (> (+ it127 1) 0)
       (> (+ (* it2585 (- 1)) it2587) 0)
       (> (+ it127 (- 1)) 0)
       a!2
