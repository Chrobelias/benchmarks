...
(assert (let ((a!1 (>= (+ (+ (* it2511 (- 1)) it2506)
                  (* it996 it375 (- 1))
                  (* it1871 it996 (- 1))
                  (- 2))
               0))
      (a!2 (>= (+ (+ (* it1871 (- 1)) (* it2511 (- 1)))
                  (* it1871 (+ it996 (- 1)) (- 1))
                  (* (+ it996 (- 1)) it375 (- 1))
                  it2506
                  (* it375 (- 1))
                  (- 1))
               0))
      (a!3 (+ (+ (+ (* it2511 (- 1)) it2506) (* it375 (- 1))) (- 1)))
      (a!4 (>= (+ (+ (* it2511 (- 1)) it2506) (- 2)) 0))
      (a!5 (+ (+ (+ (* it2511 (- 1)) it2506) (* it375 (- 1))) (- 2)))
      (a!6 (+ (* it2511 (- 1))
              (* it1871 (+ it996 (- 1)) (- 1))
              (* (+ it996 (- 1)) it375 (- 1))
              it2506))
      (a!7 (>= (+ (+ (* it1871 (- 1)) (* it2511 (- 1)))
                  it2506
                  (* it375 (- 1))
                  (- 1))
               0))
      (a!9 (> (+ (+ (* it2511 (- 1)) it2513) (- 1)) 0))
      (a!10 (>= (+ (+ (* it2511 (- 1)) it2513) (- 1)) 0))
      (a!11 (>= (+ (+ (* it2511 (- 1)) it2513) (- 2)) 0)))
(let ((a!8 (>= (+ (+ a!6 (* it375 (- 1))) (- 1)) 0))
      (a!12 (>= (+ (+ a!6 (* it375 (- 1))) (- 2)) 0)))
  (and (> it110 0)
       (> it109 0)
       (>= (+ it2512 (- 1)) 0)
       (>= (+ it2509 (- 1)) 0)
