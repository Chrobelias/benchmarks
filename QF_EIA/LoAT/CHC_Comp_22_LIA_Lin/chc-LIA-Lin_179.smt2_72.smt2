...
(assert (or (not bt1512)
    bt1516
    (distinct (+ it1289 (* it1292 (- 1))) 0)
    (distinct (+ (* it1294 (- 1)) it1291) 0)
    bt1517
    (not bt1511)
    (distinct (+ it1288 (- 2)) 0)
    (not bt1514)
    (distinct (+ (* it1293 (- 1)) it1290) 0)
    bt1515
    (not bt1510)))
(assert (let ((a!1 (and (= (+ it1289 (* it1292 (- 1))) 0)
                bt1516
                (= (+ (* it1294 (- 1)) it1291) 0)
                (not bt1514)))
      (a!3 (= (+ (+ (* it1293 (- 1)) it1290) (- 1)) 0))
      (a!6 (and (= (+ it1289 (* it1292 (- 1))) 0)
                (not bt1516)
                (= (+ (* it1294 (- 1)) it1291) 0)))
      (a!8 (and bt1516 (= (+ (* it1294 (- 1)) it1291) 0))))
(let ((a!2 (and (and a!1 (not bt1517)) (= (+ (* it1293 (- 1)) it1290) 0) bt1515))
      (a!4 (and (= (+ it1289 (* it1292 (- 1))) 0)
                a!3
                bt1516
                (= (+ (* it1294 (- 1)) it1291) 0)
                (not bt1517)
                (not bt1515)
                bt1514))
      (a!5 (or (or bt1511 bt1512)
               (not bt1510)
               bt1513
               (and (and a!1 (not bt1517)) (= (+ it1293 (- 10)) 0) bt1515)))
      (a!7 (and (and a!6 (not bt1514)) bt1517 (= (+ (* it1293 (- 1)) it1290) 0)))
      (a!9 (and a!8
                (= (+ (* it1289 2) (* it1292 (- 1))) 0)
                (not bt1517)
                (= (+ (* it1293 (- 1)) it1290) 0)
                bt1514
                bt1515))
      (a!10 (and a!6 (not bt1517) (= (+ (* it1293 (- 1)) it1290) 0)))
      (a!12 (and a!1 bt1517 (= (+ (* it1293 (- 1)) it1290) 0)))
      (a!13 (and (and a!6 (not bt1514))
                 (not bt1517)
                 (= (+ (* it1293 (- 1)) it1290) 0)
                 (not bt1515)))
      (a!14 (and a!6
      ...
      (a!16 (and a!8
                 ...
                 (not bt1515)
                 (= (+ it1292 (- 1)) 0))))
(let ((a!11 (or (or (or bt1512 (not bt1510) (not bt1511)) bt1513)
                (and a!10 (not bt1515) bt1514)
                (<= (+ it1291 (* it1289 (- 1))) 0)))
      (a!15 (or (or (or bt1512 (not bt1510) (not bt1511)) bt1513)
                (> (+ it1291 (* it1289 (- 1))) 0)
                (and a!7 bt1515))))
  (and (or bt1511 a!2 bt1512 bt1510 (not bt1513))
       (or a!4 (not bt1511) bt1513 (not bt1512) bt1510)
       a!5
       (or bt1511
           (> it1290 0)
           bt1513
           ...
           (and a!7 (not bt1515)))
       (= (+ it1288 (- 2)) 0)
       (or bt1511 a!9 (not bt1510) bt1513 (not bt1512))
       a!11
       (or bt1511 (and a!12 bt1515) bt1512 (not bt1510) (not bt1513))
       (or (or bt1511 bt1512) bt1513 a!13 bt1510)
       (or bt1511
           bt1513
           (not bt1512)
           bt1510
           (and a!10 bt1514 bt1515)
           (<= it1290 0))
       (or (<= it1289 0)
           bt1512
           (and a!12 (not bt1515))
           ...
           bt1510
           (not bt1513))
       (or bt1512 (> it1289 0) (not bt1511) bt1510 a!14 (not bt1513))
       (or bt1511 (not bt1512) bt1510 a!14 (not bt1513))
       (or (not bt1510)
           (not bt1511)
           bt1513
           (and a!10 (not bt1515) bt1514)
           (not bt1512))
       (or (or bt1512 (not bt1510) (not bt1511)) a!13 (not bt1513))
       a!15
       (or a!16 bt1512 (not bt1511) bt1513 bt1510))))))
(check-sat)
