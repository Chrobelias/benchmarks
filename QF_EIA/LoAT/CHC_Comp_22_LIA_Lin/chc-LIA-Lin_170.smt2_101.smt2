...
(assert (and (not bt614)
     ...
     (not bt615)))
(assert (= (+ it569 (- 2)) 0))
(assert (= (+ it570 (* it563 (- 1))) 0))
(assert (= (+ it571 (* it564 (- 1))) 0))
(assert (= (+ it572 (* it565 (- 1))) 0))
(assert (or (and (not bt614) (not bt621)) (and bt621 bt614)))
(assert (or (and bt622 bt613) (and (not bt622) (not bt613))))
(assert (or (and bt623 bt615) (and (not bt623) (not bt615))))
(assert (or (and bt616 bt624) (and (not bt616) (not bt624))))
(assert (and bt621 (= (+ it569 (- 2)) 0) bt622 (not bt623) bt624))
(check-sat)
