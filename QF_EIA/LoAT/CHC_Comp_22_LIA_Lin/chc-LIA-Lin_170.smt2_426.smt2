...
(declare-fun bt1621 () Bool)
(declare-fun bt1622 () Bool)
(declare-fun bt1623 () Bool)
(declare-fun bt1624 () Bool)
(assert (= (+ i1 (- 1)) 0))
(assert (= (+ it1100 (- 2)) 0))
...
(assert (and (not bt1577)
     ...
     (= (+ it1476 (- 2)) 0)))
(assert (= (+ it1510 (- 2)) 0))
(assert (= (+ (* it1480 (- 1)) it1511) 0))
(assert (= (+ (* it1481 (- 1)) it1512) 0))
(assert (= (+ it1513 (* it1482 (- 1))) 0))
(assert (or (and bt1582 bt1621) (and (not bt1582) (not bt1621))))
(assert (or (and bt1622 bt1581) (and (not bt1581) (not bt1622))))
(assert (or (and bt1583 bt1623) (and (not bt1583) (not bt1623))))
(assert (or (and (not bt1624) (not bt1584)) (and bt1584 bt1624)))
(assert (and bt1621 bt1622 (not bt1623) (= (+ it1510 (- 2)) 0) bt1624))
(check-sat)
