...
(assert (= (+ (* it1143 (- 1)) it1147) 0))
(assert (= (+ it1148 (* it1144 (- 1))) 0))
(assert (or (and (not bt1213) (not bt1210)) (and bt1210 bt1213)))
(assert (or (and (not bt1209) (not bt1214)) (and bt1209 bt1214)))
(assert (or (and bt1211 bt1215) (and (not bt1211) (not bt1215))))
(assert (or (and (not bt1212) (not bt1216)) (and bt1212 bt1216)))
(assert (and bt1213 (not bt1215) (= (+ it1145 (- 2)) 0) bt1214 bt1216))
(check-sat)
