...
(declare-fun bt1665 () Bool)
(declare-fun bt1666 () Bool)
(declare-fun bt1667 () Bool)
(declare-fun bt1668 () Bool)
(assert (= (+ i1 (- 1)) 0))
(assert (= (+ it1100 (- 2)) 0))
...
(assert (and (= (+ it1563 (- 2)) 0)
     ...
     (not bt1661)))
(assert (= (+ it1572 (- 2)) 0))
(assert (= (+ (* it1567 (- 1)) it1573) 0))
(assert (= (+ (* it1568 (- 1)) it1574) 0))
(assert (= (+ it1575 (* it1569 (- 1))) 0))
(assert (or (and (not bt1662) (not bt1665)) (and bt1665 bt1662)))
(assert (or (and (not bt1666) (not bt1661)) (and bt1661 bt1666)))
(assert (or (and (not bt1663) (not bt1667)) (and bt1667 bt1663)))
(assert (or (and bt1668 bt1664) (and (not bt1664) (not bt1668))))
(assert (and (not bt1667) bt1665 bt1668 (= (+ it1572 (- 2)) 0) bt1666))
(check-sat)
