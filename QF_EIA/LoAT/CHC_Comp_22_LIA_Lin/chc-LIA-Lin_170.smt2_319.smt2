...
(assert (let ((a!1 (and bt1347 (not bt1348) (= (+ (* it1260 (- 1)) it1257) 0)))
      (a!3 (and (and (not bt1345) (not bt1348))
                (= (+ (* it1260 (- 1)) it1257) 0)))
      (a!6 (and (not bt1345) (= (+ (* it1260 (- 1)) it1257) 0)))
      (a!8 (and (= (+ (* it1260 (- 1)) it1257) 0)
                bt1346
                (= (+ (* it1261 (- 1)) it1258) 0)
                (= (+ (* it1259 (- 1)) it1256) 0)
                bt1348
      ...
      (a!9 (and (not bt1345)
                ...
                (not bt1348)
                (= (+ (* it1260 (- 1)) it1257) 0)))
      (a!13 (and (and (not bt1345) (not bt1348))
                 (= (+ it1259 (- 1)) 0)
                 (= (+ (* it1260 (- 1)) it1257) 0)
                 bt1346
                 (= (+ (* it1261 (- 1)) it1258) 0)
                 (not bt1347)))
      (a!17 (and (= (+ (* it1260 (- 1)) it1257) 0)
                 (not bt1346)
                 (= (+ (* it1261 (- 1)) it1258) 0)
                 (= (+ (* it1259 (- 1)) it1256) 0)
                 bt1348
      ...
      (a!18 (and (not bt1348)
                 ...
                 bt1345
                 (not bt1347))))
(let ((a!2 (and (and a!1 (not bt1346))
                (= (+ (* it1259 (- 1)) (* it1256 2)) 0)
                (= (+ (* it1261 (- 1)) it1258) 0)
                bt1345))
      (a!4 (and a!3
...
(let ((a!16 (or bt1344
                ...
                bt1342
                a!15)))
  (and (or (or bt1344 (not bt1343)) a!2 bt1342 bt1341)
       (or bt1344 a!4 bt1343 bt1342 bt1341)
       (or bt1344 a!5 (not bt1343) (not bt1341) (not bt1342))
       (or (not bt1344) a!7 bt1343 (not bt1342) bt1341)
       (or (or (not bt1344) bt1343 a!8) (not bt1341) (not bt1342))
       (or bt1344 a!10 bt1343 (> it1257 0) (not bt1341) (not bt1342))
       (or (or bt1344 (not bt1343)) (not bt1341) bt1342 a!11)
       (or (or bt1344 bt1343) (<= it1257 0) (not bt1341) (not bt1342) a!12)
       (or (or bt1344 bt1343) (not bt1342) a!13 bt1341)
       (or (or (not bt1344) bt1343 a!8) bt1342 bt1341 (> it1256 0))
       (or (or bt1344 (not bt1343)) a!14 (not bt1342) bt1341)
       a!16
       (or (not bt1344) a!4 bt1343 (not bt1341) bt1342)
       (or (not bt1344) (<= it1256 0) bt1343 bt1342 bt1341 a!17)
       a!19
       (= (+ it1255 (- 2)) 0))))))
(check-sat)
