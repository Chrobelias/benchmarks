...
(assert (or (not bt1207)
    bt1209
    (distinct (+ it1138 (- 2)) 0)
    bt1211
    bt1205
    bt1212
    (distinct (+ (* it1142 (- 1)) it1139) 0)
    (distinct (+ (* it1143 (- 1)) it1140) 0)
    (distinct (+ it1141 (* it1144 (- 1))) 0)
    (not bt1206)
    (not bt1210)))
(assert (let ((a!1 (and bt1210
                (not bt1212)
                (not bt1209)
                (= (+ (* it1143 (- 1)) it1140) 0)
                (not bt1211)
      ...
      (a!3 (and (not bt1210)
                ...
                (= (+ it1141 (* it1144 (- 1))) 0)
                (= (+ (* it1142 (- 1)) it1139) 0)))
      (a!4 (and (and (not bt1210) bt1209)
                bt1211
                (not bt1212)
                (= (+ (* it1143 (- 1)) it1140) 0)
                (= (+ it1141 (* it1144 (- 1))) 0)
                (= (+ (* it1142 (- 1)) it1139) 0)))
      (a!5 (and (and bt1209 bt1210)
                (not bt1212)
                (= (+ (* it1143 (- 1)) it1140) 0)
                (not bt1211)
                (= (+ it1141 (* it1144 (- 1))) 0)
                (= (+ (* it1142 (- 1)) it1139) 0)))
      (a!7 (and (and (not bt1210) bt1209)
                (= (+ (* it1143 (- 1)) it1140) 0)
                (not bt1211)
                bt1212
                (= (+ it1141 (* it1144 (- 1))) 0)
                (= (+ (* it1142 (- 1)) it1139) 0)))
      (a!8 (and (and (not bt1210) bt1209)
                (= (+ (* it1142 (- 1)) (* it1139 2)) 0)
                bt1211
                (not bt1212)
                (= (+ (* it1143 (- 1)) it1140) 0)
      ...
      (a!15 (and bt1210
                 ...
                 (not bt1211)
                 (= (+ it1141 (* it1144 (- 1))) 0))))
(let ((a!6 (or (or bt1207 bt1208)
               a!5
               (<= (+ it1141 (* it1139 (- 1))) 0)
               bt1206
               (not bt1205)))
      (a!13 (or (or bt1207 bt1208)
                a!12
                bt1206
                (> (+ it1141 (* it1139 (- 1))) 0)
                (not bt1205))))
  (and (or bt1208 a!1 (not bt1206) bt1205 (not bt1207))
       (or (or (or bt1207 bt1208) (not bt1206)) (> it1140 0) (not bt1205) a!2)
       (or (or (or bt1207 bt1208) (not bt1206)) (not bt1205) a!3 (<= it1140 0))
       (or bt1208 (not bt1206) a!4 (not bt1205) (not bt1207))
       a!6
       (or bt1207 bt1205 (not bt1208) bt1206 a!7 (<= it1139 0))
       (or bt1208 a!8 bt1205 bt1206 (not bt1207))
       (or (or bt1207 bt1208) bt1205 bt1206 a!9)
       (or bt1207 (not bt1208) bt1206 a!9 (not bt1205))
       (or bt1208 bt1206 (not bt1205) (not bt1207) a!10)
       (= (+ it1138 (- 2)) 0)
       (or (or bt1207 (not bt1206)) bt1205 (not bt1208) a!11)
       a!13
       (or (or bt1207 (not bt1206)) (not bt1208) (not bt1205) a!14)
       (or bt1207 (> it1139 0) bt1205 (not bt1208) bt1206 a!14)
       (or (or (or bt1207 bt1208) (not bt1206)) bt1205 a!15)))))
(check-sat)
