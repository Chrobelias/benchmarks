...
(assert (let ((a!1 (and (not bt1640) (= (+ (* it1544 (- 1)) it1541) 0)))
      (a!3 (and (not bt1637) (not bt1640) (= (+ (* it1544 (- 1)) it1541) 0)))
      (a!7 (and (not bt1637)
                (= (+ (* it1544 (- 1)) it1541) 0)
                (not bt1639)
                (= (+ (* it1543 (- 1)) it1540) 0)
...
(let ((a!2 (and a!1
      ...
      (a!9 (and a!1
                ...
                bt1638
                bt1637))
      (a!11 (and (and a!3 (not bt1639))
                 (= (+ (* it1545 (- 1)) it1542) 0)
                 bt1638
                 (= (+ it1543 (- 1)) 0)))
      (a!12 (or (> (+ it1542 (* it1540 (- 1))) 0)
                (not bt1633)
                bt1634
                bt1635
                (and a!7 (not bt1638))
...
(let ((a!10 (or a!9
                ...
                (<= (+ it1542 (* it1540 (- 1))) 0)
                bt1636)))
  (and (or (not bt1635) a!2 (not bt1633) bt1634 bt1636)
       (or (not bt1636) (and a!4 (not bt1638)) (not bt1633) bt1634 bt1635)
       (or (or (not bt1634) (not bt1633))
           bt1635
           (> it1541 0)
           (and a!5 bt1638 bt1639)
           bt1636)
       (or (or (not bt1635) (not bt1634)) bt1633 (and a!4 bt1638) bt1636)
       (or (not bt1635) bt1633 bt1634 a!6 bt1636)
       (or (and a!4 (not bt1638)) bt1633 bt1634 bt1635 bt1636)
       (or (or (not bt1634) (not bt1633))
           (and a!5 (not bt1638) bt1639)
           bt1635
           bt1636
           (<= it1541 0))
       (= (+ it1539 (- 2)) 0)
       (or (and a!7 bt1638) (not bt1634) (not bt1636) bt1633 bt1635)
       (or (not bt1634)
           (not bt1636)
           (not bt1633)
           bt1635
           (and a!8 bt1638 bt1637))
       a!10
       (or (not bt1634) a!11 bt1633 bt1635 bt1636)
       (or (not bt1636)
           (> it1540 0)
           bt1633
           bt1634
           ...
           (and a!8 bt1638 bt1637))
       (or (not bt1636)
           (and a!8 (not bt1638) bt1637)
           bt1633
           bt1634
           (<= it1540 0)
           bt1635)
       a!12
       (or (or (not bt1635) (not bt1634)) (not bt1633) bt1636 a!13))))))
(check-sat)
