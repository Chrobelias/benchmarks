...
(assert (or (<= it1479 0)
    ...
    (not bt1735)
    (not bt1740)
    (distinct (+ (* it1475 (- 1)) it1479) 0)
    (not bt1734)
    (distinct (+ it1477 (- 2)) 0)
    bt1739
    (distinct (+ it1480 (* it1476 (- 1))) 0)
    bt1737
    bt1736
    bt1738
    (distinct (+ (* it1474 (- 1)) it1478) 0)))
(assert (let ((a!1 (and (= (+ (* it1474 (- 1)) it1478) 0)
                ...
                bt1736
                (not bt1734)))
      (a!2 (and (= (+ (* it1475 (- 1)) it1479) 0)
                (= (+ (* it1474 (- 1)) it1478) 0)))
      (a!13 (and (= (+ (* it1475 (- 1)) it1479) 0)
                 (= (+ (* it1474 (- 1)) (* it1478 2)) 0)
                 (= (+ it1480 (* it1476 (- 1))) 0)
                 (not bt1737)
                 bt1735
      ...
      (a!14 (and (= (+ (* it1475 (- 1)) it1479) 0)
                 ...
                 bt1736
                 (not bt1734)))
      (a!15 (= (+ (+ (* it1475 (- 1)) it1479) (- 1)) 0)))
(let ((a!3 (and a!2 (not bt1735) (= (+ it1480 (* it1476 (- 1))) 0)))
      (a!5 (and a!2 (= (+ it1480 (* it1476 (- 1))) 0)))
      (a!16 (and (= (+ (* it1474 (- 1)) it1478) 0)
                 (not bt1735)
                 (= (+ it1480 (* it1476 (- 1))) 0)
                 a!15
                 (not bt1737)
                 bt1734
                 bt1736)))
(let ((a!4 (or (<= (+ it1480 (* it1478 (- 1))) 0)
               bt1741
               bt1740
               (not bt1738)
               (and (and a!3 (not bt1737)) bt1734 (not bt1736))
               (not bt1739)))
      (a!6 (or (or (or bt1740 (not bt1741)) (not bt1738))
               (and (and a!5 bt1735 bt1737) bt1736 (not bt1734))
               bt1739))
      (a!7 (or (and (and a!5 (not bt1737) bt1735) bt1736 (not bt1734))
               bt1740
               (not bt1741)
               bt1739
               bt1738))
      (a!8 (or (or bt1741 bt1740)
               bt1739
               bt1738
               (and (and a!3 (not bt1737)) (not bt1734) (not bt1736))))
      (a!9 (or (or bt1741 (not bt1740))
               (and (and a!5 (not bt1737) bt1735) bt1734 (not bt1736))
               bt1739
               bt1738
               (<= it1479 0)))
      (a!10 (or (or (or bt1740 (not bt1741)) (not bt1738))
                (and (and a!3 (not bt1737)) (not bt1734) (not bt1736))
                (not bt1739)))
      (a!11 (or (or bt1741 bt1740)
                (and (and a!5 bt1735 bt1737) (not bt1734) (not bt1736))
                (> (+ it1480 (* it1478 (- 1))) 0)
                (not bt1738)
                (not bt1739)))
      (a!12 (or (or bt1741 (not bt1740))
                (not bt1738)
                (and (and a!3 (not bt1737)) bt1734 (not bt1736))
                (not bt1739))))
  (and (or (or bt1741 bt1740) (not bt1738) bt1739 a!1)
       (or (or bt1740 (not bt1741))
           (<= it1478 0)
           bt1738
           (and (and a!3 bt1737) bt1736 (not bt1734))
           (not bt1739))
       a!4
       a!6
       a!7
       (or (and a!3 bt1734 bt1737 (not bt1736))
           (not bt1740)
           (not bt1741)
           bt1739
           bt1738)
       ...
       (or (and a!3 bt1734 bt1737 (not bt1736))
           ...
           (not bt1739))
       a!12
       (or (or bt1741 (not bt1740))
           (> it1479 0)
           bt1739
           (and (and a!3 bt1737) (not bt1734) (not bt1736))
           bt1738)
       (or a!13 bt1741 (not bt1740) (not bt1738) bt1739)
       (or (or bt1741 bt1740) a!14 bt1738 (not bt1739))
       (or bt1741 a!16 (not bt1740) bt1738 (not bt1739)))))))
(check-sat)
