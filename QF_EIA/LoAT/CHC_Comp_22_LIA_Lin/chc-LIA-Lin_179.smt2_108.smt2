...
(assert (or (distinct (+ (* it1494 (- 1)) it1491 (- 1)) 0)
    bt1755
    (not bt1751)
    bt1750
    (not bt1752)
    (not bt1754)
    bt1757
    (distinct (+ (* it1495 (- 1)) it1492) 0)
    (not bt1756)
    (distinct (+ it1489 (- 2)) 0)
    (distinct (+ (* it1493 (- 1)) it1490) 0)))
(assert (let ((a!1 (and (= (+ it1493 (- 1)) 0)
                (not bt1754)
                (= (+ (* it1495 (- 1)) it1492) 0)
                (not bt1755)
                bt1756
      ...
      (a!2 (and (= (+ it1494 (- 10)) 0)
                ...
                bt1756
                (not bt1757)))
      (a!3 (and (not bt1754) (= (+ (* it1493 (- 1)) it1490) 0)))
      (a!6 (and (= (+ (* it1493 (- 1)) it1490) 0)
                (not bt1756)
                (= (+ (* it1495 (- 1)) it1492) 0)))
      (a!9 (and (= (+ (* it1495 (- 1)) it1492) 0)
                bt1755
                bt1756
                (not bt1757)
                bt1754
                (= (+ (* it1494 (- 1)) it1491) 0)
                (= (+ (* it1493 (- 1)) (* it1490 2)) 0)))
      (a!16 (= (+ (+ (* it1494 (- 1)) it1491) (- 1)) 0)))
(let ((a!4 (and a!3 (not bt1756) (= (+ (* it1495 (- 1)) it1492) 0)))
      (a!7 (and (and a!6 (not bt1755))
                (not bt1757)
                bt1754
                (= (+ (* it1494 (- 1)) it1491) 0)))
      (a!12 (and a!3 (= (+ (* it1495 (- 1)) it1492) 0)))
      (a!14 (and (and a!6 (not bt1755))
                 bt1757
                 bt1754
                 (= (+ (* it1494 (- 1)) it1491) 0)))
      (a!17 (and a!16
      ...
      (a!18 (and a!6
                 ...
                 bt1754
                 (= (+ (* it1494 (- 1)) it1491) 0))))
(let ((a!5 (and (and a!4 (not bt1755))
                (not bt1757)
                (= (+ (* it1494 (- 1)) it1491) 0)))
      (a!8 (or (not bt1750)
               (<= (+ it1492 (* it1490 (- 1))) 0)
               ...
               a!7
               bt1752))
      (a!10 (and a!4 bt1755 bt1757 (= (+ (* it1494 (- 1)) it1491) 0)))
      (a!13 (and (and a!12 bt1755 bt1756)
                 (not bt1757)
                 (= (+ (* it1494 (- 1)) it1491) 0)))
      (a!15 (and (and a!4 (not bt1755))
                 bt1757
                 (= (+ (* it1494 (- 1)) it1491) 0)))
      (a!19 (and a!12
                 (not bt1755)
                 ...
                 bt1757
                 (= (+ (* it1494 (- 1)) it1491) 0)))
      (a!20 (and (and a!12 bt1755 bt1756)
                 bt1757
                 (= (+ (* it1494 (- 1)) it1491) 0))))
(let ((a!11 (or (> (+ it1492 (* it1490 (- 1))) 0)
                (not bt1750)
                a!10
                bt1753
                (not bt1751)
                bt1752)))
  (and (or bt1750 bt1753 (not bt1751) a!1 bt1752)
       (or bt1751 (not bt1750) a!2 bt1753 bt1752)
       (or a!5 (not bt1750) (not bt1753) (not bt1751) bt1752)
       a!8
       (or bt1751 a!9 (not bt1750) (not bt1752) bt1753)
       (= (+ it1489 (- 2)) 0)
       a!11
       (or (not bt1750) (not bt1752) bt1753 (not bt1751) a!7)
       (or (or bt1751 (not bt1753)) a!13 bt1750 bt1752)
       (or (or bt1751 (not bt1753)) bt1750 a!14 (not bt1752))
       (or bt1751 a!5 bt1750 bt1753 bt1752)
       (or bt1751 a!15 bt1750 (not bt1752) (> it1491 0) bt1753)
       (or bt1750 (not bt1752) bt1753 (not bt1751) a!17)
       (or bt1751 bt1750 (not bt1752) bt1753 a!18 (<= it1491 0))
       (or (or (not bt1753) bt1750) a!19 (<= it1490 0) (not bt1751) bt1752)
       (or (or (not bt1753) bt1750) (> it1490 0) a!14 (not bt1751) bt1752)
       (or a!20 bt1751 (not bt1750) (not bt1753) bt1752)))))))
(check-sat)
