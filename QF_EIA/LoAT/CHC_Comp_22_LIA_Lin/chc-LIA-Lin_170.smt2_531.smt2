...
(assert (or (distinct (+ it1639 (- 2)) 0)
    bt1734
    bt1738
    bt1735
    bt1739
    (distinct (+ it1642 (* it1645 (- 1))) 0)
    bt1736
    (distinct (+ it1641 (* it1644 (- 1))) 0)
    bt1733
    bt1737
    (distinct (+ (* it1643 (- 1)) it1640) 0)
    bt1740))
(assert (let ((a!1 (and bt1738
                (= (+ (* it1643 (- 1)) it1640) 0)
                (not bt1740)
                bt1739
                (= (+ it1642 (* it1645 (- 1))) 0)
                (= (+ it1641 (* it1644 (- 1))) 0)
                (not bt1737)))
      (a!2 (and (not bt1739) (not bt1738) (= (+ (* it1643 (- 1)) it1640) 0)))
      (a!4 (and (and bt1738 (not bt1739)) (= (+ (* it1643 (- 1)) it1640) 0)))
      (a!6 (and (not bt1738)
                (not bt1740)
                bt1739
                (= (+ it1642 (* it1645 (- 1))) 0)
      ...
      (a!8 (and (not bt1738)
                ...
                (= (+ it1642 (* it1645 (- 1))) 0)
                (= (+ it1641 (* it1644 (- 1))) 0)))
      (a!11 (and (and bt1738 (not bt1739))
                 (= (+ it1643 (- 1)) 0)
                 (not bt1740)
                 (= (+ it1642 (* it1645 (- 1))) 0)
                 (= (+ it1641 (* it1644 (- 1))) 0)
...
(let ((a!3 (and a!2
      ...
      (a!13 (and a!2
                 ...
                 (= (+ it1641 (* it1644 (- 1))) 0)
                 (not bt1737))))
(let ((a!7 (or (and a!3 (not bt1737) bt1740)
               bt1734
               bt1735
               bt1736
               (not bt1733)
      ...
      (a!10 (or bt1734
                ...
                (<= (+ it1642 (* it1640 (- 1))) 0)
                (not bt1733))))
  (and (or (not bt1734) (> it1641 0) bt1735 bt1736 (not bt1733) a!1)
       (or (and a!3 bt1737 bt1740)
           (not bt1736)
           bt1734
           bt1735
           bt1733
           (<= it1640 0))
       (or (or (and a!5 bt1737 bt1740) (not bt1736))
           (not bt1734)
           bt1735
           (not bt1733))
       (or bt1734 a!6 bt1736 bt1733 (not bt1735))
       a!7
       (or (not bt1734)
           (and a!8 (not bt1737))
           bt1735
           ...
           (not bt1733)
           (<= it1641 0))
       (or (not bt1734) bt1736 (and a!9 (not bt1737)) bt1733 (not bt1735))
       a!10
       (or a!11 (not bt1734) bt1735 bt1736 bt1733)
       (or bt1734 a!12 bt1736 (not bt1733) (not bt1735))
       (or (or (and a!5 bt1737 bt1740) (not bt1736))
           bt1734
           bt1735
           (> it1640 0)
       ...
       (or (not bt1736)
           (not bt1734)
           (and a!5 (not bt1737) bt1740)
           bt1735
           bt1733)
       (or (not bt1736) bt1734 bt1735 a!13 (not bt1733))
       (= (+ it1639 (- 2)) 0)
       (or (not bt1734) (and a!8 bt1737) bt1736 (not bt1733) (not bt1735))
       (or bt1734 bt1735 a!13 bt1736 bt1733))))))
(check-sat)
