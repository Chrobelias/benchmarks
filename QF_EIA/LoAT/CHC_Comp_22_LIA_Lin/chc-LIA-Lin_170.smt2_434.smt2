...
(assert (or (distinct (+ (* it1451 (- 1)) it1448) 0)
    bt1548
    bt1546
    (distinct (+ it1446 (- 2)) 0)
    bt1541
    ...
    bt1545
    bt1547
    (distinct (+ it1447 (* it1450 (- 1))) 0)
    bt1544
    (distinct (+ (* it1452 (- 1)) it1449) 0)))
(assert (let ((a!1 (and bt1545 (= (+ (* it1452 (- 1)) it1449) 0) (not bt1548)))
      (a!3 (and (not bt1545)
                (= (+ (* it1452 (- 1)) it1449) 0)
                (not bt1548)
                (not bt1546)
                ...
                (= (+ it1447 (* it1450 (- 1))) 0)
                (= (+ (* it1451 (- 1)) it1448) 0)))
      (a!4 (and (and (and (not bt1545) (not bt1547)) bt1546)
                (= (+ it1450 (- 1)) 0)
                (= (+ (* it1452 (- 1)) it1449) 0)
                (not bt1548)
                (= (+ (* it1451 (- 1)) it1448) 0)))
      (a!5 (and (and (not bt1547) bt1548)
                bt1546
                bt1545
                (= (+ (* it1452 (- 1)) it1449) 0)
                (= (+ it1447 (* it1450 (- 1))) 0)
                (= (+ (* it1451 (- 1)) it1448) 0)))
      (a!6 (and (and (and (not bt1545) (not bt1547)) bt1548)
                bt1546
                (= (+ (* it1452 (- 1)) it1449) 0)
                (= (+ it1447 (* it1450 (- 1))) 0)
                (= (+ (* it1451 (- 1)) it1448) 0)))
      (a!7 (and (and (and (not bt1545) (not bt1547)) bt1546)
                (= (+ (* it1452 (- 1)) it1449) 0)
                (not bt1548)
                (= (+ it1447 (* it1450 (- 1))) 0)
                (= (+ (* it1451 (- 1)) it1448) 0)))
      (a!8 (and bt1546
                ...
                (= (+ (* it1451 (- 1)) it1448) 0)
                (= (+ (* it1447 3) (* it1450 (- 1))) 0)))
      (a!9 (and (and (and (not bt1545) (not bt1547)) bt1548)
                (= (+ (* it1452 (- 1)) it1449) 0)
                (not bt1546)
                (= (+ it1447 (* it1450 (- 1))) 0)
                (= (+ (* it1451 (- 1)) it1448) 0)))
      (a!11 (and (and (not bt1545) (not bt1547))
                 (= (+ (* it1452 (- 1)) it1449) 0)
                 (not bt1548)
                 (not bt1546)
                 (= (+ it1447 (* it1450 (- 1))) 0)
      ...
      (a!12 (and (not bt1547)
                 ...
                 (= (+ it1447 (* it1450 (- 1))) 0)
                 (= (+ (* it1451 (- 1)) it1448) 0)))
      (a!15 (and (and (not bt1547) bt1548)
                 bt1545
                 (= (+ (* it1452 (- 1)) it1449) 0)
                 (not bt1546)
                 (= (+ it1447 (* it1450 (- 1))) 0)
...
(let ((a!2 (and a!1
      ...
      (a!14 (and a!1
                 ...
                 (= (+ it1447 (* it1450 (- 1))) 0)
                 (= (+ (* it1451 (- 1)) it1448) 0))))
  (and (or (or bt1541 bt1542) bt1544 a!2 (not bt1543))
       (or (<= it1448 0) bt1543 (not bt1542) bt1544 a!3 (not bt1541))
       (or a!4 bt1541 bt1543 (not bt1542) bt1544)
       (or (> it1447 0) (not bt1544) bt1541 bt1542 bt1543 a!5)
       (or a!6 (not bt1544) bt1541 bt1543 (not bt1542))
       (or a!7 bt1541 (not bt1542) bt1544 (not bt1543))
       (or bt1542 a!8 bt1544 (not bt1543) (not bt1541))
       a!10
       (or (not bt1544) bt1542 bt1543 a!11 (not bt1541))
       a!13
       (or (not bt1544) bt1543 (not bt1542) (not bt1541) a!5)
       (or a!14 (not bt1542) bt1544 (not bt1543) (not bt1541))
       (or (not bt1544) bt1541 bt1542 bt1543 a!15 (<= it1447 0))
       (or (> it1448 0) bt1543 (not bt1542) bt1544 a!16 (not bt1541))
       (= (+ it1446 (- 2)) 0)
       (or (or bt1541 bt1542) bt1543 bt1544 a!11)))))
(check-sat)
