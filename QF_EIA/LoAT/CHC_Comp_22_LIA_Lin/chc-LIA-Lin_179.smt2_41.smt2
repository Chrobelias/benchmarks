...
(assert (and bt1046
     ...
     (= (+ (* it905 (- 1)) it902) 0)))
(assert (= (+ it951 (- 2)) 0))
(assert (= (+ it952 (* it903 (- 1))) 0))
(assert (= (+ it953 (* it904 (- 1))) 0))
(assert (= (+ it954 (* it905 (- 1))) 0))
(assert (or (and (not bt1052) (not bt1110)) (and bt1052 bt1110)))
(assert (or (and bt1051 bt1111) (and (not bt1111) (not bt1051))))
(assert (or (and bt1050 bt1112) (and (not bt1050) (not bt1112))))
(assert (or (and (not bt1113) (not bt1053)) (and bt1053 bt1113)))
(assert (and bt1112 (not bt1110) bt1113 (= (+ it951 (- 2)) 0) (not bt1111)))
(check-sat)
