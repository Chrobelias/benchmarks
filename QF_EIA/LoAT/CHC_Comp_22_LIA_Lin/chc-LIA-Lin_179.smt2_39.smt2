...
(assert (let ((a!1 (and (= (+ it903 (- 1)) 0)
      ...
      (a!4 (and bt1050
                ...
                (= (+ (* it903 (- 1)) it900) 0)
                (= (+ (* it905 (- 1)) it902) 0)))
      (a!5 (and (and bt1052 bt1051)
                (= (+ (* it904 (- 1)) it901) 0)
                (not bt1053)
                (= (+ (* it903 (- 1)) it900) 0)
                (not bt1050)
                (= (+ (* it905 (- 1)) it902) 0)))
      (a!6 (and (and bt1053 (not bt1052))
                (not bt1051)
                (= (+ (* it904 (- 1)) it901) 0)
                (= (+ (* it903 (- 1)) it900) 0)
                (not bt1050)
                (= (+ (* it905 (- 1)) it902) 0)))
      (a!7 (and (and bt1050 (not bt1052))
                (not bt1051)
                (= (+ (* it904 (- 1)) it901) 0)
                (not bt1053)
                (= (+ (* it903 (- 1)) it900) 0)
                (= (+ (* it905 (- 1)) it902) 0)))
      (a!9 (and (and bt1052 bt1051)
                (not bt1053)
                (= (+ (* it903 (- 1)) it900) 0)
                (not bt1050)
                (= (+ it904 (- 10)) 0)
                (= (+ (* it905 (- 1)) it902) 0)))
      (a!10 (and (and bt1050 bt1052)
                 (= (+ (* it903 (- 1)) (* it900 2)) 0)
                 bt1051
                 (= (+ (* it904 (- 1)) it901) 0)
                 (not bt1053)
                 (= (+ (* it905 (- 1)) it902) 0)))
      (a!11 (and (and bt1053 bt1052)
                 (not bt1051)
                 (= (+ (* it904 (- 1)) it901) 0)
                 (= (+ (* it903 (- 1)) it900) 0)
                 (not bt1050)
      ...
      (a!12 (and (and bt1050 (not bt1052))
                 ...
                 (= (+ (* it903 (- 1)) it900) 0)
                 (= (+ (* it905 (- 1)) it902) 0)))
      (a!13 (or (or (or (not bt1047) bt1049) (not bt1046)) bt1048))
      (a!14 (and (and bt1053 (not bt1052))
                 bt1051
                 (= (+ (* it904 (- 1)) it901) 0)
                 (= (+ (* it903 (- 1)) it900) 0)
                 (not bt1050)
                 (= (+ (* it905 (- 1)) it902) 0)))
      (a!16 (and (and bt1053 bt1052)
                 bt1051
                 (= (+ (* it904 (- 1)) it901) 0)
                 (= (+ (* it903 (- 1)) it900) 0)
                 (not bt1050)
                 (= (+ (* it905 (- 1)) it902) 0)))
      (a!18 (= (+ (+ (* it904 (- 1)) it901) (- 1)) 0)))
(let ((a!2 (or (or (or (not bt1047) bt1049) bt1046) bt1048 a!1))
      (a!8 (or (or (or (not bt1047) bt1049) (not bt1046)) (not bt1048) a!7))
      (a!15 (or a!13 a!14 (> (+ it902 (* it900 (- 1))) 0)))
      (a!17 (or a!13 (<= (+ it902 (* it900 (- 1))) 0) a!7))
      (a!19 (and (and bt1050 bt1052)
                 (not bt1051)
                 (not bt1053)
                 (= (+ (* it903 (- 1)) it900) 0)
                 (= (+ (* it905 (- 1)) it902) 0)
                 a!18)))
(let ((a!20 (or (or (or (not bt1047) bt1049) bt1046) a!19 (not bt1048))))
  (and a!2
       (or (or (or bt1049 bt1046) bt1047) a!3 bt1048)
       (or (or (not bt1047) bt1046 (not bt1049)) (> it900 0) a!4 bt1048)
       (or (or bt1046 (not bt1049)) bt1047 bt1048 a!5)
       (or (not bt1047) (not bt1049) (not bt1046) a!3 bt1048)
       (or (or (or bt1049 bt1046) bt1047) a!6 (not bt1048) (> it901 0))
       a!8
       (or (or bt1049 bt1047 (not bt1046)) bt1048 a!9)
       (or (or bt1049 bt1047 (not bt1046)) (not bt1048) a!10)
       (or (or (not bt1047) bt1046 (not bt1049)) a!11 (<= it900 0) bt1048)
       (or (or bt1049 bt1046) (<= it901 0) bt1047 (not bt1048) a!12)
       (or (or bt1046 (not bt1049)) a!4 bt1047 (not bt1048))
       a!15
       (or (not bt1049) bt1047 (not bt1046) bt1048 a!16)
       a!17
       (= (+ it899 (- 2)) 0)
       a!20)))))
(check-sat)
