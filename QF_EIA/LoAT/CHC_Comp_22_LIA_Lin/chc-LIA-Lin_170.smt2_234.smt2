...
(declare-fun bt1141 () Bool)
(declare-fun bt1142 () Bool)
(declare-fun bt1143 () Bool)
(declare-fun bt1144 () Bool)
(assert (= (+ i1 (- 1)) 0))
(assert (= (+ it787 (- 2)) 0))
...
(assert (and (not bt1109)
     ...
     bt1106))
(assert (= (+ it1066 (- 2)) 0))
(assert (= (+ (* it1040 (- 1)) it1067) 0))
(assert (= (+ (* it1041 (- 1)) it1068) 0))
(assert (= (+ it1069 (* it1042 (- 1))) 0))
(assert (or (and (not bt1110) (not bt1141)) (and bt1141 bt1110)))
(assert (or (and (not bt1109) (not bt1142)) (and bt1109 bt1142)))
(assert (or (and (not bt1143) (not bt1111)) (and bt1143 bt1111)))
(assert (or (and (not bt1144) (not bt1112)) (and bt1112 bt1144)))
(assert (and (not bt1143) bt1141 bt1142 (= (+ it1066 (- 2)) 0) bt1144))
(check-sat)
