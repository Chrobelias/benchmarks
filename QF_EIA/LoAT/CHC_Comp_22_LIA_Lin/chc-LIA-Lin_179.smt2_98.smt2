...
(assert (let ((a!1 (and (and bt1798 (not bt1800))
                bt1801
                (= (+ (* it1528 (- 1)) it1525) 0)
                (not bt1799)
                (= (+ (* it1529 (- 1)) it1526) 0)
                (= (+ (* it1530 (- 1)) it1527) 0)))
      (a!2 (and (and (not bt1800) bt1801)
                (= (+ (* it1528 (- 1)) it1525) 0)
                (not bt1799)
                (= (+ (* it1529 (- 1)) it1526) 0)
                (not bt1798)
                (= (+ (* it1530 (- 1)) it1527) 0)))
      (a!3 (and bt1799 (= (+ (* it1528 (- 1)) it1525) 0) bt1800))
      (a!5 (and (and bt1798 (not bt1800))
                (= (+ (* it1528 (- 1)) it1525) 0)
                (not bt1799)
                (= (+ (* it1529 (- 1)) it1526) 0)
                (not bt1801)
                (= (+ (* it1530 (- 1)) it1527) 0)))
      (a!6 (= (+ (+ (* it1529 (- 1)) it1526) (- 1)) 0))
      (a!8 (and bt1801
                bt1799
                (= (+ (* it1528 (- 1)) it1525) 0)
                bt1800
      ...
      (a!10 (and (not bt1800)
                 ...
                 (not bt1798)
                 (= (+ (* it1530 (- 1)) it1527) 0)))
      (a!11 (and (and bt1798 (not bt1800))
                 bt1799
                 (= (+ (* it1528 (- 1)) it1525) 0)
                 (= (+ (* it1529 (- 1)) it1526) 0)
                 (not bt1801)
      ...
      (a!15 (and bt1798
                 ...
                 (= (+ (* it1528 (- 1)) (* it1525 2)) 0)
                 (= (+ (* it1530 (- 1)) it1527) 0)))
      (a!16 (and (and (not bt1800) bt1801)
                 bt1799
                 (= (+ (* it1528 (- 1)) it1525) 0)
                 (= (+ (* it1529 (- 1)) it1526) 0)
                 (not bt1798)
...
(let ((a!4 (and a!3
      ...
      (a!17 (or a!16
                ...
                bt1796
                (not bt1795))))
  (and (or a!1 bt1794 (not bt1796) (not bt1797) bt1795)
       (or (> it1526 0) bt1794 a!2 (not bt1796) bt1797 bt1795)
       (or bt1794 a!4 (not bt1797) bt1796 bt1795)
       (or (not bt1794) a!5 (not bt1796) bt1797 (not bt1795))
       (or bt1794 a!7 (not bt1796) bt1797 (not bt1795))
       (or a!8 (not bt1794) (not bt1797) bt1796 bt1795)
       (= (+ it1524 (- 2)) 0)
       (or bt1794 a!9 bt1797 bt1796 (not bt1795))
       (or (not bt1794) (not bt1797) bt1796 a!10 (not bt1795))
       (or bt1794 bt1797 bt1796 a!10 bt1795)
       (or a!11 bt1794 (not bt1796) bt1797 (<= it1526 0) bt1795)
       (or (<= it1525 0) bt1794 a!12 (not bt1797) bt1796 (not bt1795))
       (or (not bt1794) a!13 bt1797 bt1796 bt1795)
       a!14
       (or a!1 (> it1525 0) bt1794 (not bt1797) bt1796 (not bt1795))
       (or (not bt1794) a!15 (not bt1796) bt1797 bt1795)
       a!17))))
(check-sat)
