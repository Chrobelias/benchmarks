...
(assert (let ((a!1 (and bt1508
      ...
      (a!10 (and bt1509
                 ...
                 (not bt1506)
                 (not bt1507)))
      (a!11 (and (and bt1506 bt1507)
                 bt1508
                 (= (+ (* it1286 (- 1)) it1283) 0)
                 (= (+ (* it1287 (- 1)) it1284) 0)
                 (not bt1509)
                 (= (+ (* it1285 (- 1)) (* it1282 2)) 0)))
      (a!14 (= (+ (+ (* it1286 (- 1)) it1283) (- 1)) 0))
      (a!16 (and bt1508
                 bt1509
                 (= (+ (* it1285 (- 1)) it1282) 0)
                 (= (+ (* it1286 (- 1)) it1283) 0)
                 ...
                 (not bt1506)
                 (not bt1507)))
      (a!17 (and (and bt1507 bt1508) (= (+ (* it1285 (- 1)) it1282) 0))))
(let ((a!7 (or (or bt1504 bt1505 (not bt1502) (not bt1503))
               (> (+ it1284 (* it1282 (- 1))) 0)
               a!6))
      (a!9 (or (or (or bt1503 (not bt1504)) bt1505) bt1502 (<= it1283 0) a!8))
      (a!12 (or (or (or bt1503 (not bt1504)) bt1505) (not bt1502) a!11))
      (a!13 (or (or bt1504 bt1505 (not bt1502) (not bt1503))
                a!4
                (<= (+ it1284 (* it1282 (- 1))) 0)))
      (a!15 (and bt1506
                 bt1508
      ...
      (a!19 (and a!17
                 ...
                 (not bt1509)
                 (= (+ it1286 (- 10)) 0))))
  (and (or a!1 bt1504 bt1505 bt1502 (not bt1503))
       (or (or bt1503 (not bt1505) bt1504) (not bt1502) a!2)
       (or (or bt1503 (not bt1504)) (not bt1505) bt1502 a!3)
       (or (or (not bt1504) bt1505) (not bt1502) (not bt1503) a!4)
       (or (or (not bt1505) bt1504) (not bt1502) (not bt1503) a!5)
       a!7
       a!9
       (or (or bt1503 (not bt1504)) a!10 bt1505 bt1502 (> it1283 0))
       (= (+ it1281 (- 2)) 0)
       a!12
       a!13
       (or (or (not bt1504) bt1505) bt1502 (not bt1503) a!15)
       (or (not bt1505) (> it1282 0) bt1504 bt1502 (not bt1503) a!3)
       (or (or (not bt1505) bt1504) bt1502 (not bt1503) a!16 (<= it1282 0))
       (or (or bt1503 (not bt1505) bt1504) bt1502 a!18)
       (or (or bt1503 bt1504 bt1505) bt1502 a!5)
       (or (or bt1503 bt1504 bt1505) (not bt1502) a!19)))))
(check-sat)
