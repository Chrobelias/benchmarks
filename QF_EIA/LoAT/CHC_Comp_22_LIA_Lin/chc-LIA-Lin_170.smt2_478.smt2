...
(assert (let ((a!1 (and bt1661
      ...
      (a!2 (and (not bt1662)
                ...
                (= (+ (* it1567 (- 1)) it1564) 0)
                (= (+ (* it1568 (- 1)) it1565) 0)))
      (a!3 (and (not bt1663) (= (+ (* it1569 (- 1)) it1566) 0) bt1662))
      (a!5 (and (not bt1663) bt1661 (= (+ (* it1569 (- 1)) it1566) 0) bt1662))
      (a!8 (and (not bt1662)
                (= (+ (* it1569 (- 1)) it1566) 0)
                bt1663
                (not bt1664)
      ...
      (a!9 (and (= (+ (* it1567 (- 1)) (* it1564 2)) 0)
                ...
                (not bt1664)
                (= (+ (* it1568 (- 1)) it1565) 0)))
      (a!10 (and (and (not bt1663) (not bt1662))
                 (= (+ (* it1569 (- 1)) it1566) 0)))
      (a!16 (and (and (not bt1663) (not bt1662))
                 bt1661
                 (= (+ (* it1569 (- 1)) it1566) 0)
                 (= (+ (* it1567 (- 1)) it1564) 0)
                 bt1664
                 (= (+ (* it1568 (- 1)) it1565) 0)))
      (a!18 (and (= (+ (* it1569 (- 1)) it1566) 0)
                 bt1662
                 bt1663
                 (not bt1664)
                 (= (+ (* it1567 (- 1)) it1564) 0)
                 (not bt1661)
                 (= (+ (* it1568 (- 1)) it1565) 0))))
(let ((a!4 (and (and a!3 (not bt1664))
                (= (+ (* it1567 (- 1)) it1564) 0)
                (not bt1661)
                (= (+ (* it1568 (- 1)) it1565) 0)))
      (a!6 (and a!5
...
(let ((a!13 (or bt1660
      ...
      (a!15 (or bt1660
                ...
                bt1659
                (not bt1657))))
  (and (or bt1660 a!1 bt1658 (not bt1657) (not bt1659))
       (or (or bt1660 (not bt1658)) (not bt1657) a!2 (not bt1659))
       (or (or bt1660 (not bt1658)) bt1657 a!4 (not bt1659))
       (or (> it1564 0) bt1658 bt1659 (not bt1660) bt1657 a!6)
       (or (or bt1660 (not bt1658)) bt1659 bt1657 a!7)
       (or (or (not bt1658) bt1659) (not bt1660) a!6 (not bt1657))
       (or bt1660 a!8 (not bt1658) bt1659 (not bt1657) (<= it1565 0))
       (or (or bt1660 bt1658) a!9 bt1657 (not bt1659))
       (or (or bt1660 bt1658) bt1659 a!11 bt1657)
       a!13
       (= (+ it1563 (- 2)) 0)
       (or bt1658 bt1659 (not bt1660) a!11 (not bt1657))
       a!15
       (or (<= it1564 0) bt1658 bt1659 (not bt1660) bt1657 a!16)
       (or (or (not bt1658) bt1659) a!17 (not bt1660) bt1657)
       (or bt1660 (> it1565 0) (not bt1658) bt1659 (not bt1657) a!18))))))
(check-sat)
