...
(assert (or bt1694
    bt1690
    (distinct (+ (* it1610 (- 1)) it1607) 0)
    bt1696
    bt1693
    (distinct (+ (* it1608 (- 1)) it1605) 0)
    (not bt1692)
    (distinct (+ it1604 (- 2)) 0)
    (distinct (+ (* it1609 (- 1)) it1606) 0)
    (not bt1689)
    bt1695))
(assert (let ((a!1 (and (not bt1695) (not bt1693) (= (+ (* it1610 (- 1)) it1607) 0)))
      (a!4 (and bt1694
                (not bt1693)
                (= (+ (* it1610 (- 1)) it1607) 0)
                (not bt1696)
      ...
      (a!10 (and bt1694
                 ...
                 (= (+ (* it1609 (- 1)) it1606) 0)
                 bt1695))
      (a!11 (and (and (not bt1695) bt1694) (= (+ (* it1610 (- 1)) it1607) 0)))
      (a!17 (and (not bt1693)
                 (= (+ (* it1610 (- 1)) it1607) 0)
                 (not bt1696)
                 (= (+ (* it1608 (- 1)) it1605) 0)
...
(let ((a!2 (and a!1
      ...
      (a!15 (and a!11
                 ...
                 (= (+ (* it1608 (- 1)) it1605) 0)
                 (= (+ (* it1609 (- 1)) it1606) 0))))
(let ((a!3 (or (or bt1691 bt1690 bt1692)
               (> (+ it1607 (* it1605 (- 1))) 0)
               a!2
               (not bt1689)))
      (a!6 (or (or (or bt1691 (not bt1692)) bt1690) a!5 (not bt1689)))
      (a!16 (or (or bt1691 bt1690 bt1692)
                (<= (+ it1607 (* it1605 (- 1))) 0)
                a!15
                (not bt1689)))
      (a!18 (or (or (or bt1691 (not bt1692)) bt1690) a!12 (> it1605 0) bt1689)))
  (and a!3
       (or (or (or bt1691 bt1692) (not bt1690)) (> it1606 0) a!4 (not bt1689))
       a!6
       (or a!7 bt1690 bt1692 bt1689 (not bt1691))
       (or bt1692 (not bt1690) a!9 bt1689 (not bt1691))
       (or bt1690 bt1692 a!10 (not bt1691) (not bt1689))
       (or (or bt1691 (not bt1692)) a!12 (not bt1690) (not bt1689))
       (or (or bt1691 (not bt1692)) (not bt1690) bt1689 a!13)
       (or (or (or bt1691 bt1692) (not bt1690)) bt1689 a!14)
       a!16
       (or (or bt1691 bt1692) a!17 (not bt1690) (<= it1606 0) (not bt1689))
       a!18
       (or (or bt1691 bt1690 bt1692) bt1689 a!5)
       (or a!19 bt1692 (not bt1690) (not bt1691) (not bt1689))
       (= (+ it1604 (- 2)) 0)
       (or (<= it1605 0) bt1691 (not bt1692) a!20 bt1690 bt1689))))))
(check-sat)
