...
(assert (let ((a!1 (and (= (+ (* it1643 (- 1)) it1640) 0)
                (not bt1737)
                (not bt1739)
                (= (+ it1641 (* it1644 (- 1))) 0)
                (= (+ it1642 (* it1645 (- 1))) 0)
                bt1740
                (not bt1738)))
      (a!3 (and (= (+ (* it1643 (- 1)) it1640) 0) (not bt1740)))
      (a!5 (and (= (+ (* it1643 (- 1)) it1640) 0) bt1738))
      (a!7 (and (= (+ (* it1643 (- 1)) it1640) 0)
                (not bt1739)
                (= (+ it1641 (* it1644 (- 1))) 0)
                (= (+ it1642 (* it1645 (- 1))) 0)
                bt1737
...
(let ((a!2 (or bt1734
               ...
               (> (+ it1642 (* it1640 (- 1))) 0)
               (not bt1733)))
      (a!4 (and (and (and a!3 bt1738) (not bt1737))
                (not bt1739)
                (= (+ it1641 (* it1644 (- 1))) 0)
                (= (+ it1642 (* it1645 (- 1))) 0)))
      (a!6 (and a!5
      ...
      (a!11 (and a!5
                 ...
                 (= (+ it1642 (* it1645 (- 1))) 0)
                 bt1740))
      (a!12 (and (and (and a!3 bt1738) (not bt1737))
                 (= (+ it1641 (* it1644 (- 1))) 0)
                 (= (+ it1642 (* it1645 (- 1))) 0)
                 bt1739))
      (a!14 (and (and a!3 (not bt1737))
                 (= (+ it1641 (* it1644 (- 1))) 0)
                 (= (+ it1642 (* it1645 (- 1))) 0)
                 bt1739
                 (not bt1738)))
      (a!15 (and (and a!3 (not bt1737))
                 (not bt1739)
                 (= (+ it1641 (* it1644 (- 1))) 0)
                 (= (+ it1642 (* it1645 (- 1))) 0)
                 (not bt1738)))
      (a!16 (and (and a!3 bt1738)
                 (not bt1739)
                 (= (+ it1641 (* it1644 (- 1))) 0)
                 (= (+ it1642 (* it1645 (- 1))) 0)
                 bt1737)))
(let ((a!17 (or a!16
                ...
                (not bt1733))))
  (and a!2
       (or a!4 bt1736 (not bt1735) (not bt1734) bt1733)
       (or (not bt1736) a!6 bt1735 (not bt1734) (not bt1733))
       (or bt1734 (<= it1640 0) (not bt1736) bt1735 a!7 bt1733)
       (or a!8 bt1734 bt1736 (not bt1735) bt1733)
       (or a!9 bt1736 (not bt1735) (not bt1734) (not bt1733))
       (= (+ it1639 (- 2)) 0)
       (or a!10 bt1735 bt1736 (not bt1734) bt1733)
       (or (not bt1736) bt1735 (not bt1734) bt1733 a!11)
       (or (> it1641 0) bt1735 bt1736 (not bt1734) (not bt1733) a!12)
       (or bt1734 bt1736 (not bt1735) (not bt1733) a!13)
       (or a!14 bt1735 bt1736 (not bt1734) (<= it1641 0) (not bt1733))
       (or (or bt1734 (not bt1736)) bt1735 (not bt1733) a!15)
       (or bt1734 bt1735 bt1736 bt1733 a!15)
       (or (or bt1734 (not bt1736)) (> it1640 0) a!6 bt1735 bt1733)
       a!17)))))
(check-sat)
