...
(assert (or (distinct (+ (* it1530 (- 1)) it1527) 0)
    (not bt1795)
    bt1801
    bt1799
    (distinct (+ it1524 (- 2)) 0)
    ...
    (not bt1796)
    (not bt1794)
    (distinct (+ (* it1529 (- 1)) it1526) 0)
    bt1800
    (distinct (+ (* it1528 (- 1)) it1525) 0)))
(assert (let ((a!1 (and (= (+ (* it1529 (- 1)) it1526) 0) bt1801))
      (a!4 (and (= (+ (* it1529 (- 1)) it1526) 0)
                bt1799
                (= (+ (* it1530 (- 1)) it1527) 0)
                (= (+ (* it1528 (- 1)) it1525) 0)
                bt1800
      ...
      (a!5 (and (= (+ (* it1529 (- 1)) it1526) 0)
                ...
                (not bt1801)
                (not bt1798)))
      (a!6 (and bt1798 (= (+ (* it1529 (- 1)) it1526) 0)))
      (a!9 (= (+ (+ (* it1529 (- 1)) it1526) (- 1)) 0))
      (a!11 (and (= (+ it1528 (- 1)) 0)
                 (= (+ (* it1529 (- 1)) it1526) 0)
                 (not bt1799)
                 (= (+ (* it1530 (- 1)) it1527) 0)
      ...
      (a!17 (and bt1799
                 ...
                 (not bt1801)
                 (not bt1798))))
(let ((a!2 (and (and a!1 (not bt1799))
                (not bt1800)
                (= (+ (* it1530 (- 1)) it1527) 0)
                (= (+ (* it1528 (- 1)) it1525) 0)
                (not bt1798)))
      (a!3 (and (and a!1 bt1799)
                (= (+ (* it1530 (- 1)) it1527) 0)
                (= (+ (* it1528 (- 1)) it1525) 0)
                bt1800
                (not bt1798)))
      ...
      (a!10 (and bt1798
                 ...
                 (not bt1801)
                 a!9))
      (a!12 (and (and a!1 (not bt1799))
                 (= (+ (* it1530 (- 1)) it1527) 0)
                 (= (+ (* it1528 (- 1)) it1525) 0)
                 bt1800
                 (not bt1798)))
      (a!13 (and (and a!6 bt1799)
                 (not bt1800)
                 (= (+ (* it1530 (- 1)) it1527) 0)
                 (= (+ (* it1528 (- 1)) it1525) 0)
                 (not bt1801)))
      (a!14 (and (and a!1 bt1799)
                 (not bt1800)
                 (= (+ (* it1530 (- 1)) it1527) 0)
                 (= (+ (* it1528 (- 1)) it1525) 0)
                 (not bt1798)))
      (a!16 (and a!6
                 ...
                 (= (+ (* it1530 (- 1)) it1527) 0)
                 (= (+ (* it1528 (- 1)) it1525) 0)))
      (a!18 (and (and a!6 bt1799)
                 (= (+ (* it1528 (- 1)) (* it1525 2)) 0)
                 (= (+ (* it1530 (- 1)) it1527) 0)
                 bt1800
                 (not bt1801))))
(let ((a!8 (or (<= (+ (* it1525 (- 1)) it1527) 0)
               a!7
               (not bt1794)
               (not bt1795)
               bt1797
               bt1796))
      (a!15 (or (> (+ (* it1525 (- 1)) it1527) 0)
                (not bt1794)
                (not bt1795)
                bt1797
                a!14
                bt1796)))
  (and (or (> it1526 0) a!2 (not bt1796) bt1794 bt1797 bt1795)
       (or (or (not bt1797) (not bt1794)) a!3 bt1796 bt1795)
       (or a!4 (not bt1797) bt1794 bt1796 bt1795)
       (or a!5 bt1794 bt1797 bt1796 bt1795)
       a!8
       (or (not bt1795) (not bt1796) a!10 bt1794 bt1797)
       (or a!11 (not bt1795) bt1794 bt1797 bt1796)
       (= (+ it1524 (- 2)) 0)
       (or (or (not bt1797) (not bt1794)) (not bt1795) a!5 bt1796)
       (or a!7 (not bt1794) (not bt1795) (not bt1796) bt1797)
       (or (not bt1797) a!12 (not bt1795) bt1794 (<= it1525 0) bt1796)
       (or (not bt1796) a!13 (<= it1526 0) bt1794 bt1797 bt1795)
       a!15
       (or (not bt1797) (not bt1795) bt1794 (> it1525 0) bt1796 a!16)
       (or (not bt1794) a!17 bt1797 bt1796 bt1795)
       (or a!18 (not bt1794) (not bt1796) bt1797 bt1795)
       (or (not bt1797) (not bt1796) bt1794 a!16 bt1795))))))
(check-sat)
