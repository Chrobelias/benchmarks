...
(assert (or (not bt725)
    (distinct (+ it680 (- 2)) 0)
    (distinct (+ it682 (* it685 (- 1))) 0)
    (not bt727)
    (distinct (+ (* it684 (- 1)) (* it681 3)) 0)
    bt728
    (not bt723)
    (not bt721)
    (not bt726)
    (distinct (+ (* it686 (- 1)) it683) 0)
    bt722))
(assert (let ((a!1 (and (= (+ it682 (* it685 (- 1))) 0) (= (+ (* it684 (- 1)) it681) 0)))
      (a!4 (and (= (+ it682 (* it685 (- 1))) 0)
                bt725
                (not bt728)
                (= (+ (* it686 (- 1)) it683) 0)))
      (a!12 (and (= (+ it682 (* it685 (- 1))) 0)
                 (not bt725)
                 (not bt728)
                 (= (+ (* it686 (- 1)) it683) 0)
                 bt726
                 (not bt727)
                 (= (+ it684 (- 1)) 0))))
(let ((a!2 (and (and a!1 (not bt725)) (= (+ (* it686 (- 1)) it683) 0)))
      (a!5 (and a!4 bt727 (not bt726) (= (+ (* it684 (- 1)) (* it681 2)) 0)))
      (a!6 (and a!4 bt726 (= (+ (* it684 (- 1)) (* it681 3)) 0) bt727))
      (a!7 (and (and a!1 bt725) (= (+ (* it686 (- 1)) it683) 0)))
      (a!9 (and (and a!1 (not bt725))
                (not bt728)
                (= (+ (* it686 (- 1)) it683) 0)))
      (a!10 (and (and a!1 bt725) (not bt728) (= (+ (* it686 (- 1)) it683) 0))))
(let ((a!3 (or (and a!2 bt728 (not bt726) (not bt727))
               bt723
               bt724
               (> (+ it683 (* it681 (- 1))) 0)
               (not bt721)
               bt722))
      (a!8 (or (and a!7 bt726 bt728 (not bt727)) bt723 (not bt724)))
      (a!11 (or (or bt723 bt724)
                (<= (+ it683 (* it681 (- 1))) 0)
                (and a!10 bt726 (not bt727))
                (not bt721)
                bt722)))
  (and a!3
       (or bt724 (not bt723) a!5 bt721 bt722)
       (or (or bt723 (not bt724))
           (and a!2 bt726 bt728 (not bt727))
           (not bt722)
           bt721)
       (or bt724 a!6 (not bt723) (not bt721) bt722)
       (or a!8 (not bt722) (not bt721))
       (or a!8 (> it681 0) bt721 bt722)
       (or (> it682 0)
           bt723
           bt724
           (not bt722)
           (and (and a!9 bt726) bt727)
           (not bt721))
       a!11
       (or bt724
           (and (and a!9 bt726) (not bt727))
           (not bt723)
           (not bt722)
           bt721)
       (or (and a!9 bt727 (not bt726))
           bt723
           bt724
           (<= it682 0)
           (not bt722)
           (not bt721))
       (or bt724
           (and a!10 bt727 (not bt726))
           (not bt723)
           (not bt722)
           (not bt721))
       (or (or bt723 bt724) (and a!9 (not bt726) (not bt727)) bt721 bt722)
       (= (+ it680 (- 2)) 0)
       (or (or bt723 (not bt724))
           (and a!9 (not bt726) (not bt727))
           (not bt721)
           bt722)
       (or (or bt723 bt724) a!12 (not bt722) bt721)
       (or (or bt723 (not bt724))
           (and a!7 bt728 (not bt726) (not bt727))
           (<= it681 0)
           bt721
           bt722))))))
(check-sat)
