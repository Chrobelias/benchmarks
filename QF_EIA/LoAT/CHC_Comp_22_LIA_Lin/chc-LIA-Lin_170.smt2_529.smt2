...
(declare-fun bt1778 () Bool)
(declare-fun bt1779 () Bool)
(declare-fun bt1780 () Bool)
(assert (= (+ i1 (- 1)) 0))
(assert (= (+ it1100 (- 2)) 0))
...
(assert (and (= (+ (* it1643 (- 1)) it1640) 0)
     ...
     (= (+ it1642 (* it1645 (- 1))) 0)))
(assert (= (+ it1675 (- 2)) 0))
(assert (= (+ (* it1643 (- 1)) it1676) 0))
(assert (= (+ (* it1644 (- 1)) it1677) 0))
(assert (= (+ (* it1645 (- 1)) it1678) 0))
(assert (or (and (not bt1777) (not bt1738)) (and bt1738 bt1777)))
(assert (or (and bt1778 bt1737) (and (not bt1737) (not bt1778))))
(assert (or (and bt1739 bt1779) (and (not bt1779) (not bt1739))))
(assert (or (and (not bt1780) (not bt1740)) (and bt1780 bt1740)))
(assert (and bt1777 bt1778 (= (+ it1675 (- 2)) 0) bt1780 (not bt1779)))
(check-sat)
