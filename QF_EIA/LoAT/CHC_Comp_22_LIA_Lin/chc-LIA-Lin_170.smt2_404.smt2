...
(assert (let ((a!1 (and (= (+ (* it1414 (- 1)) it1411) 0)
                bt1497
                (= (+ (* it1413 (- 1)) it1410) 0)))
      (a!3 (and (= (+ (* it1414 (- 1)) it1411) 0)
                (not bt1497)
                (= (+ (* it1413 (- 1)) it1410) 0))))
(let ((a!2 (and (and a!1 (not bt1500))
                (not bt1498)
                bt1499
                (= (+ (* it1412 (- 1)) it1409) 0)))
      (a!4 (and (and (and a!3 (not bt1499)) (not bt1500))
                (= (+ it1412 (- 1)) 0)
                bt1498))
      (a!5 (and (and a!1 (not bt1499))
                (not bt1500)
                (= (+ (* it1412 (- 1)) it1409) 0)
                bt1498))
      (a!7 (and (and (and a!3 (not bt1499)) (not bt1500))
                (= (+ (* it1412 (- 1)) it1409) 0)
                bt1498))
      (a!8 (and (and a!3 (not bt1500))
                (not bt1498)
                bt1499
                (= (+ (* it1412 (- 1)) it1409) 0)))
      (a!9 (and (and a!3 (not bt1499))
                (not bt1498)
                bt1500
                (= (+ (* it1412 (- 1)) it1409) 0)))
      (a!11 (and (and a!1 (not bt1499))
                 bt1500
                 (= (+ (* it1412 (- 1)) it1409) 0)
                 bt1498))
      (a!12 (and (and a!3 (not bt1500))
                 bt1499
                 (= (+ (* it1412 (- 1)) it1409) 0)
                 bt1498))
      (a!13 (and (and (and a!3 (not bt1499)) (not bt1500))
                 (not bt1498)
                 (= (+ (* it1412 (- 1)) it1409) 0)))
      (a!14 (and (and a!1 (not bt1499))
                 (not bt1498)
                 bt1500
                 (= (+ (* it1412 (- 1)) it1409) 0)))
      (a!15 (and (and a!1 (not bt1500))
                 bt1499
                 (= (+ (* it1412 (- 1)) (* it1409 3)) 0)
                 bt1498))
      (a!16 (and (and a!3 (not bt1499))
                 bt1500
                 (= (+ (* it1412 (- 1)) it1409) 0)
                 bt1498))
      (a!17 (and (and a!1 (not bt1500))
                 (= (+ (* it1412 (- 1)) (* it1409 2)) 0)
                 (not bt1498)
                 bt1499)))
(let ((a!6 (or a!5
               ...
               (not bt1493)
               bt1496))
      (a!10 (or (> (+ (* it1409 (- 1)) it1411) 0)
                bt1494
                bt1495
                (not bt1493)
                a!9
                bt1496)))
  (and (or a!2 (not bt1494) (not bt1495) (not bt1493) bt1496)
       (or (or (not bt1494) bt1495) bt1493 a!4 bt1496)
       a!6
       (or (not bt1494) a!7 (not bt1495) bt1493 bt1496)
       (or (not bt1494) a!8 bt1495 (not bt1493) (<= it1410 0) bt1496)
       a!10
       (or bt1494 bt1495 a!11 bt1493 (> it1409 0) (not bt1496))
       (or (or (not bt1494) bt1495) a!12 (not bt1493) (> it1410 0) bt1496)
       (or (or bt1494 a!13 bt1495) (not bt1493) (not bt1496))
       (or bt1494 a!14 bt1495 bt1493 (not bt1496) (<= it1409 0))
       (or bt1494 (not bt1495) a!15 (not bt1493) bt1496)
       (or a!16 (not bt1494) bt1495 bt1493 (not bt1496))
       (or bt1494 a!17 (not bt1495) bt1493 bt1496)
       (or (or bt1494 a!13 bt1495) bt1493 bt1496)
       (= (+ it1408 (- 2)) 0)
       (or (or (not bt1494) bt1495) a!11 (not bt1493) (not bt1496)))))))
(check-sat)
