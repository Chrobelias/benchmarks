...
(assert (= (+ (+ 0 it1085) (* (+ 0 it1010) (exp 2 it1082) (+ 0 (- 1))))
   (+ 0 0)))
...
(assert (and (not bt1162)
     ...
     (> it1086 0)))
(assert (= (+ it1093 (- 2)) 0))
(assert (= (+ (* it800 (- 1)) it1094) 0))
(assert (= (+ (* it801 (- 1)) it1095) 0))
(assert (= (+ it1096 (* it802 (- 1))) 0))
(assert (or (and bt850 bt1165) (and (not bt1165) (not bt850))))
(assert (or (and bt849 bt1166) (and (not bt1166) (not bt849))))
(assert (or (and (not bt851) (not bt1167)) (and bt1167 bt851)))
(assert (or (and bt852 bt1168) (and (not bt1168) (not bt852))))
(assert (and bt1168 (not bt1167) bt1166 (= (+ it1093 (- 2)) 0) bt1165))
(check-sat)
