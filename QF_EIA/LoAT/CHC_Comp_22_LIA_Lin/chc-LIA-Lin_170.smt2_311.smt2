...
(assert (let ((a!1 (and (= (+ (* it1223 (- 1)) it1220) 0)
                (= (+ (* it1222 (- 1)) it1219) 0)))
      ...
      (a!13 (and (= (+ (* it1223 (- 1)) it1220) 0)
                 ...
                 bt1299
                 (not bt1300))))
(let ((a!2 (and a!1 (not bt1297) bt1298 (= (+ (* it1224 (- 1)) it1221) 0)))
      (a!3 (and (and a!1 (not bt1298))
                bt1297
                (= (+ (* it1224 (- 1)) it1221) 0)
                bt1299
                (not bt1300)))
      (a!5 (and (and (and a!1 (not bt1298)) bt1300)
                bt1297
                (= (+ (* it1224 (- 1)) it1221) 0)
                (not bt1299)))
      (a!6 (and (and a!1 bt1300)
                bt1297
                bt1298
                (= (+ (* it1224 (- 1)) it1221) 0)
                (not bt1299)))
      (a!7 (and (and (and a!1 (not bt1298)) bt1300)
                (not bt1297)
                (= (+ (* it1224 (- 1)) it1221) 0)
                (not bt1299)))
      (a!10 (and a!1
                 ...
                 (not bt1299)
                 (not bt1300)))
      (a!12 (and (and a!1 (not bt1298))
                 (not bt1297)
                 (= (+ (* it1224 (- 1)) it1221) 0)))
      (a!14 (and (and a!1 bt1300)
                 (not bt1297)
                 bt1298
                 (= (+ (* it1224 (- 1)) it1221) 0)
                 (not bt1299))))
(let ((a!8 (or bt1296
      ...
      (a!11 (or a!10
                ...
                (not bt1293))))
  (and (or (> it1220 0)
           (and a!2 bt1299 (not bt1300))
           bt1296
           (not bt1294)
           bt1295
           (not bt1293))
       (or (or bt1296 (not bt1294))
           (and a!2 (not bt1299) (not bt1300))
           bt1293
           (not bt1295))
       (or (or bt1296 (not bt1294)) a!3 (not bt1293) (not bt1295))
       (or bt1296 bt1294 a!4 (not bt1293) (not bt1295))
       (or (<= it1219 0) (not bt1296) bt1295 bt1294 bt1293 a!5)
       (or (or (not bt1294) (not bt1296) bt1295) a!6 (not bt1293))
       a!8
       (= (+ it1218 (- 2)) 0)
       (or a!9 bt1296 (not bt1294) bt1295 bt1293)
       (or (not bt1296) (> it1219 0) bt1295 bt1294 bt1293 a!6)
       a!11
       (or (not bt1296)
           bt1295
           bt1294
           (and a!12 (not bt1299) (not bt1300))
           (not bt1293))
       (or bt1296 a!13 bt1294 bt1293 (not bt1295))
       (or (<= it1220 0)
           bt1296
           (not bt1294)
           bt1295
           (not bt1293)
           (and a!12 bt1299 (not bt1300)))
       (or bt1296 bt1295 bt1294 (and a!12 (not bt1299) (not bt1300)) bt1293)
       (or (or (not bt1294) (not bt1296) bt1295) bt1293 a!14))))))
(check-sat)
