...
(assert (let ((a!1 (and (= (+ it1479 (* it1482 (- 1))) 0) bt1582))
      (a!5 (and (= (+ it1479 (* it1482 (- 1))) 0) (not bt1581)))
      (a!7 (and (= (+ (* it1480 (- 1)) (* it1477 2)) 0)
                bt1583
                (= (+ it1479 (* it1482 (- 1))) 0)
                (not bt1584)
                (= (+ (* it1481 (- 1)) it1478) 0)
                bt1581
                (not bt1582)))
      (a!9 (and bt1583 (= (+ it1479 (* it1482 (- 1))) 0)))
      (a!15 (and (= (+ it1479 (* it1482 (- 1))) 0)
                 bt1584
                 (= (+ (* it1480 (- 1)) it1477) 0)
                 (= (+ (* it1481 (- 1)) it1478) 0)
                 bt1581
...
(let ((a!2 (and a!1
      ...
      (a!6 (and a!5
                ...
                (not bt1582)
                (not bt1583)))
      (a!8 (and (and a!1 (not bt1581))
                (not bt1584)
                (= (+ (* it1480 (- 1)) it1477) 0)
                (= (+ (* it1481 (- 1)) it1478) 0)
                (not bt1583)))
      (a!10 (and (and a!9 bt1582)
                 (not bt1584)
                 (= (+ (* it1481 (- 1)) it1478) 0)
                 (= (+ (* it1480 (- 1)) (* it1477 3)) 0)
                 bt1581))
      ...
      (a!16 (and a!5
                 ...
                 (not bt1582)
                 (not bt1583)))
      (a!18 (and (and a!9 bt1582)
                 (not bt1581)
                 (not bt1584)
                 (= (+ (* it1480 (- 1)) it1477) 0)
                 (= (+ (* it1481 (- 1)) it1478) 0))))
(let ((a!3 (or (or bt1580 bt1578)
               bt1579
               a!2
               (<= (+ it1479 (* it1477 (- 1))) 0)
               (not bt1577)))
      (a!17 (or bt1580
                ...
                a!16)))
  (and a!3
       (or (not bt1580) bt1577 bt1579 (not bt1578) a!4)
       (or (not bt1580) bt1578 bt1579 a!6 (not bt1577))
       (or (or bt1580 (not bt1579)) bt1578 bt1577 a!7)
       (or bt1580 a!8 (not bt1579) bt1577 (not bt1578))
       (= (+ it1476 (- 2)) 0)
       (or a!10 bt1580 (not bt1579) bt1578 (not bt1577))
       (or (not bt1580) bt1579 a!11 (not bt1578) (not bt1577))
       (or (or bt1580 (not bt1579)) a!12 (not bt1578) (not bt1577))
       (or (> it1477 0) (not bt1580) bt1578 bt1577 bt1579 a!11)
       (or a!13 bt1580 bt1579 (<= it1478 0) (not bt1578) (not bt1577))
       (or a!14 bt1580 bt1577 bt1579 (not bt1578))
       (or (<= it1477 0) (not bt1580) bt1578 bt1577 bt1579 a!15)
       (or (or bt1580 bt1578) bt1577 bt1579 a!6)
       a!17
       (or a!18 bt1580 (> it1478 0) bt1579 (not bt1578) (not bt1577)))))))
(check-sat)
