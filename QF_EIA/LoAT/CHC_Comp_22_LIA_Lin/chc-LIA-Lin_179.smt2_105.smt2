...
(assert (or (not bt1774)
    (distinct (+ it1505 (- 2)) 0)
    (not bt1776)
    (not bt1772)
    (distinct (+ (* it1509 (- 1)) (* it1506 2)) 0)
    bt1771
    (not bt1770)
    bt1777
    (distinct (+ (* it1510 (- 1)) it1507) 0)
    (not bt1775)
    (distinct (+ (* it1511 (- 1)) it1508) 0)))
(assert (let ((a!1 (and (not bt1776)
                (not bt1774)
                bt1777
                (= (+ (* it1510 (- 1)) it1507) 0)
                (= (+ (* it1509 (- 1)) it1506) 0)
                (= (+ (* it1511 (- 1)) it1508) 0)))
      (a!3 (and (and (not bt1777) (not bt1776))
                (not bt1774)
                (= (+ (* it1510 (- 1)) it1507) 0)
                (= (+ (* it1509 (- 1)) it1506) 0)
                (= (+ (* it1511 (- 1)) it1508) 0)
                (not bt1775)))
      (a!4 (and (and (not bt1777) (not bt1776))
                bt1774
                (= (+ (* it1510 (- 1)) it1507) 0)
                (= (+ (* it1509 (- 1)) it1506) 0)
                (= (+ (* it1511 (- 1)) it1508) 0)))
      ...
      (a!6 (and (not bt1774)
                ...
                (= (+ (* it1509 (- 1)) it1506) 0)
                (= (+ (* it1511 (- 1)) it1508) 0)))
      (a!7 (and (not bt1777) (not bt1774) (= (+ (* it1510 (- 1)) it1507) 0)))
      (a!11 (and (not bt1777)
                 (= (+ it1510 (- 10)) 0)
                 (not bt1774)
                 (= (+ (* it1509 (- 1)) it1506) 0)
                 ...
                 bt1775
                 bt1776))
      (a!12 (and (and (not bt1777) bt1774)
                 (= (+ (* it1510 (- 1)) it1507) 0)
                 (= (+ (* it1509 (- 1)) (* it1506 2)) 0)
                 (= (+ (* it1511 (- 1)) it1508) 0)
                 bt1775
                 bt1776))
      (a!13 (= (+ (+ (* it1510 (- 1)) it1507) (- 1)) 0)))
(let ((a!2 (or (or (not bt1770) bt1772)
               (> (+ it1508 (* it1506 (- 1))) 0)
               (and a!1 bt1775)
               bt1773
               (not bt1771)))
      ...
      (a!9 (and a!7
                ...
                (not bt1775)
                bt1776))
      (a!10 (or (or (not bt1770) bt1772)
                (<= (+ it1508 (* it1506 (- 1))) 0)
                bt1773
                (and a!4 (not bt1775))
                (not bt1771)))
      (a!14 (and (and (not bt1777) bt1774)
                 (= (+ (* it1509 (- 1)) it1506) 0)
                 (= (+ (* it1511 (- 1)) it1508) 0)
                 (not bt1775)
                 a!13
                 bt1776)))
  (and a!2
       (or bt1772 a!3 bt1771 bt1770 bt1773)
       (or (not bt1770) bt1773 (and a!4 (not bt1775)) (not bt1771) (not bt1772))
       (or a!5 bt1772 bt1770 (> it1506 0) (not bt1773) (not bt1771))
       (= (+ it1505 (- 2)) 0)
       (or (<= it1506 0)
           bt1772
           bt1770
           (not bt1773)
           (not bt1771)
           (and a!6 (not bt1775) bt1776))
       (or (or (not bt1770) bt1772) bt1771 (and a!6 bt1775 bt1776) (not bt1773))
       (or bt1772 bt1771 bt1770 a!8 (not bt1773))
       (or bt1772 bt1770 bt1773 a!9 (not bt1771))
       a!10
       (or (and a!1 (not bt1775))
           bt1771
           bt1770
           bt1773
           (> it1507 0)
           (not bt1772))
       (or a!11 (not bt1770) bt1772 bt1771 bt1773)
       (or a!5 bt1771 bt1770 (not bt1773) (not bt1772))
       (or (or (not bt1770) bt1772) a!3 (not bt1773) (not bt1771))
       (or (and a!4 bt1775) (<= it1507 0) bt1771 bt1770 bt1773 (not bt1772))
       (or (not bt1770) bt1771 bt1773 (not bt1772) a!12)
       (or a!14 bt1770 bt1773 (not bt1771) (not bt1772))))))
(check-sat)
