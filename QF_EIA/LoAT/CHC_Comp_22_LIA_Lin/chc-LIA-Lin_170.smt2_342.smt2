...
(assert (or (<= it1162 0)
    (distinct (+ it1164 (* it1167 (- 1))) 0)
    bt1222
    bt1221
    (not bt1228)
    (not bt1225)
    (distinct (+ (* it1165 (- 1)) it1162) 0)
    (distinct (+ it1161 (- 2)) 0)
    bt1226
    bt1227
    (not bt1224)
    (distinct (+ (* it1166 (- 1)) it1163) 0)))
(assert (let ((a!1 (and (= (+ (* it1165 (- 1)) (* it1162 3)) 0)
                (= (+ (* it1166 (- 1)) it1163) 0)
                bt1225
                (= (+ it1164 (* it1167 (- 1))) 0)
                (not bt1228)
                bt1226
                bt1227))
      (a!2 (and (= (+ (* it1165 (- 1)) it1162) 0)
                (= (+ (* it1166 (- 1)) it1163) 0)))
      (a!8 (and (= (+ (* it1166 (- 1)) it1163) 0)
                (= (+ it1165 (- 1)) 0)
                (not bt1227)
                (= (+ it1164 (* it1167 (- 1))) 0)
                (not bt1228)
...
(let ((a!3 (and a!2
                ...
                bt1227
                (not bt1226)))
      (a!4 (and (and a!2 (not bt1227))
                bt1225
                (= (+ it1164 (* it1167 (- 1))) 0)
                (not bt1228)
                bt1226))
      (a!6 (and (and a!2 (not bt1227))
                (= (+ it1164 (* it1167 (- 1))) 0)
                (not bt1228)))
      (a!7 (and (and a!2 bt1228 (not bt1227)) (= (+ it1164 (* it1167 (- 1))) 0)))
      (a!9 (and a!2 (= (+ it1164 (* it1167 (- 1))) 0) (not bt1228)))
      (a!10 (and (and a!2 bt1228 (not bt1227))
                 bt1225
                 (= (+ it1164 (* it1167 (- 1))) 0))))
(let ((a!5 (or a!4
               bt1222
               ...
               (not bt1221)
               (<= (+ (* it1162 (- 1)) it1164) 0)))
      (a!11 (or (and a!7 (not bt1226) (not bt1225))
                (> (+ (* it1162 (- 1)) it1164) 0)
                bt1222
                bt1224
                bt1223
                (not bt1221)))
      (a!12 (or (or (and a!6 (not bt1226) (not bt1225)) bt1222)
                bt1221
                bt1224
                bt1223))
      (a!14 (or (or (and a!6 (not bt1226) (not bt1225)) bt1222)
                bt1223
                (not bt1224)
                (not bt1221))))
  (and (or bt1222 bt1224 a!1 (not bt1223) (not bt1221))
       (or (or bt1224 (not bt1222)) (not bt1223) a!3 (not bt1221))
       a!5
       (or (or bt1221 bt1224)
           (and a!6 bt1226 (not bt1225))
           (not bt1222)
           (not bt1223))
       (= (+ it1161 (- 2)) 0)
       (or bt1221
           (not bt1222)
           (and a!7 bt1226 (not bt1225))
           bt1223
           (not bt1224))
       (or (or bt1221 bt1224) (not bt1222) bt1223 a!8)
       (or (or bt1224 (not bt1222))
           bt1223
           (and a!9 bt1227 (not bt1226) (not bt1225))
           (<= it1163 0)
           (not bt1221))
       (or bt1222 bt1221 (and a!10 bt1226) bt1223 (> it1162 0) (not bt1224))
       a!11
       (or (and a!10 (not bt1226))
           (<= it1162 0)
           bt1222
           bt1221
           bt1223
       ...
       (or (> it1163 0)
           ...
           (not bt1222)
           bt1223
           (and a!9 bt1226 bt1227 (not bt1225))
           (not bt1221))
       (or (and a!10 bt1226) (not bt1222) bt1223 (not bt1224) (not bt1221))
       (or a!13 bt1222 bt1221 bt1224 (not bt1223))
       a!14)))))
(check-sat)
