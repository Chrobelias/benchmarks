...
(assert (let ((a!1 (and (and bt1181 bt1182)
                (not bt1183)
                (= (+ it1533 (* it1112 (- 1))) 0)))
      (a!3 (and (= (+ (* it1111 (- 1)) (* it1532 2)) 0)
                bt1181
                (= (+ it1533 (* it1112 (- 1))) 0)
                (not bt1182)
                bt1183
                (= (+ it1534 (* it1113 (- 1))) 0)
                (not bt1184)))
      (a!4 (and (not bt1183) (= (+ it1533 (* it1112 (- 1))) 0) (not bt1182)))
      (a!6 (and bt1182
                (= (+ it1533 (* it1112 (- 1))) 0)
                bt1183
                (= (+ (* it1111 (- 1)) it1532) 0)
                ...
                (= (+ it1534 (* it1113 (- 1))) 0)
                (not bt1184)))
      (a!9 (and bt1182 (not bt1183) (= (+ it1533 (* it1112 (- 1))) 0)))
      (a!11 (and bt1181
                 (not bt1183)
                 (= (+ it1533 (* it1112 (- 1))) 0)
                 (not bt1182)
...
(let ((a!8 (or (<= (+ (* it1532 (- 1)) it1534) 0)
      ...
      (a!16 (or a!15
                ...
                bt1631
                bt1632)))
  (and (or (or (not bt1629) bt1631 (not bt1630)) (not bt1632) a!2)
       (or a!3 bt1630 bt1629 (not bt1631) bt1632)
       (or (or (not bt1629) bt1630) bt1631 a!5 (not bt1632))
       (or (or bt1630 bt1631 bt1629) (> it1532 0) (not bt1632) a!2)
       (or (or bt1630 bt1631 bt1629) a!5 bt1632)
       (or (not bt1629) a!6 bt1631 (not bt1630) bt1632 (> it1533 0))
       a!8
       (= (+ it1531 (- 2)) 0)
       (or a!10 bt1629 (not bt1630) (not bt1631) bt1632)
       (or (or bt1630 bt1631 bt1629) (<= it1532 0) (not bt1632) a!11)
       (or (not bt1629) a!12 (not bt1630) (not bt1631) bt1632)
       (or (or bt1631 bt1629 (not bt1630)) bt1632 a!13)
       (or (or (not bt1629) bt1631 (not bt1630)) bt1632 (<= it1533 0) a!14)
       a!16
       (or (or (not bt1629) bt1630) (not bt1631) bt1632 a!17)
       (or (or bt1631 bt1629 (not bt1630)) a!18 (not bt1632)))))))
(check-sat)
