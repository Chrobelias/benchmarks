...
(declare-fun bt1871 () Bool)
(declare-fun bt1872 () Bool)
(declare-fun it1786 () Int)
(declare-fun it1784 () Int)
(declare-fun bt1869 () Bool)
(declare-fun bt1870 () Bool)
(declare-fun it1789 () Int)
(declare-fun it1790 () Int)
(declare-fun it1791 () Int)
(declare-fun it1792 () Int)
(declare-fun bt1873 () Bool)
(declare-fun bt1874 () Bool)
(declare-fun bt1875 () Bool)
(declare-fun bt1876 () Bool)
...
(assert (and (not bt1870)
     ...
     bt1865))
(assert (= (+ it1789 (- 2)) 0))
(assert (= (+ (* it1784 (- 1)) it1790) 0))
(assert (= (+ (* it1785 (- 1)) it1791) 0))
(assert (= (+ (* it1786 (- 1)) it1792) 0))
(assert (or (and (not bt1870) (not bt1873)) (and bt1870 bt1873)))
(assert (or (and (not bt1869) (not bt1874)) (and bt1874 bt1869)))
(assert (or (and (not bt1871) (not bt1875)) (and bt1871 bt1875)))
(assert (or (and (not bt1872) (not bt1876)) (and bt1872 bt1876)))
(assert (let ((a!1 (+ (* (exp 2 (+ it1082 (- 1))) (+ 0 it1790) (+ 0 (- 1)))
              (+ 0 it1792))))
  (and (> a!1 (+ 0 0))
       (not bt1875)
       (> (+ it1792 (* it1790 (- 1))) 0)
