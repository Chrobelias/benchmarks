...
(declare-fun bt1401 () Bool)
(declare-fun bt1402 () Bool)
(declare-fun bt1403 () Bool)
(declare-fun bt1404 () Bool)
(assert (= (+ i1 (- 1)) 0))
(assert (= (+ it1100 (- 2)) 0))
...
(assert (and (not bt1345)
     ...
     (not bt1344)))
(assert (= (+ it1302 (- 2)) 0))
(assert (= (+ (* it1259 (- 1)) it1303) 0))
(assert (= (+ (* it1260 (- 1)) it1304) 0))
(assert (= (+ it1305 (* it1261 (- 1))) 0))
(assert (or (and bt1401 bt1346) (and (not bt1346) (not bt1401))))
(assert (or (and (not bt1345) (not bt1402)) (and bt1402 bt1345)))
(assert (or (and (not bt1403) (not bt1347)) (and bt1347 bt1403)))
(assert (or (and bt1404 bt1348) (and (not bt1404) (not bt1348))))
(assert (and bt1402 bt1404 bt1401 (= (+ it1302 (- 2)) 0) (not bt1403)))
(check-sat)
