...
(assert (let ((a!1 (and (= (+ it1556 (* it1559 (- 1))) 0)
                bt1655
                (not bt1653)
                bt1654
                (= (+ it1557 (* it1560 (- 1))) 0)
                (not bt1656)
                (= (+ it1558 (* it1561 (- 1))) 0)))
      (a!2 (and (not bt1654) (= (+ it1556 (* it1559 (- 1))) 0)))
      (a!4 (and (= (+ it1556 (* it1559 (- 1))) 0) bt1654 bt1653))
      (a!7 (and (= (+ it1556 (* it1559 (- 1))) 0) (not bt1653) bt1654))
      (a!12 (and (not bt1654)
                 bt1655
                 bt1653
                 (= (+ it1557 (* it1560 (- 1))) 0)
      ...
      (a!18 (and (= (+ (* it1556 3) (* it1559 (- 1))) 0)
                 ...
                 (not bt1656)
                 (= (+ it1558 (* it1561 (- 1))) 0))))
(let ((a!3 (and (and a!2 (not bt1653))
                (= (+ it1557 (* it1560 (- 1))) 0)
                (not bt1656)
                (= (+ it1558 (* it1561 (- 1))) 0)
                (not bt1655)))
      ...
      (a!13 (and a!2
                 ...
                 (= (+ it1558 (* it1561 (- 1))) 0)
                 (not bt1655)))
      (a!14 (and (and a!2 bt1655)
                 (not bt1653)
                 (= (+ it1557 (* it1560 (- 1))) 0)
                 (not bt1656)
                 (= (+ it1558 (* it1561 (- 1))) 0)))
      (a!16 (and (and a!2 (not bt1653))
                 bt1656
                 (= (+ it1557 (* it1560 (- 1))) 0)
                 (= (+ it1558 (* it1561 (- 1))) 0)
                 (not bt1655))))
(let ((a!10 (or (or bt1651 bt1650)
                (<= (+ it1558 (* it1556 (- 1))) 0)
                a!9
                (not bt1649)
                bt1652))
      (a!17 (or (or bt1651 bt1650)
                (> (+ it1558 (* it1556 (- 1))) 0)
                a!16
                (not bt1649)
                bt1652)))
  (and (or (not bt1650) a!1 bt1651 (> it1557 0) (not bt1649) bt1652)
       (or (or a!3 bt1651 bt1650) bt1649 bt1652)
       (or a!5 (> it1556 0) bt1651 bt1650 (not bt1652) bt1649)
       (or (not bt1650) a!5 bt1651 (not bt1652) (not bt1649))
       (or (or (not bt1650) (not bt1651)) a!6 (not bt1649) bt1652)
       (or (or (not bt1650) bt1651) (not bt1652) a!8 bt1649)
       a!10
       (or (or (not bt1650) (not bt1651)) a!11 bt1649 bt1652)
       (or bt1650 a!12 (not bt1651) bt1649 bt1652)
       (or a!13 bt1651 bt1650 (not bt1652) (<= it1556 0) bt1649)
       (or (not bt1650) (<= it1557 0) bt1651 a!14 (not bt1649) bt1652)
       (or (or (not bt1650) bt1651) bt1649 a!15 bt1652)
       (= (+ it1555 (- 2)) 0)
       a!17
       (or (or a!3 bt1651 bt1650) (not bt1652) (not bt1649))
       (or bt1650 a!18 (not bt1651) (not bt1649) bt1652))))))
(check-sat)
