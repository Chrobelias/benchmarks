...
(assert (let ((a!1 (and (= (+ (* it480 (- 1)) it477) 0) (= (+ (* it478 (- 1)) it475) 0)))
      (a!6 (and (= (+ (* it480 (- 1)) it477) 0)
                (not bt519)
                (= (+ it478 (- 1)) 0)
                bt518
                (= (+ (* it479 (- 1)) it476) 0)
      ...
      (a!11 (and (= (+ (* it480 (- 1)) it477) 0)
                 ...
                 bt519
                 bt517)))
(let ((a!2 (and (and a!1 (not bt519)) bt518 (= (+ (* it479 (- 1)) it476) 0)))
      (a!5 (and (and a!1 (not bt519))
                (not bt518)
                (= (+ (* it479 (- 1)) it476) 0)))
      (a!7 (and a!1
                (not bt518)
      ...
      (a!8 (and a!1
                ...
                bt519
                (not bt517))))
(let ((a!3 (or (and (and a!2 (not bt520)) bt517)
               bt514
               bt515
               bt516
               (not bt513)
               (<= (+ it477 (* it475 (- 1))) 0)))
      (a!4 (or (not bt515)
               (and (and a!2 (not bt520)) (not bt517))
               bt516
               bt513
               (not bt514)))
      (a!10 (or (> (+ it477 (* it475 (- 1))) 0)
                bt514
                bt515
                bt516
                (and (and a!5 bt520) (not bt517))
                (not bt513))))
  (and a!3
       a!4
       (or (not bt516)
           (and a!5 (not bt520) (not bt517))
           bt514
           bt515
           (not bt513))
       (or (and a!5 (not bt520) (not bt517)) bt514 bt515 bt516 bt513)
       (or (not bt516)
           bt514
           bt515
           (> it475 0)
           (and (and a!2 bt520) bt517)
           bt513)
       (or a!6 bt515 bt516 bt513 (not bt514))
       (= (+ it474 (- 2)) 0)
       (or (and a!7 (not bt517))
           bt515
           bt516
           (not bt513)
           (<= it476 0)
           (not bt514))
       (or (> it476 0) a!8 bt515 bt516 (not bt513) (not bt514))
       (or (not bt515) bt516 (and a!7 bt517) (not bt513) (not bt514))
       (or a!9 (not bt515) bt514 bt516 bt513)
       a!10
       (or (not bt516)
           (and (and a!5 bt520) bt517)
           bt514
           bt515
           (<= it475 0)
           bt513)
       (or (not bt516)
           (and (and a!2 bt520) (not bt517))
           bt515
           bt513
           (not bt514))
       (or (not bt516)
           ...
           (not bt513)
           (not bt514))
       (or (not bt515) bt514 bt516 (not bt513) a!11))))))
(check-sat)
