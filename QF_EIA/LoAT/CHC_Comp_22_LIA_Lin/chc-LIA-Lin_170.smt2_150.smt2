...
(assert (or (not bt735)
    (distinct (+ (* it691 (- 1)) it688) 0)
    (not bt731)
    bt734
    (not bt729)
    (distinct (+ (* it693 (- 1)) it690) 0)
    (distinct (+ it687 (- 2)) 0)
    bt736
    (distinct (+ (* it692 (- 1)) it689) 0)
    (not bt730)
    (not bt733)))
(assert (let ((a!1 (and (= (+ (* it692 (- 1)) it689) 0) (= (+ (* it691 (- 1)) it688) 0)))
      (a!10 (and (= (+ (* it692 (- 1)) it689) 0)
                 bt734
                 bt735
                 (= (+ (* it693 (- 1)) it690) 0)
                 (= (+ (* it691 (- 1)) (* it688 3)) 0)
      ...
      (a!12 (and (= (+ (* it692 (- 1)) it689) 0)
                 ...
                 bt733
                 (not bt736))))
(let ((a!2 (and a!1 bt735 (= (+ (* it693 (- 1)) it690) 0) (not bt734)))
      (a!3 (and (and a!1 (not bt735))
                (= (+ (* it693 (- 1)) it690) 0)
                (not bt734)
                (not bt733)
                (not bt736)))
      (a!4 (and (and (and a!1 (not bt735)) bt734)
                bt736
                (= (+ (* it693 (- 1)) it690) 0)))
      (a!5 (and (and (and a!1 (not bt735)) bt734)
                (= (+ (* it693 (- 1)) it690) 0)))
      (a!7 (and (and a!1 (not bt735))
                bt736
                (= (+ (* it693 (- 1)) it690) 0)
                (not bt734)))
      (a!8 (and a!1
                ...
                (not bt733)
                (not bt736))))
(let ((a!6 (or (and a!5 bt733 (not bt736))
               bt730
               bt731
               bt732
               (not bt729)
               (<= (+ (* it688 (- 1)) it690) 0)))
      (a!9 (or (and a!7 (not bt733))
               (> (+ (* it688 (- 1)) it690) 0)
               bt730
               bt731
               bt732
               (not bt729))))
  (and (or (and a!2 bt733 (not bt736))
           (not bt730)
           bt732
           (not bt729)
           (not bt731))
       (or a!3 bt730 (not bt732) bt731 (not bt729))
       (or (> it688 0) (and a!4 bt733) bt729 bt730 (not bt732) bt731)
       a!6
       (or (<= it688 0) (and a!7 bt733) bt729 bt730 (not bt732) bt731)
       (or bt729 (not bt732) (not bt730) bt731 (and a!4 (not bt733)))
       (or a!8 (not bt730) bt731 bt732 (not bt729) (> it689 0))
       (or (and a!2 (not bt733) (not bt736))
           (<= it689 0)
           (not bt730)
           bt731
           bt732
       ...
       a!9
       (= (+ it687 (- 2)) 0)
       (or bt730 bt732 (not bt729) (not bt731) a!10)
       (or (and a!5 (not bt733) (not bt736))
           bt729
           (not bt730)
           bt732
           (not bt731))
       (or a!3 bt729 bt730 bt731 bt732)
       (or (and a!4 bt733) (not bt732) (not bt730) bt731 (not bt729))
       (or a!11 bt729 (not bt730) bt731 bt732)
       (or bt729 bt730 bt732 (not bt731) a!12))))))
(check-sat)
