...
(assert (and bt781
     ...
     (not bt787)))
(assert (= (+ it771 (- 2)) 0))
(assert (= (+ it772 (* it743 (- 1))) 0))
(assert (= (+ it773 (* it744 (- 1))) 0))
(assert (= (+ it774 (* it745 (- 1))) 0))
(assert (or (and (not bt786) (not bt821)) (and bt821 bt786)))
(assert (or (and bt822 bt785) (and (not bt822) (not bt785))))
(assert (or (and bt787 bt823) (and (not bt823) (not bt787))))
(assert (or (and (not bt788) (not bt824)) (and bt824 bt788)))
(assert (and bt824 bt822 bt821 (= (+ it771 (- 2)) 0) (not bt823)))
(check-sat)
