...
(assert (or (not bt1500)
    bt1497
    (not bt1498)
    (distinct (+ (* it1412 (- 1)) it1409) 0)
    bt1499
    bt1493
    (not bt1496)
    (not bt1494)
    (distinct (+ (* it1414 (- 1)) it1411) 0)
    (distinct (+ (* it1413 (- 1)) it1410) 0)
    (distinct (+ it1408 (- 2)) 0)))
(assert (let ((a!1 (and bt1497
                (not bt1500)
                (= (+ (* it1413 (- 1)) it1410) 0)
                (= (+ (* it1412 (- 1)) (* it1409 3)) 0)
                (= (+ (* it1414 (- 1)) it1411) 0)
                bt1499
                bt1498))
      (a!2 (and (= (+ (* it1412 (- 1)) it1409) 0) (not bt1500)))
      (a!4 (and (= (+ (* it1412 (- 1)) it1409) 0) bt1497))
      (a!9 (and (not bt1498) (= (+ (* it1412 (- 1)) it1409) 0)))
      (a!11 (and (not bt1498)
                 bt1497
                 (not bt1500)
                 (= (+ (* it1413 (- 1)) it1410) 0)
...
(let ((a!3 (and a!2
      ...
      (a!13 (and a!9
                 ...
                 (not bt1497)
                 bt1500))
      (a!15 (and (and a!9 (not bt1500))
                 (not bt1499)
                 (= (+ (* it1413 (- 1)) it1410) 0)
                 (= (+ (* it1414 (- 1)) it1411) 0)
                 (not bt1497)))
      (a!18 (and (and a!9 (not bt1500))
                 (= (+ (* it1413 (- 1)) it1410) 0)
                 (= (+ (* it1414 (- 1)) it1411) 0)
                 (not bt1497)
                 bt1499))
      (a!19 (and (and a!9 bt1497)
                 (not bt1499)
                 (= (+ (* it1413 (- 1)) it1410) 0)
                 (= (+ (* it1414 (- 1)) it1411) 0)
                 bt1500)))
(let ((a!7 (or bt1494
               ...
               (not bt1493)
               bt1496))
      (a!14 (or (> (+ (* it1409 (- 1)) it1411) 0)
                bt1494
                bt1495
                a!13
                (not bt1493)
                bt1496))
      (a!16 (or (or (or bt1494 (not bt1496)) bt1495) a!15 (not bt1493)))
      (a!20 (or (or (or bt1494 (not bt1496)) bt1495) (<= it1409 0) bt1493 a!19)))
  (and (or (or (not bt1495) bt1494) a!1 (not bt1493) bt1496)
       (or (not bt1495) a!3 bt1493 (not bt1494) bt1496)
       (or (not bt1496) a!5 bt1495 (not bt1494) (not bt1493))
       (or (or bt1494 (not bt1496)) a!5 bt1495 bt1493 (> it1409 0))
       a!7
       (or (> it1410 0) bt1495 a!8 (not bt1494) (not bt1493) bt1496)
       (or (not bt1495) (not bt1494) a!10 (not bt1493) bt1496)
       (or (or (not bt1495) bt1494) bt1493 a!11 bt1496)
       (or a!12 bt1495 bt1493 (not bt1494) bt1496)
       a!14
       a!16
       (or a!17 (not bt1496) bt1495 bt1493 (not bt1494))
       (or (<= it1410 0) bt1495 a!18 (not bt1494) (not bt1493) bt1496)
       a!20
       (or bt1494 bt1495 bt1493 a!15 bt1496)
       (= (+ it1408 (- 2)) 0))))))
(check-sat)
