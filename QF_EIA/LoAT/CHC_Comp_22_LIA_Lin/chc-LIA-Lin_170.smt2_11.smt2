...
(assert (let ((a!1 (and (and (and (not bt192) (not bt191)) bt190)
                bt189
                (= (+ it165 (* it168 (- 1))) 0)
                (= (+ (* it169 (- 1)) it166) 0)
                (= (+ it164 (* it167 (- 1))) 0)))
      (a!3 (and (and (not bt192) bt190)
                bt189
                (= (+ (* it164 3) (* it167 (- 1))) 0)
                (= (+ it165 (* it168 (- 1))) 0)
                bt191
      ...
      (a!5 (and (not bt191)
                ...
                (= (+ (* it169 (- 1)) it166) 0)
                (= (+ it164 (* it167 (- 1))) 0)))
      (a!6 (and (and (and (not bt192) (not bt191)) bt190)
                (= (+ it165 (* it168 (- 1))) 0)))
      (a!8 (and (not bt192)
                (= (+ it165 (* it168 (- 1))) 0)
                bt191
      ...
      (a!11 (and (not bt191)
                 ...
                 (not bt189)
                 (= (+ it164 (* it167 (- 1))) 0)))
      (a!13 (and (and (not bt191) bt190)
                 (= (+ it165 (* it168 (- 1))) 0)
                 bt192
                 (= (+ (* it169 (- 1)) it166) 0)
                 (not bt189)
                 (= (+ it164 (* it167 (- 1))) 0)))
      (a!14 (and (and (not bt192) (not bt191))
                 (= (+ it165 (* it168 (- 1))) 0)
                 (not bt190)
                 (= (+ (* it169 (- 1)) it166) 0)
                 (not bt189)
                 (= (+ it164 (* it167 (- 1))) 0)))
      (a!15 (and (and (not bt191) bt190)
                 bt189
                 (= (+ it165 (* it168 (- 1))) 0)
                 bt192
                 (= (+ (* it169 (- 1)) it166) 0)
                 (= (+ it164 (* it167 (- 1))) 0))))
(let ((a!2 (or (or (or bt187 bt186) bt188)
               (not bt185)
               (<= (+ it166 (* it164 (- 1))) 0)
               a!1))
      (a!7 (and a!6
  ...
  (and (= (+ it163 (- 2)) 0)
       a!2
       (or bt186 bt188 (not bt187) (not bt185) a!3)
       (or (or bt188 (not bt187)) (not bt185) a!4 (not bt186))
       (or (or bt187 bt186) (<= it164 0) bt185 (not bt188) a!5)
       (or (or bt188 (not bt187)) bt185 (not bt186) a!7)
       (or (or (or bt187 bt188) (not bt185)) a!8 (not bt186) (<= it165 0))
       (or (or (or bt187 bt188) (not bt185)) (not bt186) (> it165 0) a!9)
       (or bt186 a!10 bt188 (not bt187) bt185)
       a!12
       (or bt187 bt185 (not bt186) (not bt188) a!13)
       (or (or bt187 bt186) (not bt185) (not bt188) a!14)
       (or (or (or bt187 bt186) bt188) bt185 a!14)
       (or bt187 (not bt185) (not bt186) (not bt188) a!15)
       (or (or bt187 bt188) a!16 bt185 (not bt186))
       (or bt187 (> it164 0) bt186 bt185 (not bt188) a!15)))))
(check-sat)
