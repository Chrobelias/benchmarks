...
(assert (or (distinct (+ (* it499 (- 1)) it496) 0)
    (not bt539)
    bt544
    (not bt543)
    (not bt538)
    ...
    (not bt537)
    (distinct (+ it495 (- 2)) 0)
    (distinct (+ (* it501 (- 1)) it498) 0)
    (distinct (+ (* it500 (- 1)) it497) 0)
    (not bt541)))
(assert (let ((a!1 (and (= (+ (* it500 (- 1)) it497) 0)
                bt544
                (= (+ (* it499 (- 1)) it496) 0)))
      (a!3 (and bt543 (= (+ (* it500 (- 1)) it497) 0)))
      (a!6 (and (= (+ (* it500 (- 1)) it497) 0) (= (+ (* it499 (- 1)) it496) 0)))
      (a!18 (and (= (+ (* it500 (- 1)) it497) 0)
                 (= (+ it499 (- 1)) 0)
                 (not bt543)
                 bt542
                 (not bt541)
      ...
      (a!19 (and bt543
                 ...
                 bt541
                 (not bt544))))
(let ((a!2 (and (and a!1 (not bt543) bt542)
                (not bt541)
                (= (+ (* it501 (- 1)) it498) 0)))
      (a!4 (and a!3 (= (+ (* it499 (- 1)) it496) 0)))
      (a!7 (and a!6
                (not bt542)
                (not bt543)
                (not bt541)
                (= (+ (* it501 (- 1)) it498) 0)
                (not bt544)))
      (a!8 (and (and a!1 (not bt542) (not bt543))
                (= (+ (* it501 (- 1)) it498) 0)
                bt541))
      (a!9 (and (and a!1 (not bt542) (not bt543))
                (not bt541)
                (= (+ (* it501 (- 1)) it498) 0)))
      (a!13 (and (and a!6 (not bt543) bt542)
                 (= (+ (* it501 (- 1)) it498) 0)
                 bt541
                 (not bt544)))
      (a!15 (and (and a!1 (not bt543) bt542)
                 (= (+ (* it501 (- 1)) it498) 0)
                 bt541))
      (a!17 (and (and a!6 (not bt543) bt542)
                 (not bt541)
                 (= (+ (* it501 (- 1)) it498) 0)
                 (not bt544)))
      (a!21 (and a!3
...
(let ((a!5 (and (and a!4 (not bt542))
      ...
      (a!14 (or a!13
                ...
                (not bt537)
                bt538))
      (a!16 (or (or (or bt539 (not bt540)) a!15) (> it496 0) bt538 bt537))
      (a!20 (or (or (or bt539 (not bt540)) a!15) (not bt538) (not bt537))))
  (and (or (or bt539 (not bt540)) (not bt538) bt537 a!2)
       (or (or bt540 bt539) a!5 (not bt538) (<= it497 0) (not bt537))
       (= (+ it495 (- 2)) 0)
       (or (or bt540 bt539) a!7 bt538 bt537)
       (or (or bt539 (not bt540)) a!8 (<= it496 0) bt538 bt537)
       a!10
       (or (or bt540 bt539) (not bt538) (> it497 0) (not bt537) a!11)
       (or bt540 a!12 (not bt538) (not bt539) (not bt537))
       a!14
       a!16
       (or bt540 (not bt538) (not bt539) a!17 bt537)
       (or (or bt539 (not bt540)) a!7 (not bt537) bt538)
       (or (or bt540 bt539) a!18 (not bt538) bt537)
       (or bt540 a!19 (not bt539) bt538 bt537)
       a!20
       (or bt540 a!21 (not bt539) (not bt537) bt538))))))
(check-sat)
