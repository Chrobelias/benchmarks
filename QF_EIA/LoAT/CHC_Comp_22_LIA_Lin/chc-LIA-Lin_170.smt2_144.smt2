...
(assert (and (not bt737)
     ...
     (not bt744)))
(assert (= (+ it703 (- 2)) 0))
(assert (= (+ (* it700 (- 1)) it704) 0))
(assert (= (+ (* it701 (- 1)) it705) 0))
(assert (= (+ (* it702 (- 1)) it706) 0))
(assert (or (and (not bt742) (not bt745)) (and bt742 bt745)))
(assert (or (and bt746 bt741) (and (not bt741) (not bt746))))
(assert (or (and (not bt747) (not bt743)) (and bt743 bt747)))
(assert (or (and bt744 bt748) (and (not bt748) (not bt744))))
(assert (and (= (+ it703 (- 2)) 0) bt745 bt746 (not bt747) bt748))
(check-sat)
