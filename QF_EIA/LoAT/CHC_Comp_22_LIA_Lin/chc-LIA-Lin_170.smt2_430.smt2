...
(declare-fun bt1584 () Bool)
(declare-fun it1481 () Int)
(declare-fun it1482 () Int)
(declare-fun bt1582 () Bool)
(declare-fun bt1583 () Bool)
...
(assert (or (distinct (+ (* it1480 (- 1)) it1477) 0)
    bt1583
    bt1582
    bt1580
    (distinct (+ it1476 (- 2)) 0)
    (distinct (+ it1479 (* it1482 (- 1))) 0)
    bt1578
    bt1577
    bt1579
    (distinct (+ (* it1481 (- 1)) it1478) 0)
    bt1584
    bt1581))
(assert (let ((a!1 (and (and (and bt1583 (not bt1584)) (not bt1582))
                (= (+ (* it1480 (- 1)) (* it1477 2)) 0)
                (= (+ (* it1481 (- 1)) it1478) 0)
                bt1581
                (= (+ it1479 (* it1482 (- 1))) 0)))
      (a!2 (and (and (and bt1583 (not bt1584)) bt1582)
                (= (+ (* it1481 (- 1)) it1478) 0)
                (= (+ (* it1480 (- 1)) (* it1477 3)) 0)
                bt1581
                (= (+ it1479 (* it1482 (- 1))) 0)))
      (a!3 (and (and (and (not bt1584) bt1582) (not bt1581))
                (not bt1583)
                (= (+ (* it1481 (- 1)) it1478) 0)
                (= (+ it1480 (- 1)) 0)
                (= (+ it1479 (* it1482 (- 1))) 0)))
      (a!4 (and bt1582
                ...
                bt1581
                (= (+ it1479 (* it1482 (- 1))) 0)))
      (a!5 (and (and (and (not bt1584) bt1582) (not bt1581))
                (= (+ (* it1480 (- 1)) it1477) 0)
                (not bt1583)
                (= (+ (* it1481 (- 1)) it1478) 0)
                (= (+ it1479 (* it1482 (- 1))) 0)))
      (a!6 (and (and bt1583 (not bt1584))
                (not bt1581)
                (not bt1582)
                (= (+ (* it1480 (- 1)) it1477) 0)
                (= (+ (* it1481 (- 1)) it1478) 0)
                (= (+ it1479 (* it1482 (- 1))) 0)))
      (a!8 (and (and (not bt1584) bt1582)
                (= (+ (* it1480 (- 1)) it1477) 0)
                (not bt1583)
                (= (+ (* it1481 (- 1)) it1478) 0)
                bt1581
      ...
      (a!10 (and (not bt1581)
                 ...
                 (= (+ (* it1481 (- 1)) it1478) 0)
                 (= (+ it1479 (* it1482 (- 1))) 0)))
      (a!12 (and (and (and bt1583 (not bt1584)) bt1582)
                 (not bt1581)
                 (= (+ (* it1480 (- 1)) it1477) 0)
                 (= (+ (* it1481 (- 1)) it1478) 0)
                 (= (+ it1479 (* it1482 (- 1))) 0)))
      ...
      (a!15 (and bt1582
                 ...
                 (= (+ (* it1481 (- 1)) it1478) 0)
                 (= (+ it1479 (* it1482 (- 1))) 0)))
      (a!16 (and (and (and bt1583 (not bt1584)) (not bt1582))
                 (= (+ (* it1480 (- 1)) it1477) 0)
                 (= (+ (* it1481 (- 1)) it1478) 0)
                 bt1581
                 (= (+ it1479 (* it1482 (- 1))) 0)))
      (a!18 (and (not bt1584)
                 ...
                 (= (+ (* it1481 (- 1)) it1478) 0)
                 (= (+ it1479 (* it1482 (- 1))) 0))))
(let ((a!7 (or (or (or (not bt1578) bt1580) (not bt1577))
               (<= it1478 0)
               bt1579
               a!6))
      (a!9 (or (<= (+ it1479 (* it1477 (- 1))) 0)
               bt1580
               (not bt1577)
               a!8
               bt1578
               bt1579))
      (a!11 (or (or bt1580 (not bt1577))
                a!10
                bt1578
                bt1579
                (> (+ it1479 (* it1477 (- 1))) 0)))
      (a!13 (or (or (or (not bt1578) bt1580) (not bt1577))
                a!12
                (> it1478 0)
                bt1579))
      (a!17 (or (or (or (not bt1578) bt1580) (not bt1577)) (not bt1579) a!16)))
  (and (or a!1 bt1580 bt1578 (not bt1579) bt1577)
       (or (or bt1580 (not bt1577)) bt1578 (not bt1579) a!2)
       (or a!3 (not bt1578) bt1580 bt1577 bt1579)
       (= (+ it1476 (- 2)) 0)
       (or (not bt1578) (not bt1577) a!4 (not bt1580) bt1579)
       (or (or (not bt1578) bt1580) (not bt1579) bt1577 a!5)
       a!7
       a!9
       (or (> it1477 0) bt1578 a!4 bt1577 (not bt1580) bt1579)
       a!11
       a!13
       (or a!14 bt1578 (<= it1477 0) bt1577 (not bt1580) bt1579)
       (or (not bt1578) a!15 bt1577 (not bt1580) bt1579)
       a!17
       (or bt1580 bt1578 bt1577 bt1579 a!18)
       (or (not bt1577) bt1578 (not bt1580) bt1579 a!18)))))
(check-sat)
