...
(assert (let ((a!1 (and (= (+ it675 (* it678 (- 1))) 0)
                (= (+ (* it677 (- 1)) it674) 0)
                (not bt720)))
      (a!3 (and bt720
                (= (+ it675 (* it678 (- 1))) 0)
                (= (+ (* it677 (- 1)) it674) 0))))
(let ((a!2 (and (and a!1 (not bt718))
                (not bt719)
                (not bt717)
                (= (+ (* it676 (- 1)) it673) 0)))
      (a!4 (and (and a!3 (not bt719))
                (not bt717)
                (= (+ (* it676 (- 1)) it673) 0)
                bt718))
      (a!5 (and (and (and a!1 (not bt719)) (not bt717))
                (= (+ it676 (- 1)) 0)
                bt718))
      (a!6 (and (and a!1 (not bt719))
                bt717
                (= (+ (* it676 (- 1)) it673) 0)
                bt718))
      (a!8 (and (and a!3 (not bt718) (not bt719))
                bt717
                (= (+ (* it676 (- 1)) it673) 0)))
      (a!9 (and (and a!1 (not bt718))
                bt717
                (= (+ (* it676 (- 1)) it673) 0)
                bt719))
      (a!10 (and a!1 (= (+ (* it676 (- 1)) (* it673 3)) 0) bt717 bt718 bt719))
      (a!11 (and (and a!3 (not bt719))
                 bt717
                 (= (+ (* it676 (- 1)) it673) 0)
                 bt718))
      (a!12 (and (and a!1 (not bt718))
                 (not bt717)
                 (= (+ (* it676 (- 1)) it673) 0)
                 bt719))
      (a!13 (and (and a!3 (not bt718) (not bt719))
                 (not bt717)
                 (= (+ (* it676 (- 1)) it673) 0)))
      (a!15 (and (and a!1 (not bt718))
                 (= (+ (* it676 (- 1)) (* it673 2)) 0)
                 bt717
                 bt719))
      (a!16 (and a!1 (not bt717) (= (+ (* it676 (- 1)) it673) 0) bt718 bt719))
      (a!17 (and (and (and a!1 (not bt719)) (not bt717))
                 (= (+ (* it676 (- 1)) it673) 0)
                 bt718)))
(let ((a!7 (or (not bt713)
               (<= (+ it675 (* it673 (- 1))) 0)
               bt714
               bt715
               bt716
      ...
      (a!14 (or (not bt713)
                ...
                bt716
                (> (+ it675 (* it673 (- 1))) 0))))
  (and (or a!2 (not bt713) (not bt716) bt714 bt715)
       (or (not bt716) a!4 (not bt714) bt715 bt713)
       (or (not bt714) a!5 bt715 bt716 bt713)
       a!7
       (or (<= it673 0) (not bt716) bt714 bt715 bt713 a!8)
       (or (or (not bt713) (not bt715)) (not bt714) a!9 bt716)
       (or (or (not bt713) (not bt715)) a!10 bt714 bt716)
       (= (+ it672 (- 2)) 0)
       (or a!11 (not bt713) (not bt716) (not bt714) bt715)
       (or (not bt713) (<= it674 0) (not bt714) a!12 bt715 bt716)
       a!14
       (or a!2 bt714 bt715 bt716 bt713)
       (or (> it673 0) a!11 (not bt716) bt714 bt715 bt713)
       (or (not bt715) a!15 bt714 bt716 bt713)
       (or (not bt713) a!16 (> it674 0) (not bt714) bt715 bt716)
       (or (not bt715) (not bt714) bt716 bt713 a!17))))))
(check-sat)
