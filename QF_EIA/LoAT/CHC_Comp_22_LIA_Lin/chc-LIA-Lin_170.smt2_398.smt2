...
(assert (let ((a!1 (and (not bt1488)
      ...
      (a!6 (and (= (+ (* it1401 (- 1)) (* it1398 2)) 0)
                ...
                bt1487
                (not bt1486))))
(let ((a!4 (or (or (not bt1482) bt1481)
               (and (and a!1 (not bt1487)) bt1486 (not bt1485))
               (not bt1483)
               bt1484))
      (a!7 (or (and (and a!1 (not bt1487)) (not bt1485) (not bt1486))
               bt1481
               bt1482
               bt1483
               bt1484))
      (a!8 (or (or (not bt1481) bt1482)
               (> (+ (* it1398 (- 1)) it1400) 0)
               bt1483
               (and a!3 (not bt1485) (not bt1486))
               bt1484))
      (a!9 (or (and (and a!1 (not bt1487)) (not bt1485) (not bt1486))
               (not bt1481)
               bt1482
               (not bt1484)
               bt1483))
      (a!10 (or (or (not bt1481) bt1482)
                (and (and a!1 (not bt1487)) bt1485 bt1486)
                (<= (+ (* it1398 (- 1)) it1400) 0)
                bt1483
                bt1484)))
  (and (or (or (not bt1482) (not bt1481))
           (not bt1483)
           (and a!1 bt1485 bt1487 (not bt1486))
           bt1484)
       (or (or (not bt1481) bt1482) a!2 (not bt1483) bt1484)
       (or (not bt1482)
           (and a!1 bt1486 (not bt1485) bt1487)
           (not bt1481)
           (> it1399 0)
           bt1483
           bt1484)
       (or bt1481
           bt1482
           (and (and a!3 bt1485) bt1486)
           (not bt1484)
           (> it1398 0)
           bt1483)
       a!4
       (or (or (not bt1482) bt1481) a!5 bt1483 bt1484)
       (or a!6 bt1481 bt1482 (not bt1483) bt1484)
       a!7
       (= (+ it1397 (- 2)) 0)
       a!8
       a!9
       (or (or (not bt1482) bt1481)
           (and a!3 bt1486 (not bt1485))
           (not bt1484)
           bt1483)
       (or (<= it1398 0)
           bt1481
           ...
           (not bt1484)
           bt1483
           (and (and a!3 bt1485) (not bt1486)))
       (or (or (not bt1482) (not bt1481))
           bt1483
           (<= it1399 0)
           (and a!1 (not bt1485) bt1487 (not bt1486))
           bt1484)
       (or (or (not bt1482) (not bt1481))
           (and (and a!3 bt1485) bt1486)
           (not bt1484)
