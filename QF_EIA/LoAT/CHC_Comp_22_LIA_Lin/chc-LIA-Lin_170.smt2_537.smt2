...
(assert (or (distinct (+ (* it1615 (- 1)) it1612) 0)
    bt1702
    bt1699
    bt1697
    bt1700
    (distinct (+ it1611 (- 2)) 0)
    (distinct (+ (* it1616 (- 1)) it1613) 0)
    bt1703
    bt1701
    (distinct (+ (* it1617 (- 1)) it1614) 0)
    bt1704
    bt1698))
(assert (let ((a!1 (and (= (+ (* it1615 (- 1)) it1612) 0)
                (= (+ (* it1617 (- 1)) it1614) 0)))
      (a!9 (and (= (+ (* it1615 (- 1)) (* it1612 2)) 0)
                (= (+ (* it1617 (- 1)) it1614) 0)
                (not bt1704)
                (= (+ (* it1616 (- 1)) it1613) 0)
                (not bt1702)
                bt1703
                bt1701))
      (a!12 (and (= (+ (* it1617 (- 1)) it1614) 0)
                 bt1702
                 (not bt1704)
                 (= (+ (* it1616 (- 1)) it1613) 0))))
(let ((a!2 (and (and a!1 bt1702) (not bt1704) (= (+ (* it1616 (- 1)) it1613) 0)))
      (a!4 (and a!1 (= (+ (* it1616 (- 1)) it1613) 0)))
      (a!6 (and a!1 (not bt1704) (= (+ (* it1616 (- 1)) it1613) 0)))
      (a!11 (and (and a!1 bt1702) (= (+ (* it1616 (- 1)) it1613) 0)))
      (a!13 (and a!12 (= (+ (* it1615 (- 1)) (* it1612 3)) 0) bt1703 bt1701))
      (a!15 (or (or bt1699 bt1697)
                (and a!12 (= (+ it1615 (- 1)) 0) (not bt1701) (not bt1703))
                bt1700
                (not bt1698))))
(let ((a!3 (or (or bt1699 bt1700 (not bt1697))
               (and (and a!2 (not bt1701)) bt1703)
               (not bt1698)
               (> it1613 0)))
      (a!5 (or (and a!4 (not bt1701) (not bt1702) bt1704 (not bt1703))
               bt1699
               bt1700
               (not bt1697)
               (> (+ it1614 (* it1612 (- 1))) 0)
               bt1698))
      (a!7 (or (or bt1699 (not bt1700) (not bt1697))
               (and (and a!6 (not bt1701) (not bt1702)) (not bt1703))
               bt1698))
      (a!8 (or (or bt1699 bt1700 (not bt1697))
               (not bt1698)
               (<= it1613 0)
               (and (and a!6 (not bt1701) (not bt1702)) bt1703)))
      (a!10 (or (or bt1699 bt1697)
                bt1700
                (and (and a!6 (not bt1701) (not bt1702)) (not bt1703))
                bt1698))
      (a!14 (or (and (and a!2 (not bt1701)) (not bt1703))
                (not bt1699)
                bt1697
                bt1700
                (not bt1698)))
  ...
  (and a!3
       ...
       (= (+ it1611 (- 2)) 0)
       a!8
       (or a!9 (not bt1699) bt1697 bt1700 bt1698)
       a!10
       (or (> it1612 0)
           bt1699
           bt1697
           (not bt1700)
           (and a!11 bt1701 bt1704 (not bt1703))
           bt1698)
       (or (or (not bt1699) bt1700) (not bt1697) a!13 bt1698)
       (or (or (not bt1699) bt1700)
           (and a!6 (not bt1702) bt1703 bt1701)
           (not bt1697)
           (not bt1698))
       (or (or bt1699 (not bt1700) (not bt1697))
           (and a!11 bt1701 bt1704 (not bt1703))
           (not bt1698))
       a!14
       (or (or bt1699 bt1697)
           (not bt1700)
           (not bt1698)
           (and a!11 (not bt1701) bt1704 (not bt1703)))
       (or (<= it1612 0)
           (and a!4 (not bt1702) bt1701 bt1704 (not bt1703))
           bt1699
           bt1697
           (not bt1700)
           bt1698)
