...
(assert (or (not bt1495)
    (distinct (+ (* it1280 (- 1)) it1277) 0)
    bt1501
    bt1499
    (distinct (+ it1274 (- 2)) 0)
    (not bt1498)
    (not bt1496)
    (distinct (+ (* it1278 (- 1)) it1275) 0)
    (not bt1500)
    (distinct (+ (* it1279 (- 1)) it1276 (- 1)) 0)
    bt1494))
(assert (let ((a!1 (and (not bt1500) (= (+ (* it1278 (- 1)) it1275) 0)))
      (a!6 (and (= (+ (* it1278 (- 1)) it1275) 0) (not bt1498) bt1500 bt1501))
      (a!8 (and (= (+ it1278 (- 1)) 0)
                (not bt1501)
                (not bt1498)
                bt1500
      ...
      (a!13 (and (= (+ (* it1278 (- 1)) it1275) 0)
                 ...
                 (= (+ (* it1279 (- 1)) it1276) 0)
                 (= (+ (* it1280 (- 1)) it1277) 0))))
(let ((a!2 (and (and a!1 (not bt1501))
                bt1498
                (= (+ (* it1279 (- 1)) it1276) 0)
                (= (+ (* it1280 (- 1)) it1277) 0)
                (not bt1499)))
      (a!4 (and (and a!1 (not bt1498) bt1501)
                (= (+ (* it1279 (- 1)) it1276) 0)
                (= (+ (* it1280 (- 1)) it1277) 0)
                (not bt1499)))
      (a!5 (and (and a!1 (not bt1501))
                (not bt1498)
                (= (+ (* it1279 (- 1)) it1276) 0)
                (= (+ (* it1280 (- 1)) it1277) 0)
                (not bt1499)))
      ...
      (a!14 (and a!6
                 ...
                 (= (+ (* it1279 (- 1)) it1276) 0)
                 (= (+ (* it1280 (- 1)) it1277) 0)))
      (a!15 (and (and a!1 (not bt1498) bt1501)
                 bt1499
                 (= (+ (* it1279 (- 1)) it1276) 0)
                 (= (+ (* it1280 (- 1)) it1277) 0)))
      (a!17 (and a!1
                 ...
                 (= (+ (* it1280 (- 1)) it1277) 0)
                 (not bt1499)))
      (a!18 (and (and a!1 (not bt1501))
                 bt1499
                 bt1498
                 (= (+ (* it1279 (- 1)) it1276) 0)
                 (= (+ (* it1280 (- 1)) it1277) 0))))
(let ((a!3 (or (or (or bt1496 bt1497) (not bt1495))
               a!2
               (<= (+ it1277 (* it1275 (- 1))) 0)
               (not bt1494)))
      (a!16 (or (or (or bt1496 bt1497) (not bt1495))
                a!15
                (> (+ it1277 (* it1275 (- 1))) 0)
                (not bt1494))))
  (and a!3
       (or (or bt1497 (not bt1496)) a!4 (> it1276 0) bt1494 bt1495)
       (or (or bt1496 bt1497) a!5 bt1494 bt1495)
       (or bt1496 a!5 (not bt1495) (not bt1497) (not bt1494))
       (or bt1496 a!7 (not bt1495) bt1494 (<= it1275 0) (not bt1497))
       (or (or bt1496 bt1497) a!8 (not bt1495) bt1494)
       (or a!9 bt1496 bt1497 bt1495 (not bt1494))
       (or (or bt1497 (not bt1496)) a!11 (not bt1495) bt1494)
       (or (or bt1497 (not bt1496)) a!12 bt1495 (not bt1494))
       (or bt1496 a!13 bt1494 bt1495 (not bt1497))
       (or bt1496 a!14 bt1495 (not bt1497) (not bt1494))
       a!16
       (or (not bt1496) bt1494 bt1495 a!17 (not bt1497))
       (or bt1496 (> it1275 0) (not bt1495) bt1494 a!17 (not bt1497))
       (= (+ it1274 (- 2)) 0)
       (or (or bt1497 (not bt1496)) (not bt1495) a!2 (not bt1494))
       (or (or bt1497 (not bt1496)) (<= it1276 0) a!18 bt1494 bt1495))))))
(check-sat)
