...
(assert (let ((a!1 (and bt766 (= (+ (* it729 (- 1)) it726) 0)))
      (a!4 (and (not bt766) (= (+ (* it729 (- 1)) it726) 0)))
      (a!9 (and bt766
                (= (+ it727 (- 1)) 0)
                (= (+ (* it729 (- 1)) it726) 0)
                (not bt765)
...
(let ((a!2 (and (and a!1 (not bt765))
      ...
      (a!3 (and a!1
                ...
                (= (+ (* it727 (- 1)) it724) 0)
                bt765))
      (a!5 (and (and a!4 (not bt765))
                (not bt768)
                (= (+ (* it728 (- 1)) it725) 0)
                (not bt767)
                (= (+ (* it727 (- 1)) it724) 0)))
      (a!6 (and (and a!1 (not bt765))
                (not bt768)
                (= (+ (* it728 (- 1)) it725) 0)
                (not bt767)
                (= (+ (* it727 (- 1)) it724) 0)))
      (a!7 (and a!1
                ...
                (= (+ (* it728 (- 1)) it725) 0)
                bt765))
      (a!8 (and (and a!4 (not bt765))
                bt767
                (not bt768)
                (= (+ (* it728 (- 1)) it725) 0)
                (= (+ (* it727 (- 1)) it724) 0)))
      (a!10 (and (and a!1 (not bt765))
                 bt768
                 (= (+ (* it728 (- 1)) it725) 0)
                 (not bt767)
                 (= (+ (* it727 (- 1)) it724) 0)))
      ...
      (a!17 (and a!4
                 ...
                 (= (+ (* it727 (- 1)) it724) 0)
                 bt765)))
(let ((a!12 (or (or bt764 bt763)
                a!11
                (not bt761)
                bt762
                (<= (+ it726 (* it724 (- 1))) 0)))
      (a!14 (or (or (or bt764 bt763) (not bt761))
                (> (+ it726 (* it724 (- 1))) 0)
                a!13
                bt762)))
  (and (or (or (or bt764 bt763) (not bt761)) a!2 (> it725 0) (not bt762))
       (or (or bt761 bt763) (> it724 0) a!3 bt762 (not bt764))
       (or (or bt763 (not bt761)) a!5 bt762 (not bt764))
       (= (+ it723 (- 2)) 0)
       (or (or bt764 bt761) (not bt762) a!6 (not bt763))
       (or (or bt763 (not bt761)) a!3 (not bt762) (not bt764))
       (or (or bt764 (not bt761)) bt762 a!7 (not bt763))
       (or (or (or bt764 bt763) (not bt761)) (<= it725 0) (not bt762) a!8)
       (or (or (or bt764 bt761) bt763) a!9 (not bt762))
       (or (or bt761 bt763) a!10 (not bt762) (not bt764))
       a!12
       a!14
       (or (or bt764 (not bt761)) (not bt762) (not bt763) a!15)
       (or (or bt764 bt761) a!16 bt762 (not bt763))
       (or (or bt761 bt763) a!17 bt762 (not bt764) (<= it724 0))
       (or (or (or bt764 bt761) bt763) a!5 bt762))))))
(check-sat)
