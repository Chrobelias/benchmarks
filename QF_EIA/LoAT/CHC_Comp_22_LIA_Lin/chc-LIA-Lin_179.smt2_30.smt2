...
(assert (let ((a!1 (and (= (+ (* it867 (- 1)) it864) 0)
                (not bt1008)
                (= (+ (* it868 (- 1)) it865) 0)))
      (a!6 (= (+ (+ (* it867 (- 1)) it864) (- 1)) 0))
      (a!8 (and (= (+ (* it867 (- 1)) it864) 0) (= (+ (* it868 (- 1)) it865) 0)))
      (a!16 (and (= (+ (* it868 (- 1)) it865) 0)
                 (= (+ it867 (- 10)) 0)
                 bt1007
                 (= (+ (* it866 (- 1)) it863) 0)
                 (not bt1006)
                 (not bt1009)
                 bt1008)))
(let ((a!2 (and a!1 bt1009 bt1007 (= (+ (* it866 (- 1)) it863) 0) (not bt1006)))
      (a!4 (and (and a!1 (not bt1007)) (= (+ (* it866 (- 1)) it863) 0)))
      (a!7 (and a!6
                (= (+ (* it868 (- 1)) it865) 0)
                (not bt1007)
                (= (+ (* it866 (- 1)) it863) 0)
      ...
      (a!9 (or (not bt1003)
               ...
               bt1002
               bt1004
               (and (and a!8 (not bt1007))
                    (= (+ it866 (- 1)) 0)
                    (not bt1006)
                    (not bt1009)
                    bt1008)))
      (a!10 (and (and a!1 (not bt1007)) bt1009 (= (+ (* it866 (- 1)) it863) 0)))
      (a!11 (and a!8
                 bt1009
                 bt1007
                 (= (+ (* it866 (- 1)) it863) 0)
                 (not bt1006)
                 bt1008))
      (a!12 (and (and a!8 bt1007)
                 (= (+ (* it866 (- 1)) it863) 0)
                 (not bt1006)
                 (not bt1009)
                 bt1008))
      (a!13 (and (and a!8 bt1007)
                 (not bt1009)
                 bt1008
                 bt1006
                 (= (+ (* it866 (- 1)) (* it863 2)) 0)))
      (a!14 (and a!1 bt1007 (= (+ (* it866 (- 1)) it863) 0) (not bt1009) bt1006))
      (a!15 (and (and a!8 (not bt1007))
                 bt1009
                 (= (+ (* it866 (- 1)) it863) 0)
                 (not bt1006)
                 bt1008)))
(let ((a!3 (or (not bt1002)
               (> (+ (* it863 (- 1)) it865) 0)
               (not bt1003)
               bt1005
               bt1004
               a!2))
      (a!5 (or (and a!4 (not bt1009) bt1006)
               (not bt1002)
               (not bt1003)
               (<= (+ (* it863 (- 1)) it865) 0)
               bt1005
  ...
  (and a!3
       a!5
       (= (+ it862 (- 2)) 0)
       (or (and a!4 (not bt1006) (not bt1009)) bt1005 bt1002 bt1003 bt1004)
       (or (not bt1004) (not bt1003) bt1005 bt1002 a!7)
       (or (and a!4 (not bt1009) bt1006)
           (not bt1004)
           (not bt1002)
           (not bt1003)
           bt1005)
       ...
       (or (and a!10 bt1006)
           ...
           bt1004
           (> it863 0))
       (or (not bt1005) a!11 (not bt1002) bt1003 bt1004)
       (or (and a!10 (not bt1006))
           (not bt1004)
           bt1005
           bt1002
           bt1003
           (> it864 0))
       (or (not bt1005) bt1002 bt1003 bt1004 a!12)
       (or a!13 (not bt1004) (not bt1002) bt1005 bt1003)
       (or (and a!10 bt1006) (not bt1004) (not bt1005) bt1002 bt1003)
       (or (<= it864 0) (not bt1004) bt1005 bt1002 bt1003 a!14)
       (or a!15 (not bt1005) (not bt1003) bt1002 bt1004 (<= it863 0))
       (or a!16 (not bt1002) bt1005 bt1003 bt1004)
       (or (not bt1005)
           (and a!4 (not bt1006) (not bt1009))
           (not bt1002)
           (not bt1003)
           bt1004))))))
(check-sat)
