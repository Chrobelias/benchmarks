...
(declare-fun bt421 () Bool)
(declare-fun bt422 () Bool)
(declare-fun bt423 () Bool)
(declare-fun bt424 () Bool)
(assert (= (+ i1 (- 1)) 0))
(assert (= (+ it186 (- 2)) 0))
...
(assert (= (+ (* it370 (- 1)) it377) 0))
(assert (or (and (not bt414) (not bt421)) (and bt414 bt421)))
(assert (or (and (not bt413) (not bt422)) (and bt422 bt413)))
(assert (or (and (not bt423) (not bt415)) (and bt423 bt415)))
(assert (or (and (not bt424) (not bt416)) (and bt424 bt416)))
(assert (and bt421 (not bt423) bt422 bt424 (= (+ it374 (- 2)) 0)))
(check-sat)
