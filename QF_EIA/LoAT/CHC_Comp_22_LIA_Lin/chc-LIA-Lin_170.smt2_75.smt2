...
(declare-fun bt601 () Bool)
(declare-fun bt602 () Bool)
(declare-fun bt603 () Bool)
(declare-fun bt604 () Bool)
(assert (= (+ i1 (- 1)) 0))
(assert (= (+ it384 (- 2)) 0))
...
(assert (and (= (+ (* it521 (- 1)) it518) 0)
     ...
     bt570))
(assert (= (+ it545 (- 2)) 0))
(assert (= (+ it546 (* it521 (- 1))) 0))
(assert (= (+ it547 (* it522 (- 1))) 0))
(assert (= (+ (* it523 (- 1)) it548) 0))
(assert (or (and (not bt570) (not bt601)) (and bt570 bt601)))
(assert (or (and (not bt602) (not bt569)) (and bt569 bt602)))
(assert (or (and (not bt603) (not bt571)) (and bt603 bt571)))
(assert (or (and (not bt604) (not bt572)) (and bt604 bt572)))
(assert (and bt604 (not bt603) (= (+ it545 (- 2)) 0) bt602 bt601))
(check-sat)
