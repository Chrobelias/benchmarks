...
(assert (or (distinct (+ (* it1196 (- 1)) it1193) 0)
    (distinct (+ (* it1194 (- 1)) it1191) 0)
    bt1262
    bt1264
    bt1258
    (not bt1257)
    (distinct (+ (* it1195 (- 1)) it1192) 0)
    (distinct (+ it1190 (- 2)) 0)
    bt1263
    bt1261
    (not bt1260)))
(assert (let ((a!1 (and (= (+ (* it1196 (- 1)) it1193) 0)
                bt1262
                (= (+ (* it1194 (- 1)) it1191) 0)
                (not bt1263)
                bt1264))
      (a!4 (and (= (+ (* it1196 (- 1)) it1193) 0) (not bt1264)))
      (a!12 (and (= (+ (* it1196 (- 1)) it1193) 0)
                 (= (+ (* it1194 (- 1)) it1191) 0)
                 (not bt1263)
                 bt1264)))
(let ((a!2 (and a!1 (= (+ (* it1195 (- 1)) it1192) 0) bt1261))
      (a!3 (and a!1 (not bt1261) (= (+ (* it1195 (- 1)) it1192) 0)))
      (a!5 (and (and a!4 bt1262) (= (+ (* it1194 (- 1)) it1191) 0)))
      (a!7 (and a!4 (= (+ (* it1194 (- 1)) it1191) 0)))
      (a!9 (and a!4
                bt1263
                (not bt1262)
                (= (+ (* it1194 (- 1)) (* it1191 2)) 0)
      ...
      (a!13 (and a!12
                 ...
                 (not bt1262)
                 (= (+ (* it1195 (- 1)) it1192) 0)))
      (a!16 (and a!12 (not bt1262) (= (+ (* it1195 (- 1)) it1192) 0) bt1261))
      (a!17 (and (and a!4 bt1262)
                 (not bt1263)
                 (= (+ it1194 (- 1)) 0)
                 (not bt1261)
                 (= (+ (* it1195 (- 1)) it1192) 0)))
      (a!20 (and (and a!4 bt1262)
                 (= (+ (* it1194 (- 1)) (* it1191 3)) 0)
                 bt1263
                 (= (+ (* it1195 (- 1)) it1192) 0)
                 bt1261)))
(let ((a!6 (and a!5 (not bt1261) bt1263 (= (+ (* it1195 (- 1)) it1192) 0)))
      (a!8 (and a!7
                (not bt1263)
                (not bt1261)
                (not bt1262)
                (= (+ (* it1195 (- 1)) it1192) 0)))
      (a!10 (and (and a!5 (not bt1263))
                 (= (+ (* it1195 (- 1)) it1192) 0)
                 bt1261))
      (a!14 (or (> (+ it1193 (* it1191 (- 1))) 0)
                (not bt1257)
                a!13
                bt1258
                bt1260
      ...
      (a!19 (and a!7
                 ...
                 (not bt1262)
                 (= (+ (* it1195 (- 1)) it1192) 0))))
(let ((a!11 (or (not bt1257)
                a!10
                bt1258
                bt1260
                bt1259
                (<= (+ it1193 (* it1191 (- 1))) 0))))
  (and (or (> it1191 0) (not bt1260) bt1258 a!2 bt1259 bt1257)
       (or a!3 (not bt1260) (not bt1258) bt1259 bt1257)
       (or (> it1192 0) (not bt1257) (not bt1258) bt1260 a!6 bt1259)
       (or a!8 bt1258 bt1260 bt1259 bt1257)
       (or a!9 (not bt1259) bt1258 bt1260 bt1257)
       a!11
       a!14
       (or a!15 (not bt1257) (not bt1259) (not bt1258) bt1260)
       (or (<= it1191 0) (not bt1260) bt1258 a!16 bt1259 bt1257)
       (= (+ it1190 (- 2)) 0)
       (or a!8 (not bt1257) (not bt1260) bt1258 bt1259)
       (or (not bt1258) bt1260 bt1259 bt1257 a!17)
       (or a!18 (not bt1259) (not bt1258) bt1260 bt1257)
       (or (not bt1257) (not bt1260) (not bt1258) a!2 bt1259)
       (or (<= it1192 0) (not bt1257) (not bt1258) bt1260 bt1259 a!19)
       (or (not bt1257) a!20 (not bt1259) bt1258 bt1260)))))))
(check-sat)
