...
(assert (let ((a!1 (and bt1686 (= (+ (* it1599 (- 1)) it1596) 0)))
      (a!4 (and bt1685 (= (+ (* it1599 (- 1)) it1596) 0)))
      (a!6 (and (and bt1685 bt1686)
                (= (+ (* it1599 (- 1)) it1596) 0)
                (= (+ (* it1598 (- 1)) it1595) 0)
                (= (+ (* it1600 (- 1)) it1597) 0)))
      (a!8 (and (= (+ (* it1599 (- 1)) it1596) 0)
                (not bt1686)
                (= (+ (* it1598 (- 1)) it1595) 0)
                (= (+ (* it1600 (- 1)) it1597) 0)))
      (a!16 (and (and bt1685 bt1686)
                 (= (+ (* it1598 (- 1)) (* it1595 3)) 0)
                 (= (+ (* it1599 (- 1)) it1596) 0)
                 (= (+ (* it1600 (- 1)) it1597) 0)
                 (not bt1688)
...
(let ((a!2 (and a!1
      ...
      (a!9 (or (not bt1681)
               ...
               bt1684
               bt1683
               (and a!8 bt1688 (not bt1685) (not bt1687))
               bt1682))
      (a!10 (and a!4
                 (not bt1686)
                 (= (+ (* it1598 (- 1)) it1595) 0)
                 (= (+ (* it1600 (- 1)) it1597) 0)))
      (a!12 (or (or (not bt1681) (not bt1684))
                (and (and a!8 (not bt1688) (not bt1685)) (not bt1687))
                bt1683
                bt1682))
      (a!13 (or bt1681
                bt1684
      ...
      (a!14 (and a!1
                 ...
                 (not bt1687)))
      (a!15 (or (not bt1681)
                (and (and a!8 (not bt1688) (not bt1685)) bt1687)
                (<= it1596 0)
                (not bt1682)
                bt1684
                bt1683)))
(let ((a!3 (or (not bt1683)
               bt1681
               (not bt1682)
               bt1684
               (and (and a!2 (not bt1688) (not bt1685)) (not bt1687))))
      (a!11 (or (not bt1681)
                (> it1596 0)
                (and (and a!2 (not bt1688) (not bt1685)) bt1687)
                (not bt1682)
                bt1684
                bt1683)))
  (and a!3
       (or a!5 (not bt1683) bt1681 bt1684 bt1682)
       (or (or (not bt1681) (not bt1684))
           (not bt1682)
           (and a!6 bt1688 (not bt1687))
           bt1683)
       (or (or (not bt1684) bt1681)
           (and a!2 bt1688 (not bt1685) (not bt1687))
           (not bt1682)
           bt1683)
       a!7
       a!9
       (or (<= it1595 0)
           (not bt1684)
           bt1681
           (and a!10 bt1688 (not bt1687))
           bt1683
           bt1682)
       a!11
       (= (+ it1594 (- 2)) 0)
       (or (or (not bt1683) (not bt1681))
           (not bt1682)
           bt1684
           (and a!10 (not bt1688) bt1687))
       (or (or (not bt1684) bt1681)
           (and a!6 bt1688 (not bt1687))
           (> it1595 0)
           bt1683
       ...
       a!12
       a!13
       (or a!14 bt1681 (not bt1682) bt1684 bt1683)
       a!15
       (or (or (not bt1683) (not bt1681)) bt1684 a!16 bt1682))))))
(check-sat)
