...
(assert (and bt1798
     ...
     bt1795))
(assert (= (+ it1546 (- 2)) 0))
(assert (= (+ (* it1528 (- 1)) it1547) 0))
(assert (= (+ (* it1529 (- 1)) it1548) 0))
(assert (= (+ it1549 (* it1530 (- 1))) 0))
(assert (or (and (not bt1822) (not bt1800)) (and bt1800 bt1822)))
(assert (or (and bt1799 bt1823) (and (not bt1823) (not bt1799))))
(assert (or (and bt1798 bt1824) (and (not bt1798) (not bt1824))))
(assert (or (and (not bt1801) (not bt1825)) (and bt1801 bt1825)))
(assert (and bt1824 (not bt1822) (= (+ it1546 (- 2)) 0) (not bt1823) bt1825))
(check-sat)
