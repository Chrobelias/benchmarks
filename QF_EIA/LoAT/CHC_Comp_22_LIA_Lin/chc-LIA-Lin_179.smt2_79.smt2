...
(assert (or bt1493
    bt1456
    (not bt1455)
    (distinct (+ it1270 (* it1238 (- 1))) 0)
    bt1457
    (distinct (+ it1268 (- 2)) 0)
    (not bt1492)
    (not bt1454)
    (distinct (+ it1271 (* it1239 (- 1))) 0)
    (distinct (+ it1269 (* it1237 (- 1))) 0)
    bt1491
    bt1490
    (<= it1270 0)))
(assert (let ((a!1 (and bt1455 (not bt1456) (= (+ it1269 (* it1237 (- 1))) 0)))
      (a!5 (and (not bt1456) (not bt1455) (= (+ it1269 (* it1237 (- 1))) 0)))
      (a!7 (and (and (not bt1455) bt1456) (= (+ it1269 (* it1237 (- 1))) 0)))
      (a!9 (and (and (not bt1455) bt1456)
                (not bt1457)
                (not bt1454)
                (= (+ it1270 (* it1238 (- 1))) 0)
                (= (+ it1237 (- 1)) 0)
                (= (+ it1271 (* it1239 (- 1))) 0)))
      (a!10 (and (and bt1455 bt1456)
                 (not bt1457)
                 (= (+ it1270 (* it1238 (- 1))) 0)
                 (= (+ it1271 (* it1239 (- 1))) 0)
                 bt1454
                 (= (+ (* it1269 2) (* it1237 (- 1))) 0)))
      (a!11 (and (and bt1455 bt1456) (= (+ it1269 (* it1237 (- 1))) 0)))
      (a!18 (= (+ (+ it1270 (* it1238 (- 1))) (- 1)) 0)))
(let ((a!2 (and a!1
                (not bt1454)
                bt1457
                (= (+ it1270 (* it1238 (- 1))) 0)
      ...
      (a!8 (and a!7
                ...
                (= (+ it1270 (* it1238 (- 1))) 0)
                (= (+ it1271 (* it1239 (- 1))) 0)))
      (a!12 (and (and a!11 (not bt1457) (not bt1454))
                 (= (+ it1238 (- 10)) 0)
                 (= (+ it1271 (* it1239 (- 1))) 0)))
      (a!13 (and a!5
                 (not bt1454)
      ...
      (a!16 (and a!11
                 ...
                 (= (+ it1270 (* it1238 (- 1))) 0)
                 (= (+ it1271 (* it1239 (- 1))) 0)))
      (a!17 (and (and a!5 (not bt1457))
                 (not bt1454)
                 (= (+ it1270 (* it1238 (- 1))) 0)
                 (= (+ it1271 (* it1239 (- 1))) 0)))
      (a!19 (and a!7 (not bt1457) a!18 (= (+ it1271 (* it1239 (- 1))) 0) bt1454))
      (a!20 (and (and a!11 (not bt1457) (not bt1454))
                 (= (+ it1270 (* it1238 (- 1))) 0)
                 (= (+ it1271 (* it1239 (- 1))) 0))))
(let ((a!3 (or (or bt1493 (not bt1491))
               a!2
               (> (+ (* it1269 (- 1)) it1271) 0)
               bt1492
               (not bt1490)))
      (a!14 (or (<= (+ (* it1269 (- 1)) it1271) 0)
                bt1493
                (not bt1491)
                a!6
                bt1492
                (not bt1490))))
  (and a!3
       (or bt1493 (<= it1270 0) bt1491 (not bt1492) a!4 bt1490)
       (or (or bt1493 (not bt1491)) a!6 (not bt1492) (not bt1490))
       (or (or (not bt1493) (not bt1491)) a!8 bt1492 bt1490 (<= it1269 0))
       (or a!9 bt1493 (not bt1491) bt1492 bt1490)
       (or bt1493 a!10 bt1491 (not bt1492) (not bt1490))
       (or bt1493 a!12 bt1491 bt1492 (not bt1490))
       (or bt1493 (> it1270 0) a!13 bt1491 (not bt1492) bt1490)
       a!14
       (or (not bt1493) (> it1269 0) (not bt1491) a!15 bt1492 bt1490)
       (or (not bt1493) a!15 bt1491 (not bt1492) bt1490)
       (or (not bt1493) bt1491 bt1492 a!16 (not bt1490))
       (or (or (not bt1493) (not bt1491)) bt1492 a!17 (not bt1490))
       (or bt1493 bt1491 bt1492 a!17 bt1490)
       (= (+ it1268 (- 2)) 0)
       (or (or bt1493 (not bt1491)) (not bt1492) a!19 bt1490)
       (or (not bt1493) a!20 bt1491 bt1492 bt1490))))))
(check-sat)
