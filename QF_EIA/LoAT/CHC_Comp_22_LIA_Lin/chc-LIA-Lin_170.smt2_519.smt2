...
(assert (let ((a!1 (and (not bt1703) (= (+ (* it1616 (- 1)) it1613) 0)))
      (a!6 (and (not bt1703) (not bt1704) (= (+ (* it1616 (- 1)) it1613) 0)))
      (a!9 (and (not bt1704) (= (+ (* it1616 (- 1)) it1613) 0))))
(let ((a!2 (and (and a!1 (not bt1701))
                (= (+ (* it1617 (- 1)) it1614) 0)
                (= (+ (* it1615 (- 1)) it1612) 0)
                (not bt1702)
                bt1704))
      (a!4 (and (and a!1 (not bt1701))
                bt1702
                (= (+ (* it1617 (- 1)) it1614) 0)
                (= (+ (* it1615 (- 1)) it1612) 0)
                bt1704))
      (a!7 (and (and a!6 (not bt1701)) bt1702 (= (+ (* it1617 (- 1)) it1614) 0)))
      (a!10 (and a!9 (= (+ (* it1617 (- 1)) it1614) 0)))
      (a!13 (and (and a!9 (not bt1701))
                 (= (+ (* it1617 (- 1)) it1614) 0)
                 (= (+ (* it1615 (- 1)) it1612) 0)
                 (not bt1702)
                 bt1703))
      (a!15 (and (and a!6 (not bt1701))
                 (= (+ (* it1617 (- 1)) it1614) 0)
                 (= (+ (* it1615 (- 1)) it1612) 0)
                 (not bt1702)))
      (a!16 (and a!9
...
(let ((a!3 (or bt1699
               ...
               bt1698
               (> (+ it1614 (* it1612 (- 1))) 0)))
      (a!5 (or (or (or (not bt1700) bt1699) bt1697) a!4 (not bt1698)))
      (a!8 (or bt1699
               bt1697
               bt1700
               (and a!7 (= (+ it1615 (- 1)) 0))
      ...
      (a!12 (and a!10
                 ...
                 bt1703
                 bt1701))
      (a!14 (and a!7 (= (+ (* it1615 (- 1)) it1612) 0)))
      (a!20 (or a!19
                bt1699
                bt1700
                (not bt1697)
                (<= (+ it1614 (* it1612 (- 1))) 0)
                bt1698))
      (a!22 (or (or (or (not bt1700) bt1699) bt1697) a!21 (> it1612 0) bt1698)))
  (and a!3
       a!5
       a!8
       (or a!11 bt1697 bt1700 (not bt1699) bt1698)
       (= (+ it1611 (- 2)) 0)
       (or (or bt1700 (not bt1699)) (not bt1698) (not bt1697) a!12)
       (or a!13 bt1699 (<= it1613 0) bt1700 (not bt1698) (not bt1697))
       (or a!14 bt1697 bt1700 (not bt1699) (not bt1698))
       (or a!15 (not bt1700) bt1699 (not bt1697) bt1698)
       (or (or bt1700 (not bt1699)) (not bt1697) bt1698 a!16)
       (or (or (not bt1700) bt1699) a!17 bt1697 (<= it1612 0) bt1698)
       (or a!18 bt1699 bt1700 (> it1613 0) (not bt1698) (not bt1697))
       (or a!15 bt1699 bt1697 bt1700 bt1698)
       a!20
       (or (or (not bt1700) bt1699) a!21 (not bt1698) (not bt1697))
       a!22)))))
(check-sat)
