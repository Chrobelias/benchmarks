...
(assert (or bt1344
    ...
    bt1343
    bt1346
    (distinct (+ (* it1261 (- 1)) it1258) 0)
    bt1342
    bt1341
    (distinct (+ it1255 (- 2)) 0)
    (distinct (+ (* it1260 (- 1)) it1257) 0)
    (distinct (+ (* it1259 (- 1)) it1256) 0)
    bt1348
    bt1345))
(assert (let ((a!1 (and (not bt1347)
                (= (+ (* it1260 (- 1)) it1257) 0)
                (= (+ (* it1259 (- 1)) it1256) 0)))
      (a!3 (and (not bt1347) (not bt1345) (= (+ (* it1260 (- 1)) it1257) 0)))
      (a!8 (and bt1347
                (not bt1345)
                (= (+ (* it1260 (- 1)) it1257) 0)
                (= (+ (* it1259 (- 1)) it1256) 0)))
...
(let ((a!2 (and a!1
                ...
                bt1348
                bt1345))
      (a!4 (and a!3 (= (+ (* it1259 (- 1)) it1256) 0)))
      (a!6 (and (and a!1 bt1346)
                (not bt1348)
                (= (+ (* it1261 (- 1)) it1258) 0)
                bt1345))
      (a!9 (and a!8 (not bt1348) (= (+ (* it1261 (- 1)) it1258) 0) (not bt1346)))
      (a!13 (and a!8 bt1346 (not bt1348) (= (+ (* it1261 (- 1)) it1258) 0)))
      (a!16 (and (and a!1 bt1346)
                 (= (+ (* it1261 (- 1)) it1258) 0)
                 bt1348
                 bt1345))
      (a!17 (and a!3
                 ...
                 (= (+ (* it1261 (- 1)) it1258) 0)
                 (= (+ it1259 (- 1)) 0))))
(let ((a!5 (and a!4 (not bt1348) (= (+ (* it1261 (- 1)) it1258) 0) (not bt1346)))
      (a!7 (or (or bt1344 (not bt1341))
               a!6
               bt1343
               (<= (+ (* it1256 (- 1)) it1258) 0)
               bt1342))
      (a!11 (and a!4 (= (+ (* it1261 (- 1)) it1258) 0) (not bt1346) bt1348))
      (a!14 (and (and a!4 bt1346) (= (+ (* it1261 (- 1)) it1258) 0) bt1348))
      (a!18 (and (and a!4 bt1346)
                 (not bt1348)
                 (= (+ (* it1261 (- 1)) it1258) 0))))
(let ((a!12 (or (or bt1344 (not bt1341))
                a!11
                bt1343
                bt1342
                (> (+ (* it1256 (- 1)) it1258) 0))))
  (and (or bt1343 (<= it1256 0) (not bt1344) bt1342 a!2 bt1341)
       (or (not bt1341) bt1343 a!5 (not bt1344) bt1342)
       a!7
       (or bt1344 bt1343 a!5 bt1342 bt1341)
       (or (or bt1344 (not bt1342)) (<= it1257 0) (not bt1341) bt1343 a!9)
       (or (or bt1344 (not bt1342)) (not bt1341) (not bt1343) a!10)
       a!12
       (or (or bt1344 (not bt1342)) a!13 (not bt1341) (> it1257 0) bt1343)
       (or (not bt1342) a!14 bt1343 (not bt1344) bt1341)
       (or bt1344 (not bt1343) bt1342 bt1341 a!15)
       (or (> it1256 0) bt1343 a!16 (not bt1344) bt1342 bt1341)
       (or (or bt1344 (not bt1342)) a!17 bt1343 bt1341)
       (or (not bt1342) (not bt1341) bt1343 a!16 (not bt1344))
       (= (+ it1255 (- 2)) 0)
       (or (or bt1344 (not bt1342)) (not bt1343) bt1341 a!18)
       (or (or bt1344 (not bt1341)) (not bt1343) bt1342 a!19)))))))
(check-sat)
