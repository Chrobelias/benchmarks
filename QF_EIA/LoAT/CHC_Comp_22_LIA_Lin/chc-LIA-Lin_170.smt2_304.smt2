...
(assert (let ((a!1 (and (= (+ (* it1196 (- 1)) it1193) 0) bt1262))
      (a!5 (and (not bt1262) (= (+ (* it1196 (- 1)) it1193) 0)))
      (a!16 (and (not bt1262)
                 (= (+ (* it1194 (- 1)) (* it1191 2)) 0)
                 (= (+ (* it1196 (- 1)) it1193) 0)
                 bt1263
                 ...
                 (= (+ (* it1195 (- 1)) it1192) 0)
                 bt1261)))
(let ((a!2 (and (and a!1 bt1264 (not bt1263))
                (not bt1261)
                (= (+ (* it1195 (- 1)) it1192) 0)
                (= (+ (* it1194 (- 1)) it1191) 0)))
      (a!3 (and (and (and a!1 (not bt1263)) (not bt1261))
                (not bt1264)
                (= (+ (* it1195 (- 1)) it1192) 0)
                (= (+ (* it1194 (- 1)) it1191) 0)))
      (a!4 (and (and a!1 bt1264 (not bt1263))
                (= (+ (* it1195 (- 1)) it1192) 0)
                (= (+ (* it1194 (- 1)) it1191) 0)
                bt1261))
      (a!6 (and (and a!5 bt1264 (not bt1263))
                (not bt1261)
                (= (+ (* it1195 (- 1)) it1192) 0)
                (= (+ (* it1194 (- 1)) it1191) 0)))
      (a!8 (and a!5
      ...
      (a!13 (and a!1
                 ...
                 bt1261
                 (= (+ (* it1194 (- 1)) (* it1191 3)) 0)))
      (a!14 (and (and (and a!1 (not bt1263)) (not bt1261))
                 (= (+ it1194 (- 1)) 0)
                 (not bt1264)
                 (= (+ (* it1195 (- 1)) it1192) 0)))
      (a!15 (and a!1
                 ...
                 (= (+ (* it1195 (- 1)) it1192) 0)
                 (= (+ (* it1194 (- 1)) it1191) 0)))
      (a!17 (and (and a!5 bt1264 (not bt1263))
                 (= (+ (* it1195 (- 1)) it1192) 0)
                 (= (+ (* it1194 (- 1)) it1191) 0)
                 bt1261)))
(let ((a!7 (or (or (or (not bt1257) bt1258) bt1260)
               bt1259
               (> (+ it1193 (* it1191 (- 1))) 0)
               a!6))
      (a!11 (or (or (or (not bt1257) bt1258) bt1260)
                a!10
                bt1259
                (<= (+ it1193 (* it1191 (- 1))) 0))))
  (and (or (not bt1258) a!2 (not bt1260) bt1259 bt1257)
       (or (not bt1258) bt1260 a!3 (not bt1259) bt1257)
       (or a!4 (> it1191 0) bt1258 (not bt1260) bt1259 bt1257)
       a!7
       (or a!8 bt1258 bt1260 bt1259 bt1257)
       (or (or (not bt1257) (not bt1258)) a!9 (<= it1192 0) bt1260 bt1259)
       (or (or (not bt1257) (not bt1258)) a!4 (not bt1260) bt1259)
       a!11
       (or (or (not bt1257) (not bt1258)) a!12 bt1260 (not bt1259))
       (or (or (not bt1257) bt1258) a!13 bt1260 (not bt1259))
       (= (+ it1190 (- 2)) 0)
       (or a!14 (not bt1258) bt1260 bt1259 bt1257)
       (or (> it1192 0) a!15 (not bt1257) (not bt1258) bt1260 bt1259)
       (or a!16 bt1258 bt1260 (not bt1259) bt1257)
       (or a!17 bt1258 (<= it1191 0) (not bt1260) bt1259 bt1257)
       (or a!8 (not bt1257) bt1258 (not bt1260) bt1259))))))
(check-sat)
