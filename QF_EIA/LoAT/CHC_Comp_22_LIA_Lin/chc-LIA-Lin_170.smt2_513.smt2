...
(assert (let ((a!1 (and (= (+ (* it1608 (- 1)) (* it1605 2)) 0)
                bt1693
                (not bt1694)
                (not bt1696)
                (= (+ (* it1609 (- 1)) it1606) 0)
      ...
      (a!15 (and bt1694
                 ...
                 (= (+ (* it1608 (- 1)) it1605) 0)
                 (= (+ (* it1610 (- 1)) it1607) 0)))
      (a!18 (and (and bt1694 (not bt1693))
                 bt1696
                 (= (+ (* it1609 (- 1)) it1606) 0)
                 (not bt1695)
                 (= (+ (* it1608 (- 1)) it1605) 0)
                 (= (+ (* it1610 (- 1)) it1607) 0))))
(let ((a!3 (and (and a!2 (not bt1695))
                (= (+ it1608 (- 1)) 0)
                (= (+ (* it1610 (- 1)) it1607) 0)))
      (a!9 (or (or (or bt1691 bt1690) bt1692)
               a!8
               (not bt1689)
               (> (+ it1607 (* it1605 (- 1))) 0)))
      (a!11 (and a!10
      ...
      (a!19 (and a!10
                 ...
                 (= (+ (* it1610 (- 1)) it1607) 0)
                 bt1695)))
(let ((a!4 (or (or (or bt1691 (not bt1690)) bt1692) a!3 bt1689))
      (a!14 (or (or (or bt1691 (not bt1690)) bt1692)
                (> it1606 0)
                a!13
                (not bt1689))))
  (and (or (or bt1690 bt1692 (not bt1691)) a!1 bt1689)
       a!4
       (or (or bt1691 bt1690) (<= it1605 0) a!5 bt1689 (not bt1692))
       (or (or bt1691 (not bt1690)) a!6 (not bt1689) (not bt1692))
       (or (not bt1690) bt1692 (not bt1691) a!7 (not bt1689))
       a!9
       (or (or (or bt1691 bt1690) bt1692) a!11 bt1689)
       (or (or bt1691 bt1690) a!11 (not bt1689) (not bt1692))
       (or (or bt1690 bt1692 (not bt1691)) a!12 (not bt1689))
       a!14
       a!16
       (or (not bt1690) a!17 bt1692 (not bt1691) bt1689)
       (or (or bt1691 (not bt1690)) a!18 bt1689 (not bt1692))
       (or (or bt1691 bt1690) a!6 (> it1605 0) bt1689 (not bt1692))
       (= (+ it1604 (- 2)) 0)
       (or (or bt1691 (not bt1690)) a!19 (<= it1606 0) bt1692 (not bt1689)))))))
(check-sat)
