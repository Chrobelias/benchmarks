...
(assert (let ((a!1 (and (= (+ it1279 (- 10)) 0)
                bt1500
                bt1499
                (= (+ (* it1278 (- 1)) it1275) 0)
                (= (+ (* it1280 (- 1)) it1277) 0)
      ...
      (a!5 (and (= (+ it1278 (- 1)) 0)
                ...
                (not bt1498)
                (not bt1501)))
      (a!6 (and (and (not bt1499) (not bt1500))
                bt1501
                (= (+ (* it1278 (- 1)) it1275) 0)
                (= (+ (* it1279 (- 1)) it1276) 0)
                (= (+ (* it1280 (- 1)) it1277) 0)))
      (a!7 (and (and (not bt1499) (not bt1500))
                (= (+ (* it1278 (- 1)) it1275) 0)
                (= (+ (* it1279 (- 1)) it1276) 0)
                (= (+ (* it1280 (- 1)) it1277) 0)))
      (a!8 (and (and (not bt1499) bt1500)
                bt1501
                (= (+ (* it1278 (- 1)) it1275) 0)
                (= (+ (* it1279 (- 1)) it1276) 0)
                (= (+ (* it1280 (- 1)) it1277) 0)
                (not bt1498)))
      (a!9 (and (and bt1500 bt1499)
                (= (+ (* it1279 (- 1)) it1276) 0)
                (= (+ (* it1280 (- 1)) it1277) 0)
                bt1498
                (not bt1501)
      ...
      (a!12 (and bt1500
                 ...
                 (= (+ (* it1280 (- 1)) it1277) 0)
                 (not bt1498)))
      (a!13 (= (+ (+ (* it1279 (- 1)) it1276) (- 1)) 0)))
(let ((a!4 (or (or bt1496 bt1497)
               (> (+ it1277 (* it1275 (- 1))) 0)
               (not bt1494)
               (not bt1495)
               a!3))
      (a!10 (or (or bt1496 bt1497)
                (<= (+ it1277 (* it1275 (- 1))) 0)
                (and a!7 bt1498 (not bt1501))
                (not bt1494)
                (not bt1495)))
      (a!14 (and (and (not bt1499) bt1500)
                 (= (+ (* it1278 (- 1)) it1275) 0)
                 (= (+ (* it1280 (- 1)) it1277) 0)
                 bt1498
                 (not bt1501)
                 a!13)))
  (and (or (or bt1496 bt1497) a!1 (not bt1494) bt1495)
       (or (or (not bt1497) bt1496) a!2 bt1494 bt1495)
       a!4
       (or a!5 bt1496 bt1497 (not bt1495) bt1494)
       (or bt1497
           (and a!6 (not bt1498))
           (not bt1496)
           (> it1276 0)
           bt1494
           bt1495)
       (or (or bt1496 bt1497) (and a!7 (not bt1498) (not bt1501)) bt1494 bt1495)
       (or (or (not bt1497) bt1496)
           (> it1275 0)
           (and a!6 bt1498)
           (not bt1495)
           bt1494)
       (or (or (not bt1497) bt1496) a!8 (<= it1275 0) (not bt1495) bt1494)
       (or bt1497 (not bt1494) (not bt1496) bt1495 a!9)
       a!10
       (or bt1497 (not bt1496) a!11 (<= it1276 0) bt1494 bt1495)
       (or (or (not bt1497) bt1496) (not bt1494) bt1495 a!12)
       (= (+ it1274 (- 2)) 0)
       (or bt1497 (not bt1495) (not bt1496) bt1494 a!14)
       (or (not bt1497) (and a!6 bt1498) (not bt1496) bt1494 bt1495)
       (or bt1497
           (and a!7 bt1498 (not bt1501))
           (not bt1494)
           (not bt1495)
