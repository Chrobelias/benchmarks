...
(assert (or (distinct (+ it482 (- 2)) 0)
    (not bt527)
    bt522
    (distinct (+ (* it488 (- 1)) it485) 0)
    (not bt521)
    (not bt526)
    (distinct (+ (* it487 (- 1)) it484) 0)
    (distinct (+ (* it486 (- 1)) (* it483 3)) 0)
    bt528
    (not bt525)
    (not bt523)))
(assert (let ((a!1 (and (not bt528)
                (= (+ (* it488 (- 1)) it485) 0)
                (not bt525)
                (= (+ (* it487 (- 1)) it484) 0)
                (= (+ (* it486 (- 1)) it483) 0)
                (not bt526)
                bt527))
      (a!2 (and (and (and (not bt527) bt525) bt526)
                (= (+ (* it488 (- 1)) it485) 0)
                (= (+ (* it487 (- 1)) it484) 0)
                (= (+ (* it486 (- 1)) it483) 0)
                bt528))
      (a!3 (and (and (not bt527) bt526)
                (= (+ (* it488 (- 1)) it485) 0)
                (not bt525)
                (= (+ (* it487 (- 1)) it484) 0)
                (= (+ (* it486 (- 1)) it483) 0)
      ...
      (a!5 (and bt525
                ...
                bt527
                (= (+ (* it486 (- 1)) (* it483 3)) 0)))
      (a!6 (and (and (and (not bt527) bt525) bt526)
                (not bt528)
                (= (+ (* it488 (- 1)) it485) 0)
                (= (+ (* it487 (- 1)) it484) 0)
                (= (+ (* it486 (- 1)) it483) 0)))
      (a!8 (and (and (not bt527) bt526)
                (not bt528)
                (= (+ (* it488 (- 1)) it485) 0)
                (not bt525)
                (= (+ (* it487 (- 1)) it484) 0)))
      (a!11 (and (not bt527)
                 ...
                 (not bt526)
                 bt528))
      (a!13 (and (and (not bt527) bt525)
                 (= (+ (* it488 (- 1)) it485) 0)
                 (= (+ (* it487 (- 1)) it484) 0)
                 (= (+ (* it486 (- 1)) it483) 0)
                 (not bt526)
                 bt528))
      (a!14 (and (= (+ (* it486 (- 1)) (* it483 2)) 0)
                 bt525
                 (not bt528)
                 (= (+ (* it488 (- 1)) it485) 0)
                 (= (+ (* it487 (- 1)) it484) 0)
...
(let ((a!7 (or a!6
               ...
               bt524
               (not bt521)))
      (a!9 (or (or (not bt522) bt521)
               (and a!8 (= (+ it486 (- 1)) 0))
               bt523
               bt524))
      (a!10 (and a!8 (= (+ (* it486 (- 1)) it483) 0)))
      (a!12 (or (> (+ it485 (* it483 (- 1))) 0)
                bt522
                bt523
                bt524
                (not bt521)
                a!11)))
  (and (or (not bt522) (<= it484 0) a!1 bt523 bt524 (not bt521))
       (or (not bt522) a!2 bt523 (not bt521) (not bt524))
       (or (or (not bt522) bt521) a!3 bt523 (not bt524))
       (or bt522 bt523 (not bt521) (not bt524) a!4)
       (or bt522 (not bt523) bt524 (not bt521) a!5)
       (or (or bt521 bt522) bt523 bt524 a!4)
       a!7
       (= (+ it482 (- 2)) 0)
       a!9
       (or (or (not bt522) bt521) a!10 (not bt523) bt524)
       a!12
       (or a!13 bt521 bt522 (<= it483 0) bt523 (not bt524))
       (or (or bt521 bt522) (not bt523) bt524 a!14)
       (or (not bt522) a!15 bt523 bt524 (not bt521) (> it484 0))
       (or (or bt521 bt522) a!2 bt523 (not bt524) (> it483 0))
       (or (not bt522) (not bt523) a!16 bt524 (not bt521))))))
(check-sat)
