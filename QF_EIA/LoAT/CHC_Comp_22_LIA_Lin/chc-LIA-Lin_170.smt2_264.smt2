...
(assert (let ((a!1 (and (= (+ (* it1142 (- 1)) (* it1139 2)) 0)
                (= (+ (* it1143 (- 1)) it1140) 0)
                (not bt1212)
                bt1209
                bt1211
                (= (+ it1141 (* it1144 (- 1))) 0)
                (not bt1210)))
      (a!2 (and (= (+ (* it1143 (- 1)) it1140) 0) (not bt1212)))
      (a!8 (and (= (+ (* it1143 (- 1)) it1140) 0)
                bt1210
                (= (+ it1141 (* it1144 (- 1))) 0)
                bt1212
                (not bt1209)
                (not bt1211)
                (= (+ (* it1142 (- 1)) it1139) 0)))
      (a!9 (and (= (+ (* it1143 (- 1)) it1140) 0) bt1209))
      (a!17 (and (= (+ (* it1143 (- 1)) it1140) 0)
                 (= (+ it1141 (* it1144 (- 1))) 0)
                 bt1212
                 (not bt1209)
                 (not bt1210)
...
(let ((a!3 (and (and a!2 bt1209)
      ...
      (a!15 (and a!9
                 ...
                 (not bt1211)
                 (= (+ (* it1142 (- 1)) it1139) 0)))
      (a!18 (or (or (or bt1207 bt1208) (not bt1205))
                bt1206
                a!17
                (> (+ it1141 (* it1139 (- 1))) 0)))
      (a!19 (and (and a!2 bt1209)
                 (= (+ (* it1142 (- 1)) (* it1139 3)) 0)
                 bt1210
                 bt1211
                 (= (+ it1141 (* it1144 (- 1))) 0)))
      (a!20 (and (and a!2 bt1209)
                 bt1211
                 (= (+ it1141 (* it1144 (- 1))) 0)
                 (not bt1210)
                 (= (+ (* it1142 (- 1)) it1139) 0)))
      (a!21 (and (and a!2 bt1210)
                 bt1211
                 (= (+ it1141 (* it1144 (- 1))) 0)
                 (not bt1209)
                 (= (+ (* it1142 (- 1)) it1139) 0))))
(let ((a!4 (or (or bt1207 bt1208)
               a!3
               (<= (+ it1141 (* it1139 (- 1))) 0)
               (not bt1205)
               bt1206))
      (a!11 (or (or (or bt1207 (not bt1208)) (not bt1205)) a!10 (not bt1206)))
      (a!13 (or (or (or bt1207 (not bt1208)) (not bt1205)) bt1206 a!12))
      (a!14 (or (or (or bt1207 (not bt1208)) bt1205 bt1206) a!10 (> it1139 0)))
      (a!16 (or (or (or bt1207 (not bt1208)) bt1205 bt1206) (<= it1139 0) a!15)))
  (and (or (or (not bt1207) bt1208) bt1205 bt1206 a!1)
       a!4
       (= (+ it1138 (- 2)) 0)
       (or (or bt1207 bt1208) a!5 bt1205 (not bt1206))
       (or (or (not bt1207) bt1208) a!6 bt1205 (not bt1206))
       (or (or bt1207 bt1208) a!7 (not bt1205) (<= it1140 0) (not bt1206))
       (or bt1207 a!8 (not bt1208) bt1205 (not bt1206))
       a!11
       a!13
       (or (or bt1207 bt1208) bt1205 bt1206 a!12)
       a!14
       a!16
       a!18
       (or (or (not bt1207) bt1208) a!19 (not bt1205) bt1206)
       (or (or (not bt1207) bt1208) a!20 (not bt1205) (not bt1206))
       (or (or (or bt1207 bt1208) (not bt1205)) (> it1140 0) (not bt1206) a!21))))))
(check-sat)
