...
(declare-fun it487 () Int)
(declare-fun it495 () Int)
(declare-fun it496 () Int)
(declare-fun it497 () Int)
(declare-fun it498 () Int)
(declare-fun bt537 () Bool)
(declare-fun bt538 () Bool)
(declare-fun bt539 () Bool)
(declare-fun bt540 () Bool)
(declare-fun bt541 () Bool)
(declare-fun bt542 () Bool)
(declare-fun it499 () Int)
(declare-fun it501 () Int)
(declare-fun bt544 () Bool)
(declare-fun bt543 () Bool)
(declare-fun it500 () Int)
(declare-fun it517 () Int)
(declare-fun it518 () Int)
(declare-fun it519 () Int)
(declare-fun it520 () Int)
(declare-fun bt565 () Bool)
(declare-fun bt566 () Bool)
(declare-fun bt567 () Bool)
(declare-fun bt568 () Bool)
(declare-fun bt571 () Bool)
(declare-fun bt572 () Bool)
(declare-fun bt569 () Bool)
...
(assert (and (= (+ (* it487 (- 1)) it484) 0)
     ...
     (= (+ (* it486 (- 1)) (* it483 3)) 0)))
(assert (= (+ it495 (- 2)) 0))
(assert (= (+ it496 (* it486 (- 1))) 0))
(assert (= (+ (* it487 (- 1)) it497) 0))
(assert (= (+ (* it488 (- 1)) it498) 0))
(assert (or (and (not bt537) (not bt526)) (and bt526 bt537)))
(assert (or (and bt525 bt538) (and (not bt538) (not bt525))))
(assert (or (and bt539 bt527) (and (not bt527) (not bt539))))
(assert (or (and bt540 bt528) (and (not bt540) (not bt528))))
(assert (and (= (+ (* it500 (- 1)) it497) 0)
     bt539
     bt543
     (not bt544)
     (= (+ (* it501 (- 1)) it498) 0)
     ...
     bt537))
(assert (= (+ it517 (- 2)) 0))
(assert (= (+ (* it499 (- 1)) it518) 0))
(assert (= (+ (* it500 (- 1)) it519) 0))
(assert (= (+ it520 (* it501 (- 1))) 0))
(assert (or (and bt565 bt542) (and (not bt565) (not bt542))))
(assert (or (and (not bt541) (not bt566)) (and bt566 bt541)))
(assert (or (and bt543 bt567) (and (not bt543) (not bt567))))
(assert (or (and (not bt568) (not bt544)) (and bt544 bt568)))
(assert (or (distinct (+ it517 (- 2)) 0)
    bt565
    (distinct (+ (* it523 (- 1)) it520) 0)
    (not bt567)
    (distinct (+ (* it522 (- 1)) it519) 0)
    (distinct (+ (* it521 (- 1)) it518) 0)
    (not bt570)
    (not bt566)
    bt569
    bt572
    bt571))
(assert (let ((a!1 (and (= (+ (* it521 (- 1)) (* it518 3)) 0)
                (= (+ (* it522 (- 1)) it519) 0)
                (not bt572)
                (= (+ (* it523 (- 1)) it520) 0)
                bt569
                bt571
                bt570))
      (a!2 (and (not bt571) (= (+ (* it522 (- 1)) it519) 0)))
      (a!7 (and (not bt571) (not bt570) (= (+ (* it522 (- 1)) it519) 0)))
      (a!12 (and (not bt570) (= (+ (* it522 (- 1)) it519) 0)))
      (a!19 (and (not bt571)
                 (= (+ it521 (- 1)) 0)
                 (= (+ (* it522 (- 1)) it519) 0)
                 (not bt569)
      ...
      (a!21 (and (= (+ (* it522 (- 1)) it519) 0)
                 ...
                 bt571
                 bt570)))
(let ((a!3 (and a!2 (not bt569) (= (+ (* it521 (- 1)) it518) 0)))
      (a!5 (and a!2 (= (+ (* it521 (- 1)) it518) 0)))
      (a!8 (and a!7 (not bt569) (= (+ (* it521 (- 1)) it518) 0)))
      (a!13 (and a!12
                 (= (+ (* it521 (- 1)) it518) 0)
                 (not bt572)
                 (= (+ (* it523 (- 1)) it520) 0)
      ...
      (a!20 (and a!7
                 ...
                 bt569
                 bt572)))
(let ((a!4 (and a!3 (not bt572) (= (+ (* it523 (- 1)) it520) 0) bt570))
      (a!6 (and a!5 (= (+ (* it523 (- 1)) it520) 0) bt569 bt572 bt570))
      (a!9 (and a!8 (not bt572) (= (+ (* it523 (- 1)) it520) 0)))
      (a!10 (and a!5 (not bt572) (= (+ (* it523 (- 1)) it520) 0) bt569 bt570))
      (a!16 (and a!8 (= (+ (* it523 (- 1)) it520) 0) bt572))
      (a!18 (and a!3 (= (+ (* it523 (- 1)) it520) 0) bt572 bt570)))
(let ((a!11 (or (or bt566 (not bt565))
                bt567
                (<= (+ it520 (* it518 (- 1))) 0)
                bt568
                a!10))
      (a!17 (or bt566
                ...
                bt567
                bt568)))
  (and (or (or (not bt567) bt566) (not bt565) a!1 bt568)
       (= (+ it517 (- 2)) 0)
       (or (not bt567) bt565 (not bt566) a!4 bt568)
       (or (not bt565) a!6 (not bt568) (not bt566) bt567)
       (or (or bt566 bt565) a!9 bt567 bt568)
       a!11
       (or (or bt566 bt565) a!6 (not bt568) bt567 (> it518 0))
       (or (or bt566 (not bt565)) (not bt568) a!9 bt567)
       (or (not bt567) (not bt565) a!13 (not bt566) bt568)
       (or (or (not bt567) bt566) bt565 a!14 bt568)
       (or (not bt565) (not bt566) bt567 a!15 bt568 (<= it519 0))
       a!17
       (or bt565 (not bt568) (not bt566) bt567 a!18)
       (or bt565 a!19 (not bt566) bt567 bt568)
       (or bt566 a!20 bt565 (<= it518 0) (not bt568) bt567)
       (or (> it519 0) (not bt565) (not bt566) bt567 bt568 a!21)))))))
(check-sat)
