...
(assert (and bt1511
     ...
     (= (+ (* it1294 (- 1)) it1291) 0)))
(assert (= (+ it1295 (- 2)) 0))
(assert (= (+ (* it1292 (- 1)) it1296) 0))
(assert (= (+ (* it1293 (- 1)) it1297) 0))
(assert (= (+ (* it1294 (- 1)) it1298) 0))
(assert (or (and bt1516 bt1518) (and (not bt1518) (not bt1516))))
(assert (or (and (not bt1519) (not bt1515)) (and bt1519 bt1515)))
(assert (or (and bt1520 bt1514) (and (not bt1520) (not bt1514))))
(assert (or (and (not bt1521) (not bt1517)) (and bt1517 bt1521)))
(assert (and bt1520 (not bt1519) (not bt1518) bt1521 (= (+ it1295 (- 2)) 0)))
(check-sat)
