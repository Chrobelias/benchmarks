...
(assert (or bt1449
    (distinct (+ (* it1369 (- 1)) it1366) 0)
    (distinct (+ (* it1368 (- 1)) it1365) 0)
    (not bt1447)
    bt1445
    (not bt1446)
    bt1452
    (distinct (+ it1364 (- 2)) 0)
    bt1451
    (distinct (+ it1367 (* it1370 (- 1))) 0)
    (not bt1450)))
(assert (let ((a!1 (and (and bt1449 (not bt1452))
                (not bt1451)
                (= (+ it1367 (* it1370 (- 1))) 0)
                (= (+ (* it1368 (- 1)) it1365) 0)
                (= (+ (* it1369 (- 1)) it1366) 0)
                bt1450))
      (a!3 (and (and (not bt1452) (not bt1449))
                (not bt1451)
                (= (+ it1367 (* it1370 (- 1))) 0)))
      (a!6 (and (and (not bt1452) (not bt1449))
                (= (+ it1367 (* it1370 (- 1))) 0)
                (= (+ (* it1368 (- 1)) it1365) 0)))
      (a!8 (and (and bt1449 (not bt1452)) (= (+ it1367 (* it1370 (- 1))) 0)))
      (a!10 (and (not bt1449)
                 (not bt1451)
                 (= (+ it1367 (* it1370 (- 1))) 0)
                 (= (+ (* it1368 (- 1)) it1365) 0)))
      (a!14 (and bt1449
                 ...
                 (= (+ it1367 (* it1370 (- 1))) 0)
                 (= (+ (* it1368 (- 1)) it1365) 0))))
(let ((a!2 (or (or bt1447 bt1448)
               a!1
               (<= (+ it1367 (* it1365 (- 1))) 0)
               (not bt1445)
               bt1446))
      (a!4 (and a!3 (= (+ (* it1368 (- 1)) it1365) 0)))
      (a!7 (and a!6 (not bt1450) (= (+ (* it1369 (- 1)) it1366) 0) bt1451))
      (a!9 (and a!8
                (not bt1450)
                (= (+ (* it1369 (- 1)) it1366) 0)
                (= (+ (* it1368 (- 1)) (* it1365 2)) 0)
                bt1451))
      (a!11 (and a!10 (= (+ (* it1369 (- 1)) it1366) 0) bt1450 bt1452))
      (a!12 (and a!8
                 (= (+ (* it1368 (- 1)) (* it1365 3)) 0)
                 (= (+ (* it1369 (- 1)) it1366) 0)
                 bt1450
      ...
      (a!13 (and a!3
                 ...
                 (= (+ (* it1369 (- 1)) it1366) 0)
                 bt1450))
      (a!15 (and a!14 (= (+ (* it1369 (- 1)) it1366) 0) bt1450 bt1452))
      (a!16 (and a!6 (= (+ (* it1369 (- 1)) it1366) 0) bt1450 bt1451))
      (a!17 (and a!10 (not bt1450) (= (+ (* it1369 (- 1)) it1366) 0) bt1452))
      (a!19 (and a!8
                 (= (+ (* it1368 (- 1)) it1365) 0)
                 (not bt1450)
                 (= (+ (* it1369 (- 1)) it1366) 0)
                 bt1451))
      (a!20 (and a!14 (not bt1450) (= (+ (* it1369 (- 1)) it1366) 0) bt1452)))
(let ((a!5 (and a!4 (not bt1450) (= (+ (* it1369 (- 1)) it1366) 0)))
      (a!18 (or a!17
                (> (+ it1367 (* it1365 (- 1))) 0)
                bt1447
                bt1448
                (not bt1445)
                bt1446))
      (a!21 (and a!4 (= (+ (* it1369 (- 1)) it1366) 0) bt1450)))
  (and a!2
       (or bt1447 (not bt1445) (not bt1448) bt1446 a!5)
       (or (or bt1447 (not bt1446)) bt1448 a!7 (<= it1366 0) (not bt1445))
       (= (+ it1364 (- 2)) 0)
       (or bt1448 bt1445 a!9 bt1446 (not bt1447))
       (or (or bt1447 (not bt1446)) bt1445 (not bt1448) a!11)
       (or bt1448 (not bt1445) a!12 bt1446 (not bt1447))
       (or a!13 bt1447 (not bt1446) bt1448 bt1445)
       (or (or a!15 bt1447) (not bt1446) (not bt1445) (not bt1448))
       (or (> it1366 0) a!16 bt1447 (not bt1446) bt1448 (not bt1445))
       a!18
       (or (or bt1447 bt1448) bt1445 bt1446 a!5)
       (or (or (not bt1446) bt1448) (not bt1445) (not bt1447) a!19)
       (or (<= it1365 0) bt1447 bt1445 (not bt1448) bt1446 a!20)
       (or (or a!15 bt1447) bt1445 (not bt1448) bt1446 (> it1365 0))
       (or (or (not bt1446) bt1448) a!21 bt1445 (not bt1447)))))))
(check-sat)
