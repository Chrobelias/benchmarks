...
(assert (let ((a!1 (and (= (+ (* it1111 (- 1)) it1532) 0)
      ...
      (a!2 (and (= (+ (* it1111 (- 1)) (* it1532 3)) 0)
                ...
                (not bt1184)
                bt1183))
      (a!3 (and (= (+ (* it1111 (- 1)) it1532) 0) (not bt1182)))
      (a!9 (and (= (+ (* it1111 (- 1)) it1532) 0)
                bt1182
                (= (+ it1533 (* it1112 (- 1))) 0)))
      (a!14 (and (not bt1182)
                 bt1181
      ...
      (a!16 (and (= (+ it1111 (- 1)) 0)
                 ...
                 (not bt1184)
                 (not bt1181))))
(let ((a!4 (and a!3 bt1181 (= (+ it1533 (* it1112 (- 1))) 0)))
      (a!7 (and a!3 (= (+ it1533 (* it1112 (- 1))) 0)))
      (a!10 (and a!9 (not bt1183) (= (+ it1534 (* it1113 (- 1))) 0)))
      (a!13 (or (not bt1629)
                bt1630
                bt1631
                (<= (+ (* it1532 (- 1)) it1534) 0)
      ...
      (a!15 (and a!9
                 ...
                 bt1183
                 (not bt1181))))
(let ((a!5 (and a!4 (not bt1183) (= (+ it1534 (* it1113 (- 1))) 0) bt1184))
      (a!6 (and a!4 (= (+ it1534 (* it1113 (- 1))) 0) (not bt1184) bt1183))
      (a!8 (and a!7 (not bt1183) (= (+ it1534 (* it1113 (- 1))) 0)))
      (a!12 (and a!7
                 (= (+ it1534 (* it1113 (- 1))) 0)
                 (not bt1184)
                 bt1183
                 (not bt1181))))
(let ((a!11 (or (not bt1629)
                (> (+ (* it1532 (- 1)) it1534) 0)
                bt1630
                bt1631
                bt1632
                (and a!8 bt1184 (not bt1181)))))
  (and (or (not bt1629) (and a!1 bt1184) (not bt1630) bt1631 (not bt1632))
       (or (and a!1 bt1184) bt1630 bt1631 bt1629 (not bt1632) (> it1532 0))
       (or (or (not bt1629) (not bt1631)) a!2 bt1630 bt1632)
       (or (<= it1532 0) bt1630 bt1631 bt1629 (not bt1632) a!5)
       (or (or (not bt1629) (not bt1631)) (not bt1630) bt1632 a!6)
       (= (+ it1531 (- 2)) 0)
       (or (and a!8 (not bt1184) (not bt1181)) bt1630 bt1631 bt1629 bt1632)
       (or (not bt1631)
           (not bt1630)
           bt1629
           bt1632
           (and a!10 (not bt1184) (not bt1181)))
       a!11
       (or (or (not bt1629) (not bt1630) bt1631) bt1632 (<= it1533 0) a!12)
       (or (not bt1629)
           (and a!8 (not bt1184) (not bt1181))
           bt1630
           bt1631
           (not bt1632))
       a!13
       (or (or (not bt1630) bt1631 bt1629)
           (and a!10 bt1184 (not bt1181))
           (not bt1632))
       (or (not bt1631) bt1630 bt1629 bt1632 a!14)
       (or (or (not bt1629) (not bt1630) bt1631) (> it1533 0) bt1632 a!15)
       (or (or (not bt1630) bt1631 bt1629) bt1632 a!16)))))))
(check-sat)
