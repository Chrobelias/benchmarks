...
(assert (let ((a!1 (+ (+ 0 (+ it142 (* it134 (- 2)) (* it149 2)))
              ...
              (+ 0 (* it142 it132 (- 2))))))
  (= a!1 (+ 0 0))))
(assert (and (> (+ (* it148 (- 1)) it147) 0)
     (<= (+ it144 (* it145 (- 1))) 0)
     (= (+ it143 (- 2)) 0)))
(assert (= (+ it167 (- 2)) 0))
(assert (= (+ it168 (* it144 (- 1)) (- 1)) 0))
(assert (= (+ it169 (* it145 (- 1))) 0))
(assert (= (+ (* it144 (- 1)) it170 (* it146 (- 1))) 0))
(assert (= (+ it171 (* it147 (- 1))) 0))
(assert (= (+ it172 (* it148 (- 1))) 0))
(assert (= (+ it173 (* it149 (- 1))) 0))
(assert (let ((a!1 (or (< (+ (* it173 (- 1)) it170) 0) (> (+ (* it173 (- 1)) it170) 0))))
  (and (> (+ (* it172 (- 1)) it171) 0)
       (= (+ it167 (- 2)) 0)
       (> (+ it168 (* it169 (- 1))) 0)
       a!1)))
