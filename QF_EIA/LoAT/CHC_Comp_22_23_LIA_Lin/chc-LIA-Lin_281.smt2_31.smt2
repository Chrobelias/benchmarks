...
(assert (and (<= (+ it168 (* it169 (- 1))) 0)
     (= (+ it164 (- 2)) 0)
     (<= (+ it165 (* it166 (- 1))) 0)))
(assert (= (+ it202 (- 2)) 0))
(assert (= (+ (* it165 (- 1)) it203 (- 1)) 0))
(assert (= (+ it204 (* it166 (- 1))) 0))
(assert (= (+ (* it165 (- 1)) it205 (* it167 (- 1))) 0))
(assert (= (+ (* it168 (- 1)) it206 (- 1)) 0))
(assert (= (+ it207 (* it169 (- 1))) 0))
(assert (= (+ (* it168 (- 1)) it208 (* it170 (- 1))) 0))
(assert (let ((a!1 (or (< (+ (* it208 (- 1)) it205) 0) (> (+ (* it208 (- 1)) it205) 0))))
  (and a!1
       (= (+ it202 (- 2)) 0)
       (> (+ (* it207 (- 1)) it206) 0)
       (> (+ (* it204 (- 1)) it203) 0))))
