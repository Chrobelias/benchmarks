...
(assert (= (+ (* (+ 0 it106) (** 5 it148) (+ 0 (- 1))) (+ 0 it152))
   (+ 0 0)))
(assert (= (+ it153 (* it148 (- 1)) (* it107 (- 1))) 0))
(assert (= (+ it154 (* it108 (- 1))) 0))
(assert (= (+ (* (+ 0 it109) (** 5 it148) (+ 0 (- 1))) (+ 0 it155))
   (+ 0 0)))
...
(assert (and (>= (+ it158 (- 2)) 0)
     (>= (+ (* it159 (- 1)) it160 (* it172 (- 1)) 1) 0)
     (>= (+ (* it158 (- 1)) 2) 0)
     (>= (+ (* it162 (- 1)) it163 (* it172 (- 1)) 1) 0)
     (>= (+ it172 (- 1)) 0)))
(assert (= (+ it173 (* it158 (- 1))) 0))
(assert (= (+ it174 (* it159 (- 1)) (* it172 (- 1))) 0))
(assert (= (+ it175 (* it160 (- 1))) 0))
(assert (= (+ (+ 0 (* it159 it172 (- 2)))
      (* (** it172 2) (+ 0 (- 1)))
      (+ 0 (* it176 2))
      (+ 0 it172)
      (+ 0 (* it161 (- 2))))
   (+ 0 0)))
(assert (= (+ (* it162 (- 1)) it177 (* it172 (- 1))) 0))
...
(assert (= (+ (* (** it172 2) (+ 0 (- 1)))
      ...
      (+ 0 it172))
   (+ 0 0)))
(assert (and (> (+ it177 (* it178 (- 1))) 0)
     (>= (+ (* it174 (- 1)) it175 (* it125 (- 1)) 1) 0)
     (>= (+ it125 (- 1)) 0)
     (>= (+ (* it173 (- 1)) 2) 0)
     (>= (+ it173 (- 2)) 0)))
(assert (= (+ it181 (* it173 (- 1))) 0))
(assert (= (+ (* it174 (- 1)) it182 (* it125 (- 1))) 0))
(assert (= (+ (* it175 (- 1)) it183) 0))
(assert (= (+ (* (** it125 2) (+ 0 (- 1)))
      (+ 0 (* it184 2))
      (+ 0 it125)
      (+ 0 (* it176 (- 2)))
      (+ 0 (* it174 it125 (- 2))))
   (+ 0 0)))
(assert (= (+ (* it177 (- 1)) it185) 0))
(assert (= (+ (* it178 (- 1)) it186) 0))
(assert (= (+ it187 (* it179 (- 1))) 0))
(assert (let ((a!1 (or (< (+ it184 (* it187 (- 1))) 0) (> (+ it184 (* it187 (- 1))) 0))))
  (and (< (+ (* it185 (- 1)) it186) 0)
       (< (+ (* it182 (- 1)) it183) 0)
       (= (+ it181 (- 2)) 0)
       a!1)))
