...
(assert (= (+ (+ 0 (* it314 it324 (- 2)))
      ...
      (+ 0 it324))
   (+ 0 0)))
(assert (and (>= (+ (* it326 (- 1)) it327 (* it215 (- 1)) 1) 0)
     (>= (+ it215 (- 1)) 0)
     (> (+ it329 (* it330 (- 1))) 0)
     (>= (+ it325 (- 2)) 0)
     (>= (+ (* it325 (- 1)) 2) 0)))
...
(assert (= (+ (+ 0 it366) (* (** 2 it362) (+ 0 it351) (+ 0 (- 1))))
   (+ 0 0)))
(assert (= (+ (* it362 (- 1)) it367 (* it352 (- 1))) 0))
(assert (= (+ (* it353 (- 1)) it368) 0))
(assert (= (+ (+ 0 it369) (* (** 2 it362) (+ 0 it354) (+ 0 (- 1))))
   (+ 0 0)))
...
(assert (and (>= it394 0)
     ...
     (>= (+ (* it393 (- 1)) 3) 0)
     (>= (* it396 (- 1)) 0)))
(assert (= (+ (* it393 (- 1)) it403) 0))
(assert (= (+ it249 (* it394 (- 1)) it404) 0))
(assert (let ((a!1 (+ (+ 0 (+ (* it249 (- 1)) (* it249 it394 (- 2))))
              (** it249 2)
              (+ 0 (* it395 (- 2)))
              (+ 0 (* it405 2)))))
  (= a!1 (+ 0 0))))
(assert (= (+ (* it396 (- 1)) it406) 0))
(assert (= (+ (* it397 (- 1)) it407) 0))
(assert (= (+ (* it175 (- 1)) it408) 0))
(assert (= (+ it409 (* it176 (- 1))) 0))
(assert (let ((a!1 (or (< (+ (* it407 (- 1)) it405) 0) (> (+ (* it407 (- 1)) it405) 0))))
  (and (< it404 0) (= (+ it403 (- 3)) 0) (<= it406 0) a!1)))
(check-sat)
