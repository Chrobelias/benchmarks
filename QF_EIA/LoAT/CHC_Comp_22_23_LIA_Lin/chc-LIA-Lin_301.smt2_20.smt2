...
(assert (= (+ (* (** 5 it118) (+ 0 it106) (+ 0 (- 1))) (+ 0 it122))
   (+ 0 0)))
(assert (= (+ (* it118 (- 1)) (* it107 (- 1)) it123) 0))
(assert (= (+ it124 (* it108 (- 1))) 0))
(assert (= (+ (* (** 5 it118) (+ 0 it109) (+ 0 (- 1))) (+ 0 it125))
   (+ 0 0)))
(assert (and (> (+ it120 (* it121 (- 1))) 0)
     (> (+ (* it124 (- 1)) it123) 0)
     (= (+ it119 (- 3)) 0)))
(assert (= (+ it128 (- 2)) 0))
(assert (= it129 0))
...
(assert (let ((a!1 (+ (+ 0 (+ it142 (* it134 (- 2)) (* it149 2)))
              ...
              (+ 0 (* it142 it132 (- 2))))))
  (= a!1 (+ 0 0))))
(assert (and (>= (+ (* it144 (- 1)) it145 (* it158 (- 1)) 1) 0)
     (> (+ (* it148 (- 1)) it147) 0)
     (>= (+ it158 (- 1)) 0)
     (>= (+ it143 (- 2)) 0)
     (>= (+ (* it143 (- 1)) 2) 0)))
(assert (= (+ it159 (* it143 (- 1))) 0))
(assert (= (+ (* it144 (- 1)) (* it158 (- 1)) it160) 0))
(assert (= (+ it161 (* it145 (- 1))) 0))
(assert (let ((a!1 (+ (+ 0 (+ (* it144 it158 (- 2)) it158))
              (* (** it158 2) (+ 0 (- 1)))
              (+ 0 (* it162 2))
              (+ 0 (* it146 (- 2))))))
  (= a!1 (+ 0 0))))
(assert (= (+ it163 (* it147 (- 1))) 0))
(assert (= (+ it164 (* it148 (- 1))) 0))
(assert (= (+ it165 (* it149 (- 1))) 0))
(assert (let ((a!1 (or (< (+ (* it165 (- 1)) it162) 0) (> (+ (* it165 (- 1)) it162) 0))))
  (and (= (+ it159 (- 2)) 0)
       (> (+ (* it164 (- 1)) it163) 0)
       (> (+ (* it161 (- 1)) it160) 0)
       a!1)))
