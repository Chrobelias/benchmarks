...
(assert (and (>= it287 0) (= (+ it286 (- 2)) 0) (> it289 0)))
(assert (= (+ it348 (- 2)) 0))
(assert (= (+ it349 (* it287 (- 1)) 1) 0))
(assert (= (+ (* it288 (- 1)) it350 (* it287 (- 1))) 0))
(assert (= (+ it351 (* it289 (- 1)) 1) 0))
(assert (= (+ it352 (* it289 (- 1)) (* it290 (- 1))) 0))
(assert (= (+ (* it177 (- 1)) it353) 0))
(assert (= (+ it354 (* it178 (- 1))) 0))
(assert (let ((a!1 (or (< (+ (* it352 (- 1)) it350) 0) (> (+ (* it352 (- 1)) it350) 0))))
  (and (<= it351 0) a!1 (= (+ it348 (- 2)) 0) (< it349 0))))
(check-sat)
