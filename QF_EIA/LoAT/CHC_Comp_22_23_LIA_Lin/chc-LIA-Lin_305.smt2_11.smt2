...
(assert (and (= (+ it372 (- 3)) 0) (> it375 0) (>= it373 0)))
(assert (= (+ it381 (- 3)) 0))
(assert (= (+ it382 (* it373 (- 1)) 1) 0))
(assert (= (+ (* it373 (- 1)) it383 (* it374 (- 1))) 0))
(assert (= (+ (* it375 (- 1)) it384 1) 0))
(assert (= (+ (* it375 (- 1)) it385 (* it376 (- 1))) 0))
(assert (= (+ (* it171 (- 1)) it386) 0))
(assert (= (+ (* it172 (- 1)) it387) 0))
(assert (let ((a!1 (or (< (+ (* it385 (- 1)) it383) 0) (> (+ (* it385 (- 1)) it383) 0))))
  (and a!1 (< it382 0) (<= it384 0) (= (+ it381 (- 3)) 0))))
(check-sat)
