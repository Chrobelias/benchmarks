...
(assert (and (>= (+ it307 (- 2)) 0)
     ...
     (>= (+ it326 (- 1)) 0)
     (>= (+ it308 (* it326 (- 1)) 1) 0)))
(assert (= (+ it329 (* it307 (- 1))) 0))
(assert (= (+ (* it308 (- 1)) it326 it330) 0))
(assert (let ((a!1 (+ (+ 0 (+ (* it326 (- 1))
                          (* it331 2)
                          (* it309 (- 2))
                          (* it308 it326 (- 2))))
              (** it326 2))))
  (= a!1 (+ 0 0))))
(assert (= (+ it332 (* it310 (- 1))) 0))
(assert (= (+ (* it311 (- 1)) it333) 0))
(assert (= (+ it334 (* it181 (- 1))) 0))
(assert (= (+ (* it182 (- 1)) it335) 0))
(assert (let ((a!1 (or (< (+ it331 (* it333 (- 1))) 0) (> (+ it331 (* it333 (- 1))) 0))))
  (and (< it330 0) (= (+ it329 (- 2)) 0) a!1 (<= it332 0))))
(check-sat)
