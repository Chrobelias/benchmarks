...
(assert (and (>= (+ (* it229 (- 1)) it220 (* it219 (- 1)) 1) 0)
...
(assert (let ((a!1 (+ (+ 0 (+ it229
              ...
              (* (** it229 2) (+ 0 (- 1))))))
  (= a!1 (+ 0 0))))
(assert (and (>= (+ it232 (* it169 (- 1)) (* it231 (- 1)) 1) 0)
     (> (+ (* it235 (- 1)) it234) 0)
     (>= (+ it169 (- 1)) 0)
     (>= (+ (* it230 (- 1)) 2) 0)
     (>= (+ it230 (- 2)) 0)))
...
(assert (= (+ (* (** 2 it267) (+ 0 it256) (+ 0 (- 1))) (+ 0 it271))
   (+ 0 0)))
(assert (= (+ (* it267 (- 1)) it272 (* it257 (- 1))) 0))
(assert (= (+ it273 (* it258 (- 1))) 0))
(assert (= (+ (* (** 2 it267) (+ 0 it259) (+ 0 (- 1))) (+ 0 it274))
   (+ 0 0)))
(assert (let ((a!1 (or (< (+ (* it274 (- 1)) it271) 0) (> (+ (* it274 (- 1)) it271) 0))))
  (and (= (+ it268 (- 4)) 0)
       (> (+ (* it273 (- 1)) it272) 0)
       (> (+ it269 (* it270 (- 1))) 0)
       a!1)))
