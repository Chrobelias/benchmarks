...
(assert (= (+ (* (+ 0 it265) (** 2 it276) (+ 0 (- 1))) (+ 0 it280))
   (+ 0 0)))
(assert (= (+ it281 (* it266 (- 1)) (* it276 (- 1))) 0))
(assert (= (+ it282 (* it267 (- 1))) 0))
(assert (= (+ (* (+ 0 it268) (** 2 it276) (+ 0 (- 1))) (+ 0 it283))
   (+ 0 0)))
...
(assert (and (>= it287 0) (> it289 0) (= (+ it286 (- 2)) 0)))
(assert (= (+ it295 (- 2)) 0))
(assert (= (+ it296 (* it287 (- 1)) 1) 0))
(assert (= (+ (* it288 (- 1)) (* it287 (- 1)) it297) 0))
(assert (= (+ it298 (* it289 (- 1)) 1) 0))
(assert (= (+ (* it289 (- 1)) it299 (* it290 (- 1))) 0))
(assert (= (+ (* it177 (- 1)) it300) 0))
(assert (= (+ it301 (* it178 (- 1))) 0))
(assert (let ((a!1 (or (< (+ (* it299 (- 1)) it297) 0) (> (+ (* it299 (- 1)) it297) 0))))
  (and (< it296 0) (= (+ it295 (- 2)) 0) a!1 (<= it298 0))))
(check-sat)
