...
(assert (and (<= (+ it129 (* it130 (- 1))) 0)
     (= (+ it128 (- 2)) 0)
     (<= (+ (* it133 (- 1)) it132) 0)))
(assert (= (+ it174 (- 2)) 0))
(assert (= (+ (* it129 (- 1)) it175 (- 1)) 0))
(assert (= (+ (* it130 (- 1)) it176) 0))
(assert (= (+ (* it129 (- 1)) (* it131 (- 1)) it177) 0))
(assert (= (+ it178 (* it132 (- 1)) (- 1)) 0))
(assert (= (+ (* it133 (- 1)) it179) 0))
(assert (= (+ (* it134 (- 1)) it180 (* it132 (- 1))) 0))
(assert (let ((a!1 (or (> (+ (* it180 (- 1)) it177) 0) (< (+ (* it180 (- 1)) it177) 0))))
  (and a!1
       (= (+ it174 (- 2)) 0)
       (> (+ it175 (* it176 (- 1))) 0)
       (> (+ it178 (* it179 (- 1))) 0))))
