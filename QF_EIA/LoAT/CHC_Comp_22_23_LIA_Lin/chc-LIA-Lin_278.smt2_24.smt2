...
(assert (and (= (+ it307 (- 2)) 0) (<= it310 0) (>= it308 0)))
(assert (= (+ it339 (- 2)) 0))
(assert (= (+ (* it308 (- 1)) it340 1) 0))
(assert (= (+ (* it308 (- 1)) (* it309 (- 1)) it341) 0))
(assert (= (+ it342 (* it310 (- 1))) 0))
(assert (= (+ (* it311 (- 1)) it343) 0))
(assert (= (+ (* it181 (- 1)) it344) 0))
(assert (= (+ it345 (* it182 (- 1))) 0))
(assert (let ((a!1 (or (< (+ (* it343 (- 1)) it341) 0) (> (+ (* it343 (- 1)) it341) 0))))
  (and a!1 (= (+ it339 (- 2)) 0) (<= it342 0) (< it340 0))))
(check-sat)
