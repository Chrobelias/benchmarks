...
(assert (= (+ it317 (- 2)) 0))
(assert (= (+ (* it308 (- 1)) it318 1) 0))
(assert (= (+ (* it308 (- 1)) it319 (* it309 (- 1))) 0))
(assert (= (+ it320 (* it310 (- 1))) 0))
(assert (= (+ it321 (* it311 (- 1))) 0))
(assert (= (+ it322 (* it181 (- 1))) 0))
(assert (= (+ (* it182 (- 1)) it323) 0))
(assert (let ((a!1 (or (< (+ (* it321 (- 1)) it319) 0) (> (+ (* it321 (- 1)) it319) 0))))
  (and (<= it320 0) a!1 (< it318 0) (= (+ it317 (- 2)) 0))))
(check-sat)
