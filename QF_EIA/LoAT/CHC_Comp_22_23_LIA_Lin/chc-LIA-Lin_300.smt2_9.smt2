...
(assert (and (= (+ it158 (- 2)) 0)
     ...
     (>= (+ (* it162 (- 1)) it163) 0)))
(assert (= (+ it165 (- 2)) 0))
(assert (= (+ (* it159 (- 1)) it166 (- 1)) 0))
(assert (= (+ (* it160 (- 1)) it167) 0))
(assert (= (+ it168 (* it159 (- 1)) (* it161 (- 1))) 0))
(assert (= (+ (* it162 (- 1)) it169 (- 1)) 0))
(assert (= (+ (* it163 (- 1)) it170) 0))
(assert (= (+ (* it162 (- 1)) (* it164 (- 1)) it171) 0))
(assert (let ((a!1 (or (> (+ it168 (* it171 (- 1))) 0) (< (+ it168 (* it171 (- 1))) 0))))
  (and (= (+ it165 (- 2)) 0)
       (< (+ (* it169 (- 1)) it170) 0)
       (< (+ (* it166 (- 1)) it167) 0)
       a!1)))
