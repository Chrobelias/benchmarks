...
(assert (and (<= (+ it129 (* it130 (- 1))) 0)
     ...
     (<= (+ (* it133 (- 1)) it132) 0)))
(assert (= (+ it135 (- 2)) 0))
(assert (= (+ (* it129 (- 1)) it136 (- 1)) 0))
(assert (= (+ it137 (* it130 (- 1))) 0))
(assert (= (+ (* it129 (- 1)) it138 (* it131 (- 1))) 0))
(assert (= (+ it139 (* it132 (- 1)) (- 1)) 0))
(assert (= (+ (* it133 (- 1)) it140) 0))
(assert (= (+ it141 (* it134 (- 1)) (* it132 (- 1))) 0))
(assert (let ((a!1 (or (< (+ (* it141 (- 1)) it138) 0) (> (+ (* it141 (- 1)) it138) 0))))
  (and (> (+ it139 (* it140 (- 1))) 0)
       (> (+ (* it137 (- 1)) it136) 0)
       a!1
       (= (+ it135 (- 2)) 0))))
