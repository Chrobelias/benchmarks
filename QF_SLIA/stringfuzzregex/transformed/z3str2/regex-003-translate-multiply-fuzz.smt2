...
(assert (str.in_re x (re.+ (re.++ (str.to_re "LA'\t'zVL`6Jtt[fBC9-lC%Nmo:'\x0c''\x0c'yW,NZ:dh\\%:o6yy+LLlF?E!YSqIgx0bbYo0N2iYJsQ+!0!s%h'\t'TByK3A*8L-[SDI''\r'b*l#yq'e)7.l309>\\'\\\\6N+0T[CmGsxlrYA^38xFhg;""''\n'rEfp*#91fpgu=\\4(77p|XA_p1;?'\x0c'oP<e#yo/4E9m0F'\t'W5z\\/Sd(") (str.to_re "\\\\\\V;eo""nX'\n'[jXyY/7(N'qYA")))))
(check-sat)
