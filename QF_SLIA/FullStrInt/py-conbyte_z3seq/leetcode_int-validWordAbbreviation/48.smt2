...
(assert ( = ( ite ( str.prefixof "-" ( str.at abbr 3  )  ) ( - ( str.to_int ( str.substr ( str.at abbr 3  ) 1 ( - ( str.len ( str.at abbr 3  )  ) 1  )  )  )  ) ( str.to_int ( str.at abbr 3  )  )  ) 0  ))
