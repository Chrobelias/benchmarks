...
(assert (not ( <= ( ite ( str.prefixof "-" ( str.substr dtstr 8 ( - 10 8  )  )  ) ( - ( str.to_int ( str.substr ( str.substr dtstr 8 ( - 10 8  )  ) 1 ( - ( str.len ( str.substr dtstr 8 ( - 10 8  )  )  ) 1  )  )  )  ) ( str.to_int ( str.substr dtstr 8 ( - 10 8  )  )  )  ) 0  )))

(assert ( ite ( str.prefixof "-" ( str.substr dtstr 8 ( - 10 8  )  )  ) ( and ( ite ( = (- 1) ( str.to_int ( str.substr ( str.substr dtstr 8 ( - 10 8  )  ) 1 ( - ( str.len ( str.substr dtstr 8 ( - 10 8  )  )  ) 1  )  )  )  ) false true  ) ( > ( str.len ( str.substr dtstr 8 ( - 10 8  )  )  ) 1  )  ) ( ite ( = (- 1) ( str.to_int ( str.substr dtstr 8 ( - 10 8  )  )  )  ) false true  )  ))

(assert (not ( not ( = ( str.at dtstr 7  ) "-"  )  )))
...
(assert ( > ( ite ( str.prefixof "-" ( str.substr dtstr 8 ( - 10 8  )  )  ) ( - ( str.to_int ( str.substr ( str.substr dtstr 8 ( - 10 8  )  ) 1 ( - ( str.len ( str.substr dtstr 8 ( - 10 8  )  )  ) 1  )  )  )  ) ( str.to_int ( str.substr dtstr 8 ( - 10 8  )  )  )  ) 32  ))
