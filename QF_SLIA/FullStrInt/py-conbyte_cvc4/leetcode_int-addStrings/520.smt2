...
(assert ( >= ( + ( ite ( str.prefixof "-" ( str.at num2 ( + ( str.len num2  ) (- 4)  )  )  ) ( - ( str.to_int ( str.substr ( str.at num2 ( + ( str.len num2  ) (- 4)  )  ) 1 ( - ( str.len ( str.at num2 ( + ( str.len num2  ) (- 4)  )  )  ) 1  )  )  )  ) ( str.to_int ( str.at num2 ( + ( str.len num2  ) (- 4)  )  )  )  ) 1  ) 10  ))
...
(assert ( >= ( + ( ite ( str.prefixof "-" ( str.at num2 ( + ( str.len num2  ) (- 3)  )  )  ) ( - ( str.to_int ( str.substr ( str.at num2 ( + ( str.len num2  ) (- 3)  )  ) 1 ( - ( str.len ( str.at num2 ( + ( str.len num2  ) (- 3)  )  )  ) 1  )  )  )  ) ( str.to_int ( str.at num2 ( + ( str.len num2  ) (- 3)  )  )  )  ) 1  ) 10  ))
