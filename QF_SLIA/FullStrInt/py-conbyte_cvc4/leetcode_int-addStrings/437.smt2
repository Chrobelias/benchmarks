...
(assert (not ( >= ( + ( ite ( str.prefixof "-" ( str.at num2 ( + ( str.len num2  ) (- 6)  )  )  ) ( - ( str.to_int ( str.substr ( str.at num2 ( + ( str.len num2  ) (- 6)  )  ) 1 ( - ( str.len ( str.at num2 ( + ( str.len num2  ) (- 6)  )  )  ) 1  )  )  )  ) ( str.to_int ( str.at num2 ( + ( str.len num2  ) (- 6)  )  )  )  ) 0  ) 10  )))
...
(assert (not ( >= ( + ( ite ( str.prefixof "-" ( str.at num2 ( + ( str.len num2  ) (- 5)  )  )  ) ( - ( str.to_int ( str.substr ( str.at num2 ( + ( str.len num2  ) (- 5)  )  ) 1 ( - ( str.len ( str.at num2 ( + ( str.len num2  ) (- 5)  )  )  ) 1  )  )  )  ) ( str.to_int ( str.at num2 ( + ( str.len num2  ) (- 5)  )  )  )  ) 0  ) 10  )))
...
(assert (not ( >= ( + ( ite ( str.prefixof "-" ( str.at num2 ( + ( str.len num2  ) (- 2)  )  )  ) ( - ( str.to_int ( str.substr ( str.at num2 ( + ( str.len num2  ) (- 2)  )  ) 1 ( - ( str.len ( str.at num2 ( + ( str.len num2  ) (- 2)  )  )  ) 1  )  )  )  ) ( str.to_int ( str.at num2 ( + ( str.len num2  ) (- 2)  )  )  )  ) 0  ) 10  )))
...
(assert (not ( >= ( + ( - (- 1) 1  ) ( ite ( < ( str.len "0"  ) ( str.len num2  )  ) ( str.len "0"  ) ( str.len num2  )  )  ) 0  )))
