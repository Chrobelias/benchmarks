...
(assert ( >= ( + ( ite ( str.prefixof "-" ( str.at num2 ( + ( str.len num2  ) (- 2)  )  )  ) ( - ( str.to_int ( str.substr ( str.at num2 ( + ( str.len num2  ) (- 2)  )  ) 1 ( - ( str.len ( str.at num2 ( + ( str.len num2  ) (- 2)  )  )  ) 1  )  )  )  ) ( str.to_int ( str.at num2 ( + ( str.len num2  ) (- 2)  )  )  )  ) 0  ) 10  ))
