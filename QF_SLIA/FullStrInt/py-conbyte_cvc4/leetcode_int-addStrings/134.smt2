...
(assert ( >= ( + ( ite ( str.prefixof "-" ( str.at num1 ( + ( str.len num1  ) (- 2)  )  )  ) ( - ( str.to_int ( str.substr ( str.at num1 ( + ( str.len num1  ) (- 2)  )  ) 1 ( - ( str.len ( str.at num1 ( + ( str.len num1  ) (- 2)  )  )  ) 1  )  )  )  ) ( str.to_int ( str.at num1 ( + ( str.len num1  ) (- 2)  )  )  )  ) 0  ) 10  ))
